...
return [
    ...
    'Assets' => 'Assets',
    'Routes' => 'Routes',
    'File Directory Path' => 'Verzeichnispfad',
    ...
    'Default Email Template Creation Method' => 'Standard Email-Benachrichtigungsmethode',
    ...
    "Provide a relative path to the Craft Templates folder where your email templates directory is. If you have not yet created the directory, please do that before filling in this setting. This allows you to use Twig template files for your email formatting and allows Freeform to locate these files when setting up notifications. To add a starter example template, click the 'Add a sample template' button, and then edit the template after." => 'Definiere einen relativen Pfad zum Craft Root-Verzeichnis, in dem dein Email-Template-Verzeichnis liegt. Das ermöglicht es dir, Twig Template Files für deine Email-Formatierung zu nutzen, und hilft dem Form Builder, die Files beim Setup neuer Benachrichtigungen zu lokalisieren',
    "Select which storage method to use when creating new email notifications with 'Add New Template' option in the form builder." => 'Welche Speichermethode soll beim Erstellen neuer Email-Benachrichtigungen mit "Neue Benachrichtigung hinzufügen" verwendet werden?',

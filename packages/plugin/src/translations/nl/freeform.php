...
return [
    ...
    'Comma-separated Stripe payment method types allowed on subscriptions (e.g. "bacs_debit, card, us_bank_account"). Leave blank to use your Stripe account default.' => 'Door komma’s gescheiden Stripe-betaalmethodetypes die zijn toegestaan bij abonnementen (bijv. "bacs_debit, card, us_bank_account"). Laat leeg om de standaardinstelling van je Stripe-account te gebruiken.',
    'e.g. "bacs_debit"' => 'bijv. "bacs_debit"',

...
return [
    ...
    "Provide a relative path to the Craft Templates folder where your email templates directory is. If you have not yet created the directory, please do that before filling in this setting. This allows you to use Twig template files for your email formatting and allows Freeform to locate these files when setting up notifications. To add a starter example template, click the 'Add a sample template' button, and then edit the template after." => "Provide a relative path to the Craft Templates folder where your email templates directory is. If you have not yet created the directory, please do that before filling in this setting. This allows you to use Twig template files for your email formatting and allows Freeform to locate these files when setting up notifications. To add a starter example template, click the 'Add a sample template' button, and then edit the template after.",

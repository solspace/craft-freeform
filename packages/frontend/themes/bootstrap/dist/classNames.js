...
export const darkSelectInput = "form-control form-select bg-dark-subtle text-white";
export const lightFileInput = "form-control";
export const darkFileInput = "form-control bg-dark-subtle text-white";
export const lightFileDndInput = "form-control d-flex align-items-center justify-content-center text-center";
export const darkFileDndInput = "form-control bg-dark-subtle text-white d-flex align-items-center justify-content-center text-center";
...
export function lightClassNamesByType() {
    return {
        ...
        "opinion-scale": {
            ...
            optionLabel: "freeform-bootstrap-opinion-scale d-flex flex-column align-items-center justify-content-center border border-secondary bg-light text-dark px-3 py-2 text-center user-select-none mb-0",
        ...
        cards: {
            input: "row g-3",
            optionLabel: "freeform-bootstrap-card col border rounded p-3 h-100 text-start",
            optionInput: "visually-hidden",
        },
    };
}
export function darkClassNamesByType() {
    return {
        ...
        signature: { input: "btn btn-light" },
        table: {
            input: "table-responsive table table-dark table-striped table-hover align-middle",
        },
        "opinion-scale": {
            input: "d-flex flex-wrap gap-2",
            optionLabel: "freeform-bootstrap-opinion-scale d-flex flex-column align-items-center justify-content-center border border-secondary bg-dark text-white px-3 py-2 text-center user-select-none mb-0",
            optionInput: "visually-hidden",
        },
        rating: {
            input: "d-flex flex-wrap gap-1",
        ...
        cards: {
            input: "row g-3",
            optionLabel: "freeform-bootstrap-card col border border-secondary bg-dark text-white rounded p-3 h-100 text-start",
            optionInput: "visually-hidden",
        },
    };
}

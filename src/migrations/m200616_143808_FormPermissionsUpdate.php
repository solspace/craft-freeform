...
class m200616_143808_FormPermissionsUpdate extends Migration
{
    ...
    public function safeUp()
    {
        ...
        foreach ($permissions as $permission) {
            if ($permission['name'] === 'freeform-formscreate') $create = $permission['id'];
            if ($permission['name'] === 'freeform-formsdelete') $delete = $permission['id'];
            if ($permission['name'] === 'freeform-formsmanage') $manage = $permission['id'];
        }

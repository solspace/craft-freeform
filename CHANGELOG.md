...
### Added
- Added optional **Site Filtering** setting for forms and submissions. This setting allows you to filter form lists by Sites and prevents other admins from accessing forms that belong to Sites they don't have access to.

...
return [
    ...
    'Composer has no properties' => 'Composer hat keine Properties',
    'No composer data present' => 'Keine Composer Daten verfügbar',
    ...
    'Provide a relative path to the Craft root folder where your email templates directory is. This allows you to use Twig template files for your email formatting, and helps Composer locate these files when setting up notifications.' => 'Definiere einen relativen Pfad zum Craft Root-Verzeichnis, in dem dein Email-Template-Verzeichnis liegt. Das ermöglicht es dir, Twig Template Files für deine Email-Formatierung zu nutzen, und hilft dem Composer, die Files beim Setup neuer Benachrichtigungen zu lokalisieren',
    "Which storage method to use when creating new email notifications with 'Add New Notification' option in Composer." => 'Welche Speichermethode soll beim Erstellen neuer Email-Benachrichtigungen mit "Neue Benachrichtigung hinzufügen" verwendet werden?',
    'Display Order of Fields in Composer' => 'Anzeige-Reihenfolge von Feldern im Composer',
    'The display order for the list of available fields in Composer.' => 'Anzeige-Reihenfolge für die Liste von verfügbaren Feldern im Composer.',
    'Show Composer Tutorial' => 'Zeige das Composer-Tutorial',
    'Enable this to show the interactive tutorial again in Composer. This setting disables again when the tutorial is completed or skipped.' => 'Aktivieren, um das Interaktive Tutorial im Composer erneut zu zeigen. Diese Einstellung deaktiviert sich wieder, wenn das Tutorial abgeschlossen oder übersprungen wird.',
    'Render HTML inside Composer & Submissions view?' => 'HTML im Composer & Submissions view rendern?',
    ...
    'Live rendering HTML in HTML blocks, field labels and option labels inside the Composer interface can sometimes conflict with Freeform\'s display of the form preview inside the control panel. In cases like these, you\'ll need to disable this setting to prevent HTML from rendering automatically.' => 'Das Live Rendering von HTML in HTML-Blöcken, Field Labels und Option Labels im Composer Interface kann in der Freeform-Anzeige der Formular-Vorschau im Control Panel für Fehler sorgen. In diesen Fällen musst du die Einstellung deaktivieren, um das automatische HTML-Rendering zu unterbinden.',
    'Include Default Freeform Formatting Templates' => 'Inkludiere standardmäßige Freeform Formatierungstemplates',
    'Disable this to hide the default Freeform formatting templates in the Formatting Template options list inside Composer.' => 'Deaktivieren, um die standardmäßigen Freeform Formatierungs-Templates in der Format-Optionenliste im Composer unsichtbar zu machen',
    ...
    'This is where all your configuration will happen. Clicking on any field, page tab, etc in Composer layout area will load its configuration options here.' => 'Hier erfolgt die gesamte Konfiguration. Klicken auf ein Feld, einen Page-Tab etc. im Composer Layout-Bereich lädt die jeweiligen Konfigurationen hier.',

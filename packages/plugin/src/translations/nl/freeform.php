...
return [
    ...
    'To use a Stripe payment configuration other than the Default, enter its ID here. This applies to one-time payments only. Stripe subscriptions do not support payment method configurations and will always use your Stripe account default.' => 'Voer hier het ID in van een andere Stripe-configuratie dan de standaard. Dit geldt alleen voor eenmalige betalingen. Stripe-abonnementen ondersteunen geen betaalmethodeconfiguraties en gebruiken altijd de standaardinstelling van je Stripe-account.',

...
return [
    ...
    // Solspace AI
    'Authorize Solspace AI to view usage' => 'Autoriseer Solspace AI om gebruik te bekijken',
    'Solspace AI is not enabled' => 'Solspace AI is niet ingeschakeld',
    'Authorize Solspace AI in the Integrations area (click Authorize on the Solspace AI integration) to view usage and spend.' => 'Autoriseer Solspace AI in het gedeelte Integraties (klik op Autoriseren bij de Solspace AI-integratie) om gebruik en kosten te bekijken.',
    'Enable Solspace AI in the Integrations area to view usage and spend.' => 'Schakel Solspace AI in via het gedeelte Integraties om gebruik en kosten te bekijken.',
    'Dashboard' => 'Dashboard',
    'Go to Integrations' => 'Ga naar Integraties',
    'Unknown' => 'Onbekend',
    'Solspace AI' => 'Solspace AI',
    'Solspace AI requires Freeform Pro' => 'Solspace AI vereist Freeform Pro',
    'Upgrade to the Freeform Pro edition to get access to Solspace AI.' => 'Upgrade naar de Freeform Pro-editie om toegang te krijgen tot Solspace AI.',
    'Error loading usage' => 'Fout bij laden van gebruik',
    'Failed to load usage data' => 'Laden van gebruiksgegevens mislukt',
    'Enable Solspace AI in the Integrations area to view usage.' => 'Schakel Solspace AI in via het gedeelte Integraties om gebruik te bekijken.',
    'Enable Solspace AI' => 'Solspace AI inschakelen',
    'Authorize Solspace AI in the Integrations area (click Authorize on the Solspace AI integration) to view usage.' => 'Autoriseer Solspace AI in het gedeelte Integraties (klik op Autoriseren bij de Solspace AI-integratie) om gebruik te bekijken.',
    ...
    'Usage will appear here once you start using Solspace AI.' => 'Gebruik verschijnt hier zodra je Solspace AI gaat gebruiken.',
    'Free trial' => 'Gratis proefperiode',
    'Low credits' => 'Weinig credits',
    'Out of credits' => 'Geen credits meer',
    'Since' => 'Sinds',
    'Purchase Solspace AI Credits' => 'Koop Solspace AI-credits',
    'Currency' => 'Valuta',
    'Credit plan' => 'Creditplan',
    'Credit package for Solspace AI usage.' => 'Creditpakket voor gebruik van Solspace AI.',
    'Loading...' => 'Laden...',
    'Buy now' => 'Nu kopen',
    'Recent Payments' => 'Recente betalingen',
    'Your recent Solspace AI credit purchase history.' => 'Je recente aankoopgeschiedenis van Solspace AI-credits.',
    ...
    'Solspace AI <span class="light">(enable)</span>' => 'Solspace AI <span class="light">(inschakelen)</span>',

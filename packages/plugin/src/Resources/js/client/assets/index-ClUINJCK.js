...
`,ba=20,Nx=(t,n)=>{const s=t?.getBoundingClientRect().top,i=window.innerHeight,o=n?.offsetHeight;return o===void 0?s:s&&o&&i?s+o>i-ba?s-(s+o-i+ba):s:0},zx=(t,n,s)=>{const{dimensions:i}=Ec(),[o,r]=g.useState(0),[a,c]=g.useState(0);let u=null;const p=g.useCallback(()=>{u===null&&(u=requestAnimationFrame(()=>{u=null,r(Nx(t,n));const x=t?.getBoundingClientRect()?.left;x!=null&&i&&c(x-i.left)}))},[t,n,i,u]);return g.useEffect(()=>{p()},[s]),g.useEffect(()=>{const x=()=>{p()};if(n){const f=document.querySelector(Zn.toString()),b=new ResizeObserver(x);return b.observe(n),window.addEventListener("resize",x),window.addEventListener("scroll",x),f?.addEventListener("scroll",x),()=>{b.disconnect(),window.removeEventListener("resize",x),window.removeEventListener("scroll",x),f?.removeEventListener("scroll",x),u!==null&&cancelAnimationFrame(u)}}},[n,u,p]),{top:o,left:a}},td=({wrapper:t,editor:n,isEditing:s})=>{const{top:i,left:o}=zx(t,n,s),r=t?.offsetWidth,[a,c]=g.useState(!1);return{editorAnimation:Y({immediate:p=>["top","left","width","pointerEvents","transformOrigin"].includes(p),to:{top:i,left:o,width:r,opacity:s?1:0,transformOrigin:"top left",transform:s?"scaleY(1)":"scaleY(0.5)",pointerEvents:s?"initial":"none"},config:{tension:700,friction:40}}),isVisible:a,setVisible:c}},er=t=>e.jsxs(R,{viewBox:"0 0 512 512",...t,children:[e.jsx("style",{children:`.spinner-path {
...
`,xd=({value:t,options:n,query:s,focusIndex:i,showValues:o,showHints:r,onChange:a})=>{const c=g.useRef([]);return g.useEffect(()=>{c.current[i]&&c.current[i].scrollIntoView({behavior:"smooth",block:"nearest"})},[i]),e.jsx(Rx,{children:n?.map((u,p)=>{let x,f,b;"value"in u&&(x=u.value,b=u.shadowIndex),"hint"in u&&(f=u.hint);let j;return"children"in u&&(j=u.children),e.jsxs(Px,{ref:y=>{b!==void 0&&(c.current[b]=y)},onClick:y=>{y.stopPropagation(),x!==void 0&&a&&a(x)},className:E(j!==void 0&&"has-children",x===t&&"selected",x===""&&"empty",b===i&&"focused"),children:[e.jsxs(Wn,{className:E(j!==void 0&&"has-children"),"data-value":x,children:[!j&&t===x&&e.jsx(Hs,{children:e.jsx(Ax,{})}),e.jsxs(dd,{children:[u.icon&&e.jsx(Ux,{children:u.icon}),e.jsx("div",{children:e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(u.label)}})})]}),!o&&r&&f&&e.jsx(ja,{children:f}),o&&x!==""&&x!==void 0&&x!==null&&x!==u.label&&e.jsx(ja,{children:x})]}),j&&e.jsx(xd,{options:j,value:t,query:s,focusIndex:i,onChange:a,showHints:r,showValues:o})]},p)})})},de=({emptyOption:t,value:n,options:s,showValues:i,showHints:o,showSelectedIcon:r,onChange:a,className:c,loading:u=!1})=>{const[p,x]=g.useState(!1),[f,b]=g.useState(""),[j,y]=g.useState(0),w=g.useRef(null),v=g.useRef(null),$=$t({callback:()=>x(!1),isEnabled:p,excludeClassNames:["dropdown-rollout"]}),{editorAnimation:C}=td({wrapper:$.current,editor:v.current,isEditing:p}),F=g.useCallback(()=>{u||x(!p)},[u,p]),[N,M]=Ix(s,f,t),z=g.useMemo(()=>od(s,n),[s,n]),L=g.useMemo(()=>rd(N,n),[N,n]);os(()=>x(!1),p),ft({meetsCondition:p,type:"keydown",callback:D=>{D.key==="ArrowDown"&&j<M-1&&y(J=>J+1),D.key==="ArrowUp"&&j>0&&y(J=>J-1)}},[j,M]),ft({meetsCondition:p,type:"keyup",callback:D=>{if(D.key==="Enter"){const J=ad(N,j);a?.(J),x(!1)}}},[N,j]),g.useEffect(()=>{u&&p&&x(!1)},[u,p]),g.useEffect(()=>{p?(w.current?.focus(),y(L||0)):b("")},[p,L]);const A=g.useCallback(D=>{a?.(D),x(!1)},[a]);return e.jsxs(Wx,{ref:$,className:E(p&&"open",c),onClick:F,children:[e.jsxs(ud,{className:E(u&&"disabled",(n===""||n===null)&&"empty"),children:[r&&e.jsx(hd,{children:z?.icon}),e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(z?.label||d(t))}}),u&&e.jsx(Ox,{children:e.jsx(er,{})})]}),e.jsx(nd,{children:p&&e.jsxs(pd,{className:"dropdown-rollout",ref:v,style:C,children:[e.jsx(_x,{children:e.jsx(Mx,{})}),e.jsx(Dx,{placeholder:d("Search..."),ref:w,value:f,onClick:D=>D.stopPropagation(),onKeyDown:D=>{["ArrowUp","ArrowDown"].includes(D.key)&&D.preventDefault()},onChange:D=>b(D.target.value)}),e.jsx(Bx,{children:e.jsx(xd,{options:N,value:n,focusIndex:j,showValues:i,showHints:o,onChange:A})})]})})]})},Xn={all:["field-types"],propertySections:()=>[...Xn.all,"property-sections"]},md=()=>T.get("/api/fields/types").then(t=>t.data),tr=({select:t}={})=>B({queryKey:Xn.all,queryFn:md,staleTime:1/0,select:t}),gd=()=>T.get("/api/fields/types/sections").then(t=>t.data).then(t=>t.sort((n,s)=>n.order-s.order)),nr=()=>B({queryKey:Xn.propertySections(),queryFn:gd,staleTime:1/0}),Me=t=>{const{data:n}=tr();if(n)return n.find(s=>s.typeClass===t)},Yt=()=>{const{data:t}=tr();return n=>{if(t)return t.find(s=>s.typeClass===n)}},Hx={all:["page-type"]},fd=()=>B({queryKey:Hx.all,queryFn:()=>T.get("/api/types/page-buttons").then(t=>t.data),staleTime:1/0});var K=(t=>(t.Ai="ai",t.AppStateSelect="appStateSelect",t.AssetPicker="assetPicker",t.Attributes="attributes",t.Boolean="bool",t.BooleanEnv="boolEnv",t.FormMonitorTools="formMonitorTools",t.Calculation="calculation",t.Cards="cards",t.Checkboxes="checkboxes",t.CodeEditor="codeEditor",t.Color="color",t.ConditionalRules="conditionalRules",t.DateTime="dateTime",t.DynamicCheckboxes="dynamicCheckboxes",t.DynamicSelect="dynamicSelect",t.Field="field",t.FieldMapping="fieldMapping",t.FieldSelection="fieldSelection",t.FieldType="fieldType",t.Hidden="hidden",t.Integer="int",t.Label="label",t.MinMax="minMax",t.NotificationTemplate="notificationTemplate",t.OptionPicker="optionPicker",t.Options="options",t.PageButton="pageButton",t.PageButtonsLayout="pageButtonsLayout",t.RecipientMapping="recipientMapping",t.Recipients="recipients",t.SaveButton="saveButton",t.Select="select",t.String="string",t.Table="table",t.TabularData="tabularData",t.Textarea="textarea",t.WYSIWYG="wysiwyg",t))(K||{});const Pe={current:t=>t.form,settings:{all:()=>t=>t.form.settings||{},one:t=>n=>n.form.settings?.[t],namespaces:{all:t=>n=>n.form.settings?.[t],one:(t,n)=>s=>s.form.settings?.[t]?.[n]}},errors:t=>t.form.errors},qx={namespace:(t,n)=>X(s=>s.translations?.[t],s=>{if(!n)return;let i,o=n?.uid;return"properties"in n?i="fields":"namespaceType"in n&&n.namespaceType==="settings"?(i="form",o=n.namespace):i="pages",s?.[i]?.[o]})},Qx=[K.Options];function Ce(t){const n=H(),{current:s,isPrimary:i}=Fe(),o=Yt(),a=P(Pe.settings.one("general"))?.translations,{data:c}=fd(),{data:u}=Gt(),p=t&&"typeClass"in t,x=t&&"namespaceType"in t&&t.namespaceType==="settings",f=s.id,b=x?t.namespace:t?.uid,j=p?"fields":x?"form":"pages",y=Pt(qx.namespace(s.id,t)),w=g.useCallback(L=>{if(p){const A=o(t.typeClass);return A?A.properties.find(D=>D.handle===L):void 0}if(x){const A=u?.find(D=>D.handle===b);return A?A.properties.find(D=>D.handle===L):void 0}return c?.properties?.find(A=>A.handle===L)},[p,x,o,c,b]),v=g.useCallback(L=>t&&y?.[L]!==void 0,[t,y]),$=g.useCallback(L=>{if(!a||!t||i)return!1;const A=w(L);return A===void 0?L==="label":A.translatable},[i,t,a,w]),C=g.useCallback((L,A)=>!$(L)||!v(L)?A:y[L],[y,$,v]),F=g.useCallback((L,A)=>{if(!$(L)||!v(L))return A;const D=Mt(A),J=y[L];return D.source==="custom"&&J.options&&(D.options=D.options.map(pe=>{const St=J.options.find(on=>on.value===pe.value);return St?{...pe,label:St.label}:pe})),D},[y,$,v]);return{hasTranslation:v,willTranslate:$,getTranslation:C,getOptionTranslations:F,updateTranslation:(L,A)=>$(L)?(n(to.update({siteId:f,type:j,namespace:b,handle:L,value:A})),!0):!1,removeTranslation:L=>{$(L)&&n(to.remove({siteId:f,type:j,namespace:b,handle:L}))},canUseTranslationValue:L=>L.translatable&&Qx.includes(L.type)===!1,isTranslationsEnabled:a}}const Fn=l.label`
  display: flex;
  justify-content: start;
  align-items: center;
  gap: 6px;
...
`;l.div`
  ...
  user-select: none;
  pointer-events: none;
`;const s2="yyyy-MM-dd",{metadata:{craft:{locale:i2}}}=I,so=({value:t,property:n,errors:s,updateValue:i})=>{const{dateFormat:o,minDate:r,maxDate:a}=n,c=o||s2,u=r?Qn(r):void 0,p=a?Qn(a):void 0,x=t?Qn(t):void 0,[f,b]=g.useState(void 0);return g.useEffect(()=>{t2(i2).then(b).catch(()=>b(void 0))},[]),e.jsx(W,{property:n,errors:s,children:e.jsx(n2,{children:e.jsx(v1,{locale:f,id:n.handle,minDate:u,maxDate:p,selected:x,dateFormat:c,className:E("text","fullwidth"),onChange:j=>i(j?s0(j):null)})})})},o2=()=>e.jsxs(r2,{className:"notice has-icon",children:[e.jsx("span",{className:"icon","aria-hidden":"true"}),e.jsx("span",{className:"visually-hidden",children:"Tip: "}),e.jsxs("span",{children:[d("This can begin with an environment variable.")," ",e.jsx("a",{href:"https://craftcms.com/docs/5.x/configure.html#control-panel-settings",className:"go",target:"_blank",rel:"noopener noreferrer",children:d("Learn more")})]})]}),r2=l.p`
  margin-top: 5px;
...
`,Tn=({active:t,onClick:n,...s})=>{const i=g.useRef(null),o=Ct(i),a={...hg({active:t,hovering:o}),...s?.style};return delete s.style,e.jsx(Od,{type:"button",ref:i,style:a,onClick:n,...s,children:e.jsx(Yc,{})})},xg={dark:se`
...
`,zi=l.div`
  ...
  margin-bottom: ${m.lg};
  width: 100%;
`,Sg=({data:t,closeModal:n})=>{if(!t)return null;const{screenshot:s,beforeSubmitScreenshot:i,testId:o}=t,r=!!s,a=!!i,c=r&&a,u=(x,f)=>e.jsxs(Ma,{children:[c&&e.jsx(Ia,{children:f}),e.jsx(Aa,{children:e.jsx(D1,{initialScale:1,minScale:.5,maxScale:3,wheel:{step:.1},pinch:{step:5},doubleClick:{step:.5},children:({zoomIn:b,zoomOut:j,resetTransform:y,instance:w})=>e.jsxs(e.Fragment,{children:[e.jsx(B1,{wrapperStyle:{width:"100%",height:"100%",display:"flex",justifyContent:"center",alignItems:"center"},contentStyle:{width:"100%",height:"100%",display:"flex",justifyContent:"center",alignItems:"center"},children:e.jsx(wg,{src:x,alt:f,loading:"lazy",draggable:!1})}),e.jsxs($g,{children:[e.jsxs(Cg,{children:[e.jsx(Ni,{onClick:()=>j(),disabled:w.transformState.scale<=.5,title:d("Zoom Out"),children:"−"}),e.jsx(Ni,{onClick:()=>y(),title:d("Reset Zoom"),children:"↺"}),e.jsx(Ni,{onClick:()=>b(),disabled:w.transformState.scale>=3,title:d("Zoom In"),children:"+"})]}),e.jsx(O1,{width:104,height:108,borderColor:"rgba(255, 255, 255, 0.8)",children:e.jsx("img",{src:x,alt:"Minimap"})})]})]})})})]}),p=x=>e.jsxs(Ma,{children:[e.jsx(Ia,{children:x}),e.jsx(Aa,{children:e.jsx(kg,{children:d("No screenshot available")})})]});return e.jsxs(ve,{style:{maxWidth:"90vw",width:"1200px"},children:[e.jsx(we,{children:e.jsx("h1",{children:d("Screenshots for Test",{testId:o})})}),e.jsx("div",{style:{padding:`${m.lg} ${m.xl}`},children:c?e.jsxs(vg,{children:[u(i,d("Before Submit")),u(s,d("After Submit"))]}):a?e.jsx(zi,{children:u(i,"")}):r?e.jsx(zi,{children:u(s,"")}):e.jsx(zi,{children:p(d("Screenshots"))})}),e.jsx($e,{children:e.jsx("button",{type:"button",className:"btn cancel",onClick:n,children:d("Close")})})]})},Lg=t=>{const{openModal:n}=qe();return()=>{n(Sg,t)}},Mi=l.div`
  flex: 1;
  background: ${h.white};
  padding: ${m.xl};
  overflow-y: auto;
...
`,dr=l.div`
  ...
  ${Q};
`,Qe=({preview:t,onEdit:n,onAfterEdit:s,excludeClassNames:i=[],children:o})=>{const[r,a]=g.useState(void 0),c=g.useRef(null),u=g.useRef(null),p=g.useRef(r),{editorAnimation:x}=td({wrapper:c.current,editor:u.current,isEditing:r});$t({callback:()=>{a(!1)},isEnabled:r,refObject:u,excludeClassNames:["tagify__dropdown","dropdown-rollout","elementselectormodal",...i]});const f=()=>{a(!1)},b=f0();return os(()=>a(!1),!!r),g.useEffect(()=>{p.current&&r===!1&&s?.(),p.current=r},[r,s]),e.jsxs(Ud,{ref:c,children:[e.jsx(nd,{children:e.jsx($f,{style:{zIndex:b,pointerEvents:r?"initial":"none",...x},className:E(r&&"active","editable-content"),ref:u,children:typeof o=="function"?o(r,f):o})}),e.jsx(cr,{onClick:()=>{a(!0),n?.()},children:t})]})},Ae={all:X(t=>t.layout.fields,t=>t),count:X(t=>t.layout.fields,t=>t.length),one:t=>X(n=>n.layout.fields,n=>n.find(s=>s.uid===t)),hasErrors:X(t=>t.layout.fields,t=>t.some(n=>n.errors!==void 0)),inRow:t=>X(n=>n.layout.fields,n=>n.filter(s=>s.rowUid===t.uid).sort((s,i)=>(s.order??0)-(i.order??0)))},Cf=t=>P(Ae.all).filter(i=>t.availableFieldTypes.includes("*")?!0:t.availableFieldTypes.includes(i.typeClass)).map(i=>i.properties.handle),kf=l.div`
  display: flex;
  align-items: center;
  gap: ${m.md};
...
`,f4=l.div``,jn=({value:t,property:n,errors:s,context:i,updateValue:o})=>{const r=n.flags?.includes("readonly")||n.flags?.includes("as-readonly-in-instance");return e.jsx(W,{property:n,errors:s,context:i,preContent:e.jsx(si,{children:e.jsx(iu,{children:e.jsx(en,{enabled:t,readOnly:r,onClick:a=>o(a),errors:s})})})})},ou=(t=!0)=>B({queryKey:["autosuggest","env"],queryFn:()=>T.get("/api/autosuggest/env").then(n=>n.data),enabled:t,staleTime:1/0,gcTime:1/0}),b4=t=>!!t,j4=()=>{const{data:t}=ou();return g.useMemo(()=>{const n=[{label:d("Yes"),value:"true",icon:e.jsx("span",{className:"status enabled","aria-hidden":"true"})},{label:d("No"),value:"false",icon:e.jsx("span",{className:"status white","aria-hidden":"true"})}],s=t?.map(o=>({label:o.label,children:o.data.map(r=>({label:r.name,value:r.name,hint:r.hint,icon:e.jsx("span",{className:E("status",b4(r.hint)?"enabled":"white"),"aria-hidden":"true"})}))}))??[];return[...n,...s]},[t])},y4=({children:t})=>e.jsxs(v4,{className:"notice has-icon",children:[e.jsx("span",{className:"icon","aria-hidden":"true"}),e.jsx("span",{className:"visually-hidden",children:"Tip: "}),e.jsx("span",{children:t})]}),v4=l.p`
  margin-top: 5px;
`,w4="This can be set to an environment variable with a boolean value (`yes`/`no`/`true`/`false`/`on`/`off`/`0`/`1`).",$4=({value:t,updateValue:n,property:s,errors:i,context:o})=>{const r=d(w4),a=yd(r),{data:c,isFetching:u}=ou(),p=j4();return["","0","no","off"].includes(String(t).toLowerCase())?t="false":["1","yes","on"].includes(String(t).toLowerCase())&&(t="true"),e.jsxs(W,{property:s,errors:i,context:o,children:[e.jsx(de,{value:t,options:p,onChange:x=>n(x),loading:u&&!c,showSelectedIcon:!0,showHints:!0}),e.jsx(y4,{children:a})]})},C4=l.div`
  display: flex;
  flex-direction: row;
  justify-content: start;
  align-items: stretch;
...
`,E5=({value:t,property:n,errors:s,updateValue:i})=>{const[o,r]=g.useState(!1),[a,c]=g.useState(!1),{handle:u}=n,p=g.useRef(null),x=k5(o),f=C5(o);return e.jsxs(S5,{className:E(s?.length>0&&"errors"),children:[a&&e.jsx("input",{id:u,ref:p,type:"text",className:"text fullwidth",value:t||"",onChange:b=>i(b.target.value),onBlur:()=>c(!1),onKeyDown:b=>{b.key==="Enter"&&c(!1)}}),!a&&e.jsx(F5,{style:x,onClick:()=>{c(!0),r(!1),setTimeout(()=>{p.current?.focus()},3)},onMouseEnter:()=>r(!0),onMouseLeave:()=>r(!1),children:e.jsxs("span",{children:[e.jsx("span",{children:t}),e.jsx(L5,{style:f,children:e.jsx($5,{})})]})}),e.jsx(ti,{errors:s})]})},T5=l.div`
  display: flex;
`,mu=l.input`
  width: 100%;
  --focus-ring: 0;
...
`,W8=({value:t})=>e.jsx(Jt,{"data-edit":d("Click to edit data"),children:e.jsxs(_8,{children:[!t&&e.jsx(kt,{children:d("Not configured yet")}),e.jsx("div",{dangerouslySetInnerHTML:{__html:O.sanitize(t)}})]})}),U8=({value:t,property:n,updateValue:s})=>e.jsx(Qe,{preview:e.jsx(W8,{value:t}),excludeClassNames:["tox"],children:e.jsx(B8,{menu:n.menu,statusbar:n.statusbar,toolbar:n.toolbar,value:t,updateValue:s})}),H8=l.div`
  margin-bottom: ${m.sm};
...
`,cj=({id:t,name:n,handle:s,icon:i})=>{const{setLastTab:o}=We("integrations"),r=P(as.one(t));if(!r)return null;const a=r.errors&&Object.values(r.errors).some(c=>c.length>0);return e.jsx(rj,{children:e.jsxs(he,{onClick:()=>o(`${t}/${s}`),to:`${t}/${s}`,className:E(!r.enabled&&"inactive",a&&"errors"),children:[!i&&e.jsx(jl,{children:e.jsx(oj,{})}),!!i&&e.jsx(jl,{dangerouslySetInnerHTML:{__html:O.sanitize(i)}}),e.jsx(aj,{children:n}),e.jsx(lj,{$enabled:r.enabled,className:E("status-dot")})]})})},dj=({label:t,children:n})=>e.jsxs(Du,{children:[e.jsx(sj,{children:e.jsx(Bu,{children:t})}),e.jsx(ij,{children:n.map(s=>e.jsx(cj,{...s},s.id))})]}),uj=()=>e.jsx(zn,{children:e.jsxs(Du,{children:[e.jsx(Bu,{children:e.jsx(k,{width:50})}),e.jsx(Ou,{style:{padding:14},children:[0,1,2].map(t=>e.jsxs("div",{style:{display:"flex",gap:10,alignItems:"center"},children:[e.jsx(k,{width:20,height:20,circle:!0}),e.jsx("div",{style:{flexGrow:2},children:e.jsx(k,{width:100,style:{top:2}})}),e.jsx(k,{width:10,height:10,circle:!0,style:{top:6}})]},t))})]})}),_i=l.ul`
  ...
  list-style: none;
`,pj=()=>{const{formId:t,id:n}=V(),s=ne(),{data:i,isFetching:o}=Go(t&&Number(t));nj();const{lastTab:r,setLastTab:a}=We("integrations");if(g.useEffect(()=>{r&&s(r)},[s,r]),g.useEffect(()=>{if(!n&&!r&&i){const u=i.find(Boolean);u&&(a(`${u.id}/${u.handle}`),s(`${u.id}/${u.handle}`))}},[n,i,r,s,a]),!i&&o)return e.jsx(De,{children:e.jsx(_i,{children:e.jsx(uj,{})})});if(!i&&!o)return e.jsx(De,{children:e.jsx(_i,{})});const c={};return i.forEach(u=>{const{type:p}=u;c[p]||(c[p]={type:p,label:d(p.replace("-"," ")),children:[]}),c[p].children.push(u)}),e.jsx(De,{$lean:!0,children:e.jsx(_i,{children:Object.values(c).map(u=>e.jsx(dj,{...u},u.type))})})},hj=()=>{const t=st("");return e.jsxs(Pu,{children:[e.jsx(q,{id:"integrations",label:d("Integrations"),url:t.pathname}),e.jsx(pj,{}),e.jsx(jt,{})]})},xj=({integration:t,property:n})=>{const s=H(),i=vs(t.properties,t.values,(r,a)=>{s(At.modify({id:t.id,key:r,value:a}))}),o=t.values[n.handle];return n.type===K.Hidden?null:e.jsx(je,{value:o,property:n,updateValue:i(n),errors:t?.errors?.[n.handle],context:t})},kr=l.div`
  flex: 1;
...
`,$j=({active:t,onClick:n,...s})=>{const i=g.useRef(null),o=Ct(i),a={...vj({active:t,hovering:o}),...s?.style};return delete s.style,e.jsx(Uu,{type:"button",ref:i,style:a,onClick:n,...s,children:e.jsx(wj,{})})},Hu=t=>{const n=H(),[{isOver:s},i]=ss(()=>({accept:[te.FieldType,te.Field],collect:r=>({isOver:r.isOver({shallow:!0})}),canDrop:(r,a)=>a.isOver({shallow:!0}),drop:r=>{r.type===te.FieldType&&n(Oe.move.newField.newRow({fieldType:r.data,layoutUid:t.uid})),r.type===te.Field&&n(Oe.move.existingField.newRow({field:r.data,layoutUid:t.uid}))}}),[t]),o=Y({to:{opacity:s?1:0,transform:s?"scaleY(1)":"scaleY(0)"},config:{tension:300}});return{dropRef:i,placeholderAnimation:o}},Cj=l.div`
  position: relative;
  flex-grow: 1;
...
`,dy={back:"btn",save:"btn",submit:"btn btn-submit"},uy=({page:t})=>{const n=H(),{getTranslation:s}=Ce(t),{active:i,type:o,uid:r}=P(Ot.focus),a=g.useMemo(()=>i&&o===Yn.Page&&r===t.uid,[i,o,r,t.uid]),c=Zu(t),u=c.flat().map(b=>b.assetId).filter(Boolean),{data:p,isFetching:x}=fr(u,""),f=g.useCallback(b=>{const j=p?.[b]?.src;return x?e.jsx(cy,{}):e.jsx("img",{src:j,alt:`${b}Alt`})},[p,x]);return e.jsx(Lr,{children:e.jsx(Xu,{className:E(a&&"active"),onClick:()=>{n(ye.setFocusedItem({type:Yn.Page,uid:t.uid}))},children:c.map((b,j)=>e.jsx(So,{className:"page-buttons",children:b.map(({handle:y,label:w,iconPosition:v,assetId:$},C)=>e.jsxs(ep,{className:dy[y],type:"button",children:[$&&v==="left"&&f($),s(`${y}Label`,w),$&&v==="right"&&f($)]},C))},j))})})},tp=l.div`
  display: flex;
  flex: 1 0;
  flex-direction: column;
  gap: ${m.md};
...
`,ip=()=>(t,n)=>{const s=G(),i=G(),o=n(),r=o.layout.pages.length,a=r+1,c=o.layout.pages?.[r-1];t($n.add({uid:i})),t(Cn.add({uid:s,label:d("Page {number}",{number:a}),layoutUid:i,buttons:c?.buttons??{layout:"save back|submit",attributes:{container:{},column:{},submit:{},back:{},save:{}},submitLabel:d("Submit"),submitIcon:[],submitIconPosition:"left",back:!0,backLabel:d("Back"),backIcon:[],backIconPosition:"left",save:!1,saveLabel:d("Save"),saveIcon:[],saveIconPosition:"left"}})),t(ye.setPage(s))},hy=(t,n)=>(s,i)=>{const{layoutUid:o}=n,r=G();s(Ze.add({layoutUid:o,uid:r})),s(be.moveTo({uid:t.uid,rowUid:r,position:0})),ii(i(),s)},xy=t=>(n,s)=>{const{uid:i,layoutUid:o}=t,r=s();if(!r.layout.layouts.find(u=>u.uid===o))return;const c=r.layout.pages.find(u=>u.uid!==i);n(ye.unfocus()),n(ye.setPage(c.uid)),r.layout.rows.filter(u=>u.layoutUid===o).forEach(u=>{const p=[];r.layout.fields.filter(x=>x.rowUid===u.uid).forEach(x=>{p.push(x.uid)}),n(be.removeBatch(p)),n(Ze.remove(u.uid))}),n($n.remove(o)),n(Cn.remove(i))},my=t=>e.jsx(R,{fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor",className:"w-6 h-6",...t,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M12 4.5v15m7.5-7.5h-15"})}),gy=l.button`
  display: flex;
  align-items: center;
...
`,fy=()=>{const t=H();return e.jsx(gy,{className:"new-page-tab",onClick:()=>{t(ip())},children:e.jsx(my,{})})},by=(t,n)=>{const s=H(),{dragOff:i}=ai(),[{canDrop:o},r]=ss({accept:[te.Field],canDrop:(a,c)=>c.isOver({shallow:!0}),collect:a=>({canDrop:a.canDrop()&&t!==n.uid}),drop:a=>{a.type===te.Field&&(s(hy(a.data,n)),i())}});return{ref:r,canDrop:o}},Lo=l(_.div)`
  position: relative;
`,jy=l.button`
  position: absolute;
  top: 3px;
...
`,Ay=l.div`
  text-transform: uppercase;
  font-size: 10px;
`,zr=({icon:t,label:n,dragRef:s,onClick:i})=>e.jsxs(Fr,{ref:o=>{s&&s(o)},onClick:i,title:n,children:[e.jsx(Ly,{dangerouslySetInnerHTML:{__html:t}}),e.jsx(Sy,{dangerouslySetInnerHTML:{__html:n}})]}),Mr=t=>{const{dragOn:n,dragOff:s}=ai(),[{isDragging:i},o]=qo(()=>({type:te.FieldType,collect:r=>({isDragging:r.isDragging()}),item:{type:te.FieldType,data:t}}));return g.useEffect(()=>{i?n(te.FieldType):s()},[i,n,s]),{ref:o}},Ry=({fieldType:t})=>{const{icon:n,name:s}=t,i=H(),{ref:o}=Mr(t),r=()=>{i(Oe.move.newField.newRow({fieldType:t}))};return e.jsx(zr,{icon:n,label:d(s),onClick:r,dragRef:o})},Py=(t={})=>{const n=ee(),s=t?.onSuccess;return t.onSuccess=(i,o,r,a)=>{s?.(i,o,r,a),n.invalidateQueries({queryKey:op.all})},ce({...t,mutationFn:i=>T.post("/api/fields/types/groups",i)})},Ir=t=>e.jsxs(R,{height:"15",viewBox:"0 0 15 15",width:"15",...t,children:[e.jsx("path",{d:"m0 0h15v15h-15z",fill:"none"}),e.jsx("path",{d:"m7.5 9.61c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"}),e.jsx("path",{d:"m3.57 5.68c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"}),e.jsx("path",{d:"m11.43 5.68c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"}),e.jsx("path",{d:"m7.5 1.75c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"})]}),Dy=l.div`
  cursor: pointer;
...
`,V7=l.div`
  display: flex;
  justify-content: center;
`,G7=({field:t,type:n,mutation:s})=>{const[i,o]=g.useState("");return g.useEffect(()=>{o(t.properties.label||n?.name),s.reset()},[t.uid,n?.name]),e.jsxs(K7,{children:[e.jsx(ls,{children:e.jsx(Dt,{property:{label:d("Create a favorite"),handle:t.properties?.handle,flags:[],placeholder:t.properties?.label,type:K.String},value:i,updateValue:r=>o(r)})}),e.jsx(V7,{children:e.jsx("button",{type:"button",disabled:s.isPending,className:E("btn fullwidth",!s.isSuccess&&"submit",s.isPending&&"disabled"),onClick:()=>{s.mutate({label:i,field:t,type:n})},children:e.jsx(Z,{spinner:!0,loading:s.isPending,loadingText:"Saving...",children:d(s.isSuccess?"Saved!":"Favorite")})})}),s.isError&&e.jsx(Q7,{category:"favorites",handle:"name",error:s.error})]})},jp=l(_.div)`
  position: absolute;
  top: 24px;
  right: -16px;
...
`,cv=()=>{const t=st(""),n=yr(),{templates:s}=vr(""),{templates:{canCreate:i,method:o}}=I,r=()=>{n({type:"form"})};return e.jsxs(pi,{children:[e.jsx(q,{id:"notification-manager",label:d("Manager"),url:t.pathname}),e.jsxs(yp,{children:[e.jsx("h1",{children:d("Notification Manager")}),e.jsx(Fu,{children:e.jsx(Co,{value:"",title:d("Form Templates"),templates:s.form,openEditOnClick:!0,onClick:()=>{},canCreate:i&&o!==is.Global,onCreate:r})})]})]})},dv=l.div`
  display: flex;
  height: 100%;
`,uv=(t,n)=>(s,i)=>{const{className:o,properties:r,newInstanceName:a}=t,c={};r.forEach(x=>{c[x.handle]=x.value});const u=Mn.count.ofType(o)(i()),p=`${a} notification ${u+1}`;s(Rt.add({uid:n,className:o,enabled:!0,...c,name:p}))},pv=t=>n=>{n(Rt.remove(t.uid))},Hi=20,hi=l.div`
  display: block;
  width: ${Hi}px;
  height: ${Hi}px;
  font-size: ${Hi}px;
...
`,Jk=()=>{const t=g.useRef(null),{data:n,isFetching:s}=ca();if(s)return"Loading...";const i=async()=>{if(!n||!t.current)return;const o=await J1(t.current,{cacheBust:!0,fontEmbedCSS:""}),r=me("/export/surveys/pdf"),a=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({[Craft.csrfTokenName]:Craft.csrfTokenValue,image:o})});if(!a.ok){const y=await a.text();throw new Error(y)}const c=await a.blob(),u=window.URL||window.webkitURL,p=u.createObjectURL(c),x=document.createElement("a");x.href=p;const f=a.headers.get("Content-Disposition")||"",b=/filename\*?=(?:UTF-8'')?["']?([^"';\s]+)["']?/i.exec(f),j=b?.[1]?decodeURIComponent(b[1]):"survey-results.pdf";x.download=j,document.body.appendChild(x),x.click(),x.remove(),setTimeout(()=>u.revokeObjectURL(p),1e3)};return e.jsxs(e.Fragment,{children:[e.jsx(q,{id:"survey-list",label:n.form.name,url:`/surveys/${n.form.handle}`}),e.jsxs(u1,{ref:t,children:[e.jsxs(Yk,{children:[e.jsxs(p1,{children:[d("{count} Responses",{count:n.form.submissions}),e.jsxs("small",{children:["(",d("{count} questions",{count:n.results.length}),")"]})]}),e.jsx("button",{type:"button",className:"btn",onClick:i,children:d("Export as PDF")})]}),n.results.map((o,r)=>e.jsx(Gk,{...o,responses:n.form.submissions,bulletin:r+1},o.field.id))]})]})},Zk=(t,n)=>Math.floor(Math.random()*(n-t+1))+t,Xk=ts(0,60).map(t=>({name:"",y:t>30?Zk(0,Math.random()>.5?4:1):0})),eS=()=>{const t="#cccccc";return e.jsxs(r1,{$color:t,children:[e.jsx(a1,{children:e.jsx(Z,{loading:!0,instant:!0,xl:!0,children:d("Loading")})}),e.jsx(nt,{width:"100%",height:80,children:e.jsxs(yt,{data:Xk,margin:{top:30,left:0,right:0,bottom:3},children:[e.jsx("defs",{children:e.jsxs("linearGradient",{id:"color",x1:0,y1:0,x2:0,y2:1,children:[e.jsx("stop",{offset:"5%",stopColor:t,stopOpacity:.4}),e.jsx("stop",{offset:"95%",stopColor:t,stopOpacity:.1})]})}),e.jsx(vt,{type:"monotone",dataKey:"y",stroke:t,strokeWidth:1,strokeOpacity:1,fillOpacity:1,isAnimationActive:!1,fill:"url(#color)"})]})}),e.jsx(l1,{$color:t})]})},h1=l.div`

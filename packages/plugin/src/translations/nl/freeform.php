...
return [
    ...
    'Default Email Template Creation Method' => 'Standaardmethode voor het maken van e-mailnotificaties',
    ...
    "Provide a relative path to the Craft Templates folder where your email templates directory is. If you have not yet created the directory, please do that before filling in this setting. This allows you to use Twig template files for your email formatting and allows Freeform to locate these files when setting up notifications. To add a starter example template, click the 'Add a sample template' button, and then edit the template after." => 'Geef een relatief pad op naar de Craft-hoofdmap waar uw map met e-mail templates zich bevindt. Hiermee kunt u Twig templatebestanden gebruiken voor uw e-mailopmaak, en helpt Form Builder deze bestanden te vinden bij het instellen van notificaties.',
    "Select which storage method to use when creating new email notifications with 'Add New Template' option in the form builder." => "Welke opslagmethode moet worden gebruikt bij het maken van nieuwe e-mail notificaties met de optie 'Voeg nieuwe notificatie toe' in Form Builder.",

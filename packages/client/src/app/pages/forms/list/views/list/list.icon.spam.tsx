...
const ListIconSpamComponent = (props: SVGPropsWithTitle) => (
  <SvgTag viewBox="0 0 512 512" {...props}>
    <path
      className="fa-secondary"
      opacity=".4"
      d="M64 208.1l0 47.4L222.5 373c9.7 7.2 21.4 11 33.5 11s23.8-3.9 33.5-11c52.8-39.1 105.7-78.3 158.5-117.4l0-47.4c-64-47.4-128-94.8-192-142.2c-64 47.4-128 94.8-192 142.2z"
    />
    <path
...
export default ListIconSpamComponent;

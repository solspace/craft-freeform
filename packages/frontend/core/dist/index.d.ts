...
export declare class FreeformClient {
  ...
  ): Promise<import("./index.js").CsrfToken | null>;
  private asClientOptions;
}
export declare function createFreeformClient(

...
return [
    ...
    'Auto Grow' => 'Auto Grow',
    'Automatically adjust the height of this field to fit its contents.' => 'Automatically adjust the height of this field to fit its contents.',
    'Maximum Height' => 'Maximum Height',
    'The maximum height in pixels before scrolling. Leave blank for no limit.' => 'The maximum height in pixels before scrolling. Leave blank for no limit.',
    ...
    'Map submission data to create Leads in SugarAI.' => 'Map submission data to create Leads in SugarAI.',
    'Select the Freeform fields to be mapped to the applicable SugarAI Lead fields.' => 'Select the Freeform fields to be mapped to the applicable SugarAI Lead fields.',
    'Map submission data to create Opportunities in SugarAI.' => 'Map submission data to create Opportunities in SugarAI.',
    'Select the Freeform fields to be mapped to the applicable SugarAI Opportunity fields.' => 'Select the Freeform fields to be mapped to the applicable SugarAI Opportunity fields.',
    'Map submission data to create Accounts in SugarAI.' => 'Map submission data to create Accounts in SugarAI.',
    'Select the Freeform fields to be mapped to the applicable SugarAI Account fields.' => 'Select the Freeform fields to be mapped to the applicable SugarAI Contact fields.',
    'Map submission data to create Contacts in SugarAI.' => 'Map submission data to create Contacts in SugarAI.',
    'Select the Freeform fields to be mapped to the applicable SugarAI Contact fields.' => 'Select the Freeform fields to be mapped to the applicable SugarAI Contact fields.',
    ...
    'Show Processing Overlay on Submit' => 'Show Processing Overlay on Submit',
    'Dim the form and show a centered spinner and processing message while a submission is being processed.' => 'Dim the form and show a centered spinner and processing message while a submission is being processed.',
    'Text shown on the submit button or processing overlay when the form is processing.' => 'Text shown on the submit button or processing overlay when the form is processing.',
    ...
    'Custom Cron Schedule' => 'Custom Cron Schedule',
    ...
    "Specify how often and which days (if applicable) you'd like to receive the email notifications. Custom schedules are evaluated in the site timezone." => "Specify how often and which days (if applicable) you'd like to receive the email notifications. Custom schedules are evaluated in the site timezone.",
    ...
    "For reliable delivery, configure your server to run `php craft freeform/export-notifications/run` every minute. Use <a href='https://crontab.guru/' target='_blank' rel='noopener'>Crontab.guru</a> to build and check an expression." => "For reliable delivery, configure your server to run `php craft freeform/export-notifications/run` every minute. Use <a href='https://crontab.guru/' target='_blank' rel='noopener'>Crontab.guru</a> to build and check an expression.",
    'A cron expression is required for a custom schedule.' => 'A cron expression is required for a custom schedule.',
    'Enter a valid five-part cron expression.' => 'Enter a valid five-part cron expression.',
    ...
    'Enter the full domain name of the SugarAI instance, e.g. `https://your-domain.sugarcrm.eu`' => 'Enter the full domain name of the SugarAI instance, e.g. `https://your-domain.sugarcrm.eu`',
    'Username' => 'Username',
    ...
    'Payment configurations apply to one-time payments only. To limit methods on subscriptions, use the Subscription Payment Methods setting below.' => 'Payment configurations apply to one-time payments only. To limit methods on subscriptions, use the Subscription Payment Methods setting below.',
    'e.g. "pmc_1PxtjcD6lnhW9qH54DHV8LbZ"' => 'e.g. "pmc_1PxtjcD6lnhW9qH54DHV8LbZ"',
    'Subscription Payment Methods' => 'Subscription Payment Methods',
    'Comma-separated Stripe payment method types allowed on subscriptions (e.g. `card, paypal, bacs_debit, us_bank_account`). Leave blank to use your Stripe account default.' => 'Comma-separated Stripe payment method types allowed on subscriptions (e.g. `card, paypal, bacs_debit, us_bank_account`). Leave blank to use your Stripe account default.',
    'e.g. "card, paypal, bacs_debit, us_bank_account"' => 'e.g. "card, paypal, bacs_debit, us_bank_account"',
    ...
    'Nationality: Antiguan and Barbudan' => 'Antiguan and Barbudan',
    ...
    'Nationality: Bissau-Guinean' => 'Bissau-Guinean',
    'Nationality: Bolivian' => 'Bolivian',
    'Nationality: Bosnian and Herzegovinian' => 'Bosnian and Herzegovinian',
    'Nationality: Botswanan' => 'Botswanan',
    ...
    'Nationality: Cabo Verdean' => 'Cabo Verdean',
    'Nationality: Cambodian' => 'Cambodian',
    'Nationality: Cameroonian' => 'Cameroonian',
    'Nationality: Canadian' => 'Canadian',
    'Nationality: Central African' => 'Central African',
    'Nationality: Chadian' => 'Chadian',
    'Nationality: Chilean' => 'Chilean',
    'Nationality: Chinese' => 'Chinese',
    'Nationality: Colombian' => 'Colombian',
    'Nationality: Comorian' => 'Comorian',
    'Nationality: Congolese (DR Congo)' => 'Congolese (DR Congo)',
    'Nationality: Congolese (Republic of the Congo)' => 'Congolese (Republic of the Congo)',
    'Nationality: Costa Rican' => 'Costa Rican',
    ...
    'Nationality: Djiboutian' => 'Djiboutian',
    'Nationality: Dominican (Dominica)' => 'Dominican (Dominica)',
    'Nationality: Dominican (Dominican Republic)' => 'Dominican (Dominican Republic)',
    'Nationality: Dutch' => 'Dutch',
    'Nationality: Ecuadorian' => 'Ecuadorian',
    'Nationality: Egyptian' => 'Egyptian',
    'Nationality: Emirati' => 'Emirati',
    'Nationality: Equatorial Guinean' => 'Equatorial Guinean',
    ...
    'Nationality: Kittitian and Nevisian' => 'Kittitian and Nevisian',
    'Nationality: Kuwaiti' => 'Kuwaiti',
    'Nationality: Kyrgyzstani' => 'Kyrgyzstani',
    'Nationality: Lao' => 'Lao',
    ...
    'Nationality: Maldivian' => 'Maldivian',
    ...
    'Nationality: New Zealander' => 'New Zealander',
    'Nationality: Nicaraguan' => 'Nicaraguan',
    'Nationality: Nigerian' => 'Nigerian',
    'Nationality: Nigerien' => 'Nigerien',
    'Nationality: North Korean' => 'North Korean',
    'Nationality: North Macedonian' => 'North Macedonian',
    ...
    'Nationality: Papua New Guinean' => 'Papua New Guinean',
    ...
    'Nationality: Tajikistani' => 'Tajikistani',
    ...
    'Nationality: Trinidadian and Tobagonian' => 'Trinidadian and Tobagonian',
    ...
    'Nationality: Vincentian' => 'Vincentian',
    ...
    'Choose a country to list its states, regions, provinces, or constituent countries.' => 'Choose a country to list its states, regions, provinces, or constituent countries.',
    'Survey Scale' => 'Survey Scale',
    'Identifiers are scores from 1 (lowest) to 5 (highest).' => 'Identifiers are scores from 1 (lowest) to 5 (highest).',
    'Agreement' => 'Agreement',
    ...
    'End Time' => 'End Time',
    'Enter a time in 24-hour HH:MM format, e.g. 09:00.' => 'Enter a time in 24-hour HH:MM format, e.g. 09:00.',
    'Enter a time in 24-hour HH:MM format, e.g. 17:00. Must be on the same day and at or after the start time.' => 'Enter a time in 24-hour HH:MM format, e.g. 17:00. Must be on the same day and at or after the start time.',
    'Interval' => 'Interval',
    '15 minutes' => '15 minutes',
    '30 minutes' => '30 minutes',
    '60 minutes' => '60 minutes',
    'Time Label Format' => 'Time Label Format',
    'Stored values always use 24-hour HH:MM format. These options do not check appointment availability.' => 'Stored values always use 24-hour HH:MM format. These options do not check appointment availability.',
    '24-hour' => '24-hour',
    '12-hour' => '12-hour',
    'AM' => 'AM',
    'PM' => 'PM',
    ...
    '1,001–5,000 employees' => '1,001–5,000 employees',
    ...
    'Nonprofit and Charitable Organizations' => 'Nonprofit and Charitable Organizations',
    ...
    'Burgundy-Franche-Comté' => 'Burgundy-Franche-Comté',
    'Brittany' => 'Brittany',
    ...
    'Use browser default' => 'Use browser default',
    'Tell browsers what information this field collects so they can offer saved details.' => 'Tell browsers what information this field collects so they can offer saved details.',
    'On' => 'On',
    'Off' => 'Off',
    'Full name' => 'Full name',
    ...
    'Home email address' => 'Home email address',
    'Work email address' => 'Work email address',
    'Cell / mobile phone' => 'Cell / mobile phone',

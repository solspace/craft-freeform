const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ai.usage-chart--yy-hssG.js","./vendor-D8V7Vhm6.js","./date-fns-BTAAV4UA.js","./vendor-BOeeMEG-.css"])))=>i.map(i=>d[i]);
...
`,f2=({inputRef:t,filter:n,suggestions:s,update:i})=>{const o=d2(t),r=c2(s,n);return!r.length||!o?null:e.jsx(p2,{children:r.map(a=>e.jsxs(h2,{children:[e.jsx(x2,{children:a.label}),e.jsx(m2,{children:a.data.map(({name:c,hint:u})=>e.jsxs(g2,{onClick:()=>i(c),children:[e.jsx(kd,{children:c}),!!u&&e.jsxs(e.Fragment,{children:[e.jsx(Cd,{}),e.jsx(Sd,{children:u})]})]},c))})]},a.label))})},Dt=({value:t,property:n,errors:s,updateValue:i,autoFocus:o,context:r})=>{const{handle:a}=n,c=g.useRef(null);g.useEffect(()=>{o&&c.current?.focus({preventScroll:!0})},[o]);const u=n.flags?.includes("code"),p=n.flags?.includes("readonly")||n.flags?.includes("as-readonly-in-instance"),x=n.flags?.includes("env-suggest"),{data:f}=B({queryKey:["autosuggest","env"],queryFn:()=>T.get("/api/autosuggest/env").then(b=>b.data),enabled:x,staleTime:1/0,gcTime:1/0});return e.jsx(W,{property:n,errors:s,context:r,children:e.jsxs(u2,{children:[e.jsx("input",{id:a,ref:c,type:"text",autoComplete:"off","data-1p-ignore":!0,readOnly:p,className:E("text","fullwidth",u&&"code",p&&"readonly"),value:t??"",placeholder:n.placeholder,onChange:b=>i(b.target.value)}),x&&!!f&&e.jsxs(e.Fragment,{children:[e.jsx(f2,{inputRef:c,filter:t,suggestions:f,update:b=>i(b)}),e.jsx(a2,{})]})]})})},b2=l.textarea`
  &.read-only {
...
`,ds=oe.forwardRef(({value:t,property:n,errors:s,updateValue:i,autoFocus:o,focus:r,context:a},c)=>{const{handle:u,rows:p}=n,x=g.useRef(null);return g.useImperativeHandle(c,()=>x.current),g.useEffect(()=>{r&&x.current?.focus()},[r]),e.jsx(W,{property:n,errors:s,context:a,children:e.jsx(b2,{id:u,ref:x,className:E("text","fullwidth",n.flags?.includes("as-readonly-in-instance")&&"read-only",n.flags?.includes("code")&&"code"),readOnly:n.flags?.includes("as-readonly-in-instance"),rows:p,value:t??"",placeholder:n.placeholder,autoFocus:o,onChange:f=>i(f.target.value)})})});ds.displayName="Textarea";const us={tension:300},j2=(t,n)=>Y({width:t?20:0,opacity:t?1:0,immediate:n,config:us}),y2=(t,n,s)=>Y({width:t?s?30:15:0,opacity:t?1:0,immediate:n,config:us}),v2=(t,n,s,i)=>Y({width:t&&n?s.loading.width:s.original.width,height:s.original.height,immediate:i,config:us}),w2=(t,n,s)=>Y({opacity:t&&n?0:1,transform:t&&n?"translateY(-30px)":"translateY(0px)",immediate:s,cancel:!n,config:us}),$2=(t,n)=>Y({opacity:t?1:0,transform:t?"translateY(0px)":"translateY(30px)",immediate:n,config:us}),C2=l.span`
  display: flex;
...
`;l.p`
  margin-top: ${m.md};
`;const qs={all:["ai"],usage:()=>[...qs.all,"usage"],plans:t=>[...qs.all,"plans",t??""]};function em(){return T.get(me("api/ai/usage")).then(t=>t.data)}function tm(t){return T.get(me("api/ai/plans"),{params:void 0}).then(s=>s.data)}function nm(t,n,s,i){return T.post(me("api/ai/create-checkout-session"),{success_url:t,cancel_url:n,...s&&{bundle_key:s},...i&&{currency:i}}).then(o=>o.data)}function Td(t){return B({queryKey:qs.usage(),queryFn:em,enabled:t?.enabled??!0,retry:(n,s)=>T.isAxiosError(s)&&(s.response?.status===404||s.response?.status===403)?!1:n<2})}function sm(t){return B({queryKey:qs.plans(t),queryFn:()=>tm(),retry:(n,s)=>T.isAxiosError(s)&&(s.response?.status===404||s.response?.status===403)?!1:n<2})}function Nd(){const t=I.metadata?.craft?.locale;return typeof t=="string"&&t.trim()?t.trim():void 0}const lo=t=>{if(!t)return"—";try{const n=dn(t);if(Number.isNaN(n.getTime()))return t;const s=Nd();return n.toLocaleDateString(s,{dateStyle:"medium"})}catch{return t}},im=t=>{if(!t)return"—";try{const n=dn(t);if(Number.isNaN(n.getTime()))return t;const s=Nd();return n.toLocaleString(s,{dateStyle:"medium",timeStyle:"short"})}catch{return t}},La=l.div`
  display: grid;
  width: 100%;
...
`,Ea=l.p`
  ...
  color: ${h.gray500};
  font-size: 14px;
`;function zd(t,n,s){const i=I.metadata?.craft?.locale,o=(s||n||"usd").toLowerCase(),r=i?t.toLocaleString(i,{maximumFractionDigits:0,minimumFractionDigits:0}):t.toLocaleString();return o==="eur"?`€${r}`:o==="usd"?`$${r}`:`${r} ${o.toUpperCase()}`}const fm=5,bm=2;function jm(t){return[...t??[]].sort((s,i)=>{const o=s.paid_at?Date.parse(s.paid_at):0;return(i.paid_at?Date.parse(i.paid_at):0)-o})}function ym(t,n){const s=t.package_price,i=typeof s=="number"?s:typeof s=="string"?parseFloat(s):NaN;return s==null||Number.isNaN(i)?"—":zd(Math.round(i),n,n)}function vm(t){const n=t.credits;if(n==null)return"—";const s=typeof n=="number"?n:Number(n);return Number.isNaN(s)?"—":Number.isInteger(s)?String(s):s.toLocaleString()}const wm=({closeModal:t})=>{const{data:n,isFetching:s}=sm(),{data:i,isPending:o,isFetching:r,isError:a}=Td(),c=s&&!n,u=c||!a&&(o||r&&i===void 0),p=oe.useMemo(()=>jm(i?.payment_history).slice(0,fm),[i?.payment_history]),[x,f]=oe.useState(null),b=n?.currency??"usd";return e.jsxs(om,{children:[e.jsx(we,{children:e.jsx(mm,{children:e.jsx("h1",{children:d("Purchase SolspaceAI Credits")})})}),e.jsxs(rm,{children:[c?e.jsx(Fi,{children:e.jsx(La,{children:Array.from({length:5}).map((j,y)=>e.jsxs(Fa,{children:[e.jsx("strong",{children:e.jsx(k,{width:110,height:14})}),e.jsx("p",{children:e.jsx(k,{count:2})}),e.jsx("div",{children:e.jsx(k,{width:90,height:12})}),e.jsx("div",{children:e.jsx(k,{width:120,height:12})}),e.jsx("div",{children:e.jsx(k,{width:110,height:32})})]},y))})}):e.jsx(Fi,{children:e.jsx(La,{children:(n?.bundles??[]).map(j=>e.jsxs(Fa,{children:[e.jsx(am,{children:(j.name||"").trim()||d("Credit plan")}),e.jsx(lm,{children:(j.description||"").trim()||d("Credit package for SolspaceAI usage.")}),e.jsxs(cm,{children:[e.jsx(dm,{children:zd(j.price,j.currency,n?.currency)}),e.jsxs(um,{children:[e.jsx(pm,{children:j.credits.toLocaleString()})," ",d("credits")]})]}),e.jsx(hm,{children:e.jsx(xm,{type:"button",disabled:x===j.key,onClick:async()=>{try{f(j.key);const y=window.location.href,w=await nm(y,y,j.key,n?.currency);w?.url&&(window.location.href=w.url)}finally{f(null)}},children:x===j.key?d("Loading..."):d("Buy now")})})]},j.key))})}),e.jsx(Fi,{children:e.jsxs(gm,{children:[e.jsx(io,{children:d("Recent Payments")}),e.jsx(Ed,{children:d("Your recent SolspaceAI credit purchase history.")}),u?e.jsxs(oo,{children:[e.jsx(ro,{children:e.jsxs("tr",{children:[e.jsx(Ue,{children:d("Date")}),e.jsx(Ue,{children:d("Amount")}),e.jsx(Ue,{children:d("Credits")})]})}),e.jsx("tbody",{children:Array.from({length:bm}).map((j,y)=>e.jsxs(ao,{children:[e.jsx(He,{children:e.jsx(k,{width:100,height:12})}),e.jsx(He,{children:e.jsx(k,{width:72,height:12})}),e.jsx(He,{children:e.jsx(k,{width:56,height:12})})]},`pay-skel-${y}`))})]}):a?e.jsx(Ea,{children:d("Unable to load payment history.")}):p.length===0?e.jsx(Ea,{children:d("No purchases yet.")}):e.jsxs(oo,{children:[e.jsx(ro,{children:e.jsxs("tr",{children:[e.jsx(Ue,{children:d("Date")}),e.jsx(Ue,{children:d("Amount")}),e.jsx(Ue,{children:d("Credits")})]})}),e.jsx("tbody",{children:p.map((j,y)=>e.jsxs(ao,{children:[e.jsx(He,{children:lo(j.paid_at)}),e.jsx(He,{children:ym(j,b)}),e.jsx(He,{children:vm(j)})]},j.paid_at?`${j.paid_at}-${y}`:`payment-${y}`))})]})]})})]}),e.jsx($e,{children:e.jsx("button",{type:"button",className:"btn cancel",onClick:t,children:d("Close")})})]})},$m=oe.lazy(()=>Pn(()=>import("./ai.usage-chart--yy-hssG.js"),__vite__mapDeps([0,1,2,3]),import.meta.url)),Ta="/integrations/ai/SolspaceAIV1",Cs=({title:t,subtitle:n,iconFade:s,children:i})=>e.jsx(H2,{children:e.jsx(Fd,{children:e.jsx(at,{title:t,subtitle:n,icon:e.jsx(ps,{}),iconFade:s,children:i})})}),Cm=()=>{const{openModal:t}=Ke();Fn("freeform/settings");const n=I.editions.is(re.Pro),{data:s,isFetching:i,error:o,isError:r}=Td({enabled:n}),a=r&&T.isAxiosError(o)&&o.response?.status===404,c=r&&T.isAxiosError(o)&&o.response?.status===403,u=a||c,p=s??void 0,x=p!=null,f=oe.useMemo(()=>{const C=(p?.payment_history??[]).map(F=>F?.paid_at).filter(F=>typeof F=="string"&&!!F);return C.length?C.sort((F,N)=>N.localeCompare(F))[0]:null},[p?.payment_history]),b=oe.useMemo(()=>{const $=p?.credit_status;if(!$)return d("Unknown");switch($){case"Free trial":case"Active":case"Low credits":case"Out of credits":return d($);default:return $}},[p]),j=!a&&!c&&i&&!p,y=!a&&!c&&!j&&!r,w=r&&T.isAxiosError(o)&&o.response?.data?.message?o.response.data.message:r&&o instanceof Error?o.message:null,v=$=>e.jsxs("div",{children:[e.jsx(q,{id:"settings",label:d("Settings"),url:".",external:!0}),e.jsx(q,{id:"solspace-ai",label:d("SolspaceAI"),url:"settings/ai"}),e.jsx(Ln,{children:d("SolspaceAI")}),e.jsx(U2,{activeKey:"ai",children:$})]});return v(n?e.jsxs(e.Fragment,{children:[r&&!u&&e.jsx(Cs,{title:d("Error loading usage"),subtitle:w??d("Failed to load usage data"),iconFade:!0}),a&&e.jsx(Cs,{title:d("SolspaceAI is not enabled"),subtitle:d("Enable SolspaceAI in the Integrations area to view usage."),iconFade:!0,children:e.jsx(rt,{to:Ta,className:"btn submit",children:d("Enable SolspaceAI")})}),c&&e.jsx(Cs,{title:d("Authorize SolspaceAI to view usage"),subtitle:d("Authorize SolspaceAI in the Integrations area (click Authorize on the SolspaceAI integration) to view usage."),iconFade:!0,children:e.jsx(rt,{to:Ta,className:"btn submit",children:d("Go to Integrations")})}),j&&e.jsxs(Ca,{children:[e.jsxs(ka,{children:[e.jsxs(Hn,{children:[e.jsx($s,{children:e.jsx(k,{width:80,height:10})}),e.jsx(Vn,{children:e.jsx(k,{width:100,height:24})})]}),e.jsxs(Hn,{children:[e.jsx($s,{children:e.jsx(k,{width:80,height:10})}),e.jsx(Vn,{children:e.jsx(k,{width:140,height:18})})]}),e.jsxs(Hn,{children:[e.jsx($s,{children:e.jsx(k,{width:80,height:10})}),e.jsx(Vn,{children:e.jsx(k,{width:120,height:18})})]})]}),e.jsxs(Sa,{children:[e.jsx(io,{children:e.jsx(k,{width:140,height:12})}),e.jsx(X2,{children:e.jsx("div",{style:{height:220}})})]})]}),y&&e.jsxs(Ca,{children:[e.jsx(ka,{children:p&&e.jsxs(e.Fragment,{children:[(p.credits_remaining!=null||p.credits_total!=null)&&e.jsxs(Y2,{children:[e.jsx(J2,{children:p.credits_remaining!=null?p.credits_remaining.toLocaleString():"—"}),e.jsx($s,{children:d("Credits remaining")})]}),e.jsxs(Hn,{children:[e.jsxs(K2,{children:[e.jsx(V2,{$color:p.credit_status_color??null}),e.jsx(Q2,{$color:p.credit_status_color??null,children:b})]}),p.credit_status==="Active"&&f&&e.jsxs(G2,{children:[d("Since")," ",lo(f)]}),e.jsx(Z2,{children:e.jsx("button",{type:"button",className:"btn submit",onClick:()=>t(wm),children:d("Add credits")})})]})]})}),p?.daily_metrics&&p.daily_metrics.length>0&&e.jsx(oe.Suspense,{fallback:null,children:e.jsx($m,{metrics:p.daily_metrics})}),p?.request_logs&&p.request_logs.length>0&&e.jsxs(Sa,{children:[e.jsx(io,{children:d("Request Log")}),e.jsx(Ed,{children:d("A list of recent AI requests and their credit usage.")}),e.jsxs(oo,{children:[e.jsx(ro,{children:e.jsxs("tr",{children:[e.jsx(Ue,{children:d("Date & Time")}),e.jsx(Ue,{children:d("Status")}),e.jsx(Ue,{children:d("Credits")}),e.jsx(Ue,{children:d("Duration")}),e.jsx(Ue,{children:d("Request ID")})]})}),e.jsx("tbody",{children:p.request_logs.map(($,C)=>e.jsxs(ao,{children:[e.jsx(He,{children:$.requested_at?im($.requested_at):$.date?lo($.date):d("Unknown")}),e.jsx(He,{children:$.status==="success"?d("Success"):$.status==="failure"?d("Failed"):$.status||"—"}),e.jsx(He,{children:$.credits!=null?`${$.credits} ${d("credits")}`:"—"}),e.jsx(He,{children:$.duration_s??"—"}),e.jsx(He,{children:e.jsx("code",{children:$.request_id??"—"})})]},$.request_id??C))})]})]}),!x&&e.jsx(Fd,{children:e.jsx(at,{title:d("No usage data yet"),subtitle:d("Usage will appear here once you start using SolspaceAI."),icon:e.jsx(ps,{}),iconFade:!0})})]})]}):e.jsx(Cs,{title:d("SolspaceAI requires Freeform Pro"),subtitle:d("Upgrade to the Freeform Pro edition to get access to SolspaceAI."),children:e.jsx("a",{href:Craft.getCpUrl("plugin-store/freeform"),className:"btn submit",target:"_blank",rel:"noreferrer",children:d("Plugin Store")})}))},zt={all:["rules"],form:t=>[...zt.all,"forms",t],notifications:t=>[...zt.form(t),"notifications"],integrations:t=>[...zt.form(t),"integrations"]},km=t=>{const n=ee();return g.useCallback(()=>{t&&n.removeQueries({queryKey:zt.form(t)})},[t,n])},Tn=t=>{const n=qt();return B({queryKey:zt.form(t),queryFn:()=>T.get(`/api/forms/${t}/rules`).then(s=>s.data).then(s=>(n(cn.set(s.fields)),n(_n.set(s.pages)),n(Wn.set(s.submitForm)),n(ln.set(s.buttons)),s)),staleTime:1/0,gcTime:1/0})},Md=t=>{const n=qt();return B({queryKey:zt.notifications(t),queryFn:()=>T.get(`/api/forms/${t||0}/rules/notifications`).then(s=>s.data).then(s=>(n(On.set(s)),s)),staleTime:1/0,gcTime:1/0})},Sm=t=>{const n=qt();return B({queryKey:zt.integrations(t),queryFn:()=>T.get(`/api/forms/${t||0}/rules/integrations`).then(s=>s.data).then(s=>(n(Bn.set(s)),s)),staleTime:1/0,gcTime:1/0})},Id=l.div`
  position: relative;
...
`,Ad=l.div`
  ...
  box-shadow:
    ...
    0 2px 12px rgb(205 216 228 / 50%);
  border-radius: ${S.lg};
`,qe={base:["form-monitor"],tests:(t,n)=>[...qe.base,"tests",t,n],stats:t=>[...qe.base,"stats",t],testEmailHistory:t=>[...qe.base,"test-email-history",t],testEmailStatus:t=>[...qe.base,"test-email-status",t],mailerInfo:()=>[...qe.base,"mailer-info"]},Lm=(t,n={})=>{const{limit:s=100,offset:i=0}=n;return B({queryKey:qe.tests(t,{limit:s,offset:i}),queryFn:()=>T.get(`/api/form-monitor/forms/${t}/tests`,{params:{limit:s,offset:i}}).then(o=>o.data),staleTime:0,refetchOnWindowFocus:!1,enabled:!!t})},Rd=(t,n)=>B({queryKey:qe.stats(t),queryFn:()=>T.get(`/api/form-monitor/forms/${t}/stats`).then(s=>s.data),enabled:n?.enabled??!!t}),Fm=(t,n={})=>{const{limit:s=50,offset:i=0}=n;return B({queryKey:qe.testEmailHistory({limit:s,offset:i}),queryFn:()=>T.get("/api/form-monitor/test-email/history",{params:{limit:s,offset:i}}).then(o=>o.data),staleTime:0,refetchOnWindowFocus:!1,enabled:!!t})},Em=(t,n)=>B({queryKey:qe.testEmailStatus(t||""),queryFn:()=>T.get("/api/form-monitor/test-email/status",{params:{token:t}}).then(s=>s.data),enabled:(n?.enabled??!0)&&!!t,refetchInterval:n?.refetchInterval??!1}),Tm=(t,n)=>ce({mutationFn:()=>T.post("/api/form-monitor/test-email",{formId:t}).then(s=>s.data),onSuccess:s=>{n?.onSuccess?.(s)},onError:n?.onError}),Pd=()=>B({queryKey:qe.mailerInfo(),queryFn:()=>T.get("/api/form-monitor/mailer-info").then(t=>t.data),staleTime:300*1e3});l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.lg};
  padding: ${m.xl};
...
`,Na=l.div`
  ...
  gap: ${m.md};
`,Ym=()=>e.jsx(Qt,{baseColor:h.gray100,highlightColor:h.gray200,children:e.jsxs(Dd,{children:[e.jsx(k,{width:100,height:20}),e.jsx(k,{width:120,height:16}),[...Array(3)].map((t,n)=>e.jsxs(Qm,{children:[e.jsxs(Km,{children:[e.jsx(k,{width:80,height:14}),e.jsx(k,{width:60,height:14})]}),e.jsx(k,{width:"100%",height:8})]},n))]})}),Jm=()=>e.jsx(Qt,{baseColor:h.gray100,highlightColor:h.gray200,children:e.jsxs(Vm,{children:[e.jsxs(Gm,{children:[e.jsx(k,{height:24,width:300}),e.jsx(k,{height:100})]}),e.jsxs(Na,{children:[e.jsx(k,{height:24}),e.jsx(k,{height:24}),e.jsx(k,{height:24}),e.jsx(k,{height:24}),e.jsx(k,{height:24})]}),[...Array(10)].map((t,n)=>e.jsxs(Na,{children:[e.jsx(k,{height:40}),e.jsx(k,{height:40}),e.jsx(k,{height:40}),e.jsx(k,{height:40}),e.jsx(k,{height:40,width:100})]},n))]})}),Bd=({formId:t,testId:n,onClose:s,onSuccess:i})=>{const[o,r]=g.useState(!1),[a,c]=g.useState(""),u=n===0,p=Rm(t,n,{onSuccess:()=>{i?.(),s()}}),x=Pm(t,{onSuccess:()=>{i?.(),s()}}),f=y=>{c(y.target.value)},b=()=>{u&&!o||(u?x.mutate():p.mutate())};g.useEffect(()=>{r(u?a.toUpperCase()==="DELETE":!0)},[a,u]);const j=p.isPending||x.isPending;return e.jsx(wt,{closeModal:s,children:e.jsxs(ve,{children:[e.jsx(we,{children:e.jsx("h1",{children:d(u?"Clear All Test History":"Delete Test")})}),e.jsxs(hs,{children:[e.jsx("div",{children:d(u?"Are you sure you want to clear all test history? This action cannot be undone.":"Are you sure you want to permanently delete this test? This action cannot be undone.")}),u&&e.jsxs(e.Fragment,{children:[e.jsx("div",{dangerouslySetInnerHTML:{__html:O.sanitize(d("To clear all test history, please type <strong>DELETE</strong> in the box below:"))}}),e.jsx("input",{type:"text",autoFocus:!0,value:a,autoComplete:"off",onChange:f,className:"text fullwidth"})]})]}),e.jsxs($e,{children:[e.jsx("button",{type:"button",className:"btn cancel",onClick:s,children:d("Cancel")}),e.jsx("button",{type:"button",className:E("btn submit",!o&&"disabled"),onClick:b,disabled:j||!o,children:e.jsx(Z,{loadingText:d(u?"Clearing":"Deleting"),loading:j,spinner:!0,children:d(u?"Clear All":"Delete")})})]})]})})},Zm=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.xl};
...
`,pg=t=>t==="pending"?"Processing":t.charAt(0).toUpperCase()+t.slice(1),hg=({configuration:t,refetchData:n,hasTests:s,isError:i})=>{const[o,r]=oe.useState(null),[a,c]=oe.useState(!1),[u,p]=oe.useState(!1),[x,f]=oe.useState(!1),[b,j]=oe.useState(!1),y=oe.useRef(null);oe.useEffect(()=>{const C=F=>{y.current&&!y.current.contains(F.target)&&j(!1)};return document.addEventListener("mousedown",C),()=>{document.removeEventListener("mousedown",C)}},[]);const w=Am(t.formId,{onLoading:()=>{r("loading")},onSuccess:()=>{r("success"),setTimeout(()=>{r(null),n()},2e3)},onError:()=>{r("error"),setTimeout(()=>{r(null)},2e3)}}),v=()=>{w.mutate()},$=()=>o==="loading"?d("Reactivating service..."):o==="error"?d("Reactivation unsuccessful."):o==="success"?d("Service reactivated!"):null;return e.jsxs(tg,{children:[e.jsx("h3",{children:d("Configuration")}),e.jsxs(ng,{children:[!i&&e.jsxs(Ei,{children:[e.jsx(Ti,{children:d("Integration Status")}),e.jsxs(xt,{$size:"sm",$status:t.integrationStatus==="enabled"?"success":"disabled",children:[e.jsx(fn,{$size:"md"}),d(t.integrationStatus==="enabled"?"ENABLED":"DISABLED")]})]}),e.jsxs(Ei,{children:[e.jsx(Ti,{children:d("Service Status")}),e.jsxs(sg,{children:[e.jsxs(xt,{$size:"sm",$status:t.serviceStatus==="active"?"active":t.serviceStatus==="inactive"?"inactive":"disabled",children:[e.jsx(fn,{$size:"md"}),d(i?"Error":t.serviceStatus==="active"?"ACTIVE":t.serviceStatus==="inactive"?"INACTIVE":"DISABLED")]}),t.serviceStatus==="inactive"&&t.integrationStatus==="enabled"&&(o?e.jsx(og,{$error:o==="error",children:$()}):e.jsx(ig,{onClick:v,disabled:w.isPending,children:d("Reactivate")}))]})]}),t?.monitoredUrl&&e.jsxs(Ei,{$isColumn:!0,children:[e.jsx(Ti,{children:d("Monitored URL")}),e.jsx(rg,{children:t.monitoredUrl})]}),e.jsxs(lg,{ref:y,children:[!i&&e.jsx(cg,{onClick:()=>j(!b),"aria-expanded":b,"aria-controls":"action-menu",title:d("Actions"),children:e.jsx(Vc,{})}),b&&e.jsxs(dg,{id:"action-menu",children:[s&&e.jsxs(co,{onClick:()=>{j(!1),c(!0)},children:[e.jsx(Om,{}),d("Clear All Test History")]}),t.serviceStatus!=="inactive"&&e.jsxs(co,{onClick:()=>{j(!1),p(!0)},children:[e.jsx(Wm,{}),d("Disable Monitoring")]}),e.jsxs(ug,{onClick:()=>{j(!1),f(!0)},children:[e.jsx(Um,{}),d("Disable & Delete Monitoring Data")]})]})]})]}),a&&e.jsx(Bd,{formId:t.formId,testId:0,onClose:()=>c(!1),onSuccess:()=>{c(!1),n()}}),u&&e.jsx(Hm,{formId:t.formId,onClose:()=>p(!1),onSuccess:()=>{p(!1),n()}}),x&&e.jsx(qm,{formId:t.formId,onClose:()=>f(!1),onSuccess:()=>{f(!1),n()}})]})},za=({lastTest:t})=>{const n=t?.totalStatus;return n?e.jsxs(eg,{children:[e.jsx("h3",{children:d("Most Recent Test")}),e.jsxs(Xm,{children:[t?.dateAttempted,e.jsx("div",{className:`status-${n}`,children:e.jsx("div",{className:"status-main",children:e.jsxs(xt,{$status:n,$size:"xl",children:[e.jsx(fn,{$size:"xl",$status:n,children:n==="pending"&&e.jsx(_m,{})}),d(pg(n))]})})})]})]}):null},xg=({nextMonitoringTime:t,nextMonitoringTimeIn:n})=>n?e.jsxs(ag,{children:[e.jsx("h3",{children:d("Next Scheduled Test")}),e.jsxs("div",{className:"next-test-time",children:[t," ",e.jsx("br",{})," (",d("in")," ",n?.humanReadable,")"]})]}):null,mg=({formTestsQuery:t})=>{const{data:n,isLoading:s,refetch:i}=t;if(s)return e.jsx(De,{children:e.jsx(Ym,{})});const o={integrationStatus:n?.enabled?"enabled":"disabled",serviceStatus:n?.fmFormStats?.enabled?"active":"inactive",monitoredUrl:n?.url||"",formId:n?.formId},r=n?.stats?.total>0,a=!!t.data?.error?.message;return e.jsx(De,{children:e.jsxs(Zm,{children:[r?e.jsxs(e.Fragment,{children:[e.jsx(za,{lastTest:n?.lastSubmission}),n?.lastSubmission?.status!=="pending"&&e.jsx(xg,{nextMonitoringTime:n?.fmFormStats?.nextMonitoringTime,nextMonitoringTimeIn:n?.fmFormStats?.nextMonitoringTimeIn})]}):e.jsx(za,{}),e.jsx(hg,{configuration:o,refetchData:i,hasTests:r,isError:a})]})})},gg=()=>{const{formId:t}=V(),[n]=Ho(),s=100,i=Number(n.get("page"))||1,o=i>0?(i-1)*s:0,r=Lm(Number(t),{limit:s,offset:o});return e.jsxs(Nm,{children:[e.jsx(mg,{formTestsQuery:r}),e.jsx(jt,{context:{formTestsQuery:r}})]})};function Ct(t){const[n,s]=g.useState(!1),i=()=>s(!0),o=()=>s(!1);return g.useEffect(()=>{const r=t.current;if(r)return r.addEventListener("mouseenter",i),r.addEventListener("mouseleave",o),()=>{r.removeEventListener("mouseenter",i),r.removeEventListener("mouseleave",o)}},[t]),n}const fg=({active:t,hovering:n})=>Y({opacity:t?1:0,background:n?h.error:"transparent",fill:n?"#fff":h.gray300,color:n?"#fff":h.gray300,scale:n?1.2:1,rotate:t?0:30,config:s=>{switch(s){case"background":case"color":return{tension:330,friction:20};default:return{tension:330,friction:15}}}}),Od=l(_.button)`
  display: flex;
  justify-content: center;
  align-items: center;
...
`,Nn=({active:t,onClick:n,...s})=>{const i=g.useRef(null),o=Ct(i),a={...fg({active:t,hovering:o}),...s?.style};return delete s.style,e.jsx(Od,{type:"button",ref:i,style:a,onClick:n,...s,children:e.jsx(Gc,{})})},bg={dark:se`
...
`,zi=l.div`
  ...
  margin-bottom: ${m.lg};
  width: 100%;
`,Tg=({data:t,closeModal:n})=>{if(!t)return null;const{screenshot:s,beforeSubmitScreenshot:i,testId:o}=t,r=!!s,a=!!i,c=r&&a,u=(x,f)=>e.jsxs(Ma,{children:[c&&e.jsx(Ia,{children:f}),e.jsx(Aa,{children:e.jsx(B1,{initialScale:1,minScale:.5,maxScale:3,wheel:{step:.1},pinch:{step:5},doubleClick:{step:.5},children:({zoomIn:b,zoomOut:j,resetTransform:y,instance:w})=>e.jsxs(e.Fragment,{children:[e.jsx(O1,{wrapperStyle:{width:"100%",height:"100%",display:"flex",justifyContent:"center",alignItems:"center"},contentStyle:{width:"100%",height:"100%",display:"flex",justifyContent:"center",alignItems:"center"},children:e.jsx(Sg,{src:x,alt:f,loading:"lazy",draggable:!1})}),e.jsxs(Lg,{children:[e.jsxs(Fg,{children:[e.jsx(Ni,{onClick:()=>j(),disabled:w.transformState.scale<=.5,title:d("Zoom Out"),children:"−"}),e.jsx(Ni,{onClick:()=>y(),title:d("Reset Zoom"),children:"↺"}),e.jsx(Ni,{onClick:()=>b(),disabled:w.transformState.scale>=3,title:d("Zoom In"),children:"+"})]}),e.jsx(_1,{width:104,height:108,borderColor:"rgba(255, 255, 255, 0.8)",children:e.jsx("img",{src:x,alt:"Minimap"})})]})]})})})]}),p=x=>e.jsxs(Ma,{children:[e.jsx(Ia,{children:x}),e.jsx(Aa,{children:e.jsx(Eg,{children:d("No screenshot available")})})]});return e.jsxs(ve,{style:{maxWidth:"90vw",width:"1200px"},children:[e.jsx(we,{children:e.jsx("h1",{children:d("Screenshots for Test",{testId:o})})}),e.jsx("div",{style:{padding:`${m.lg} ${m.xl}`},children:c?e.jsxs(kg,{children:[u(i,d("Before Submit")),u(s,d("After Submit"))]}):a?e.jsx(zi,{children:u(i,"")}):r?e.jsx(zi,{children:u(s,"")}):e.jsx(zi,{children:p(d("Screenshots"))})}),e.jsx($e,{children:e.jsx("button",{type:"button",className:"btn cancel",onClick:n,children:d("Close")})})]})},Ng=t=>{const{openModal:n}=Ke();return()=>{n(Tg,t)}},Mi=l.div`
  flex: 1;
  background: ${h.white};
  padding: ${m.xl};
  overflow-y: auto;
...
`,lf=l.div`
  padding-top: ${m.md};
`,cf=({tabs:t,activeTab:n,onTabChange:s})=>e.jsxs(sf,{children:[e.jsx(of,{children:t.map(i=>e.jsx(rf,{children:e.jsx(af,{className:E(n===i.id&&"active"),onClick:()=>s(i.id),children:d(i.label)})},i.id))}),e.jsx(lf,{children:t.find(i=>i.id===n)?.content})]}),Ai={position:"top",animation:"fade",delay:[100,0]},df=t=>{switch(t){case"success":return e.jsx(Yc,{});case"failed":return e.jsx(dt,{});case"pending":return e.jsx(es,{});default:return e.jsx(es,{})}},uf=({test:t,formId:n,onDelete:s,showNotifications:i})=>{const o=Ng({screenshot:t.screenshot,beforeSubmitScreenshot:t.beforeSubmitScreenshot,testId:t.id}),r=g.useRef(null),a=Ct(r),c=t.dateAttempted;return e.jsxs("tr",{ref:r,children:[e.jsx("td",{className:"no-break",children:t.id}),e.jsx("td",{className:"no-break",title:c,children:c}),e.jsx("td",{className:"no-break",children:e.jsxs(xt,{$status:t.totalStatus,$size:"sm",children:[e.jsx(fn,{$size:"lg"}),d(t.totalStatus?.toUpperCase())]})}),e.jsx("td",{className:"no-break",children:e.jsxs(Vg,{children:[e.jsx(Gg,{$status:t.status,children:e.jsx(_a,{children:df(t.status)})}),t.screenshot&&e.jsx(xe,{title:d("View Screenshot"),...Ai,children:e.jsx(Jg,{onClick:o,children:e.jsx(Cg,{})})}),t.submissionDuration!==0&&e.jsx(xe,{title:d(`Submit time is ${t.submissionDuration} seconds`,{duration:t.submissionDuration.toFixed(2)}),...Ai,children:e.jsxs(Yg,{children:[t.submissionDuration.toFixed(1),"s"]})})]})}),i&&e.jsx("td",{children:t?.totalNotifications?t.dateCompleted?e.jsx(xe,{html:e.jsx(uo,{children:e.jsxs(po,{children:[e.jsxs(Qg,{children:[e.jsxs(Oa,{children:[e.jsx("div",{className:"label",children:d("Enabled")}),e.jsx("div",{className:"value",children:t.totalNotifications})]}),e.jsxs(Oa,{children:[e.jsx("div",{className:"label",children:d("Received")}),e.jsx("div",{className:"value",children:t.notifications?.length||0})]})]}),e.jsx(qg,{children:t.notifications?.map((u,p)=>e.jsx(Kg,{children:u.type},p))})]})}),position:"top",theme:"light",animation:"fade",arrow:!0,duration:100,distance:10,size:"small",hideOnClick:!1,followCursor:!0,children:e.jsxs(xt,{$status:t.notifications?.length>=t.totalNotifications?"success":"failed",$size:"sm",style:{cursor:"pointer"},children:[t.notifications?.length||0,"/",t.totalNotifications]})}):e.jsx(Zg,{children:e.jsx(_a,{children:e.jsx(es,{})})}):e.jsx(xt,{$status:"inactive",$size:"sm",children:"N/A"})}),e.jsx("td",{className:"no-break",children:t?.totalResponse&&e.jsx(Bg,{children:e.jsx(Og,{children:t.totalResponse})})}),e.jsx("td",{children:e.jsx(xe,{title:d("Delete Test"),...Ai,children:e.jsx(Nn,{active:a,onClick:()=>s({formId:n,testId:t.id})})})})]})},pf=({groups:t})=>{const n=t.slice(0,30);if(n.length===0)return e.jsx(Hg,{children:d("No test results available for the last 30 days.")});const s=Math.max(...n.map(i=>i.tests.length),1);return e.jsx(Ug,{children:n.map((i,o)=>e.jsx(hf,{group:i,maxTests:s,isCurrentDay:o===0},i.date))})},hf=({group:t,maxTests:n,isCurrentDay:s})=>{const i=g.useRef(null),o=Ct(i),r=x=>e.jsxs(uo,{children:[e.jsx(Wg,{children:e.jsxs(xt,{$status:x.totalStatus,$size:"sm",children:[e.jsx(fn,{$size:"md"}),d(x.totalStatus?.toUpperCase())]})}),e.jsxs(po,{children:[e.jsxs("div",{className:"test-id",children:["Test: ",x.id]}),e.jsx("div",{className:"test-date",children:x.dateAttempted}),x.totalResponse&&e.jsx("div",{className:"test-response",children:x.totalResponse})]})]}),a=100/n,c=t.tests||[],u=s?n-c.length:0;if(t.isInactive)return e.jsx(Ba,{ref:i,children:e.jsx(xe,{html:e.jsx(uo,{children:e.jsxs(po,{children:[e.jsx("div",{children:d("No tests on this day")}),e.jsx("div",{className:"test-date",children:t.date})]})}),position:"top",theme:"light",animation:"fade",arrow:!0,duration:100,distance:10,size:"small",hideOnClick:!1,followCursor:!0,children:e.jsx(Ii,{$status:"inactive",$height:100,$offset:0,$isLast:!0,$isHovering:o,$isPending:!1})})});const p=[...c].reverse();return e.jsxs(Ba,{ref:i,children:[p.map((x,f)=>e.jsx(xe,{html:r(x),position:"bottom",theme:"light",animation:"fade",duration:100,distance:-15,size:"small",hideOnClick:!1,followCursor:!0,children:e.jsx(Ii,{$status:x.totalStatus,$height:a,$offset:f*a,$isLast:f===p.length-1&&u===0,$isHovering:o,$isPending:!1},x.id)},x.id)),u>0&&Array.from({length:u}).map((x,f)=>e.jsx(Ii,{$status:"inactive",$height:a,$offset:(p.length+f)*a,$isLast:f===u-1,$isHovering:o,$isPending:!0},`pending-${f}`))]})},xf=()=>{const{formTestsQuery:t}=W1(),[n,s]=Ho(),i=Number(n.get("page"))||1,[o,r]=oe.useState(null),[a,c]=oe.useState("testResults"),{data:u,isLoading:p,isFetching:x,refetch:f}=t,b=100;if(p||x)return e.jsx(Jm,{});if(u?.error)return e.jsx(Im,{children:u.error?.message});if(!u||!u.tests)return e.jsx(Mi,{children:e.jsx(Ra,{children:e.jsx("p",{children:d("Form Monitor is not enabled for this form.")})})});if(u?.stats?.total===0&&u?.fmFormStats?.enabled)return e.jsx(Mi,{children:e.jsx(Ra,{children:e.jsx("p",{children:d("This form is awaiting its first scan. This could take a few minutes.")})})});const j=J=>{s({page:String(J)}),window.scrollTo({top:0,behavior:"smooth"})},y=u.tests.flatMap(J=>J.tests),w=y.length,v=Math.ceil(w/b),$=(i-1)*b,C=$+b,F=y.slice($,C),N=u.stats?.total||0,M=u.stats?.failed||0,z=e.jsx(zg,{children:e.jsxs(Mg,{children:[e.jsx(Pa,{children:d("Of the {total30} tests that have occurred in the last 30 days, {failed} tests have failed for this form.",{total30:N,failed:M})}),e.jsx(pf,{groups:u.tests})]})}),L=e.jsx(nf,{groups:u.tests}),A=[{id:"testResults",label:"Test Results",content:z},{id:"submitTimes",label:"Form Submit Times",content:L}],D=u.stats?.total||0;return e.jsxs(Mi,{children:[e.jsx(cf,{tabs:A,activeTab:a,onTabChange:c}),e.jsxs(Ig,{children:[e.jsxs(Ag,{children:[e.jsx("h3",{children:d("Detailed Results")}),e.jsx(Pa,{children:d("A total of {total} tests have been conducted for this form.",{total:D})})]}),e.jsxs(_g,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:d("Test ID")}),e.jsx("th",{children:d("Date")}),e.jsx("th",{children:d("Status")}),e.jsx("th",{children:d("Form Submit")}),u.notifications?.enabled&&e.jsx("th",{children:d("Notifications")}),e.jsx("th",{children:d("Response")}),e.jsx("th",{})]})}),e.jsx("tbody",{children:F.map(J=>e.jsx(uf,{test:J,formId:u.formId,onDelete:r,showNotifications:u.notifications?.enabled},J.id))})]})]}),w>b&&e.jsxs(Rg,{children:[e.jsxs(Pg,{"aria-label":"test results pagination",children:[e.jsx(Da,{className:"prev-page",onClick:()=>j(i-1),disabled:i===1,title:d("Previous Page")}),e.jsx(Da,{className:"next-page",onClick:()=>j(i+1),disabled:i===v,title:d("Next Page")})]}),e.jsxs(Dg,{children:[d("Showing")," ",$+1,"-",Math.min(C,w)," ",d("of")," ",w," ",d("tests")]})]}),o&&e.jsx(Bd,{formId:o.formId,testId:o.testId,onClose:()=>r(null),onSuccess:()=>{f()}})]})},ho="freeform-builder-tabs",xo=new Set,_d=t=>t?JSON.parse(sessionStorage.getItem(ho)||"{}")[t]||{}:{},mf=(t,n)=>{const s=JSON.parse(sessionStorage.getItem(ho)||"{}");sessionStorage.setItem(ho,JSON.stringify({...s,[t]:n}))},gf=(t,n)=>_d(t)[n]??null,ff=()=>{xo.forEach(t=>{t()})},bf=t=>(xo.add(t),()=>{xo.delete(t)}),We=t=>{const{formId:n}=V(),s=g.useSyncExternalStore(bf,()=>gf(n,t)),i=g.useCallback(o=>{n&&(mf(n,{..._d(n),[t]:o??null}),ff())},[n,t]);return{lastTab:s,setLastTab:i}},ts=(t,n)=>{n===void 0&&(t>1?(n=t,t=1):(n=t,t=0));const s=[];for(let i=t;i<=n;i++)s.push(i);return s},jf=(t,n,s)=>{const i={};return t.forEach(o=>{const r=o[n];let a;a=o[s],i[r]=a}),i},Ha=(t,n)=>Math.floor(Math.random()*(n-t+1))+t,rr=l.div`
  flex: 1;
...
`,Wd=l.div`
  ...
  height: 100%;
  background: ${h.white};
`,wf=()=>e.jsxs(Wd,{children:[e.jsx(De,{children:e.jsx(Qt,{baseColor:h.gray200,highlightColor:h.gray300,children:ts(5).map(t=>e.jsx(mo,{children:e.jsx(k,{width:200},t)},t))})}),e.jsxs(rr,{children:[e.jsx(ar,{children:e.jsx(k,{width:100})}),ts(7).map(t=>e.jsxs("div",{style:{width:"100%"},children:[e.jsx(k,{width:Ha(120,300)}),e.jsx(k,{width:`${Ha(70,90)}%`,height:8}),e.jsx(k,{height:30})]},t))]})]}),$f=()=>{const{ownership:t}=P(Pe.current);return t?e.jsxs(e.Fragment,{children:[e.jsx(vf,{}),e.jsxs(lr,{children:[e.jsxs(Qa,{children:[t.created.user?e.jsxs(e.Fragment,{children:[d("Created by")," ",e.jsx(Ka,{href:t.created.user.url,target:"_blank",children:t.created.user.name})]}):d("Created")," ",d("at"),":",e.jsx("br",{})," ",t.created.datetime]}),e.jsxs(Qa,{children:[t.updated.user?e.jsxs(e.Fragment,{children:[d("Last Updated by")," ",e.jsx(Ka,{href:t.updated.user.url,target:"_blank",children:t.updated.user.name})]}):d("Last Updated")," ",d("at"),":",e.jsx("br",{})," ",t.updated.datetime]})]})]}):null},bn=t=>t?!!Object.entries(t).length:!1,Cf=t=>e.jsx(R,{viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M160 64c-17.7 0-32 14.3-32 32l0 320c0 11.7-3.1 22.6-8.6 32L432 448c26.5 0 48-21.5 48-48l0-304c0-17.7-14.3-32-32-32L160 64zM64 480c-35.3 0-64-28.7-64-64L0 160c0-35.3 28.7-64 64-64l0 32c-17.7 0-32 14.3-32 32l0 256c0 17.7 14.3 32 32 32s32-14.3 32-32L96 96c0-35.3 28.7-64 64-64l288 0c35.3 0 64 28.7 64 64l0 304c0 44.2-35.8 80-80 80L64 480zM384 112c0-8.8 7.2-16 16-16l32 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-32 0c-8.8 0-16-7.2-16-16zm0 64c0-8.8 7.2-16 16-16l32 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-32 0c-8.8 0-16-7.2-16-16zm0 64c0-8.8 7.2-16 16-16l32 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-32 0c-8.8 0-16-7.2-16-16zM160 304c0-8.8 7.2-16 16-16l256 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-256 0c-8.8 0-16-7.2-16-16zm0 64c0-8.8 7.2-16 16-16l256 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-256 0c-8.8 0-16-7.2-16-16zm32-144l128 0 0-96-128 0 0 96zM160 120c0-13.3 10.7-24 24-24l144 0c13.3 0 24 10.7 24 24l0 112c0 13.3-10.7 24-24 24l-144 0c-13.3 0-24-10.7-24-24l0-112z"})}),kf=()=>{const t=I.limitations,n=ne(),{setLastTab:s}=We("settings"),{sectionHandle:i}=V(),o=I.metadata.craft.is5,r=P(Pe.errors),{data:a}=Gt();if(!a)return null;const c=[];return a.forEach(u=>{u.properties.forEach(p=>{bn(r?.[u.handle]?.[p.handle])&&(c.includes(p.section)||c.push(p.section))})}),e.jsxs(De,{$lean:!0,children:[e.jsxs(lr,{children:[a.map(u=>u.sections.filter(p=>t.can(`settings.tab.${p.handle}`)).map(p=>e.jsxs(mo,{onClick:()=>{s(p.handle),n(`${p.handle}`)},className:E(i===p.handle&&"active",c.includes(p.handle)&&"errors"),children:[e.jsx(qa,{dangerouslySetInnerHTML:{__html:O.sanitize(p.icon)}}),d(p.label)]},p.handle))),o&&e.jsxs(mo,{onClick:()=>{s(Bs),n(Bs)},className:E(i===Bs&&"active"),children:[e.jsx(qa,{children:e.jsx(Cf,{})}),d("Usage in Elements")]})]}),e.jsx($f,{})]})},Bs="usage",Sf=()=>{const t=I.limitations,{sectionHandle:n}=V(),s=ne(),{lastTab:i,setLastTab:o}=We("settings"),r=st(""),{data:a,isFetching:c}=Gt();return g.useEffect(()=>{i&&s(i)},[s,i]),g.useEffect(()=>{if(!n&&!i){const u=a?.[0]?.sections.filter(p=>t.can(`settings.tab.${p.handle}`))?.[0];u&&(o(u.handle),s(`${u.handle}`))}},[a,n,i,s,o]),!a&&c?e.jsx(wf,{}):e.jsxs(Wd,{children:[e.jsx(q,{id:"settings",label:d("Settings"),url:r.pathname}),e.jsx(kf,{}),e.jsx(jt,{})]})},Ud=l.div`
  position: relative;
  width: 100%;
`,Lf=l(_.div)`
  position: absolute;
...
`,dr=l.div`
  ...
  ${Q};
`,Ve=({preview:t,onEdit:n,onAfterEdit:s,excludeClassNames:i=[],children:o})=>{const[r,a]=g.useState(void 0),c=g.useRef(null),u=g.useRef(null),p=g.useRef(r),{editorAnimation:x}=ed({wrapper:c.current,editor:u.current,isEditing:r});$t({callback:()=>{a(!1)},isEnabled:r,refObject:u,excludeClassNames:["tagify__dropdown","dropdown-rollout","elementselectormodal",...i]});const f=()=>{a(!1)},b=j0();return os(()=>a(!1),!!r),g.useEffect(()=>{p.current&&r===!1&&s?.(),p.current=r},[r,s]),e.jsxs(Ud,{ref:c,children:[e.jsx(td,{children:e.jsx(Lf,{style:{zIndex:b,pointerEvents:r?"initial":"none",...x},className:E(r&&"active","editable-content"),ref:u,children:typeof o=="function"?o(r,f):o})}),e.jsx(cr,{onClick:()=>{a(!0),n?.()},children:t})]})},Ae={all:X(t=>t.layout.fields,t=>t),count:X(t=>t.layout.fields,t=>t.length),one:t=>X(n=>n.layout.fields,n=>n.find(s=>s.uid===t)),hasErrors:X(t=>t.layout.fields,t=>t.some(n=>n.errors!==void 0)),inRow:t=>X(n=>n.layout.fields,n=>n.filter(s=>s.rowUid===t.uid).sort((s,i)=>(s.order??0)-(i.order??0)))},Ff=t=>P(Ae.all).filter(i=>t.availableFieldTypes.includes("*")?!0:t.availableFieldTypes.includes(i.typeClass)).map(i=>i.properties.handle),Ef=l.div`
  display: flex;
  align-items: center;
  gap: ${m.md};
...
`;const Hd=(t,n)=>{const s=t.match(/field:([a-zA-Z0-9_]+)/g);if(!s||s.length===0)return t;const i=s.map(o=>o.replace("field:",""));return n==="<mark>...</mark>"?i.map(o=>`<mark>${o}</mark>`).join(", "):i.map(o=>`[[${o}]]`).join(", ")},zf=({value:t,property:n,updateValue:s})=>{const[i,o]=g.useState(""),r=Ff(n),a=g.useRef(null),c=g.useCallback(p=>{s(p.detail.tagify.DOM.input.textContent.replace(/\u200B/g,"").replace(/\s+/g," ").trim())},[s]),u=p=>{if(!p)return;const x=a.current.createTagElem({value:p});a.current.injectAtCaret(x);const f=a.current.insertAfterTag(x,"");a.current.placeCaretAfterNode(f)};return g.useEffect(()=>{o(Hd(t))},[t]),e.jsxs(it,{children:[e.jsxs(Ef,{children:[e.jsx(Nf,{children:e.jsx(de,{emptyOption:d("Insert Field"),options:r.map(p=>({value:p,label:p})),onChange:u,value:""})}),e.jsxs("span",{children:["or type ",e.jsx("mark",{children:"@"})," to search on field handles"]})]}),e.jsx(Tf,{children:e.jsx(uc,{autoFocus:!1,tagifyRef:a,settings:{pattern:/@/,enforceWhitelist:!0,editTags:!1,pasteAsTags:!0,duplicates:!0,dropdown:{enabled:0,includeSelectedTags:!0},templates:{tag:function(p){return`
                <tag
                  title="${p.value}"
...
`,If=({value:t})=>e.jsx(Jt,{"data-edit":d("Click to edit data"),children:e.jsxs(Mf,{children:[!t&&e.jsx(kt,{children:d("Not configured yet")}),e.jsx("div",{style:{lineHeight:"2.0"},dangerouslySetInnerHTML:{__html:O.sanitize(Hd(t,"<mark>...</mark>"))}})]})}),Af=({value:t,property:n,errors:s,updateValue:i})=>e.jsx(W,{property:n,errors:s,children:e.jsx(Ve,{preview:e.jsx(If,{value:t}),children:e.jsx(zf,{value:t,property:n,updateValue:i})})}),qd=(t,n,s)=>{let i=!0;return t.forEach(o=>{new Function(...Object.keys(n),"context",`return ${o}`)(...Object.values(n),s)||(i=!1)}),i},un=(t,n)=>{const s=n.split(".");let i=t;for(const o of s){if(i===void 0)return;i=i[o]}return i},Rf=({value:t,property:n,errors:s,updateValue:i})=>{const{source:o,optionValue:r,optionLabel:a,filters:c,emptyOption:u}=n,x=ac().getState(),f=un(x,o),b=[];return f.forEach((j,y)=>{qd(c,j)&&b.push({label:a?un(j,a):j,value:r?un(j,r):y})}),e.jsx(W,{property:n,errors:s,children:e.jsx(de,{value:t,onChange:i,emptyOption:u,options:b})})},Qd={all:["craft-asset-previews"],byIds:t=>[...Qd.all,{ids:t}]},Pf=t=>B({queryKey:Qd.byIds(t),queryFn:()=>T.get(`api/assets?ids=${t.join(",")}`).then(n=>n.data),staleTime:1/0,gcTime:1/0,enabled:t?.length>0}),pr=({actionLabel:t,multiSelect:n,sources:s="*",criteria:i,limit:o,value:r,onUpdate:a})=>{const{data:c,isFetching:u}=Pf(r),p=g.useCallback(()=>{Craft.createElementSelectorModal("craft\\elements\\Asset",{multiSelect:o!==1||n,sources:s,criteria:i,storageKey:"freeform-asset-selection",onSelect:j=>{const w=j.map($=>$.id).slice(0,o).filter($=>!r?.includes($)),v=[...r||[],...w];a(v)}})},[a,n,i,o,s,r]),x=g.useCallback(j=>{a(r.filter(y=>y!==j))},[a,r]),f=o===void 0||r?.length===void 0||r?.length<o,b=c===void 0&&u&&r?.length>0;return e.jsxs("div",{className:"elementselect",children:[e.jsxs("ul",{className:"elements chips chips-small",children:[b&&r.map((j,y)=>e.jsx("li",{className:"element small",children:e.jsxs("div",{className:"chip small element",children:[e.jsx("div",{className:"thumb",children:e.jsx(k,{width:30,height:20})}),e.jsx("div",{className:"chip-content",children:e.jsx(k,{width:Bf(y)})})]})},`skeleton-${j}`)),c?.map(j=>e.jsx("li",{className:"element small removable",children:e.jsxs("div",{className:"chip small element removable",children:[e.jsx("div",{className:"thumb",children:e.jsx("img",{src:j.thumbUrl,alt:j.title,width:30,height:20})}),e.jsxs("div",{className:"chip-content",children:[e.jsx("div",{className:"element-label",children:e.jsx("a",{className:"label-link",href:j.editUrl,target:"_blank",rel:"noreferrer",children:j.title})}),e.jsx("div",{className:"chip-actions",children:e.jsx(Of,{type:"button",title:d("Remove"),onClick:()=>x(j.id)})})]})]})},j.id))]}),f&&e.jsx("div",{className:"flex",children:e.jsx("button",{type:"button",className:"btn add icon",onClick:p,children:d(t||"Add an asset")})})]})},Df=[80,100,90,70,120],Bf=t=>Df[t]||100,Of=l.button`
  font-family: 'Craft';
  font-size: 14px;
...
`,tu=l.span`
  color: ${h.red300};
`,nu=t=>{const n=[];return t.forEach(([s,i])=>{if(s=s===null?"":s,i=i===null?"":i,!s&&i&&(s=i,i=""),!(!s&&!i)){if(i===""){n.push([String(s),void 0]);return}Array.isArray(i)&&(i=i.join(" ")),n.push([String(s),String(i)])}}),n},l4=(t,n,s)=>{const i=n?.[t]||[];return{...n,[t]:[...i.slice(0,s+1),["",""],...i.slice(s+1)]}},Va=(t,n,s,i)=>{const o={...i,[n]:[...i[n]]};return o[n][t]=s,o},c4=(t,n,s)=>({...s,[n]:[...s[n].filter((i,o)=>o!==t)]}),d4=t=>{const n={};return Object.entries(t).forEach(([s,i])=>{n[s]=i.filter(([o,r])=>!!o||!!r)}),n},u4=({tab:t,attributes:n})=>{const s=n.find(([i])=>i.toLowerCase()==="tag")?.[1]||t.previewTag;return e.jsxs(a4,{children:["<",s,nu(n).filter(([i])=>i!=="tag").map(([i,o],r)=>e.jsxs("span",{children:[e.jsxs(Xd,{children:[" ",i]}),!!o&&e.jsxs(e.Fragment,{children:[e.jsx(eu,{children:"="}),e.jsx(Ks,{}),e.jsx(tu,{children:o}),e.jsx(Ks,{})]})]},r))," />"]})},p4=({property:t,attributes:n,updateValue:s})=>{const i=t.tabs||[],[o,r]=g.useState(i.at(0)),a=Object.entries(n),[c,u]=a.find(([y])=>y===o.handle)||[o.handle,[]],{activeCell:p,setActiveCell:x,setCellRef:f,keyPressHandler:b}=zn(u.length,2);if(g.useEffect(()=>{x(0,0)},[o?.handle]),!c||!u)return null;const j=(y,w,v)=>{x(v!==void 0?v+1:y,w),s(l4(c,n,v!==void 0?v:u.length-1))};return e.jsxs(s4,{children:[e.jsx(i4,{children:t.tabs?.map(y=>e.jsx("a",{className:E(y===o&&"active"),onClick:()=>r(y),children:d(y.label)},y.handle))}),e.jsxs(o4,{children:[e.jsx(u4,{tab:o,attributes:u}),e.jsx(r4,{children:e.jsx(js,{children:e.jsxs("tbody",{children:[!u.length&&e.jsxs(Qs,{children:[e.jsx(ue,{children:e.jsx(ot,{type:"text",placeholder:d("Attribute"),onFocus:()=>{j(0,0)}})}),e.jsx(ue,{children:e.jsx(ot,{type:"text",placeholder:d("Value"),onFocus:()=>{j(0,1)}})})]}),u.map(([y,w],v)=>e.jsxs(Qs,{children:[e.jsx(ue,{children:e.jsx(ot,{type:"text",value:String(y),placeholder:d("Attribute"),autoFocus:p===`${v}:0`,ref:$=>f($,v,0),onFocus:()=>x(v,0),onKeyDown:b({onEnter:$=>{j($.shiftKey?v:u.length,0,$.shiftKey?v:void 0)}}),onChange:$=>{s(Va(v,c,[$.target.value,w],n))}})}),e.jsx(ue,{children:e.jsx(ot,{type:"text",value:String(w),placeholder:d("Value"),autoFocus:p===`${v}:1`,ref:$=>f($,v,1),onFocus:()=>x(v,1),onKeyDown:b({onEnter:$=>{j($.shiftKey?v:u.length,1,$.shiftKey?v:void 0)}}),onChange:$=>{s(Va(v,c,[y,$.target.value],n))}})}),e.jsx(ue,{$tiny:!0,children:e.jsx(Bt,{tabIndex:-1,onClick:()=>{s(c4(v,c,n)),x(Math.max(v-1,0),0)},children:e.jsx(gs,{})})})]},v))]})})}),u.length>0&&e.jsx(ms,{label:"Add an attribute",onClick:()=>j(u.length,0,u.length-1)}),e.jsx("br",{}),e.jsx(Xt,{children:e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(d("Press <b>enter</b> while editing a cell to add a new row."))}})})]})]})},h4=l.div`
  min-height: 160px;
  max-height: 260px;
  overflow-x: hidden;
  overflow-y: auto;
...
`,f4=({tab:t,attributes:n})=>{const s=nu(n);return e.jsxs(g4,{className:E(!s.length&&"empty"),children:[e.jsx(su,{children:d(t.label)}),!!s.length&&e.jsx(x4,{children:s.map(([i,o],r)=>e.jsxs(m4,{children:[e.jsx(Xd,{children:i}),!!o&&e.jsxs(e.Fragment,{children:[e.jsx(eu,{children:"="}),e.jsx(Ks,{}),e.jsx(tu,{children:o}),e.jsx(Ks,{})]})]},r))})]})},b4=({property:t,attributes:n})=>e.jsx(h4,{children:t.tabs?.map(s=>e.jsx(f4,{tab:s,attributes:n[s.handle]||[]},s.handle))}),Ga=t=>{const n={};for(const s in t)n[s]=Object.entries(t[s]);return n},Ya=t=>{const n={};for(const s in t){n[s]={};for(const[i,o]of t[s])n[s][i]=o}return n},j4=({value:t,property:n,updateValue:s})=>{const{size:i}=ir(),[o,r]=g.useState(Ga(t)),a=xs(o,1e3);g.useEffect(()=>{const u=Ya(a);Ds(u,t)||s(u)},[a,s,t]),g.useEffect(()=>{const u=Ga(t);r(p=>Ds(u,p)?p:u)},[t]);const c=e.jsx(Ve,{preview:e.jsx(b4,{property:n,attributes:o}),onAfterEdit:()=>{const u=Ya(d4(o));Ds(u,t)||s(u)},children:e.jsx(p4,{property:n,attributes:o,updateValue:r})});return i==="small"?c:e.jsx(W,{property:n,children:c})},go=l.div`
  display: block;
...
`,en=({enabled:t,readOnly:n,errors:s,onClick:i})=>{const{is:o}=I.metadata.craft;return e.jsx(y4,{className:E(t&&"on",s&&"error",n&&"readonly",o.atLeast("5.8.0")&&"craft-5_8"),onClick:()=>{n||i?.(!t)},children:e.jsx(go,{})})},si=l.div`
  display: flex;
  justify-content: start;
  align-items: center;
  gap: ${m.sm};
...
`,iu=l.div`
  padding: 0 !important;
`,v4=l.div``,yn=({value:t,property:n,errors:s,context:i,updateValue:o})=>{const r=n.flags?.includes("readonly")||n.flags?.includes("as-readonly-in-instance");return e.jsx(W,{property:n,errors:s,context:i,preContent:e.jsx(si,{children:e.jsx(iu,{children:e.jsx(en,{enabled:t,readOnly:r,onClick:a=>o(a),errors:s})})})})},ou=(t=!0)=>B({queryKey:["autosuggest","env"],queryFn:()=>T.get("/api/autosuggest/env").then(n=>n.data),enabled:t,staleTime:1/0,gcTime:1/0}),w4=t=>!!t,$4=()=>{const{data:t}=ou();return g.useMemo(()=>{const n=[{label:d("Yes"),value:"true",icon:e.jsx("span",{className:"status enabled","aria-hidden":"true"})},{label:d("No"),value:"false",icon:e.jsx("span",{className:"status white","aria-hidden":"true"})}],s=t?.map(o=>({label:o.label,children:o.data.map(r=>({label:r.name,value:r.name,hint:r.hint,icon:e.jsx("span",{className:E("status",w4(r.hint)?"enabled":"white"),"aria-hidden":"true"})}))}))??[];return[...n,...s]},[t])},C4=({children:t})=>e.jsxs(k4,{className:"notice has-icon",children:[e.jsx("span",{className:"icon","aria-hidden":"true"}),e.jsx("span",{className:"visually-hidden",children:"Tip: "}),e.jsx("span",{children:t})]}),k4=l.p`
  margin-top: 5px;
`,S4="This can be set to an environment variable with a boolean value (`yes`/`no`/`true`/`false`/`on`/`off`/`0`/`1`).",L4=({value:t,updateValue:n,property:s,errors:i,context:o})=>{const r=d(S4),a=jd(r),{data:c,isFetching:u}=ou(),p=$4();return["","0","no","off"].includes(String(t).toLowerCase())?t="false":["1","yes","on"].includes(String(t).toLowerCase())&&(t="true"),e.jsxs(W,{property:s,errors:i,context:o,children:[e.jsx(de,{value:t,options:p,onChange:x=>n(x),loading:u&&!c,showSelectedIcon:!0,showHints:!0}),e.jsx(C4,{children:a})]})},F4=l.div`
  display: flex;
  flex-direction: row;
  justify-content: start;
  align-items: stretch;
...
`,hr=({value:t,options:n,onClick:s})=>{const i=[];return n.forEach((o,r)=>{"value"in o&&i.push(e.jsx(E4,{className:E(o.value===t&&"active"),onClick:()=>s(o.value),children:o.label},r))}),e.jsx(F4,{children:i})},T4=({value:t,property:n,errors:s,updateValue:i})=>{const{options:o}=n;return e.jsx(W,{property:n,errors:s,children:e.jsx(hr,{value:t,options:o,onClick:r=>i(r)})})},N4=l.div`
  display: flex;
  align-items: center;
  gap: ${m.md};
...
`,M4=l.ul`
  min-width: 25%;
`,I4="Supported Operators Reference Guide",A4=[{title:"Arithmetic",items:[{name:"Addition",operator:"+"},{name:"Subtraction",operator:"-"},{name:"Multiplication",operator:"*"},{name:"Division",operator:"/"},{name:"Square Root",operator:"sqrt()"}]},{title:"Numeric",items:[{name:"Range",operator:".."}]},{title:"Bitwise",items:[{name:"AND",operator:"&"},{name:"OR",operator:"|"},{name:"XOR",operator:"^"}]},{title:"Ternary",items:[{name:"(a ? b : c)",operator:"?"}]},{title:"String",items:[{name:"Concatenation",operator:"~"}]},{title:"Logical",items:[{name:"Not",operator:"!, not"},{name:"And",operator:"&&, and"},{name:"Or",operator:"||, or"}]},{title:"Array",items:[{name:"Contains",operator:".."},{name:"Does not contain",operator:"not in"}]},{title:"Comparison",items:[{name:"Equal",operator:"=="},{name:"Identical",operator:"==="},{name:"Not equal",operator:"!="},{name:"Not identical",operator:"!=="},{name:"Less than",operator:"<"},{name:"Greater than",operator:">"},{name:"Less than or equal to",operator:"<="},{name:"Greater than or equal to",operator:">="}]}],R4={title:I4,operators:A4},P4=l.div`
  font-style: italic;
  font-weight: 500;
  font-size: 14px;
  color: ${h.gray400};
...
`,_4=()=>{const t=R4;return e.jsxs(e.Fragment,{children:[e.jsx(P4,{children:d(t.title)}),e.jsx(D4,{children:t.operators.map(n=>e.jsxs(B4,{children:[e.jsx("span",{children:d(n.title)}),n.items.map(s=>e.jsxs(O4,{children:[e.jsx("mark",{children:s.operator}),s.name&&e.jsx("span",{children:d(s.name)})]},s.operator))]},n.title))})]})},ru=(t,n)=>t.replace(/field:([a-zA-Z0-9_]+)/g,(s,i)=>n==="<mark>...</mark>"?`<mark>${i}</mark>`:`[[${i}]]`),W4=t=>P(Ae.all).filter(i=>t.availableFieldTypes.includes(i.typeClass)).map(i=>i.properties.handle),U4=({value:t,property:n,updateValue:s})=>{const[i,o]=g.useState(""),r=W4(n),a=g.useRef(null),c=g.useCallback(p=>{s(p.detail.tagify.DOM.input.textContent.replace(/\u200B/g,"").replace(/\s+/g," ").trim())},[s]),u=p=>{if(!p)return;const x=a.current.createTagElem({value:p});a.current.injectAtCaret(x);const f=a.current.insertAfterTag(x,"");a.current.placeCaretAfterNode(f)};return g.useEffect(()=>{o(ru(t))},[t]),e.jsxs(it,{children:[e.jsxs(N4,{children:[e.jsx(M4,{children:e.jsx(de,{emptyOption:d("Insert Field"),options:r.map(p=>({value:p,label:p})),onChange:u,value:""})}),e.jsxs("span",{children:["or type ",e.jsx("mark",{children:"@"})," to search on field handles"]})]}),e.jsx(z4,{children:e.jsx(uc,{autoFocus:!1,tagifyRef:a,settings:{pattern:/@/,enforceWhitelist:!0,editTags:!1,pasteAsTags:!0,duplicates:!0,dropdown:{enabled:0,includeSelectedTags:!0},templates:{tag:function(p){return`
                <tag
                  title="${p.value}"
                  contenteditable="false"
                  spellcheck="false"
                ...
                </tag>`}},whitelist:r},onChange:c,value:i})}),e.jsx(_4,{})]})},H4=l(Zt)`
  padding: ${m.sm};
...
`,q4=({value:t})=>e.jsx(Jt,{"data-edit":d("Click to edit data"),children:e.jsxs(H4,{children:[!t&&e.jsx(kt,{children:d("Not configured yet")}),e.jsx("div",{style:{lineHeight:"2.0"},dangerouslySetInnerHTML:{__html:O.sanitize(ru(t,"<mark>...</mark>"))}})]})}),Q4=({value:t,property:n,errors:s,updateValue:i})=>e.jsx(W,{property:n,errors:s,children:e.jsx(Ve,{preview:e.jsx(q4,{value:t}),children:e.jsx(U4,{value:t,property:n,updateValue:i})})}),Ja="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",au=(t=8)=>{let n="";const s=Ja.length;let i=0;for(;i<t;)n+=Ja.charAt(Math.floor(Math.random()*s)),i+=1;return n},lu=l.div`
  position: relative;
...
`,Za=[100,150,170,130],xr=({value:t,options:n,selectAll:s,loading:i,uniqueId:o,columns:r,emptyMessage:a,onUpdate:c})=>{const u=t.length===n?.length;return o||(o=au(6)),e.jsxs(e.Fragment,{children:[s&&e.jsxs(lu,{children:[e.jsx("input",{id:`${o}-all`,type:"checkbox",className:"checkbox",checked:u,onChange:()=>{c(u?[]:n.filter(p=>!("children"in p)).map(p=>p.value))}}),e.jsx("label",{htmlFor:`${o}-all`,children:d("Select All")})]}),!i&&!n?.length&&a&&e.jsx(cs,{instructions:a}),e.jsxs(K4,{$columns:r,children:[i&&Array.from({length:n?.length||4}).map((p,x)=>e.jsx(k,{width:Za[x%Za.length],height:15},x)),!i&&n?.map(p=>{if("children"in p)return null;const x=`${o}-${p?.label}`;return e.jsxs("div",{title:p.label,children:[e.jsx("input",{id:x,type:"checkbox",className:"checkbox",checked:t.includes(p.value),onChange:()=>{t.includes(p.value)?c(t.filter(f=>f!==p.value)):c([...t,p.value])}}),e.jsx("label",{htmlFor:x,children:p.label})]},p.value)})]})]})},V4=({value:t,property:n,errors:s,updateValue:i})=>{const{handle:o,options:r,selectAll:a,columns:c}=n;return e.jsx(W,{property:n,errors:s,children:e.jsx(xr,{value:t,selectAll:a,options:r,emptyMessage:d("No options available"),uniqueId:o,columns:c,onUpdate:i})})},G4=({value:t,language:n,updateValue:s})=>e.jsx(it,{children:e.jsx(cr,{children:e.jsx(pc,{height:500,value:t,defaultLanguage:n,onChange:s,onMount:()=>{document.body.classList.remove("underline-links")},options:{scrollbar:{verticalScrollbarSize:5,horizontalScrollbarSize:5}}})})}),Y4=l.pre`
  font-size: 10px;
`,J4=l(Zt)`
  padding: ${m.sm};
`,Z4=({value:t})=>e.jsx(Jt,{"data-edit":d("Click to edit data"),children:e.jsxs(J4,{children:[!t&&e.jsx(kt,{children:d("Not configured yet")}),e.jsx(Y4,{children:t})]})}),X4=({value:t,property:n,errors:s,updateValue:i})=>{const{language:o}=n;return e.jsx(W,{property:n,errors:s,children:e.jsx(Ve,{preview:e.jsx(Z4,{value:t}),children:e.jsx(G4,{value:t,language:o,updateValue:i})})})},e5=l.div`
  display: flex;
  align-items: center;
  gap: ${m.sm};
`,t5=l.input`
...
`,l5=l(hu)`
  ...
  width: 40px;
`,c5=({value:t,property:n,errors:s,updateValue:i,context:o})=>{const{formId:r}=V(),{handle:a,source:c,parameterFields:u}=n,p={formId:r};u&&Object.entries(u).forEach(([y,w])=>{p[w]=un(o,y)});const{data:x,isFetching:f,isFetched:b,refetch:j}=B({queryKey:["dynamic-select",c,p],queryFn:()=>T.get(c,{params:p}).then(y=>y.data),staleTime:1/0,gcTime:1/0});return g.useEffect(()=>{f||!b||x!==void 0&&(Array.isArray(t)&&t.length>=0||i([]))},[x,b,f,i,t]),e.jsx(W,{property:n,errors:s,children:e.jsxs(a5,{children:[e.jsx(l5,{className:"btn",disabled:f,onClick:()=>{p.refresh="true",j(),delete p.refresh},children:e.jsx(uu,{})}),e.jsx(xr,{value:t,options:x,loading:f,emptyMessage:d("No options available"),uniqueId:a,onUpdate:i})]})})},d5=({value:t,property:n,errors:s,updateValue:i,context:o})=>{const{formId:r}=V(),{source:a,parameterFields:c,emptyOption:u}=n,p={formId:r};c&&Object.entries(c).forEach(([y,w])=>{p[w]=un(o,y)});const{data:x,isFetching:f,isFetched:b,refetch:j}=B({queryKey:["dynamic-select",a,p],queryFn:()=>T.get(a,{params:p}).then(y=>y.data),staleTime:1/0,gcTime:1/0});return g.useEffect(()=>{if(!(f||!b)&&x!==void 0&&!nd(x,t))if(u){if(t==="")return;i("")}else{const y=sd(x);if(y===t||y===void 0)return;i(y)}},[x,b,f,i,t,u]),e.jsx(W,{property:n,errors:s,context:o,children:e.jsxs(r5,{children:[e.jsx(de,{loading:f,value:t,onChange:i,emptyOption:u,options:x}),e.jsx(hu,{className:"btn",disabled:f,onClick:()=>{p.refresh="true",j(),delete p.refresh},children:e.jsx(uu,{})})]})})},xu={all:["craft-asset-previews"],byIds:t=>[...xu.all,{ids:t}]},u5=t=>B({queryKey:xu.byIds(t),queryFn:()=>T.get(`api/entries?ids=${t.join(",")}`).then(n=>n.data),staleTime:1/0,gcTime:1/0,enabled:t?.length>0}),p5=({actionLabel:t,multiSelect:n,sources:s="*",criteria:i,limit:o,value:r,onUpdate:a})=>{const{data:c,isFetching:u}=u5(r),p=g.useCallback(()=>{Craft.createElementSelectorModal("craft\\elements\\Entry",{multiSelect:o!==1||n,sources:s,criteria:i,storageKey:"freeform-entry-selection",onSelect:j=>{const w=j.map($=>$.id).slice(0,o).filter($=>!r?.includes($)),v=[...r||[],...w];a(v)}})},[a,n,i,o,s,r]),x=g.useCallback(j=>{a(r.filter(y=>y!==j))},[a,r]),f=o===void 0||r?.length===void 0||r?.length<o,b=c===void 0&&u&&r?.length>0;return e.jsxs("div",{className:"elementselect",children:[e.jsxs("ul",{className:"elements chips chips-small",children:[b&&r.map((j,y)=>e.jsx("li",{className:"element small",children:e.jsxs("div",{className:"chip small element",children:[e.jsx("div",{className:"thumb",children:e.jsx(k,{width:30,height:20})}),e.jsx("div",{className:"chip-content",children:e.jsx(k,{width:x5(y)})})]})},`skeleton-${j}`)),c?.map(j=>e.jsx("li",{className:"element small removable",children:e.jsx("div",{className:"chip small element removable",children:e.jsxs("div",{className:"chip-content",children:[e.jsx("span",{className:E("status",j.status==="live"?"open teal":"disabled"),role:"img","aria-label":d("Status: {status}",{status:j.status})}),e.jsx("div",{className:"element-label",children:e.jsx("a",{className:"label-link",href:j.editUrl,target:"_blank",rel:"noreferrer",children:j.title})}),e.jsx("div",{className:"chip-actions",children:e.jsx(m5,{type:"button",title:d("Remove"),onClick:()=>x(j.id)})})]})})},j.id))]}),f&&e.jsx("div",{className:"flex",children:e.jsx("button",{type:"button",className:"btn add icon",onClick:p,children:d(t||"Add an entry")})})]})},h5=[80,100,90,70,120],x5=t=>h5[t]||100,m5=l.button`
  font-family: 'Craft';
  font-size: 14px;
...
`,g5=({value:t,property:n,errors:s,updateValue:i})=>{const{criteria:o,multiSelect:r,actionLabel:a,limit:c}=n;return e.jsx(W,{property:n,errors:s,children:e.jsx(p5,{actionLabel:a,criteria:o,limit:c,multiSelect:r,value:t,onUpdate:i})})},f5=({value:t,property:n,errors:s,updateValue:i})=>{const o=P(Ae.all),r=Yt(),a=o.filter(c=>{if(!n.implements)return!0;const u=r(c.typeClass);return u?n.implements.some(p=>u.implements?.includes(p)):!1}).map(c=>({value:c.uid,label:c.properties.label}));return e.jsx(W,{property:n,errors:s,children:e.jsx(de,{onChange:i,value:t,options:a,emptyOption:n.emptyOption})})},b5=(t,n)=>s=>{const{uid:i}=t,o={};n.properties.forEach(r=>{const a=t.properties[r.handle];a?o[r.handle]=a:o[r.handle]=r.value}),s(be.batchEdit({uid:i,typeClass:n.typeClass,properties:o}))},j5={type:b5};var mr=(t=>(t.Checkboxes="Solspace\\Freeform\\Fields\\Implementations\\CheckboxesField",t.Checkbox="Solspace\\Freeform\\Fields\\Implementations\\CheckboxField",t.Dropdown="Solspace\\Freeform\\Fields\\Implementations\\DropdownField",t.Email="Solspace\\Freeform\\Fields\\Implementations\\EmailField",t.FileUpload="Solspace\\Freeform\\Fields\\Implementations\\FileUploadField",t.Hidden="Solspace\\Freeform\\Fields\\Implementations\\HiddenField",t.Html="Solspace\\Freeform\\Fields\\Implementations\\HtmlField",t.MultipleSelect="Solspace\\Freeform\\Fields\\Implementations\\MultipleSelectField",t.Number="Solspace\\Freeform\\Fields\\Implementations\\NumberField",t.Radios="Solspace\\Freeform\\Fields\\Implementations\\RadiosField",t.Textarea="Solspace\\Freeform\\Fields\\Implementations\\TextareaField",t.Text="Solspace\\Freeform\\Fields\\Implementations\\TextField",t.Calculation="Solspace\\Freeform\\Fields\\Implementations\\Pro\\CalculationField",t.Confirmation="Solspace\\Freeform\\Fields\\Implementations\\Pro\\ConfirmationField",t.Datetime="Solspace\\Freeform\\Fields\\Implementations\\DatetimeField",t.FileDragAndDrop="Solspace\\Freeform\\Fields\\Implementations\\Pro\\FileDragAndDropField",t.Image="Solspace\\Freeform\\Fields\\Implementations\\Pro\\ImageField",t.Cards="Solspace\\Freeform\\Fields\\Implementations\\Pro\\CardsField",t.Group="Solspace\\Freeform\\Fields\\Implementations\\Pro\\GroupField",t.Invisible="Solspace\\Freeform\\Fields\\Implementations\\Pro\\InvisibleField",t.OpinionScale="Solspace\\Freeform\\Fields\\Implementations\\Pro\\OpinionScaleField",t.Password="Solspace\\Freeform\\Fields\\Implementations\\Pro\\PasswordField",t.Phone="Solspace\\Freeform\\Fields\\Implementations\\Pro\\PhoneField",t.Rating="Solspace\\Freeform\\Fields\\Implementations\\Pro\\RatingField",t.Regex="Solspace\\Freeform\\Fields\\Implementations\\Pro\\RegexField",t.RichText="Solspace\\Freeform\\Fields\\Implementations\\Pro\\RichTextField",t.Signature="Solspace\\Freeform\\Fields\\Implementations\\Pro\\SignatureField",t.Table="Solspace\\Freeform\\Fields\\Implementations\\Pro\\TableField",t.Website="Solspace\\Freeform\\Fields\\Implementations\\Pro\\WebsiteField",t))(mr||{});const y5=(t,n)=>(s,i)=>{v5(i(),s,t,n)},v5=(t,n,s,i)=>{const o=i.layoutUid,r=G();if(s.typeClass===mr.Group){const a=s.properties.layout,c=G(),u=t.layout.layouts.find(x=>x.uid===a);u&&n(Cn.add({...u,uid:c}));const p=t.layout.rows.filter(x=>x.layoutUid===a).sort((x,f)=>x.order-f.order);for(const x of p){const f=G();n(Ze.add({layoutUid:c,uid:f})),t.layout.fields.filter(b=>b.rowUid===x.uid).forEach(b=>{n(be.duplicate({uid:G(),rowUid:f,field:b}))})}n(Ze.add({layoutUid:o,uid:r,order:i?.order+1})),n(be.duplicate({uid:G(),rowUid:r,field:{...s,properties:{...s.properties,layout:c}}}));return}n(Ze.add({layoutUid:o,uid:r,order:i?.order+1})),n(be.duplicate({uid:G(),rowUid:r,field:s}))},w5=(t,n)=>t.order-n.order,et={current:t=>t.layout.pages.find(n=>n.uid===t.context.page),count:t=>t.layout.pages.length,all:X(t=>t.layout.pages,t=>[...t].sort(w5)),one:t=>n=>n.layout.pages.find(s=>s.uid===t),pageIndex:t=>n=>n.layout.pages.findIndex(s=>s.uid===t)},ns={inLayout:X(t=>t.layout.rows,(t,n)=>n,(t,n)=>[...t].filter(s=>s.layoutUid===n).sort((s,i)=>s.order-i.order))},bt={one:X(t=>t.layout.layouts,(t,n)=>n,(t,n)=>t.find(s=>s.uid===n)),currentPageLayout:X(t=>et.current(t),t=>t.layout.layouts,(t,n)=>n.find(s=>s.uid===t?.layoutUid)),pageLayout:X(t=>t.layout.layouts,(t,n)=>n,(t,n)=>t.find(s=>s.uid===n)),cartographed:{layoutFieldList:X(t=>t.layout.fields,(t,n)=>t.layout.layouts.find(s=>s.uid===n),t=>t,(t,n,s)=>{const i=ns.inLayout(s,n?.uid),o=[];return i.forEach(r=>{o.push(...t.filter(a=>a.rowUid===r.uid))}),o}),pageFieldList:X(t=>t.layout.pages,t=>t.layout.layouts,t=>t.layout.rows,t=>t.layout.fields,(t,n,s,i)=>{const o=[];return t.forEach(r=>{const a=n.find(p=>p.uid===r.layoutUid),c=s.filter(p=>p.layoutUid===a?.uid).sort((p,x)=>p.order-x.order),u=[];c.forEach(p=>{u.push(...i.filter(x=>x.rowUid===p.uid))}),o.push({page:r.uid,fields:u})}),o}),fullLayoutList:X(t=>t.layout.pages,t=>t.layout.layouts,t=>t.layout.rows,t=>t.layout.fields,(t,n,s,i)=>{const o=[];return t.forEach(r=>{const a=n.find(p=>p.uid===r.layoutUid),c=s.filter(p=>p.layoutUid===a?.uid).sort((p,x)=>p.order-x.order),u=[];c.forEach(p=>{const x=[];x.push(...i.filter(f=>f.rowUid===p.uid)),u.push(x)}),o.push(u)}),o}),fullLayoutList_:t=>{const n=et.all(t),s=[];return n.forEach(i=>{const o=t.layout.layouts.find(c=>c.uid===i.layoutUid),r=ns.inLayout(t,o?.uid),a=[];r.forEach(c=>{const u=[];t.layout.fields.filter(p=>p.rowUid===c.uid).forEach(p=>{u.push(p)}),a.push(u)}),s.push(a)}),s}}},ii=(t,n)=>{const s=[];t.layout.rows.forEach(i=>{t.layout.fields.filter(r=>r.rowUid===i.uid).length===0&&s.push(i.uid)}),s.forEach(i=>{n(Ze.remove(i))})},$5=t=>(n,s)=>{const{field:i,order:o}=t;let{layoutUid:r}=t;const a=G();r||(r=bt.currentPageLayout(s())?.uid),n(Ze.add({layoutUid:r,uid:a,order:o})),n(be.moveTo({uid:i.uid,rowUid:a,position:0})),ii(s(),n)},C5=(t,n,s)=>(i,o)=>{i(be.moveTo({uid:t.uid,rowUid:n.uid,position:s})),ii(o(),i)},k5={newRow:$5,existingRow:C5},S5=t=>(n,s)=>{if(I.editions.is(re.Express)&&s().layout.fields.length>=I.limits.fields)return;const{fieldType:i,row:o}=t;let{layoutUid:r}=t;if(!r){const u=s();o?r=o.layoutUid:r=bt.currentPageLayout(u)?.uid}const a=G(),c=G();n(Ze.add({layoutUid:r,uid:c,order:o?.order})),n(be.add({fieldType:i,uid:a,rowUid:c}))},L5=t=>n=>{const{fieldType:s,row:i,order:o}=t,r=G();n(be.add({fieldType:s,uid:r,rowUid:i.uid,order:o}))},F5={newRow:S5,existingRow:L5},E5=t=>(n,s)=>{mu(s(),n,t),ii(s(),n)},mu=(t,n,s)=>{if(s.typeClass===mr.Group){const i=t.layout.layouts.find(r=>r.uid===s.properties.layout);if(!i)return;t.layout.rows.filter(r=>r.layoutUid===i.uid).forEach(r=>{t.layout.fields.filter(c=>c.rowUid===r.uid).forEach(c=>{mu(t,n,c)}),n(Ze.remove(r.uid))}),n(Cn.remove(i.uid))}n(be.remove(s.uid))},Oe={move:{newField:F5,existingField:k5},remove:E5,duplicate:y5,change:j5},T5=({property:t,context:n})=>{const s=H(),i=Yt(),{data:o}=tr(),r=n;return r?.typeClass?e.jsx(je,{value:r.typeClass,property:{type:K.Select,handle:"typeClass",label:d(t.label),instructions:d(t.instructions),options:o.filter(a=>a.visible!==!1).map(a=>({label:d(a.name),value:a.typeClass}))},updateValue:a=>{confirm(d("Are you sure? You might potentially lose important data."))&&s(Oe.change.type(r,i(a)))}}):null},N5=()=>null,z5=({value:t,property:n,errors:s,updateValue:i,autoFocus:o,context:r})=>{const{handle:a,min:c,max:u,unsigned:p,step:x=1}=n,f=n.flags?.includes("readonly")||n.flags?.includes("as-readonly-in-instance"),b=y=>{i(xa(y.target.value,{min:c,max:u,unsigned:p}))},j=y=>{i(xa(y.target.value))};return e.jsx(W,{property:n,errors:s,context:r,children:e.jsx("input",{id:a,type:"number",className:E("text","fullwidth",f&&["readonly","disabled"]),value:t??"",autoFocus:o,step:x,onChange:j,onBlur:b,readOnly:f})})},M5=t=>e.jsx(R,{fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor",className:"w-6 h-6",...t,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125"})}),I5=t=>Y({opacity:t?1:0,transform:t?"rotate(0deg)":"rotate(-30deg)",config:{tension:500}}),A5=t=>Y({backgroundColor:t?h.gray050:h.white,config:{tension:500}}),R5=l.div`
  margin-top: -9px;
  margin-bottom: -9px;
...
`,B5=({value:t,property:n,errors:s,updateValue:i})=>{const[o,r]=g.useState(!1),[a,c]=g.useState(!1),{handle:u}=n,p=g.useRef(null),x=A5(o),f=I5(o);return e.jsxs(R5,{className:E(s?.length>0&&"errors"),children:[a&&e.jsx("input",{id:u,ref:p,type:"text",className:"text fullwidth",value:t||"",onChange:b=>i(b.target.value),onBlur:()=>c(!1),onKeyDown:b=>{b.key==="Enter"&&c(!1)}}),!a&&e.jsx(D5,{style:x,onClick:()=>{c(!0),r(!1),setTimeout(()=>{p.current?.focus()},3)},onMouseEnter:()=>r(!0),onMouseLeave:()=>r(!1),children:e.jsxs("span",{children:[e.jsx("span",{children:t}),e.jsx(P5,{style:f,children:e.jsx(M5,{})})]})}),e.jsx(ti,{errors:s})]})},O5=l.div`
  display: flex;
`,gu=l.input`
  width: 100%;
  --focus-ring: 0;
...
`,W5=l(gu)`
  ...
  border-top-left-radius: 0;
  border-bottom-left-radius: 0;
`,U5=({value:t,property:n,errors:s,updateValue:i,context:o})=>{const[r,a]=t||[null,null],c=o.properties?.allowNegative?null:0;return e.jsx(W,{property:n,errors:s,children:e.jsxs(O5,{children:[e.jsx("div",{children:e.jsx(_5,{id:"min",value:r===null?"":r,type:"number",min:c,className:"text",placeholder:"Min",onChange:({target:u})=>{const p=u.value!==""?Number(u.value):null;i([p,a])}})}),e.jsx("div",{children:e.jsx(W5,{id:"max",value:a===null?"":a,type:"number",min:c,className:"text",placeholder:"Max",onChange:({target:u})=>{const p=u.value!==""?Number(u.value):null;i([r,p])}})})]})})},H5=(t,n)=>[...t.slice(0,n+1),{id:au(6),label:""},...t.slice(n+1)],q5=l.li`
  position: relative;
...
`,Y5=l.div`
  ...
  border-radius: 3px;
`,J5=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M448 96L416 96C398.3 96 384 110.3 384 128C384 145.7 398.3 160 416 160L448 160C465.7 160 480 174.3 480 192L480 229.5C480 255 490.1 279.4 508.1 297.4L530.7 320L508.1 342.6C490.1 360.6 480 385 480 410.5L480 448C480 465.7 465.7 480 448 480L416 480C398.3 480 384 494.3 384 512C384 529.7 398.3 544 416 544L448 544C501 544 544 501 544 448L544 410.5C544 402 547.4 393.9 553.4 387.9L598.7 342.6C611.2 330.1 611.2 309.8 598.7 297.3L553.4 252C547.4 246 544 237.9 544 229.4L544 191.9C544 138.9 501 95.9 448 95.9zM192 96C139 96 96 139 96 192L96 229.5C96 238 92.6 246.1 86.6 252.1L41.4 297.4C28.9 309.9 28.9 330.2 41.4 342.7L86.7 388C92.7 394 96.1 402.1 96.1 410.6L96 448C96 501 139 544 192 544L224 544C241.7 544 256 529.7 256 512C256 494.3 241.7 480 224 480L192 480C174.3 480 160 465.7 160 448L160 410.5C160 385 149.9 360.6 131.9 342.6L109.3 320L131.9 297.4C149.9 279.4 160 255 160 229.5L160 192C160 174.3 174.3 160 192 160L224 160C241.7 160 256 145.7 256 128C256 110.3 241.7 96 224 96L192 96z"})}),Z5=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M320 576C461.4 576 576 461.4 576 320C576 178.6 461.4 64 320 64C178.6 64 64 178.6 64 320C64 461.4 178.6 576 320 576zM231 231C240.4 221.6 255.6 221.6 264.9 231L319.9 286L374.9 231C384.3 221.6 399.5 221.6 408.8 231C418.1 240.4 418.2 255.6 408.8 264.9L353.8 319.9L408.8 374.9C418.2 384.3 418.2 399.5 408.8 408.8C399.4 418.1 384.2 418.2 374.9 408.8L319.9 353.8L264.9 408.8C255.5 418.2 240.3 418.2 231 408.8C221.7 399.4 221.6 384.2 231 374.9L286 319.9L231 264.9C221.6 255.5 221.6 240.3 231 231z"})}),X5=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M152 160C174.1 160 192 177.9 192 200L192 248C192 270.1 174.1 288 152 288L104 288C81.9 288 64 270.1 64 248L64 200C64 177.9 81.9 160 104 160L152 160zM344 288L296 288C273.9 288 256 270.1 256 248L256 200C256 177.9 273.9 160 296 160L344 160C366.1 160 384 177.9 384 200L384 248C384 270.1 366.1 288 344 288zM536 288L488 288C465.9 288 448 270.1 448 248L448 200C448 177.9 465.9 160 488 160L536 160C558.1 160 576 177.9 576 200L576 248C576 270.1 558.1 288 536 288zM536 480L488 480C465.9 480 448 462.1 448 440L448 392C448 369.9 465.9 352 488 352L536 352C558.1 352 576 369.9 576 392L576 440C576 462.1 558.1 480 536 480zM344 352C366.1 352 384 369.9 384 392L384 440C384 462.1 366.1 480 344 480L296 480C273.9 480 256 462.1 256 440L256 392C256 369.9 273.9 352 296 352L344 352zM152 480L104 480C81.9 480 64 462.1 64 440L64 392C64 369.9 81.9 352 104 352L152 352C174.1 352 192 369.9 192 392L192 440C192 462.1 174.1 480 152 480z"})}),e3=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M320 576C461.4 576 576 461.4 576 320C576 178.6 461.4 64 320 64C178.6 64 64 178.6 64 320C64 461.4 178.6 576 320 576zM404.4 276.7L324.4 404.7C320.2 411.4 313 415.6 305.1 416C297.2 416.4 289.6 412.8 284.9 406.4L236.9 342.4C228.9 331.8 231.1 316.8 241.7 308.8C252.3 300.8 267.3 303 275.3 313.6L302.3 349.6L363.7 251.3C370.7 240.1 385.5 236.6 396.8 243.7C408.1 250.8 411.5 265.5 404.4 276.8z"})}),t3=t=>{const[n,s]=g.useState(!1),{removeCard:i}=t,o=i3(t.card.metadata);return e.jsxs(q5,{children:[e.jsxs(V5,{children:[e.jsx(Xa,{onClick:()=>s(!n),className:E(n&&"active"),children:e.jsx(xe,{title:d("Custom Metadata"),delay:[500,0],children:e.jsxs(K5,{children:[e.jsx("span",{className:E(o>0&&"filled"),children:o}),e.jsx(J5,{})]})})}),e.jsx(Xa,{className:"drag-handle",title:d("Reorder Card"),children:e.jsx(X5,{})}),e.jsx(Nn,{active:!0,onClick:i,title:d("Remove Card")})]}),n&&e.jsx(s3,{...t}),!n&&e.jsx(n3,{...t})]})},n3=({card:t,updateCard:n})=>{const{label:s,value:i,assetId:o,description:r}=t;return e.jsxs(e.Fragment,{children:[e.jsx(Te,{label:"Image",children:e.jsx(pr,{criteria:{kind:["image"]},value:o?[o]:[],limit:1,onUpdate:a=>n({...t,assetId:a[0]??void 0})})}),e.jsx(Te,{label:"Title",children:e.jsx("input",{type:"text",className:"text fullwidth",value:s,onChange:a=>n({...t,label:a.target.value})})}),e.jsx(Te,{label:"Value",instructions:"Enter a value to use when this card is selected.",children:e.jsx("input",{type:"text",className:"text fullwidth",value:i,onChange:a=>n({...t,value:a.target.value})})}),e.jsx(Te,{label:"Description",children:e.jsx(Q5,{rows:4,className:"text fullwidth",value:r,onChange:a=>n({...t,description:a.target.value})})})]})},s3=({card:t,updateCard:n})=>{const s=JSON.stringify(t.metadata,null,2),[i,o]=g.useState("pending"),[r,a]=g.useState(),[c,u]=g.useState(s),p=xs(c,1e3);return g.useEffect(()=>{u(x=>x===s?x:s)},[s]),g.useEffect(()=>{if(p){a(void 0),o("pending");try{const x=JSON.parse(p),f=JSON.stringify(x,null,2);if(o("success"),f===s)return;n({...t,metadata:x})}catch(x){o("error"),a(x instanceof Error?x.message:"Invalid JSON")}}},[p,s,n,t]),e.jsxs(e.Fragment,{children:[e.jsx(Te,{label:"Metadata",instructions:"Enter metadata in JSON format. Access it in your template with `card.metadata.yourProperty`",children:e.jsx(Y5,{children:e.jsx(pc,{height:200,value:c,defaultLanguage:"json",onChange:x=>u(x),onMount:()=>{document.body.classList.remove("underline-links")},options:{folding:!1,glyphMargin:!1,renderLineHighlight:"none",minimap:{enabled:!1},lineNumbers:"on",lineNumbersMinChars:1,scrollbar:{verticalScrollbarSize:5,horizontalScrollbarSize:5}}})})}),i!=="pending"&&e.jsxs(G5,{className:i,children:[e.jsxs("span",{children:[i==="error"&&e.jsx(Z5,{}),i==="error"&&"Invalid JSON",i==="success"&&e.jsx(e3,{}),i==="success"&&"JSON Valid"]}),!!r&&e.jsx("div",{className:"code",children:r})]})]})},i3=t=>Array.isArray(t)?t.length:t&&typeof t=="object"?Object.keys(t).length:typeof t=="boolean"||typeof t=="string"?1:0,o3=({onClick:t})=>e.jsx(r3,{onClick:t,children:d("Add Card")}),r3=l.div`
  cursor: pointer;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,l3=l(dr)``,c3=l.ul`
  ...
  gap: 5px;
`,d3=({value:t,property:n,updateValue:s,context:i})=>{const o=g.useRef(null),{updateTranslation:r,getTranslation:a,willTranslate:c}=Ce(i),u=c(n.handle),p=a(n.handle,t);return g.useEffect(()=>{if(!o.current)return;const x=Ne.create(o.current,{animation:150,ghostClass:"sortable-ghost",handle:".drag-handle",onEnd:f=>{const b=[...t],[j]=b.splice(f.oldIndex,1);b.splice(f.newIndex,0,j),s(b)}});return()=>{x.destroy()}},[t,s]),e.jsxs(a3,{children:[e.jsx(l3,{children:e.jsxs(c3,{ref:o,children:[t.map((x,f)=>e.jsx(t3,{card:x,removeCard:()=>{const b=[...t];b.splice(f,1),s(b)},updateCard:b=>{if(u){const j=[...p];j[f]=b,r(n.handle,j)}else{const j=[...t];j[f]=b,s(j)}}},x.id)),e.jsx(o3,{onClick:()=>s(H5(t,t.length))})]})}),e.jsx(Xt,{children:e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(d("Press <b>enter</b> while editing a cell to add a new row."))}})})]})},gr=l.div`
  position: absolute;
  top: calc(50% - 15px);
  left: 0;
  right: 0;
...
`,fr=(t=[],n)=>B({queryKey:["assets","urls",t?.sort(),n],queryFn:()=>T.get(`/api/assets/urls?ids=${t.join(",")}&transform=${n||""}`).then(s=>s.data),staleTime:1/0,gcTime:1/0,enabled:t.length>0}),m3=l.ul`
  display: flex;
  flex-direction: column;
  gap: 5px;
...
`,v3=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M160 144C151.2 144 144 151.2 144 160L144 480C144 488.8 151.2 496 160 496L480 496C488.8 496 496 488.8 496 480L496 160C496 151.2 488.8 144 480 144L160 144zM96 160C96 124.7 124.7 96 160 96L480 96C515.3 96 544 124.7 544 160L544 480C544 515.3 515.3 544 480 544L160 544C124.7 544 96 515.3 96 480L96 160zM224 192C241.7 192 256 206.3 256 224C256 241.7 241.7 256 224 256C206.3 256 192 241.7 192 224C192 206.3 206.3 192 224 192zM360 264C368.5 264 376.4 268.5 380.7 275.8L460.7 411.8C465.1 419.2 465.1 428.4 460.8 435.9C456.5 443.4 448.6 448 440 448L200 448C191.1 448 182.8 443 178.7 435.1C174.6 427.2 175.2 417.6 180.3 410.3L236.3 330.3C240.8 323.9 248.1 320.1 256 320.1C263.9 320.1 271.2 323.9 275.7 330.3L292.9 354.9L339.4 275.9C343.7 268.6 351.6 264.1 360.1 264.1z"})}),w3=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M320 180C291.3 180 268 156.7 268 128C268 99.3 291.3 76 320 76C348.7 76 372 99.3 372 128C372 156.7 348.7 180 320 180zM320 480C337.7 480 352 494.3 352 512C352 529.7 337.7 544 320 544C302.3 544 288 529.7 288 512C288 494.3 302.3 480 320 480zM512 352C494.3 352 480 337.7 480 320C480 302.3 494.3 288 512 288C529.7 288 544 302.3 544 320C544 337.7 529.7 352 512 352zM96 320C96 302.3 110.3 288 128 288C145.7 288 160 302.3 160 320C160 337.7 145.7 352 128 352C110.3 352 96 337.7 96 320zM495.4 223.8C473.5 245.7 438.1 245.7 416.2 223.8C394.3 201.9 394.3 166.5 416.2 144.6C438.1 122.7 473.5 122.7 495.4 144.6C517.3 166.5 517.3 201.9 495.4 223.8zM161.6 478.4C149.1 465.9 149.1 445.6 161.6 433.1C174.1 420.6 194.4 420.6 206.9 433.1C219.4 445.6 219.4 465.9 206.9 478.4C194.4 490.9 174.1 490.9 161.6 478.4zM433.1 478.4C420.6 465.9 420.6 445.6 433.1 433.1C445.6 420.6 465.9 420.6 478.4 433.1C490.9 445.6 490.9 465.9 478.4 478.4C465.9 490.9 445.6 490.9 433.1 478.4zM150.3 150.3C169.1 131.5 199.4 131.5 218.2 150.3C237 169.1 237 199.4 218.2 218.2C199.4 237 169.1 237 150.3 218.2C131.5 199.4 131.5 169.1 150.3 150.3z"})}),$3=({cards:t,transform:n})=>{const s=t.map(r=>r.assetId).filter(Boolean),{data:i,isFetching:o}=fr(s,n);return e.jsxs(Ud,{"data-edit":d("Click to edit data"),children:[!t.length&&e.jsx(gr,{children:d("No cards yet. Click Add Card to create one.")}),e.jsx(m3,{children:t.map((r,a)=>e.jsxs(g3,{"data-title":"card",children:[e.jsx(f3,{children:e.jsx(C3,{assetUrl:i?.[r.assetId],loading:o})}),e.jsx(b3,{children:r.label||d("No title")}),e.jsx(j3,{children:r.description||d("No description")})]},a))})]})},C3=({assetUrl:t,loading:n})=>n?e.jsx(y3,{children:e.jsx(w3,{})}):t===void 0?e.jsx(v3,{}):e.jsx("img",{src:t.src,alt:t.title||d("No title")}),k3=({value:t,property:n,errors:s,updateValue:i,context:o})=>e.jsx(W,{property:n,errors:s,context:o,children:e.jsx(Ve,{preview:e.jsx($3,{cards:t,transform:o?.properties?.transform}),children:e.jsx(d3,{value:t,updateValue:i,property:n,context:o})})}),S3=t=>e.jsx(R,{height:"1em",viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M105.1 202.6c7.7-21.8 20.2-42.3 37.8-59.8c62.5-62.5 163.8-62.5 226.3 0L386.3 160H336c-17.7 0-32 14.3-32 32s14.3 32 32 32H463.5c0 0 0 0 0 0h.4c17.7 0 32-14.3 32-32V64c0-17.7-14.3-32-32-32s-32 14.3-32 32v51.2L414.4 97.6c-87.5-87.5-229.3-87.5-316.8 0C73.2 122 55.6 150.7 44.8 181.4c-5.9 16.7 2.9 34.9 19.5 40.8s34.9-2.9 40.8-19.5zM39 289.3c-5 1.5-9.8 4.2-13.7 8.2c-4 4-6.7 8.8-8.1 14c-.3 1.2-.6 2.5-.8 3.8c-.3 1.7-.4 3.4-.4 5.1V448c0 17.7 14.3 32 32 32s32-14.3 32-32V396.9l17.6 17.5 0 0c87.5 87.4 229.3 87.4 316.7 0c24.4-24.4 42.1-53.1 52.9-83.7c5.9-16.7-2.9-34.9-19.5-40.8s-34.9 2.9-40.8 19.5c-7.7 21.8-20.2 42.3-37.8 59.8c-62.5 62.5-163.8 62.5-226.3 0l-.1-.1L125.6 352H176c17.7 0 32-14.3 32-32s-14.3-32-32-32H48.4c-1.6 0-3.2 .1-4.8 .3s-3.1 .5-4.6 1z"})});var fu=(t=>(t.EmailMarketing="email-marketing",t.Crm="crm",t.Elements="elements",t.Captchas="captchas",t.PaymentGateways="payment-gateways",t.Webhooks="webhooks",t.Singles="single",t.Other="other",t.Ai="ai",t))(fu||{}),Ee=(t=>(t.Relation="relation",t.Custom="custom",t.Preset="preset",t))(Ee||{});const L3=t=>e.jsx(R,{viewBox:"0 0 576 512",...t,children:e.jsx("path",{d:"M266.2 4.7C273 1.6 280.5 0 288 0s15 1.6 21.8 4.7l217.4 97.5c10.2 4.6 16.8 14.7 16.8 25.9s-6.6 21.3-16.8 25.9L309.8 251.3c-6.9 3.1-14.3 4.7-21.8 4.7s-15-1.6-21.8-4.7L48.8 153.9C38.6 149.3 32 139.2 32 128s6.6-21.3 16.8-25.9L266.2 4.7zM288 32c-3 0-6 .6-8.8 1.9L69.3 128l210 94.1c2.8 1.2 5.7 1.9 8.8 1.9s6-.6 8.8-1.9l210-94.1-210-94.1C294 32.6 291 32 288 32zM48.8 358.1l45.9-20.6 39.1 17.5L69.3 384l210 94.1c2.8 1.2 5.7 1.9 8.8 1.9s6-.6 8.8-1.9l210-94.1-64.5-28.9 39.1-17.5 45.9 20.6c10.2 4.6 16.8 14.7 16.8 25.9s-6.6 21.3-16.8 25.9L309.8 507.3c-6.9 3.1-14.3 4.7-21.8 4.7s-15-1.6-21.8-4.7L48.8 409.9C38.6 405.3 32 395.2 32 384s6.6-21.3 16.8-25.9zM94.7 209.5l39.1 17.5L69.3 256l210 94.1c2.8 1.2 5.7 1.9 8.8 1.9s6-.6 8.8-1.9l210-94.1-64.5-28.9 39.1-17.5 45.9 20.6c10.2 4.6 16.8 14.7 16.8 25.9s-6.6 21.3-16.8 25.9L309.8 379.3c-6.9 3.1-14.3 4.7-21.8 4.7s-15-1.6-21.8-4.7L48.8 281.9C38.6 277.3 32 267.2 32 256s6.6-21.3 16.8-25.9l45.9-20.6z"})}),F3=t=>e.jsx(R,{height:"1em",viewBox:"0 0 384 512",...t,children:e.jsx("path",{d:"M64 496c-26.5 0-48-21.5-48-48V64c0-26.5 21.5-48 48-48H204.1c1.3 0 2.6 .1 3.9 .2V136c0 22.1 17.9 40 40 40H367.8c.2 1.3 .2 2.6 .2 3.9V448c0 26.5-21.5 48-48 48H64zM358.6 157.3c.9 .9 1.7 1.8 2.4 2.7H248c-13.3 0-24-10.7-24-24V22.9c1 .8 1.9 1.6 2.7 2.4L358.6 157.3zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V179.9c0-12.7-5.1-24.9-14.1-33.9L238.1 14.1c-9-9-21.2-14.1-33.9-14.1H64zm40 256c-4.4 0-8 3.6-8 8s3.6 8 8 8H280c4.4 0 8-3.6 8-8s-3.6-8-8-8H104zm0 64c-4.4 0-8 3.6-8 8s3.6 8 8 8H280c4.4 0 8-3.6 8-8s-3.6-8-8-8H104zm0 64c-4.4 0-8 3.6-8 8s3.6 8 8 8H280c4.4 0 8-3.6 8-8s-3.6-8-8-8H104z"})}),bu=(t,n)=>{const{getState:s}=Vo(),i=Yt(),o=P(bt.cartographed.pageFieldList),r=P(et.all);return g.useMemo(()=>o.map(a=>({label:r.find(c=>c.uid===a.page)?.label,icon:e.jsx(F3,{}),children:a.fields.map(c=>{if(t?.includes(c.uid))return null;const u=i(c.typeClass);if(n?.includes(u?.type))return null;if(u?.type==="group"){const p=bt.cartographed.layoutFieldList(s(),c.properties.layout);return{label:c.properties.label,icon:e.jsx(L3,{}),children:p.map(x=>({label:x.properties.label,value:x.uid}))}}return{value:c.uid,label:c.properties.label}}).filter(Boolean)})),[o,r,t,n,i,s])},E3=({value:t,onChange:n})=>{const s=bu();return e.jsx(de,{options:s,emptyOption:d("Do not map this field"),value:t,onChange:n})},T3=t=>e.jsx(R,{viewBox:"0 0 640 512",...t,children:e.jsx("path",{d:"M392.8 1.2c-17-4.9-34.7 5-39.6 22l-128 448c-4.9 17 5 34.7 22 39.6s34.7-5 39.6-22l128-448c4.9-17-5-34.7-22-39.6zm80.6 120.1c-12.5 12.5-12.5 32.8 0 45.3L562.7 256l-89.4 89.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l112-112c12.5-12.5 12.5-32.8 0-45.3l-112-112c-12.5-12.5-32.8-12.5-45.3 0zm-306.7 0c-12.5-12.5-32.8-12.5-45.3 0l-112 112c-12.5 12.5-12.5 32.8 0 45.3l112 112c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256l89.4-89.4c12.5-12.5 12.5-32.8 0-45.3z"})}),N3=t=>e.jsx(R,{viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M40 48C26.7 48 16 58.7 16 72l0 48c0 13.3 10.7 24 24 24l48 0c13.3 0 24-10.7 24-24l0-48c0-13.3-10.7-24-24-24L40 48zM184 72c-13.3 0-24 10.7-24 24s10.7 24 24 24l304 0c13.3 0 24-10.7 24-24s-10.7-24-24-24L184 72zm0 160c-13.3 0-24 10.7-24 24s10.7 24 24 24l304 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-304 0zm0 160c-13.3 0-24 10.7-24 24s10.7 24 24 24l304 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-304 0zM16 232l0 48c0 13.3 10.7 24 24 24l48 0c13.3 0 24-10.7 24-24l0-48c0-13.3-10.7-24-24-24l-48 0c-13.3 0-24 10.7-24 24zM40 368c-13.3 0-24 10.7-24 24l0 48c0 13.3 10.7 24 24 24l48 0c13.3 0 24-10.7 24-24l0-48c0-13.3-10.7-24-24-24l-48 0z"})}),z3=t=>e.jsx(R,{viewBox:"0 0 448 512",...t,children:e.jsx("path",{d:"M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"})}),M3=l.button`
  position: absolute;
  top: 0;
  right: 0;
...
`,B3=({sources:t,mapping:n,updateValue:s})=>{if(!n)return null;const i=(o,r,a)=>{s({...n,[o]:{type:r,value:a}})};return e.jsxs(A3,{children:[t.length===0&&e.jsx(Xt,{children:d("No data present")}),t.map(o=>{const r=n[o.id]??{type:Ee.Relation,value:""};return e.jsxs(I3,{children:[e.jsx(R3,{className:E(o.required&&"required"),children:e.jsx("span",{children:o.label})}),e.jsxs(P3,{children:[o.options?.length>0&&e.jsx(Ri,{title:d("Pre-defined options"),className:E(r.type===Ee.Preset&&"active"),onClick:()=>i(o.id,Ee.Preset),children:e.jsx(N3,{})}),e.jsx(Ri,{title:d("Twig code"),className:E(r.type===Ee.Custom&&"active"),onClick:()=>i(o.id,Ee.Custom),children:e.jsx(T3,{})}),e.jsx(Ri,{title:d("Freeform field"),className:E(r.type===Ee.Relation&&"active"),onClick:()=>i(o.id,Ee.Relation),children:e.jsx(z3,{})})]}),e.jsxs("div",{children:[r.type===Ee.Preset&&e.jsx(de,{value:r?.value,showValues:!0,emptyOption:d("Select an option"),onChange:a=>{i(o.id,Ee.Preset,a)},options:o.options.map(a=>({value:a.key,label:a.label}))}),r.type===Ee.Relation&&e.jsx(E3,{value:r?.value,onChange:a=>{i(o.id,Ee.Relation,a)}}),r.type===Ee.Custom&&e.jsx(D3,{type:"text",className:"text fullwidth code",placeholder:"e.g. {{ yourField }} {{ otherField }}",value:r?.value||"",onChange:a=>{i(o.id,Ee.Custom,a.target.value)}})]})]},o.id)})]})},O3=({value:t={},property:n,errors:s,updateValue:i,context:o})=>{const{formId:r}=V(),a={formId:r};n.parameterFields&&Object.entries(n.parameterFields).forEach(([x,f])=>{a[f]=un(o,x)});const{data:c,isFetching:u,refetch:p}=B({queryKey:["field-mapping",n.source,a],queryFn:async()=>await T.get(n.source,{params:a}).then(f=>f.data),staleTime:1/0,gcTime:1/0});return g.useEffect(()=>{if(u||c===void 0)return;const x=c.map(j=>String(j.id)),f=Mt(t);let b=!1;Object.keys(t).forEach(j=>{x.includes(j)||(delete f[j],b=!0)}),b&&i(f)},[u,c,t,i]),e.jsxs(W,{property:n,errors:s,children:[e.jsx(M3,{className:"btn",disabled:u,onClick:()=>{a.refresh="true",p(),delete a.refresh},children:e.jsx(S3,{})}),c&&e.jsx(B3,{sources:c,mapping:t,updateValue:i}),!c&&u&&e.jsxs("div",{children:[e.jsx(k,{width:"40%"}),e.jsx(k,{width:"35%"}),e.jsx(k,{width:"42%"})]})]})},tn=({value:t,onChange:n})=>e.jsx("div",{className:"select",children:e.jsxs("select",{value:t,onChange:s=>n?.(s.target.value),children:[e.jsx("option",{value:Be.Or,children:d("any")}),e.jsx("option",{value:Be.And,children:d("all")})]})}),_3=l.table`
  width: 100%;
...
`,pn={one:t=>X(n=>n.rules.fields.items,n=>n.find(s=>s.field===t)),isInCondition:t=>X(n=>n.rules.fields.items,n=>n.rules.pages.items,n=>n.rules.submitForm.item,n=>n.rules.buttons.items,(n,s,i,o)=>n.some(r=>r.conditions.some(a=>a.field===t))||s.some(r=>r.conditions.some(a=>a.field===t))||i?.conditions.some(r=>r.field===t)||o.some(r=>r.conditions.some(a=>a.field===t))),usedByFields:t=>X(n=>n.rules.fields.items,n=>n.filter(i=>i.conditions.some(o=>o.field===t)).map(i=>i.field)),hasRule:t=>X(n=>n.rules.fields.items,n=>!!n.find(s=>s.field===t))},W3=({condition:t,onChange:n})=>{const{uid:s}=V(),i=P(pn.usedByFields(s)),o=bu([...i,s],["html","rich-text","file","file-dnd","signature"]);return e.jsx(de,{options:o,emptyOption:"Choose field",value:t.field,onChange:n})},U3={[ie.Equals]:d("is equal to"),[ie.NotEquals]:d("does not equal"),[ie.GreaterThan]:d("greater than"),[ie.GreaterThanOrEquals]:d("greater than or equal to"),[ie.LessThan]:d("less than"),[ie.LessThanOrEquals]:d("less than or equal to"),[ie.Contains]:d("contains"),[ie.NotContains]:d("does not contain"),[ie.StartsWith]:d("starts with"),[ie.EndsWith]:d("ends with"),[ie.IsEmpty]:d("is empty"),[ie.IsNotEmpty]:d("is not empty"),[ie.IsOneOf]:d("is one of"),[ie.IsNotOneOf]:d("is not one of")},H3=({condition:t,onChange:n})=>{const{operator:s}=t;return e.jsx("div",{className:"select fullwidth",children:e.jsx(de,{value:s,onChange:i=>n?.(i),options:Object.entries(U3).map(([i,o])=>({value:i,label:o}))})})},q3=l.div`
  .tagify {
    --tag-bg: ${h.gray100};
    --tag-pad: 4px 7px;
...
`,yu=({value:t,options:n=[],onChange:s,allowCustom:i,placeholder:o})=>{const r=g.useRef(null);return e.jsx(q3,{children:e.jsx(U1,{tagifyRef:r,placeholder:o,settings:{tagTextProp:"name",enforceWhitelist:!i,whitelist:n,dropdown:{mapValueTo:"name",enabled:0}},value:t,onChange:a=>s(a.detail.tagify.getCleanValue().map(c=>c.value))})})};var vu=(t=>(t.Options="options",t.GeneratedOptions="generatedOptions",t))(vu||{}),mt=(t=>(t.Group="group",t.Rating="rating",t.OpinionScale="opinion-scale",t))(mt||{});const Q3=({fieldUid:t,onChange:n,value:s})=>e.jsxs("div",{className:"checkbox-wrapper",children:[e.jsx("input",{id:`${t}-rule-checkbox`,type:"checkbox",className:"checkbox",onChange:i=>n?.(i.target.checked?"1":""),checked:!!s}),e.jsx("label",{htmlFor:`${t}-rule-checkbox`,children:d(s?"Checked":"Unchecked")})]});var Re=(t=>(t.Custom="custom",t.Elements="elements",t.Predefined="predefined",t))(Re||{});const K3=[I.limitations.can("layout.options.custom")&&{value:"custom",label:d("Custom")},I.limitations.can("layout.options.elements")&&{value:"elements",label:d("Elements")},I.limitations.can("layout.options.predefined")&&{value:"predefined",label:d("Predefined")}].filter(Boolean),oi=(t,n)=>{const{getOptionTranslations:s}=Ce(t);let i,o;if(n?.type===mt.OpinionScale)i={source:Re.Custom,options:t.properties.scales.map(x=>({label:x[1]||x[0],value:x[0]})),useCustomValues:!0};else if(n?.type===mt.Rating)i={source:Re.Custom,options:Array.from({length:t.properties.maxValue},(x,f)=>({label:String(f+1),value:String(f+1)})),useCustomValues:!0};else if(n?.implements.includes(vu.GeneratedOptions)){const x=n?.properties.find(f=>f.type===K.Options);if(x){const f=t?.properties[x.handle];i=s(x.handle,f),o=f?.emptyOption}}const r=i?.source===Re.Custom,{data:a,isFetching:c}=B({queryKey:["field-options",i],queryFn:async()=>{if(!i||r)return[];if(i?.source!==Re.Custom&&!i.typeClass)return[];try{const x=await T.post("api/options",i),{data:f}=x;return f}catch(x){return console.error(x),[]}},staleTime:1/0,gcTime:1/0,enabled:!r}),u=!!i&&!r&&c;let p=r?i.options:a||[];return o&&(p=[{label:d(o),value:""},...p]),[p,u]},V3=({field:t,fieldType:n,value:s,multiple:i,onChange:o})=>{const[r,a]=oi(t,n);if(i){let c;if(s)try{c=JSON.parse(s)}catch{c=s}else c="";return e.jsx(e.Fragment,{children:!a&&e.jsx(yu,{value:c,options:r.map(u=>"value"in u?{value:u.value,name:u.label,editable:!1}:null).filter(Boolean),allowCustom:!1,onChange:u=>o(JSON.stringify(u))})})}return e.jsx(de,{emptyOption:"Select an option",value:s,options:r,loading:a,onChange:c=>o?.(c)})},G3=({field:t,value:n,onChange:s})=>{const o=(t.properties?.scales||[]).map(([r,a])=>({label:`${a||r}`,value:r}));return e.jsx(de,{emptyOption:"Select a scale value",value:n,options:o,onChange:r=>s?.(r)})},Y3=({field:t,value:n,onChange:s})=>{const i=t.properties?.maxValue||1,o=ts(1,i).map(r=>({label:`${r}`,value:`${r}`}));return e.jsx(de,{emptyOption:"Select a rating",value:n,options:o,onChange:r=>s?.(r)})},J3=({condition:t,onChange:n})=>{const{field:s,value:i,operator:o}=t,r=P(Ae.one(s)),a=Me(r?.typeClass);if(!a||Dn.noValue.includes(o))return null;if(a.implements.includes("boolean")&&Dn.boolean.includes(o))return e.jsx(Q3,{fieldUid:s,onChange:n,value:i});if(a.implements.includes("generatedOptions"))return e.jsx(V3,{field:r,fieldType:a,value:i,multiple:Dn.multiple.includes(o),onChange:x=>n?.(x)});if(Dn.multiple.includes(o))return e.jsx(yu,{value:i,allowCustom:!0,onChange:x=>n(JSON.stringify(x)),placeholder:d("Add values")});const p=a.type;return p===mt.Rating?e.jsx(Y3,{field:r,value:i,onChange:n}):p===mt.OpinionScale?e.jsx(G3,{field:r,value:i,onChange:n}):e.jsx("input",{className:"text fullwidth",type:"text",value:i,onChange:x=>n?.(x.target.value)})},nn=({conditions:t,buttonLabel:n,loading:s,onChange:i})=>e.jsx(_3,{children:e.jsxs("tbody",{children:[s&&e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(k,{height:34})}),e.jsx("td",{children:e.jsx(k,{height:34})}),e.jsx("td",{children:e.jsx(k,{height:34})}),e.jsx("td",{})]}),t.map((o,r)=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(W3,{condition:o,onChange:a=>i?.([...t.slice(0,r),{...o,field:a},...t.slice(r+1)])})}),e.jsx("td",{children:e.jsx(H3,{condition:o,onChange:a=>i?.([...t.slice(0,r),{...o,operator:a},...t.slice(r+1)])})}),e.jsx("td",{children:e.jsx(J3,{condition:o,onChange:a=>{i?.([...t.slice(0,r),{...o,value:a},...t.slice(r+1)])}})}),e.jsx("td",{children:e.jsx(ju,{children:e.jsx(dt,{onClick:()=>{i?.([...t.slice(0,r),...t.slice(r+1)])}})})})]},r)),!s&&e.jsx("tr",{children:e.jsx("td",{colSpan:4,children:e.jsx("button",{type:"button",className:"btn add icon fullwidth",onClick:()=>{i?.([...t,{uid:G(),field:"",operator:ie.Equals,value:""}])},children:d(n||"Add a condition")})})})]})}),wu=({value:t,onChange:n,options:s})=>{const{on:i,off:o}=s;return e.jsx("div",{className:"select",children:e.jsxs("select",{value:t?i:o,onChange:r=>n?.(r.target.value===i),children:[e.jsx("option",{value:i,children:d(i)}),e.jsx("option",{value:o,children:d(o)})]})})},lt=l.h1`
  padding: 0;
`,sn=l.div`
  margin-bottom: ${m.xl};
...
`,hb=({onCreate:t})=>e.jsx(ku,{className:"dashed",onClick:t,children:e.jsx($u,{children:e.jsxs(xb,{children:[e.jsx("i",{className:"fa-solid fa-plus"}),d("Create New Template")]})})}),xb=l.div`
  display: flex;
  align-items: center;
  gap: 8px;
`,Pi=({address:t})=>(Array.isArray(t)||(t=[t]),e.jsx("div",{children:t.map((n,s)=>e.jsxs("span",{children:[e.jsx(mb,{...n}),s<t.length-1&&e.jsx("span",{children:", "})]},s))})),mb=({address:t,name:n})=>n?e.jsxs("span",{children:[n," <",t,">"]}):e.jsx("span",{children:t}),gb=({attachments:t})=>e.jsx("div",{children:t.map((n,s)=>e.jsxs(fb,{children:[e.jsx("i",{className:`fa-regular fa-file-${jb(n.filename)}`}),e.jsx("span",{children:n.filename}),e.jsx(bb,{children:n.size})]},s))}),fb=l.div`
  display: flex;
  align-items: center;
  gap: 4px;
`,bb=l.span`
  ...
  font-size: 0.8em;
  color: ${h.gray250};
`,jb=t=>{const n=t.split(".").pop()?.toLowerCase();let s;switch(n){case"pdf":s="pdf";break;case"jpg":case"jpeg":case"png":case"gif":case"webp":s="image";break;case"xlsx":s="spreadsheet";break;case"doc":s="doc";break;case"ppt":s="ppt";break;default:s="file";break}return s},yb=({body:t})=>{const n=g.useRef(null);return g.useEffect(()=>{const s=n.current;if(s){const i=s.contentDocument||s.contentWindow?.document;if(i){i.open(),i.write(t),i.close();const o=()=>{if(s?.contentWindow?.document){const r=s.contentWindow.document.body.scrollHeight;s.style.height=`${r}px`,s.contentWindow.document.body.style.overflow="hidden"}};s.onload=o,setTimeout(o,50)}}},[t]),e.jsx(vb,{ref:n,width:"100%",sandbox:"allow-same-origin allow-scripts",title:"Email Preview"})},vb=l.iframe`
  display: block;
  width: 100%;
...
`,wb=l.input`
  ...
  font-size: 12px;
`,$b=()=>e.jsxs(jo,{children:[e.jsx(yo,{}),e.jsxs(Ie,{children:[e.jsxs(Ge,{children:[d("To"),":"]}),e.jsx(Ye,{children:e.jsx(k,{width:200})})]}),e.jsxs(Ie,{children:[e.jsxs(Ge,{children:[d("Subject"),":"]}),e.jsx(Ye,{children:e.jsx(k,{width:200})})]}),e.jsxs(Ie,{children:[e.jsxs(Ge,{children:[d("From"),":"]}),e.jsx(Ye,{children:e.jsx(k,{width:200})})]}),e.jsx(Ie,{children:e.jsxs(vo,{children:[e.jsx(k,{width:200}),e.jsx(k,{width:300}),e.jsx(k,{width:550}),e.jsx("br",{}),e.jsx(k,{width:500}),e.jsx(k,{width:430}),e.jsx(k,{width:520}),e.jsx("br",{}),e.jsx(k,{width:200}),e.jsx(k,{width:230}),e.jsx(k,{width:220})]})})]}),Su={preview:["notifications","templates","preview"]},Cb=t=>B({enabled:!1,queryKey:Su.preview,queryFn:async()=>(await T.post("/api/templates/preview",t)).data}),kb=()=>ce({mutationFn:async t=>await T.post("/api/templates/send-test",t)}),Lu=t=>{const{inView:n}=t,{data:s,isFetching:i,refetch:o,error:r}=Cb(t.context),a=kb(),[c,u]=g.useState();return g.useEffect(()=>{n&&o()},[n,o]),g.useEffect(()=>{if(c===void 0&&s?.from){const p=Array.isArray(s.from)?s.from[0]:s.from;u(p.address)}},[s,c]),e.jsxs(Te,{...t,extraContent:e.jsxs("div",{style:{display:"flex",gap:m.sm},children:[e.jsx("button",{className:E("btn","small","submit",i&&"disabled"),disabled:i,type:"button",onClick:()=>o(),children:d("Refresh")}),e.jsx(wb,{className:"small",type:"text",placeholder:d("john@doe.com"),value:c||"",onChange:p=>u(p.target.value),autoComplete:"off",autoCorrect:"off",spellCheck:!1,inputMode:"email","data-lpignore":"true","data-1p-ignore":!0}),e.jsx("button",{className:E("btn","small",a.isPending&&"disabled",!c&&"disabled"),disabled:a.isPending||!c,type:"button",onClick:()=>a.mutate({...t.context,targetEmail:c||""}),children:d("Send Test Email")})]}),children:[i&&e.jsx($b,{}),!!r&&e.jsxs(jo,{children:[e.jsx(yo,{}),e.jsxs(Ie,{children:[e.jsxs(Ge,{children:[d("Error"),":"]}),e.jsx(Ye,{children:e.jsx("b",{children:r.message})})]}),e.jsx(Ie,{children:e.jsx(vo,{children:r.errors.template.preview})})]}),s!==void 0&&!r&&!i&&e.jsxs(jo,{children:[e.jsx(yo,{}),e.jsxs(Ie,{children:[e.jsxs(Ge,{children:[d("From"),":"]}),e.jsx(Ye,{children:e.jsx(Pi,{address:s.from})})]}),e.jsxs(Ie,{children:[e.jsxs(Ge,{children:[d("Subject"),":"]}),e.jsx(Ye,{children:s.subject})]}),e.jsxs(Ie,{children:[e.jsxs(Ge,{children:[d("To"),":"]}),e.jsx(Ye,{children:s.to})]}),!!s.cc.length&&e.jsxs(Ie,{children:[e.jsxs(Ge,{children:[d("CC"),":"]}),e.jsx(Ye,{children:e.jsx(Pi,{address:s.cc})})]}),!!s.bcc.length&&e.jsxs(Ie,{children:[e.jsxs(Ge,{children:[d("BCC"),":"]}),e.jsx(Ye,{children:e.jsx(Pi,{address:s.bcc})})]}),!!s.attachments.length&&e.jsxs(Ie,{children:[e.jsxs(Ge,{children:[d("Attachments"),":"]}),e.jsx(Ye,{children:e.jsx(gb,{attachments:s.attachments})})]}),e.jsx(Ie,{children:e.jsx(vo,{children:e.jsx(yb,{body:s.htmlBody})})})]})]})},br={all:["notification-templates"],one:t=>[...br.all,t]},Sb=t=>B({queryKey:br.one(t),queryFn:()=>T.get(`/api/notifications/templates/${t||"get-default-metadata"}`).then(n=>n.data),staleTime:1/0,gcTime:1/0}),Lb=t=>ce({mutationFn:n=>T.post("/api/notifications/templates",{formId:t,...n}).then(s=>s.data)}),Fb=l(ve)`
  display: grid;
...
`,Vs=t=>(t=Oo(t),t.replace(/[^a-zA-Z0-9\-_]/g,"")),Fu=(t,{target:n,camelize:s=!1,transliterate:i=!1,bypassConditions:o},r,a)=>{if(o!==void 0){for(const u of o)if(!!r?.[u.name]===u.isTrue)return t}const c=Jo(t,{transliterate:i,camelize:s});return a?.(n,c),t},Ib=(t,{pattern:n,replacement:s="",modifier:i="g"})=>{const o=new RegExp(n,i);return t.replace(o,s)},Ab=Object.freeze(Object.defineProperty({__proto__:null,handle:Vs,injectInto:Fu,regex:Ib},Symbol.toStringTag,{value:"Module"})),Rb=t=>{const{value:n,onChange:s}=t;return e.jsx(Te,{...t,children:e.jsx(pr,{criteria:{kind:[]},multiSelect:!0,onUpdate:s,value:n})})},Pb=t=>{const{value:n,label:s,handle:i,instructions:o,onChange:r}=t;return e.jsx(Te,{...t,label:void 0,instructions:void 0,children:e.jsxs(si,{children:[e.jsx(iu,{children:e.jsx(en,{enabled:n,onClick:a=>r(a)})}),e.jsxs(v4,{onClick:()=>r(!n),children:[e.jsx("label",{htmlFor:i,children:d(s)}),e.jsx(cs,{instructions:o})]})]})})},Db=t=>{const{optionDefinition:n,handle:s,value:i,onChange:o}=t,[r,a]=g.useState(!1),[c,u]=g.useState([]);return g.useEffect(()=>{typeof n=="function"?(a(!0),n().then(p=>{u(p)}).finally(()=>a(!1))):u(n||[])},[n]),e.jsxs(Te,{...t,children:[e.jsx(xr,{value:i,options:c,selectAll:c.length>0,onUpdate:o,uniqueId:s,emptyMessage:d("No PDF templates were found")}),!r&&c.length===0&&e.jsxs(e.Fragment,{children:[e.jsx(lu,{}),e.jsx(cs,{instructions:d("No PDF templates were found")})]})]})},Bb=t=>{const{optionDefinition:n,emptyOption:s,value:i,onChange:o}=t,[r,a]=g.useState(!1),[c,u]=g.useState([]);return g.useEffect(()=>{typeof n=="function"?(a(!0),n().then(p=>{u(p)}).finally(()=>a(!1))):u(n||[])},[n]),e.jsx(Te,{...t,children:e.jsx(de,{options:c,emptyOption:s,value:i,onChange:p=>o(p),loading:r})})},Ob=l.div`
  //
`,_b=l.label`
  display: block;
...
`,Ub=({item:t,onClick:n})=>{const s=g.useRef(null);return g.useEffect(()=>{t.active&&s.current&&s.current.scrollIntoView({behavior:"smooth",block:"nearest"})},[t]),e.jsx(Wb,{ref:s,className:E(t?.active&&"active"),onClick:()=>n?.(t),dangerouslySetInnerHTML:{__html:O.sanitize(t.shortName)}})},Hb=({category:t,onClick:n})=>e.jsxs(Ob,{children:[e.jsx(_b,{children:t.name}),e.jsx("div",{children:t.items.map(s=>e.jsx(Ub,{item:s,onClick:n},s.token))})]}),qb=({backend:t,index:n,filter:s,setIndex:i,setFilter:o,itemCountRef:r,suggestions:a,close:c})=>{g.useEffect(()=>{const u=p=>{switch(p.key){case"Escape":p.preventDefault(),c();break;case"ArrowRight":case"ArrowLeft":p.preventDefault(),c();break;case"ArrowDown":p.preventDefault(),i(x=>x>=(r.current??0)-1?(r.current??0)-1:x<(r.current??0)?x+1:r.current-1);break;case"ArrowUp":p.preventDefault(),n>0&&i(x=>x>r.current-1?r.current-1:x>0?x-1:0);break;case"Enter":if(p.preventDefault(),p.stopPropagation(),p.stopImmediatePropagation(),n>-1){const x=a.flatMap(f=>f.items).find(f=>f.active);x&&t.insert(x,s)}return o(""),c(),!1;default:p.key.length===1&&o(x=>x+p.key);break}};return t.handlers.on.down(u,!0),()=>{t.handlers.off.down(u)}},[n,c,t,a,s,o,i,r])},Qb=({backend:t,setFilter:n,close:s})=>{g.useEffect(()=>{if(t.extrnalTrigger)return;const i=o=>{const r=t.getRange(),a=r.startContainer,c=r.startOffset;if(a.nodeType===3){const u=a.textContent;let p="",x=!1;for(let f=c-1;f>=0;f--)if(u[f]==="@"){x=!0,p=u.substring(f+1,c);break}!x||o.key==="Escape"?(s(),n("")):n(p)}else s()};return t.handlers.on.up(i,!0),()=>{t.handlers.off.up(i)}},[s,t,n])};let Ls;const Kb=t=>{const n=[];return t.getState().layout.fields.forEach(s=>{n.push({shortName:s.properties.label,name:s.properties.label,token:`fieldUids['${s.uid}']`})}),n},Vb=t=>{const{store:n}=t,[s,i]=g.useState([]);return g.useEffect(()=>{Ls?i([...Ls,{name:"Fields",items:Kb(n)}]):T.get("/api/templates/notifications/suggestions").then(o=>{Ls=o.data,i(Ls)})},[n]),s},Gb=(t,n)=>{const s=Vb(t),[i,o]=g.useState([]),[r,a]=g.useState("");return g.useEffect(()=>{let c=0;const u=s.map(p=>({...p,items:p.items.filter(x=>x.name.toLowerCase().includes(r.toLowerCase())).map(x=>({...x,active:n===c++}))})).filter(p=>p.items.length>0);o(u)},[s,r,n]),{suggestions:i,filter:r,setFilter:a}},Yb=(t,n)=>{const s=t.getRect(),{getRange:i}=t,o=i();let r;o.startContainer.nodeType===Node.ELEMENT_NODE?r=o.startContainer:r=o;const a=r.getBoundingClientRect();let c=window.scrollX,u=window.scrollY;s&&(c+=s.left,u+=s.top);const p=c+a.left+15,x=u+a.top+20;return n.current&&(n.current.style.left=`${p}px`,n.current.style.top=`${x}px`),{left:p,top:x}},Jb=l.div`
  position: absolute;
  z-index: 1000;
  left: 200px;
  top: 200px;
...
`,Xb=l.div`
  ...
  overflow-y: auto;
  ${Q};
`,e6=({backend:t,close:n})=>{const s=g.useRef(null),i=g.useRef(0),[o,r]=g.useState(0),{suggestions:a,filter:c,setFilter:u}=Gb(t,o);Yb(t,s),g.useEffect(()=>{i.current=a.reduce((x,f)=>x+f.items.length,0)},[a]),$t({isEnabled:!0,callback:n,refObject:s}),Qb({backend:t,setFilter:u,close:n}),qb({backend:t,index:o,filter:c,setIndex:r,setFilter:u,itemCountRef:i,suggestions:a,close:n});const p=g.useCallback(x=>{t.insert(x,c),u(""),n()},[c,t.insert,n,u]);return e.jsxs(Jb,{ref:s,children:[e.jsx(Zb,{children:d("Freeform Template Tokens")}),e.jsx(Xb,{children:a.map(x=>e.jsx(Hb,{category:x,onClick:p},x.name))})]})},t6=t=>{const n=document.createElement("div");n.className="freeform-tokens-dropdown",document.body.appendChild(n);const s=hc.createRoot(n),i=()=>{s.unmount(),document.body.contains(n)&&document.body.removeChild(n)};return s.render(e.jsx(e6,{backend:t,close:i})),{close:i}};let Os;const wo=t=>{jr(),Os=t6(t)},jr=()=>{Os&&(Os.close(),Os=void 0)},n6=t=>{t.PluginManager.add("freeform-tokens",n=>{const s={store:n.getParam("store"),getRect:()=>n.getContentAreaContainer().getBoundingClientRect(),getRange:()=>n.selection.getRng(),insert:(i,o)=>{const r=n.selection.getRng(),a=Math.max(0,r.startOffset-(o.length+1));r.setStart(r.startContainer,a),n.selection.setRng(r),n.execCommand("Delete"),n.insertContent(`<span contenteditable="false" data-freeform-token="${i.token}">${i.name}</span>`)},handlers:{on:{down:(i,o=!1)=>{n.on("keydown",i,o)},up:(i,o=!1)=>{n.on("keyup",i,o)}},off:{down:i=>{n.off("keydown",i)},up:i=>{n.off("keyup",i)}}}};n.on("keydown",i=>{i.key==="@"&&setTimeout(()=>{wo(s)},0)}),n.on("remove",()=>{jr()})})};n6(H1);const s6=t=>{const{value:n,onChange:s}=t,i=Vo(),o=ee(),{templates:{toolbar:r},metadata:{tinymce:{stylesPath:a}}}=I;return e.jsx(Te,{...t,children:e.jsx(xc,{init:{branding:!1,menubar:!1,statusbar:!0,promotion:!1,content_css:a,store:i,queryClient:o},value:n,onEditorChange:s,plugins:i6,toolbar:r,licenseKey:"gpl"})})},i6=["autolink","code","codesample","image","link","lists","media","searchreplace","table","freeform-tokens"],Di=t=>{const{value:n,multiline:s,onChange:i}=t;return e.jsx(Te,{...t,children:s?e.jsx("textarea",{rows:2,className:"text fullwidth",value:n,onChange:o=>i(o.target.value)}):e.jsx("input",{type:"text",className:"text fullwidth",value:n,onChange:o=>i(o.target.value)})})},o6=l.div`
  position: relative;
`,r6=l.div`
...
`,wr=oe.memo(({value:t,onChange:n})=>{const{activeCell:s,setActiveCell:i,setCellRef:o,keyPressHandler:r}=zn(t.length,1),a=()=>{i(t.length,0),n(rl(t))};return e.jsxs(e.Fragment,{children:[e.jsxs(m6,{children:[!t.length&&e.jsxs(dl,{children:[e.jsx(ll,{children:e.jsx(ol,{})}),e.jsx(cl,{type:"text",className:E("text","fullwidth","code"),placeholder:"john.doe@example.com",onClick:()=>a(),onFocus:()=>a()})]}),t?.map((c,u)=>e.jsxs(dl,{children:[e.jsx(ll,{children:e.jsx(ol,{})}),e.jsx(cl,{type:"text","data-1p-ignore":!0,className:E("text","fullwidth","code"),autoFocus:s===`${u}:0`,ref:p=>o(p,u,0),onFocus:()=>i(u,0),placeholder:"john.doe@example.com",value:c.email,onKeyDown:r({onEnter:({shiftKey:p})=>{const x=p?u+1:t.length;i(x,0),n(rl(t,p?u:void 0))},onDelete:()=>{n(al(t,u)),i(u-1,0)}}),onChange:p=>n(x6(u,{...c,email:p.target.value},t))}),e.jsx(Tu,{tabIndex:-1,onClick:()=>{n(al(t,u)),i(Math.max(u-1,0),0)},children:e.jsx(h6,{})})]},u))]}),t.length>0&&e.jsx(ms,{label:"Add a recipient",onClick:a})]})});wr.displayName="RecipientsController";const g6=l.div`
  flex: 2;

  &.multiple {
    grid-column: span 2;
  }
`,f6=({recipients:t,spanMultiple:n,onChange:s})=>e.jsx(g6,{className:E(n&&"multiple"),children:e.jsx(wr,{value:t,onChange:s})}),ul=l.div`
  flex: 1 1 0;
`,b6=({id:t,onChange:n})=>{const{templates:s,isFetching:i,selectedTemplate:o}=vr(t);if(i)return e.jsx(ul,{children:"loading..."});const r=[];return s?.form&&r.push({label:"Form",icon:e.jsx("i",{className:"fa-regular fa-clipboard-list-check"}),children:s.form.map(a=>({label:a.name,value:a.id}))}),s?.global&&r.push({label:"Global",icon:e.jsx("i",{className:"fa-solid fa-earth-americas"}),children:s.global.map(a=>({label:a.name,value:a.id}))}),e.jsx(ul,{children:e.jsx(de,{value:o?.id,options:r,emptyOption:"Use default template",onChange:a=>{/^[0-9]+$/.test(a)&&n(Number(a)),n(a)}})})},j6=l.div`
  flex-basis: 20%;
`,y6=l.input`
  &.disabled {
    background: #dfe5ec;
...
`,v6=({predefined:t,value:n,onChange:s})=>e.jsx(j6,{children:e.jsx(y6,{className:E("text","fullwidth",t&&"disabled"),readOnly:t,disabled:t,type:"text",value:n,onChange:i=>s(i.target.value)})}),Nu=({predefined:t,mapping:n,removable:s,onChange:i,onRemove:o})=>{const{value:r,template:a,recipients:c}=n;return e.jsxs(p6,{children:[e.jsx(v6,{predefined:t,value:r,onChange:u=>i({...n,value:u})}),e.jsx(b6,{id:a,onChange:u=>i({...n,template:u})}),e.jsx(f6,{recipients:c,spanMultiple:!s,onChange:u=>{i({...n,recipients:u})}}),s&&e.jsx(ju,{children:e.jsx(dt,{onClick:o})})]})},w6=({option:t,mapping:n,allMappings:s,updateValue:i})=>{const o=!!n,r=n||{value:t.value,recipients:[],template:""},a=c=>{let u;o&&(u=s.findIndex(p=>p.value===c.value)),i(u!==void 0?[...s.slice(0,u),c,...s.slice(u+1)]:[...s||[],c])};return e.jsx(Nu,{predefined:!0,mapping:r,onChange:a})},$6=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.sm};
`,C6=({value:t,property:n,errors:s,updateValue:i,context:o})=>{const r=o.field,a=P(Ae.one(r)),c=Me(a?.typeClass),[u]=oi(a,c),p=x=>t?.find(f=>f.value===x);return e.jsx(W,{property:n,errors:s,context:o,children:e.jsxs($6,{children:[!!u&&u.filter(x=>"value"in x).map((x,f)=>e.jsx(w6,{option:x,mapping:p(x.value),allMappings:t,updateValue:i},f)),!!t&&t.map((x,f)=>u.find(b=>b?.value===x.value)?null:e.jsx(Nu,{mapping:x,removable:!0,onRemove:()=>{i([...t.slice(0,f),...t.slice(f+1)])},onChange:b=>{i([...t.slice(0,f),b,...t.slice(f+1)])}},f))]})})},k6=({value:t=[],property:n,errors:s,updateValue:i,context:o})=>e.jsxs(W,{property:n,errors:s,context:o,children:[e.jsx(wr,{value:t,onChange:i}),e.jsx(Xt,{children:e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(d("Press <b>enter</b> while focusing an input to add a new set of inputs."))}})})]}),S6=l.label`
  display: flex;
  justify-content: start;
...
`,L6=({value:t,property:n,updateValue:s})=>e.jsxs(ls,{$width:n.width,children:[e.jsx(S6,{children:e.jsxs(si,{children:[n.togglable&&e.jsx(en,{enabled:t.enabled,onClick:i=>s({...t,enabled:i})}),e.jsx(En,{children:d(n.label)})]})}),(!n.togglable||t.enabled)&&e.jsx(sr,{children:e.jsx("input",{type:"text",className:E("text","fullwidth"),placeholder:d("Label"),value:t.label??"",onChange:i=>s({...t,label:i.target.value})})})]}),F6=t=>e.jsx(R,{height:"1em",viewBox:"0 0 448 512",...t,children:e.jsx("path",{d:"M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"})}),E6=t=>e.jsx(R,{height:"1em",viewBox:"0 0 448 512",...t,children:e.jsx("path",{d:"M48 96V416c0 8.8 7.2 16 16 16H384c8.8 0 16-7.2 16-16V170.5c0-4.2-1.7-8.3-4.7-11.3l33.9-33.9c12 12 18.7 28.3 18.7 45.3V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96C0 60.7 28.7 32 64 32H309.5c17 0 33.3 6.7 45.3 18.7l74.5 74.5-33.9 33.9L320.8 84.7c-.3-.3-.5-.5-.8-.8V184c0 13.3-10.7 24-24 24H104c-13.3 0-24-10.7-24-24V80H64c-8.8 0-16 7.2-16 16zm80-16v80H272V80H128zm32 240a64 64 0 1 1 128 0 64 64 0 1 1 -128 0z"})}),T6=t=>e.jsx(R,{height:"1em",viewBox:"0 0 448 512",...t,children:e.jsx("path",{d:"M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"})}),N6=l.ul`
  display: grid;
  grid-template-columns: 1fr 1fr;
  gap: ${m.sm};
...
`,t8=({value:t})=>{const{options:n=[],useCustomValues:s}=t;return e.jsx(Jt,{"data-edit":d("Click to edit data"),children:e.jsxs(Zt,{children:[!n.length&&e.jsx(kt,{children:d("Not configured yet")}),n.map((i,o)=>e.jsxs(e8,{children:[e.jsx(jn,{"data-empty":d("empty"),children:i.label}),s&&e.jsx(jn,{"data-empty":d("empty"),children:i.value})]},o))]})})},n8=({value:t,updateValue:n,property:s,defaultValue:i,updateDefaultValue:o,isMultiple:r,autoUpdateHandle:a})=>e.jsxs(e.Fragment,{children:[e.jsx(En,{children:d("Options")}),e.jsx(Ve,{preview:e.jsx(t8,{value:t,defaultValue:i,isMultiple:r}),excludeClassNames:["bulk-editor"],onAfterEdit:()=>n(Y6(t)),children:e.jsx(X6,{value:t,updateValue:n,property:s,defaultValue:i,updateDefaultValue:o,isMultiple:r,allowOptgroup:s.allowOptgroup,autoUpdateHandle:a})})]}),s8=Object.freeze(Object.defineProperty({__proto__:null,custom:n8,elements:D6,predefined:O6},Symbol.toStringTag,{value:"Module"})),i8=s8,o8=({value:t,updateValue:n,property:s,defaultValue:i,updateDefaultValue:o,convertToCustomValues:r,isMultiple:a,autoUpdateHandle:c})=>{const{source:u=Re.Custom}=t,p=i8[u];return p===void 0?e.jsxs("div",{children:[u," not implemented..."]}):(p.displayName=`Source <${u}>`,e.jsx($r,{message:`...${u} not implemented`,children:e.jsx(g.Suspense,{children:e.jsx(p,{value:t,updateValue:n,property:s,defaultValue:i,updateDefaultValue:o,convertToCustomValues:r,isMultiple:a,autoUpdateHandle:c})})}))};l.div`
  display: flex;
  align-items: center;
  gap: 0px;
...
`,ct=t=>e.jsx(j8,{type:"checkbox",...t}),y8=({column:t,onUpdate:n})=>{const s=g.useId(),i=t.checked??!1;return e.jsx(ys,{$gap:m.lg,children:e.jsxs(hn,{$alignItems:"center",children:[e.jsx(ct,{id:s,checked:i,onChange:()=>n({...t,checked:!t.checked})}),e.jsx("label",{htmlFor:s,children:d(i?"checked by default":"unchecked by default")})]})})},v8=(t,n)=>[...t.slice(0,n),"",...t.slice(n)],w8=(t,n,s)=>{const i=[...s];return i[t]=n,i},hl=(t,n)=>n.filter((s,i)=>i!==t),$8=(t,n,s)=>Xs(t,{$splice:[[n,1],[s,0,t[n]]]}),xl=(t=[],n=[])=>t.length===n.length&&t.every((s,i)=>s===n[i]),C8=({column:t,onUpdate:n})=>{const[s,i]=g.useState(t.options?.length?t.options:[""]),o=xs(s,500),r=g.useRef(t);g.useEffect(()=>{r.current=t},[t]);const a=g.useRef(n);g.useEffect(()=>{a.current=n},[n]),g.useEffect(()=>{const y=t.options?.length?t.options:[""];i(w=>xl(w,y)?w:y)},[t.options]),g.useEffect(()=>{const y=r.current,w=y.value,v=o.includes(w)?w:"";xl(y.options??[],o)&&y.value===v||a.current({...y,options:o,value:v})},[o]);const c=g.useRef([]);c.current=s.map((y,w)=>c.current[w]||oe.createRef());const{activeCell:u,setActiveCell:p,setCellRef:x,keyPressHandler:f}=zn(s.length,1),b=(y,w)=>{p(w!==void 0?w+1:s.length,y),i(v8(s,w===void 0?s.length:w+1))},j=y=>{const w=r.current,v=w.value===y?"":y,$={...w,options:s,value:v};r.current=$,a.current($)};return e.jsxs(e.Fragment,{children:[e.jsxs(Ru,{children:[e.jsx(bs,{children:e.jsxs(js,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:d("Label")}),s.length>1&&e.jsxs(e.Fragment,{children:[e.jsx("th",{children:d("Selected")}),e.jsx("th",{colSpan:2,children:d("Actions")})]})]})}),e.jsx("tbody",{children:s.map((y,w)=>e.jsxs(Cr,{index:w,dragRef:c.current[w],onDrop:(v,$)=>i($8(s,v,$)),children:[e.jsx(ue,{children:e.jsx(ot,{type:"text",value:y,placeholder:d("Label"),autoFocus:u===`${w}:0`,ref:v=>x(v,w,0),onFocus:()=>p(w,0),onKeyDown:f({onEnter:({shiftKey:v})=>{b(0,v?w:void 0)},onDelete:()=>{if(s.length>1){const v=hl(w,s),$=r.current,C={...$,options:v,value:$.value===y?"":$.value};r.current=C,a.current(C),i(v),p(Math.max(w-1,0),0)}}}),onChange:v=>{const $=w8(w,v.target.value,s),C=r.current;if(C.value===y){const F={...C,value:v.target.value,options:$};r.current=F,a.current(F)}i($)}})}),s.length>1&&e.jsxs(e.Fragment,{children:[e.jsx(ue,{$tiny:!0,children:e.jsx(Et,{children:e.jsx(yn,{property:{label:"",handle:`${w}-check`,type:K.Boolean,width:50},value:t.value===y,updateValue:()=>j(y)})})}),e.jsx(ue,{$tiny:!0,children:e.jsx(Et,{children:e.jsx(Bt,{ref:c.current[w],className:"handle",children:e.jsx(ri,{})})})}),e.jsx(ue,{$tiny:!0,children:e.jsx(Et,{children:e.jsx(Bt,{onClick:()=>{const v=hl(w,s),$=r.current,C={...$,options:v,value:$.value===y?"":$.value};r.current=C,a.current(C),i(v),p(Math.max(w-1,0),0)},children:e.jsx(gs,{})})})})]})]},w))})]})}),e.jsx(ms,{label:d("Add an option"),onClick:()=>b(0)})]}),e.jsx(Xt,{children:e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(d("Press <b>enter</b> while editing a cell to add a new row."))}})})]})},k8={fileCount:1,maxFileSizeKB:2048,fileKinds:["image"],assetSourceId:null,uploadLocation:null},S8=[{value:"image",label:"Image"},{value:"video",label:"Video"},{value:"audio",label:"Audio"},{value:"text",label:"Text"},{value:"pdf",label:"PDF"},{value:"json",label:"JSON"}],L8=({column:t,onUpdate:n,property:s})=>{const i={...k8,...t.metadata||{}},o=(x=[])=>x.flatMap(f=>"children"in f?o(f.children):f),r=o(s?.fileKindsOptions),a=r.length?r:S8,c=o(s?.assetSourceOptions),u=x=>{n({...t,metadata:{...i,...x}})},p=x=>{const f=new Set(i.fileKinds);f.has(x)?f.delete(x):f.add(x),u({fileKinds:Array.from(f)})};return e.jsxs(ys,{$gap:m.lg,children:[e.jsxs(hn,{$gap:m.md,children:[e.jsx(W,{width:40,label:d("Max Files"),handle:"fileCount",children:e.jsx("input",{type:"number",min:1,className:"text fullwidth",value:i.fileCount,onChange:x=>u({fileCount:Math.max(1,Number(x.target.value)||1)})})}),e.jsx(W,{width:60,label:d("Maximum File Size (KB)"),handle:"maxFileSizeKB",children:e.jsx("input",{type:"number",min:1,className:"text fullwidth",value:i.maxFileSizeKB,onChange:x=>u({maxFileSizeKB:Math.max(1,Number(x.target.value)||1)})})})]}),e.jsxs(hn,{children:[e.jsx(W,{width:40,label:d("Asset Source"),handle:"assetSourceId",instructions:d("Select an asset source to be able to store user uploaded files."),children:e.jsx(de,{emptyOption:d("Select source"),value:i.assetSourceId?String(i.assetSourceId):"",options:c,onChange:x=>u({assetSourceId:x?Number(x):null})})}),e.jsx(W,{width:60,label:d("Upload Location"),handle:"uploadLocation",instructions:d("The subfolder path that files should be uploaded to. May contain `{{ form.handle }}` or `{{ form.id }}` variables as well."),children:e.jsx("input",{type:"text",className:"text fullwidth",value:i.uploadLocation||"",onChange:x=>u({uploadLocation:x.target.value||null})})})]}),e.jsx(W,{label:d("File Kinds"),handle:"fileKinds",children:e.jsx(e4,{children:a.map(x=>e.jsx("label",{children:e.jsxs(hn,{$alignItems:"center",$gap:m.sm,children:[e.jsx(ct,{checked:i.fileKinds.includes(x.value),onChange:()=>p(x.value)}),e.jsx("span",{children:x.label})]})},x.value))})})]})},F8=({column:t,onUpdate:n})=>e.jsxs(ys,{$gap:m.lg,children:[e.jsx(W,{label:d("Default value"),handle:"value",children:t.type==="textarea"?e.jsx("textarea",{className:"text fullwidth",rows:4,value:t.value,onChange:s=>n({...t,value:s.target.value})}):e.jsx("input",{type:"text",className:"text fullwidth",value:t.value,onChange:s=>n({...t,value:s.target.value})})}),e.jsx(W,{label:d("Placeholder"),handle:"placeholder",children:e.jsx("input",{type:"text",className:"text fullwidth",value:t.placeholder||"",onChange:s=>n({...t,placeholder:s.target.value})})})]}),E8=(t,n)=>[...t.slice(0,n+1),{label:"",type:"text",value:""},...t.slice(n+1)],Fs=(t,n,s)=>{const i=[...s];return i[t]=n,i},T8=(t,n)=>n.filter((s,i)=>i!==t),N8=(t,n,s)=>{const i=[...s];return Xs(i,{$splice:[[t,1],[n,0,i[t]]]})},z8=t=>t.filter(n=>!!n.label||!!n.value),M8={fileCount:1,maxFileSizeKB:2048,fileKinds:["image"],assetSourceId:null,uploadLocation:null},I8=(t,n)=>n==="file"?{...t,type:n,metadata:{...M8,...t.metadata||{}}}:{...t,type:n,metadata:{}},Oi={text:e.jsx(f8,{}),textarea:e.jsx(b8,{}),select:e.jsx(h8,{}),radio:e.jsx(g8,{}),checkbox:e.jsx(p8,{}),file:e.jsx(x8,{})},A8=({columnTypes:t,columns:n,updateValue:s,property:i,context:o})=>{const[r,a]=g.useState(0),{getTranslation:c,willTranslate:u}=Ce(o),p=g.useRef(null),x=g.useRef(null),f=g.useRef([]),b=g.useRef(!1),j=g.useRef(new WeakMap),y=g.useRef(0),w=u(i.handle),v=c(i.handle,n),$=w?v:n,C=g.useMemo(()=>$[r],[r,$]),F=L=>{const A=j.current.get(L);if(A)return A;const D=`table-column-${y.current++}`;return j.current.set(L,D),D},N=g.useMemo(()=>t.reduce((L,A)=>(A.value in Oi&&L.push({...A,icon:Oi[A.value]}),L),[]),[t]);g.useEffect(()=>{p.current?.focus()},[r,$.length]),g.useEffect(()=>{f.current[r]?.scrollIntoView({behavior:"smooth",block:"nearest",inline:"nearest"}),b.current&&(b.current=!1,p.current?.scrollIntoView({behavior:"smooth",block:"nearest"}))},[r,$.length]),g.useEffect(()=>{if(!x.current||$.length<2)return;const L=Ne.create(x.current,{animation:150,draggable:".table-column-tab",handle:".column-drag-handle",onEnd:A=>{const D=A.oldIndex,J=A.newIndex;D===void 0||J===void 0||D===J||(s(N8(D,J,$)),a(pe=>pe===D?J:D<pe&&pe<=J?pe-1:J<=pe&&pe<D?pe+1:pe))}});return()=>{L.destroy()}},[$,s]);const M=()=>{const L=$.length;s([...$,{label:"New column",type:"text",value:""}]),b.current=!0,a(L)},z=L=>{if($.length<=1)return;const A=T8(L,$);let D=r;r>L?D=r-1:r===L&&(D=Math.max(0,L-1)),s(A),a(D)};return e.jsx(Zd,{children:e.jsxs(bs,{children:[e.jsxs(t4,{children:[e.jsx(Vf,{ref:x,children:$.length>0&&$.map((L,A)=>e.jsxs("a",{className:E("table-column-tab",L.required&&"required",A===r&&"active"),ref:D=>{f.current[A]=D},onClick:()=>a(A),children:[e.jsx(pd,{children:Oi[L.type]}),e.jsx(Gf,{children:d(L.label)}),$.length>1&&e.jsx(Xf,{type:"button",className:"column-drag-handle",title:d("Reorder column"),onClick:D=>{D.preventDefault(),D.stopPropagation()},children:e.jsx(ri,{})}),A===r&&$.length>1&&e.jsx(Zf,{type:"button",title:d("Remove column"),onClick:D=>{D.preventDefault(),D.stopPropagation(),z(A)},children:e.jsx(gs,{})})]},F(L)))}),e.jsx(Jf,{type:"button",className:"btn",title:d("Add column"),onClick:M,children:e.jsx(m8,{})})]}),e.jsxs(n4,{children:[e.jsxs(hn,{children:[e.jsx(W,{width:60,label:d("Label"),handle:"label",children:e.jsx("input",{type:"text",className:"text fullwidth",ref:p,value:C?.label,onChange:L=>s(Fs(r,{...C,label:L.target.value},$))})}),e.jsx(W,{width:30,label:d("Column Type"),handle:"type",children:e.jsx(de,{showSelectedIcon:!0,emptyOption:"Select Type",value:C?.type,options:N,onChange:L=>{s(Fs(r,I8(C,L),$))}})}),e.jsx(W,{width:10,label:d("Required"),handle:"required",justify:"center",children:e.jsx(en,{enabled:!!C?.required,onClick:L=>{s(Fs(r,{...C,required:L},$))}})})]}),R8(C,L=>s(Fs(r,L,$)),i)]})]})})},R8=(t,n,s)=>t?["text","textarea"].includes(t.type)?e.jsx(F8,{column:t,onUpdate:n}):["select","radio"].includes(t.type)?e.jsx(C8,{column:t,onUpdate:n}):t.type==="checkbox"?e.jsx(y8,{column:t,onUpdate:n}):t.type==="file"?e.jsx(L8,{column:t,onUpdate:n,property:s}):null:null,P8=(t,n)=>t.find(s=>s.value===n)?.label||n,D8=({columnTypes:t,columns:n})=>e.jsx(Jt,{"data-edit":d("Click to edit data"),children:e.jsxs(Zt,{children:[!n.length&&e.jsx(kt,{children:d("Not configured yet")}),n.map((s,i)=>e.jsxs(ur,{"data-title":P8(t,s.type),children:[e.jsx(jn,{"data-empty":d("empty"),className:E(s.required&&"required"),children:s.label}),e.jsx(jn,{"data-empty":d("empty"),children:B8(s)})]},i))]})}),B8=t=>t.type==="checkbox"?e.jsx(ct,{readOnly:!0,checked:!!t.checked}):t.type==="select"?e.jsx("div",{className:E("small select"),children:e.jsx("select",{disabled:!0,children:e.jsx("option",{children:t.value})})}):e.jsx(e.Fragment,{children:t.value}),O8=({value:t,property:n,errors:s,updateValue:i,context:o})=>{const{options:r}=n;return e.jsx(W,{property:n,errors:s,context:o,children:e.jsx(Ve,{preview:e.jsx(D8,{columnTypes:r,columns:t}),onAfterEdit:()=>i(z8(t)),onEdit:()=>{t.length||i(E8(t,0))},children:e.jsx(A8,{columnTypes:r,columns:t,updateValue:i,property:n,context:o})})})},Pu=(t,n,s)=>[...t.slice(0,s+1),[...n.map(()=>"")],...t.slice(s+1)],ml=(t,n,s)=>{const i=[...s];return i[t]=n,i},_8=(t,n)=>n.filter((s,i)=>i!==t),W8=(t,n,s)=>{const i=[...s];return Xs(i,{$splice:[[t,1],[n,0,i[t]]]})},U8=t=>t.filter(n=>n.filter(Boolean).length!==0),H8=({configuration:t,values:n,updateValue:s,property:i,context:o})=>{const{getTranslation:r,updateTranslation:a,willTranslate:c}=Ce(o),{handle:u}=i,p=c(u),x=r(u,n),f=g.useRef([]);f.current=n.map(($,C)=>f.current[C]||oe.createRef());const{activeCell:b,setActiveCell:j,setCellRef:y,keyPressHandler:w}=zn(n.length,t.length),v=($,C)=>{p||(j(C!==void 0?C+1:n.length,$),s(Pu(n,t,C!==void 0?C:n.length)))};return e.jsxs(Zd,{children:[e.jsx(bs,{children:e.jsx(js,{children:e.jsx("tbody",{children:n.map(($,C)=>e.jsxs(Cr,{index:C,dragRef:f.current[C],onDrop:(F,N)=>s(W8(F,N,n)),children:[t.map((F,N)=>e.jsx(ue,{children:e.jsx(ot,{type:"text",value:$[N],placeholder:d(F.label),autoFocus:b===`${C}:${N}`,disabled:p&&!F.translatable,ref:M=>y(M,C,N),onFocus:()=>j(C,N),onKeyDown:w({onEnter:M=>{v(0,M.shiftKey?C:void 0)}}),onChange:M=>{if(p){if(!F.translatable)return;a(i.handle,ml(C,[...x[C].slice(0,N),M.target.value,...x[C].slice(N+1)],x));return}s(ml(C,[...n[C].slice(0,N),M.target.value,...n[C].slice(N+1)],n))}})},N)),n.length>1&&e.jsxs(e.Fragment,{children:[e.jsx(ue,{$tiny:!0,children:e.jsx(Bt,{ref:f.current[C],className:"handle",children:e.jsx(ri,{})})}),e.jsx(ue,{$tiny:!0,children:e.jsx(Bt,{onClick:()=>{s(_8(C,n)),j(Math.max(C-1,0),0)},children:e.jsx(gs,{})})})]})]},C))})})}),e.jsx(ms,{label:"Add a row",onClick:()=>v(0),disabled:p}),e.jsx(Xt,{children:e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(d("Press <b>enter</b> while editing a cell to add a new row."))}})})]})},q8=({configuration:t,values:n})=>e.jsx(u3,{"data-edit":d("Click to edit data"),children:e.jsxs(p3,{children:[!n.length&&e.jsx(gr,{children:d("Not configured yet")}),n.map((s,i)=>e.jsx(h3,{children:t.map((o,r)=>e.jsx(x3,{"data-empty":d("empty"),"data-title":o.label,children:s[r]},r))},i))]})}),Q8=({value:t,property:n,errors:s,updateValue:i,context:o})=>{const{configuration:r}=n;return e.jsx(W,{property:n,errors:s,context:o,children:e.jsx(Ve,{preview:e.jsx(q8,{configuration:r,values:t}),onAfterEdit:()=>i(U8(t)),onEdit:()=>{t.length||i(Pu(t,r,0))},children:e.jsx(H8,{configuration:r,values:t,updateValue:i,property:n,context:o})})})},K8=({value:t,updateValue:n})=>e.jsx("input",{className:"input text fullwidth",type:"text",value:t,onChange:s=>n(s.target.value)}),V8=l.div`
  .tox {
    border: 1px solid #d1d1d1;
    border-radius: 0;
    padding: 0;
  }
`,G8=({value:t,menu:n,statusbar:s,toolbar:i,updateValue:o})=>{const{metadata:{tinymce:{stylesPath:r}}}=I;return e.jsx(it,{children:e.jsx(cr,{children:e.jsx(V8,{children:e.jsx(xc,{init:{menubar:n,statusbar:s,promotion:!1,content_css:r,relative_urls:!1,remove_script_host:!1},value:t,onEditorChange:o,plugins:Y8,toolbar:i,licenseKey:"gpl"})})})})},Y8=["autolink","code","codesample","image","link","lists","media","searchreplace","table"];l.pre`
  font-size: 10px;
`;const J8=l(Zt)`
  height: auto;
  min-height: 30px;
...
`,Z8=({value:t})=>e.jsx(Jt,{"data-edit":d("Click to edit data"),children:e.jsxs(J8,{children:[!t&&e.jsx(kt,{children:d("Not configured yet")}),e.jsx("div",{dangerouslySetInnerHTML:{__html:O.sanitize(t)}})]})}),X8=({value:t,property:n,updateValue:s})=>e.jsx(Ve,{preview:e.jsx(Z8,{value:t}),excludeClassNames:["tox"],children:e.jsx(G8,{menu:n.menu,statusbar:n.statusbar,toolbar:n.toolbar,value:t,updateValue:s})}),ej=l.div`
  margin-bottom: ${m.sm};
`,tj=/<[^>]*>/,nj=t=>t?tj.test(t):!1,sj=({value:t,property:n,errors:s,updateValue:i,context:o})=>{const r=x=>Craft.t("freeform",x),a=g.useMemo(()=>n.toggleEditor?nj(t)?"rich":"plain":"rich",[n.toggleEditor,t]),[c,u]=g.useState(a),p=x=>{if(u(x),x==="plain"&&t){const f=document.createElement("div");f.innerHTML=O.sanitize(t),i(f.textContent||"")}};return e.jsxs(W,{property:n,errors:s,context:o,children:[n.toggleEditor&&e.jsx(ej,{children:e.jsx(hr,{value:c,options:[{value:"plain",label:r("Plain Text")},{value:"rich",label:r("Rich Text")}],onClick:p})}),c==="rich"?e.jsx(X8,{value:t,property:n,updateValue:i}):e.jsx(K8,{value:t,updateValue:i})]})},ij=Object.freeze(Object.defineProperty({__proto__:null,aiBox:Af,appStateSelect:Rf,assetPicker:_f,attributes:j4,bool:yn,boolEnv:L4,buttonGroup:T4,calculationBox:Q4,cards:k3,checkboxes:V4,codeEditor:X4,colorPicker:o5,conditionalIntegrationRule:Z3,conditionalNotificationRule:cb,datePicker:so,dynamicCheckboxes:c5,dynamicSelect:d5,entryPicker:g5,field:f5,fieldMapping:O3,fieldType:T5,formMonitorTools:lb,hidden:N5,int:z5,label:B5,minMax:U5,notificationTemplate:u6,options:u8,pageButton:L6,pageButtonLayout:A6,recipientMapping:C6,recipients:k6,select:Iu,string:Dt,table:O8,tabularData:Q8,textarea:ds,wysiwyg:sj},Symbol.toStringTag,{value:"Module"})),oj=l.div`
  position: relative;
  min-height: 10px;
...
`,rj=({delimiter:t})=>t?e.jsx(oj,{children:e.jsx("div",{children:t.name})}):null,aj=(t,n)=>{const s=P(et.current);return g.useMemo(()=>{if(t.length===0)return!0;const i={config:I,page:s};try{return qd(t,n,i)}catch(o){return console.error(`Failed to evaluate visibility expression: ${t.join(" && ")}`,o),!1}},[t,n,s])},lj=ij,je=({value:t,updateValue:n,property:s,errors:i,context:o,autoFocus:r=!1})=>{const{handle:a,type:c,visibilityFilters:u}=s,p=lj[c],x=aj(u||[],o);return p===void 0?e.jsx("div",{children:`[${a}]: <${c}>`}):(p.displayName=`FormComponent: <${c}>`,x?e.jsx($r,{message:`...${a} <${c}>`,children:e.jsxs(g.Suspense,{children:[e.jsx(rj,{delimiter:s.delimiter}),e.jsx(p,{value:t,property:s,updateValue:n,errors:i,context:o,autoFocus:r})]})}):null)},gl=Ab,fl=(t,n,s,i)=>{let o=t;return n?.forEach(r=>{const[a,c]=r;gl[a]&&(o=gl[a](t,c,s,i))}),o},vs=(t,n,s)=>{const{isPrimary:i}=Fe(),r=P(Pe.settings.one("general"))?.translations;return g.useCallback(a=>{if(!a.disabled)return r&&!i?c=>{s(a.handle,c)}:c=>{const u=(p,x)=>{const f=t.find(b=>b.handle===p);!f||f.disabled||s(f.handle,fl(x,f.middleware,n))};s(a.handle,fl(c,a.middleware,n,u))}},[t,n,s,i,r])},cj=({namespace:t,property:n})=>{const s=H(),{data:i}=Gt(),o=i.find(y=>y.handle===t).properties,r=P(Pe.errors),a=P(Pe.current),u={...P(Pe.settings.one(t)),isNew:a.isNew,namespaceType:"settings",namespace:t},{getTranslation:p,updateTranslation:x}=Ce(u),f=p(n.handle,u[n.handle]),b=vs(o,u,(y,w)=>{x(y,w)||s(gt.modifySettings({namespace:t,key:y,value:w}))}),j=r?.[t]?.[n.handle];return e.jsx(je,{value:f,property:n,updateValue:b(n),errors:j,context:u})},dj=t=>e.jsxs(R,{viewBox:"0 0 512 512",...t,children:[e.jsx("path",{className:"fa-secondary",opacity:".4",d:"M48 480c26.5 0 48-21.5 48-48L96 96c0-35.3 28.7-64 64-64l288 0c35.3 0 64 28.7 64 64l0 320c0 35.3-28.7 64-64 64L96 480l-48 0zM160 120l0 80c0 13.3 10.7 24 24 24l112 0c13.3 0 24-10.7 24-24l0-80c0-13.3-10.7-24-24-24L184 96c-13.3 0-24 10.7-24 24zm0 184c0 8.8 7.2 16 16 16l256 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-256 0c-8.8 0-16 7.2-16 16zm0 96c0 8.8 7.2 16 16 16l256 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-256 0c-8.8 0-16 7.2-16 16zM368 112c0 8.8 7.2 16 16 16l48 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-48 0c-8.8 0-16 7.2-16 16zm0 96c0 8.8 7.2 16 16 16l48 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-48 0c-8.8 0-16 7.2-16 16z"}),e.jsx("path",{className:"fa-primary",d:"M0 160L0 432c0 26.5 21.5 48 48 48s48-21.5 48-48L96 96 64 96C28.7 96 0 124.7 0 160zM384 96c-8.8 0-16 7.2-16 16s7.2 16 16 16l48 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-48 0zm0 96c-8.8 0-16 7.2-16 16s7.2 16 16 16l48 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-48 0zM176 288c-8.8 0-16 7.2-16 16s7.2 16 16 16l256 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-256 0zm0 96c-8.8 0-16 7.2-16 16s7.2 16 16 16l256 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-256 0z"})]}),uj=()=>{const{data:t,isFetching:n}=_h(),s=st("");return I.metadata.craft.is5?e.jsxs(rr,{children:[e.jsx(q,{id:"settings-usage",label:d("Usage in Elements"),url:s.pathname}),!t&&n&&e.jsx("div",{children:"Loading..."}),!n&&t?.length===0&&e.jsx(at,{title:d("No results found"),subtitle:d("This form is currently not attached to any elements."),icon:e.jsx(dj,{}),iconFade:!0}),t?.length>0&&e.jsxs(e.Fragment,{children:[e.jsx(ar,{children:d("Usage in Elements")}),e.jsxs("table",{className:"data fullwidth collapsible",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:d("Element")}),e.jsx("th",{children:d("Type")}),e.jsx("th",{children:d("Status")})]})}),e.jsx("tbody",{children:t.map(o=>e.jsxs("tr",{className:"element-row",children:[e.jsx("th",{children:e.jsx("div",{className:"chip small element","data-id":o.id,children:e.jsxs("div",{className:"chip-content",children:[e.jsx("span",{className:E("status",o.status.toLowerCase()),role:"img"}),e.jsx("a",{href:o.url,className:"label-link",children:e.jsx("span",{children:o.title})})]})})}),e.jsx("td",{children:o.type}),e.jsx("td",{children:o.status})]},o.id))})]})]})]}):null},bl=()=>{const{sectionHandle:t}=V(),n=st(""),{data:s}=Gt();if(!s)return null;let i,o;if(s.forEach(a=>{a.sections.forEach(c=>{c.handle===t&&(i=a,o=c)})}),!i||!o)return t===Bs?e.jsx(uj,{}):null;const{properties:r}=i;return e.jsxs(rr,{children:[e.jsx(q,{id:"sub-settings",label:o.label,url:n.pathname}),e.jsx(ar,{children:d(o?.label)}),e.jsx(yf,{children:r.filter(a=>a.section===o?.handle).filter(a=>a.visible).map(a=>e.jsx(cj,{namespace:i.handle,property:a},a.handle))})]})},Du=l.div`
  display: flex;
  ...
  border-radius: ${S.lg};
  box-shadow: ${ae.box};
`,pj=()=>{const[,t]=g.useReducer(n=>n+1,0);g.useEffect(()=>{setTimeout(()=>{t()},0)},[])},Bu=l.div``,hj=l.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  gap: 5px;
...
`,_u=l.div`
  ...
  padding: ${m.xs} 0;
`,xj=_u,mj=t=>e.jsx(R,{viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M495.9 166.6c3.2 8.7 .5 18.4-6.4 24.6l-43.3 39.4c1.1 8.3 1.7 16.8 1.7 25.4s-.6 17.1-1.7 25.4l43.3 39.4c6.9 6.2 9.6 15.9 6.4 24.6c-4.4 11.9-9.7 23.3-15.8 34.3l-4.7 8.1c-6.6 11-14 21.4-22.1 31.2c-5.9 7.2-15.7 9.6-24.5 6.8l-55.7-17.7c-13.4 10.3-28.2 18.9-44 25.4l-12.5 57.1c-2 9.1-9 16.3-18.2 17.8c-13.8 2.3-28 3.5-42.5 3.5s-28.7-1.2-42.5-3.5c-9.2-1.5-16.2-8.7-18.2-17.8l-12.5-57.1c-15.8-6.5-30.6-15.1-44-25.4L83.1 425.9c-8.8 2.8-18.6 .3-24.5-6.8c-8.1-9.8-15.5-20.2-22.1-31.2l-4.7-8.1c-6.1-11-11.4-22.4-15.8-34.3c-3.2-8.7-.5-18.4 6.4-24.6l43.3-39.4C64.6 273.1 64 264.6 64 256s.6-17.1 1.7-25.4L22.4 191.2c-6.9-6.2-9.6-15.9-6.4-24.6c4.4-11.9 9.7-23.3 15.8-34.3l4.7-8.1c6.6-11 14-21.4 22.1-31.2c5.9-7.2 15.7-9.6 24.5-6.8l55.7 17.7c13.4-10.3 28.2-18.9 44-25.4l12.5-57.1c2-9.1 9-16.3 18.2-17.8C227.3 1.2 241.5 0 256 0s28.7 1.2 42.5 3.5c9.2 1.5 16.2 8.7 18.2 17.8l12.5 57.1c15.8 6.5 30.6 15.1 44 25.4l55.7-17.7c8.8-2.8 18.6-.3 24.5 6.8c8.1 9.8 15.5 20.2 22.1 31.2l4.7 8.1c6.1 11 11.4 22.4 15.8 34.3zM256 336c44.2 0 80-35.8 80-80s-35.8-80-80-80s-80 35.8-80 80s35.8 80 80 80z"})}),gj=l.div`
  > a {
    display: flex;
    align-items: center;
    gap: ${m.sm};
...
`,jj=({id:t,name:n,handle:s,icon:i})=>{const{setLastTab:o}=We("integrations"),r=P(as.one(t));if(!r)return null;const a=r.errors&&Object.values(r.errors).some(c=>c.length>0);return e.jsx(gj,{children:e.jsxs(he,{onClick:()=>o(`${t}/${s}`),to:`${t}/${s}`,className:E(!r.enabled&&"inactive",a&&"errors"),children:[!i&&e.jsx(jl,{children:e.jsx(mj,{})}),!!i&&e.jsx(jl,{dangerouslySetInnerHTML:{__html:O.sanitize(i)}}),e.jsx(fj,{children:n}),e.jsx(bj,{$enabled:r.enabled,className:E("status-dot")})]})})},yj=({label:t,children:n})=>e.jsxs(Bu,{children:[e.jsx(hj,{children:e.jsx(Ou,{children:t})}),e.jsx(xj,{children:n.map(s=>e.jsx(jj,{...s},s.id))})]}),vj=()=>e.jsx(Mn,{children:e.jsxs(Bu,{children:[e.jsx(Ou,{children:e.jsx(k,{width:50})}),e.jsx(_u,{style:{padding:14},children:[0,1,2].map(t=>e.jsxs("div",{style:{display:"flex",gap:10,alignItems:"center"},children:[e.jsx(k,{width:20,height:20,circle:!0}),e.jsx("div",{style:{flexGrow:2},children:e.jsx(k,{width:100,style:{top:2}})}),e.jsx(k,{width:10,height:10,circle:!0,style:{top:6}})]},t))})]})}),_i=l.ul`
  display: flex;
  flex-direction: column;
  gap: ${m.sm};

  list-style: none;
`,wj=()=>{const{formId:t,id:n}=V(),s=ne(),{data:i,isFetching:o}=Go(t&&Number(t));pj();const{lastTab:r,setLastTab:a}=We("integrations");if(g.useEffect(()=>{r&&s(r)},[s,r]),g.useEffect(()=>{if(!n&&!r&&i){const u=i.find(Boolean);u&&(a(`${u.id}/${u.handle}`),s(`${u.id}/${u.handle}`))}},[n,i,r,s,a]),!i&&o)return e.jsx(De,{children:e.jsx(_i,{children:e.jsx(vj,{})})});if(!i&&!o)return e.jsx(De,{children:e.jsx(_i,{})});const c={};return i.forEach(u=>{const{type:p}=u;c[p]||(c[p]={type:p,label:d(p.replace("-"," ")),children:[]}),c[p].children.push(u)}),e.jsx(De,{$lean:!0,children:e.jsx(_i,{children:Object.values(c).map(u=>e.jsx(yj,{...u},u.type))})})},$j=()=>{const t=st("");return e.jsxs(Du,{children:[e.jsx(q,{id:"integrations",label:d("Integrations"),url:t.pathname}),e.jsx(wj,{}),e.jsx(jt,{})]})},Cj=({integration:t,property:n})=>{const s=H(),i=vs(t.properties,t.values,(r,a)=>{s(At.modify({id:t.id,key:r,value:a}))}),o=t.values[n.handle];return n.type===K.Hidden?null:e.jsx(je,{value:o,property:n,updateValue:i(n),errors:t?.errors?.[n.handle],context:t})},kr=l.div`
  flex: 1;
...
`,kj=l.div`
  ...
  flex-direction: column;
  gap: ${m.md};
`,Sj=()=>e.jsx(kr,{children:e.jsx(at,{title:d("No integrations found"),subtitle:d("To add an integration, click the button below"),icon:e.jsx(ps,{}),children:e.jsx(rt,{className:E("btn add icon"),to:"/integrations",children:d("Add integration")})})}),Lj=()=>e.jsx(kr,{children:e.jsxs(Mn,{children:[e.jsx(k,{width:120,height:20}),e.jsx("br",{}),e.jsx(k,{width:100,height:10}),e.jsx(k,{width:50,height:20}),e.jsx("br",{}),e.jsx(k,{width:200,height:10}),e.jsx(k,{width:500,height:10}),e.jsx(k,{height:30}),e.jsx("br",{}),e.jsx(k,{width:150,height:10}),e.jsx(k,{width:300,height:10}),e.jsx(k,{height:30})]})}),Fj=()=>{const{id:t}=V(),n=st(""),s=H(),{formId:i}=V(),{data:o,isFetching:r}=Go(i&&Number(i)),a=P(as.one(Number(t)));if(!o&&r)return e.jsx(Lj,{});if(!a)return e.jsx(Sj,{});const{id:c,handle:u,enabled:p,name:x,description:f,properties:b}=a;return e.jsxs(kr,{children:[e.jsx(q,{id:"integration-editor",label:x,url:n.pathname}),e.jsx("h1",{title:u,children:x}),!!f&&e.jsx("p",{children:f}),e.jsxs(kj,{children:[e.jsx(yn,{property:{label:"Enabled",handle:"enabled",type:K.Boolean},value:p,errors:a?.errors?.enabled,updateValue:()=>s(At.toggle(c))}),b.map(j=>e.jsx(Cj,{integration:a,property:j},j.handle))]})]})},Wu=g.createContext({isDragging:!1,dragType:void 0,position:void 0,dragOn:()=>{},dragOff:()=>{}}),Ej=({children:t})=>{const[n,s]=g.useState(!1),[i,o]=g.useState(),[r,a]=g.useState();return e.jsx(Wu.Provider,{value:{isDragging:n,dragType:i,position:r,dragOn:(c,u)=>{s(!0),a(u),o(c)},dragOff:()=>{s(!1),a(void 0),o(void 0)}},children:t})},ai=()=>g.useContext(Wu),Ot={currentPage:t=>{const n=t.context.page;return n?t.layout.pages.find(s=>s.uid===n):t.layout.pages.find(Boolean)},hasErrors:t=>n=>{const i=n.layout.pages.find(o=>o.uid===t).layoutUid;return n.layout.rows.filter(o=>o.layoutUid===i).some(o=>n.layout.fields.filter(r=>r.rowUid===o.uid).some(r=>bn(r.errors))),!1},focus:t=>t.context.focus,state:t=>t.context.state},Uu=l.div`
  display: flex;
  flex-direction: column;
  align-items: stretch;
  ...
  flex: 1;
  overflow: hidden;
`,Tj=()=>{const t=g.useRef(null),[n,s]=g.useState({height:0,width:0,x:0,y:0}),[i]=g.useState(()=>new ResizeObserver(([o])=>{const{width:r,height:a,x:c,y:u}=o.target.getBoundingClientRect();s({width:r,height:a,x:c,y:u})}));return g.useEffect(()=>(t.current&&i.observe(t.current),()=>i.disconnect()),[i]),{ref:t,dimensions:n}},Nj=({active:t,hovering:n})=>Y({opacity:t?1:0,background:n?h.green600:"transparent",fill:n?"#fff":h.gray300,color:n?"#fff":h.gray300,scale:n?1.2:1,rotate:t?0:30,config:s=>{switch(s){case"background":case"color":return{tension:330,friction:20};default:return{tension:330,friction:15}}}}),zj=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M480 400L288 400C279.2 400 272 392.8 272 384L272 128C272 119.2 279.2 112 288 112L421.5 112C425.7 112 429.8 113.7 432.8 116.7L491.3 175.2C494.3 178.2 496 182.3 496 186.5L496 384C496 392.8 488.8 400 480 400zM288 448L480 448C515.3 448 544 419.3 544 384L544 186.5C544 169.5 537.3 153.2 525.3 141.2L466.7 82.7C454.7 70.7 438.5 64 421.5 64L288 64C252.7 64 224 92.7 224 128L224 384C224 419.3 252.7 448 288 448zM160 192C124.7 192 96 220.7 96 256L96 512C96 547.3 124.7 576 160 576L352 576C387.3 576 416 547.3 416 512L416 496L368 496L368 512C368 520.8 360.8 528 352 528L160 528C151.2 528 144 520.8 144 512L144 256C144 247.2 151.2 240 160 240L176 240L176 192L160 192z"})}),Hu=l(_.button)`
  display: flex;
  justify-content: center;
  align-items: center;
...
`,Mj=({active:t,onClick:n,...s})=>{const i=g.useRef(null),o=Ct(i),a={...Nj({active:t,hovering:o}),...s?.style};return delete s.style,e.jsx(Hu,{type:"button",ref:i,style:a,onClick:n,...s,children:e.jsx(zj,{})})},qu=t=>{const n=H(),[{isOver:s},i]=ss(()=>({accept:[te.FieldType,te.Field],collect:r=>({isOver:r.isOver({shallow:!0})}),canDrop:(r,a)=>a.isOver({shallow:!0}),drop:r=>{r.type===te.FieldType&&n(Oe.move.newField.newRow({fieldType:r.data,layoutUid:t.uid})),r.type===te.Field&&n(Oe.move.existingField.newRow({field:r.data,layoutUid:t.uid}))}}),[t]),o=Y({to:{opacity:s?1:0,transform:s?"scaleY(1)":"scaleY(0)"},config:{tension:300}});return{dropRef:i,placeholderAnimation:o}},Ij=l.div`
  position: relative;
  flex-grow: 1;
...
`,Rj=l.div`
  ...
  font-size: 18px;
  text-align: center;
`,Pj=({field:t,layoutUid:n})=>{const s=H(),i=Pt(c=>bt.one(c,n)),o=Pt(c=>ns.inLayout(c,i?.uid)),{dropRef:r,placeholderAnimation:a}=qu(i);return g.useEffect(()=>{if(!n){const c=G();s(Cn.add({uid:c})),s(be.edit({uid:t.uid,handle:"layout",value:c}))}},[s,t.uid,n]),e.jsxs(Ij,{ref:c=>{r(c)},children:[!o.length&&e.jsx(Rj,{children:d("Add fields")}),o.map(c=>e.jsx(Sr,{row:c},c.uid)),e.jsx(Aj,{style:a,children:d("Drop a field here")})]})},Dj=t=>{const n=Y({scale:t?1:.3,opacity:t?1:0}),s=Y({scale:t?.3:1,opacity:t?0:1});return[n,s]},Bj=se`
  .options-one-line {
    display: inline-block;
    margin-right: 10px;
  }
...
`,Yu=g.memo(({field:t,row:n,index:s,width:i,isOver:o,isCurrentRow:r,isDraggingField:a,dragFieldIndex:c,hoverPosition:u})=>{const p=H(),[x,f]=g.useState(!1),{isDragging:b,drag:j,preview:y}=oy(t,s),w=iy({width:i,isDragging:b,isOver:o,isCurrentRow:r,isDraggingField:a,dragFieldIndex:c,index:s,hoverPosition:u}),v=I.limitations.can("layout.fields.clone");return e.jsxs(e.Fragment,{children:[e.jsx(Q1,{connect:y,src:ry(t.properties?.label)}),e.jsxs(Gu,{onMouseEnter:()=>f(!0),onMouseLeave:()=>f(!1),ref:$=>{j($)},style:w,children:[v&&e.jsx(Mj,{active:x,onClick:()=>{p(ye.unfocus()),p(Oe.duplicate(t,n))}}),e.jsx(Nn,{active:x,onClick:()=>{p(ye.unfocus()),p(Oe.remove(t))}}),e.jsx(ny,{field:t})]})]})});Yu.displayName="Field";const ay=l(_.div)`
  position: absolute;
  top: 0;
  bottom: 0;
  ...
  border-radius: ${S.md};
`,ly=({isActive:t,hoverPosition:n=0,fieldWidth:s=1e3})=>{const i=Y({opacity:t?1:0,x:n*s,scale:t?1:0,width:s,config:{tension:700,mass:.5}});return e.jsx(ay,{style:i})},cy=t=>Y({to:{height:t?30:20,opacity:t?1:0,transform:t?"scaleY(1)":"scaleY(0)"},delay:t?200:0,config:{tension:500}}),dy=t=>Y({to:{y:t?20:0},delay:t?200:0,config:{tension:300}}),uy=t=>{const n=H(),[{isOver:s,canDrop:i},o]=ss(()=>({accept:[te.FieldType,te.Field],collect:r=>({isOver:r.isOver({shallow:!0}),canDrop:r.canDrop()}),canDrop:(r,a)=>a.isOver({shallow:!0}),drop:r=>{r.type===te.Field&&n(Oe.move.existingField.newRow({layoutUid:t.layoutUid,field:r.data,order:t.order})),r.type===te.FieldType&&n(Oe.move.newField.newRow({fieldType:r.data,row:t}))}}),[t]);return{ref:o,isOver:s,canDrop:i}},py=(t,n,s,i,o)=>{const r=H(),[a,c]=g.useState(),[u,p]=g.useState(),[{isOver:x,isCurrentRow:f,dragFieldIndex:b,isDraggingField:j,canDrop:y},w]=ss({accept:[te.Field,te.FieldType],collect:v=>{const $=v.getItem(),C=$?.type===te.Field,F=$?.type===te.Field&&$.data.rowUid===n.uid;return{isOver:v.isOver({shallow:!0}),canDrop:v.canDrop(),dragFieldIndex:$?.type===te.Field?$.index:void 0,isCurrentRow:F,isDraggingField:C}},canDrop:(v,$)=>$.isOver({shallow:!0}),hover:(v,$)=>{if(i===void 0||o===void 0)return;const C=v.type===te.Field&&v.data.rowUid===n.uid,F=s+(C?0:1);if(F<=1)return;const M=$.getClientOffset().x-o,z=Math.floor(M/(i/F));u!==z&&p(z)},drop:v=>{v.type===te.Field?r(Oe.move.existingField.existingRow(v.data,n,u)):v.type===te.FieldType&&r(Oe.move.newField.existingRow({fieldType:v.data,row:n,order:u})),p(void 0)}},[t,n,s,u,i]);return g.useEffect(()=>{let v=s;x&&!f&&(v+=1),c(i/Math.max(1,v))},[x,s,i,f]),{ref:w,isOver:x,isCurrentRow:f,isDraggingField:j,canDrop:y,hoverPosition:u,fieldWidth:a,dragFieldIndex:b}},hy="72px",Ju=l(_.div)`
  position: relative;
...
`;l(_.div)`
  ...
  flex-grow: 1;
  flex-shrink: 0;
`;const Sr=g.memo(({row:t})=>{const n=P(Ae.inRow(t)),{ref:s,dimensions:i}=Tj(),o=i.width,r=i.x,{ref:a,isOver:c}=uy(t),u=cy(c),p=dy(c),{ref:x,isOver:f,isCurrentRow:b,isDraggingField:j,dragFieldIndex:y,hoverPosition:w,fieldWidth:v}=py(s,t,n.length,o,r),$=x(s);return e.jsxs(Ju,{ref:$,children:[e.jsx(xy,{ref:C=>{a(C)},children:e.jsx(my,{style:u})}),e.jsxs(Zu,{style:p,children:[e.jsx(ly,{isActive:f,hoverPosition:w,fieldWidth:v}),n.map((C,F)=>e.jsx(Yu,{field:C,row:t,isOver:f,hoverPosition:w,isCurrentRow:b,isDraggingField:j,dragFieldIndex:y,index:F,width:v||o},C.uid))]})]})});Sr.displayName="Row";const Lr=l.div`
  position: relative;
...
`,yy={back:"btn",save:"btn",submit:"btn btn-submit"},vy=({page:t})=>{const n=H(),{getTranslation:s}=Ce(t),{active:i,type:o,uid:r}=P(Ot.focus),a=g.useMemo(()=>i&&o===Yn.Page&&r===t.uid,[i,o,r,t.uid]),c=Xu(t),u=c.flat().map(b=>b.assetId).filter(Boolean),{data:p,isFetching:x}=fr(u,""),f=g.useCallback(b=>{const j=p?.[b]?.src;return x?e.jsx(jy,{}):e.jsx("img",{src:j,alt:`${b}Alt`})},[p,x]);return e.jsx(Lr,{children:e.jsx(ep,{className:E(a&&"active"),onClick:()=>{n(ye.setFocusedItem({type:Yn.Page,uid:t.uid}))},children:c.map((b,j)=>e.jsx(So,{className:"page-buttons",children:b.map(({handle:y,label:w,iconPosition:v,assetId:$},C)=>e.jsxs(tp,{className:yy[y],type:"button",children:[$&&v==="left"&&f($),s(`${y}Label`,w),$&&v==="right"&&f($)]},C))},j))})})},np=l.div`
  display: flex;
  flex: 1 0;
  flex-direction: column;
  gap: ${m.md};
  ...
  overflow-x: hidden;
  ${Q};
`,wy=({page:t})=>{const n=Pt(s=>bt.pageLayout(s,t?.layoutUid));return e.jsxs(np,{children:[n&&e.jsx(by,{layout:n}),e.jsx(vy,{page:t})]})},sp=l.div`
  margin: 10px 15px;
`,ip=l.div`
  display: flex;
  justify-content: flex-start;
...
`,op=()=>(t,n)=>{const s=G(),i=G(),o=n(),r=o.layout.pages.length,a=r+1,c=o.layout.pages?.[r-1];t(Cn.add({uid:i})),t(kn.add({uid:s,label:d("Page {number}",{number:a}),layoutUid:i,buttons:c?.buttons??{layout:"save back|submit",attributes:{container:{},column:{},submit:{},back:{},save:{}},submitLabel:d("Submit"),submitIcon:[],submitIconPosition:"left",back:!0,backLabel:d("Back"),backIcon:[],backIconPosition:"left",save:!1,saveLabel:d("Save"),saveIcon:[],saveIconPosition:"left"}})),t(ye.setPage(s))},$y=(t,n)=>(s,i)=>{const{layoutUid:o}=n,r=G();s(Ze.add({layoutUid:o,uid:r})),s(be.moveTo({uid:t.uid,rowUid:r,position:0})),ii(i(),s)},Cy=t=>(n,s)=>{const{uid:i,layoutUid:o}=t,r=s();if(!r.layout.layouts.find(u=>u.uid===o))return;const c=r.layout.pages.find(u=>u.uid!==i);n(ye.unfocus()),n(ye.setPage(c.uid)),r.layout.rows.filter(u=>u.layoutUid===o).forEach(u=>{const p=[];r.layout.fields.filter(x=>x.rowUid===u.uid).forEach(x=>{p.push(x.uid)}),n(be.removeBatch(p)),n(Ze.remove(u.uid))}),n(Cn.remove(o)),n(kn.remove(i))},ky=t=>e.jsx(R,{fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor",className:"w-6 h-6",...t,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M12 4.5v15m7.5-7.5h-15"})}),Sy=l.button`
  display: flex;
  align-items: center;
...
`,Ly=()=>{const t=H();return e.jsx(Sy,{className:"new-page-tab",onClick:()=>{t(op())},children:e.jsx(ky,{})})},Fy=(t,n)=>{const s=H(),{dragOff:i}=ai(),[{canDrop:o},r]=ss({accept:[te.Field],canDrop:(a,c)=>c.isOver({shallow:!0}),collect:a=>({canDrop:a.canDrop()&&t!==n.uid}),drop:a=>{a.type===te.Field&&(s($y(a.data,n)),i())}});return{ref:r,canDrop:o}},Lo=l(_.div)`
  position: relative;
`,Ey=l.button`
  position: absolute;
  top: 3px;
...
`,zy=l.div`
  ...
  transform: scale(0.8);
`,My=({page:t,index:n})=>{const s=P(Ot.currentPage),i=P(et.count),o=H(),{willTranslate:r,updateTranslation:a,getTranslation:c,hasTranslation:u,removeTranslation:p}=Ce(t),x=P(Ot.hasErrors(t.uid)),f=g.useRef(null),b=g.useRef(null),[j,y]=g.useState(!1),w=Ct(f),{canDrop:v,ref:$}=Fy(s?.uid,t);g.useEffect(()=>{j&&(b.current?.focus(),b.current?.select())},[j]);const C=()=>{const z=b.current.value||t.label;a("label",z)||o(kn.updateLabel({uid:t.uid,label:z}))},F=z=>{z.key==="Enter"&&(C(),y(!1)),z.key==="Escape"&&y(!1)},N=$t({callback:()=>{C(),y(!1)},isEnabled:j}),M=$(f);return e.jsx(Lo,{ref:M,className:"page-tab sortable-page-tab","data-page-index":n,children:e.jsxs(Fo,{ref:N,className:E(s?.uid===t.uid&&"active",x&&"errors",v&&"can-drop",j&&"is-editing"),onClick:()=>{o(ye.setPage(t.uid))},onDoubleClick:()=>y(!0),children:[j?e.jsx(Ny,{type:"text",ref:b,className:"text small",placeholder:t.label,defaultValue:c("label",t.label),onKeyUp:F}):e.jsxs(Ty,{children:[e.jsx("span",{children:c("label",t.label)}),r("label")&&e.jsx(fd,{className:E(u("label")&&"active"),onClick:()=>{u("label")&&confirm("Are you sure you want to remove the translation?")&&p("label")},children:e.jsx(yd,{})})]}),i>1&&e.jsx(zy,{children:e.jsx(Nn,{active:w&&!j,onClick:()=>{confirm(d("Are you sure?"))&&o(Cy(t))}})})]})})},Iy=()=>{const t=H(),n=P(et.all),s=g.useRef(null),i=I.editions.isAtLeast(re.Lite)&&I.limitations.can("layout.multiPageForms");return g.useEffect(()=>{if(!s.current)return;const o=Ne.create(s.current,{animation:150,ghostClass:"sortable-ghost",draggable:".sortable-page-tab",onEnd:r=>{if(r.oldDraggableIndex===void 0||r.newDraggableIndex===void 0||r.oldDraggableIndex===r.newDraggableIndex)return;const a=n[r.oldDraggableIndex];a&&t(kn.moveTo({uid:a.uid,order:r.newDraggableIndex}))}});return()=>{o.destroy()}},[t,n]),e.jsx(sp,{children:e.jsxs(ip,{ref:s,children:[n.map((o,r)=>e.jsx(My,{index:r,page:o},o.uid)),i&&e.jsx(Ly,{})]})})},Ay=()=>{const t=P(Ot.currentPage);return e.jsxs(Uu,{children:[e.jsx(Iy,{}),t&&e.jsx(wy,{page:t})]})},Fr=l.div`
  cursor: pointer;
...
`,ci=l.div`
  ...
  margin: 0;
  padding: 0;
`,cp=({title:t,disabled:n,button:s,minEdition:i,children:o})=>{const{editions:r}=I,a=i!==void 0?r.isAtLeast(i):!0;return e.jsxs(lp,{className:E(n&&"disabled"),children:[e.jsxs(Tr,{children:[t,s&&a&&e.jsx("button",{type:"button",title:s.title,onClick:s.onClick,children:s.icon})]}),o]})},Oy=()=>e.jsx(Fr,{children:e.jsxs(Qt,{children:[e.jsx(k,{width:18,height:18,borderRadius:"50%",style:{position:"relative",top:-2}}),e.jsx(k,{width:50,style:{position:"relative",top:-1}})]})}),Nr=({words:t,items:n})=>e.jsxs(lp,{children:[e.jsx(Tr,{children:t.map((s,i)=>e.jsx(k,{width:s,height:16,inline:!0,style:{marginRight:8}},i))}),e.jsx(ci,{children:ts(n).map(s=>e.jsx(Oy,{},s))})]}),di={query:t=>n=>n.search[t]},_y=()=>{const t=P(di.query(Sn.Fields));return g.useCallback(n=>{if(!t)return n;const s=n.types?.filter(o=>o.toLowerCase().includes(t.toLowerCase())),i=n.groups.grouped.map(o=>({...o,types:o.types.filter(r=>r.toLowerCase().includes(t.toLowerCase()))})).filter(o=>o.types.length>0);return{types:s||[],groups:{...n.groups,grouped:i||[]}}},[t])},Wy=()=>{const t=P(di.query(Sn.Fields));return g.useCallback(n=>t?n.filter(s=>s.label.toLowerCase().includes(t.toLowerCase())):n,[t])},Uy=()=>{const t=P(di.query(Sn.Fields));return g.useCallback(n=>t?n.map(s=>({...s,fields:s.fields.filter(i=>i.label.toLowerCase().includes(t.toLowerCase()))})).filter(s=>s.fields.length>0):n,[t])},Hy=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.xs};
  margin-bottom: ${m.md};
...
`,qy=l.div`
  text-transform: uppercase;
  font-size: 10px;
`,zr=({icon:t,label:n,dragRef:s,onClick:i})=>e.jsxs(Fr,{ref:o=>{s&&s(o)},onClick:i,title:n,children:[e.jsx(Py,{dangerouslySetInnerHTML:{__html:t}}),e.jsx(Ry,{dangerouslySetInnerHTML:{__html:n}})]}),Mr=t=>{const{dragOn:n,dragOff:s}=ai(),[{isDragging:i},o]=qo(()=>({type:te.FieldType,collect:r=>({isDragging:r.isDragging()}),item:{type:te.FieldType,data:t}}));return g.useEffect(()=>{i?n(te.FieldType):s()},[i,n,s]),{ref:o}},Qy=({fieldType:t})=>{const{icon:n,name:s}=t,i=H(),{ref:o}=Mr(t),r=()=>{i(Oe.move.newField.newRow({fieldType:t}))};return e.jsx(zr,{icon:n,label:d(s),onClick:r,dragRef:o})},Ky=(t={})=>{const n=ee(),s=t?.onSuccess;return t.onSuccess=(i,o,r,a)=>{s?.(i,o,r,a),n.invalidateQueries({queryKey:rp.all})},ce({...t,mutationFn:i=>T.post("/api/fields/types/groups",i)})},Ir=t=>e.jsxs(R,{height:"15",viewBox:"0 0 15 15",width:"15",...t,children:[e.jsx("path",{d:"m0 0h15v15h-15z",fill:"none"}),e.jsx("path",{d:"m7.5 9.61c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"}),e.jsx("path",{d:"m3.57 5.68c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"}),e.jsx("path",{d:"m11.43 5.68c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"}),e.jsx("path",{d:"m7.5 1.75c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"})]}),Vy=l.div`
  cursor: pointer;
...
`,Jy=l.div`
  color: ${h.gray500};
  margin-right: ${m.xs};
`,Wi=({typeClass:t})=>{const n=Me(t),s=g.useRef(null),i=Ct(s);if(!n)return null;const{name:o,icon:r}=n;return e.jsxs(Vy,{"data-id":t,ref:s,title:o,children:[e.jsx(Yy,{dangerouslySetInnerHTML:{__html:O.sanitize(r)}}),e.jsx(Gy,{children:o}),i&&e.jsx(Jy,{className:"remove field-item-remove",children:e.jsx(dt,{})})]})},Zy=()=>`#${(Math.floor(Math.random()*16777215)+16777216).toString(16).slice(1)}`,Xy=(t,n,s)=>{const i=g.useCallback(()=>{n(a=>({...a,groups:{...a.groups,grouped:[...a.groups.grouped,{uid:G(),label:"",color:Zy(),types:[]}]}}))},[n]),o=g.useCallback((a,c,u)=>{n(p=>({...p,groups:{...p.groups,grouped:p.groups.grouped.map(x=>x.uid===u?{...x,[a]:c}:x)}}))},[n]),r=g.useCallback(()=>{const a=Ne.get(s.current.hidden).toArray(),u=Ne.get(s.current.groupWrapper).toArray().map(p=>({...t.groups.grouped.find(f=>f.uid===p),types:Ne.get(s.current[p]).toArray()}));return{hidden:a,grouped:u}},[s,t]);return{addGroup:i,updateGroupInfo:o,syncFromRefs:r}},e7=l.div`
  display: grid;
  grid-template-columns: 1fr 1fr;
...
`;dp.defaultProps={$empty:"Click the 'Add Group' button on the right to begin."};const n7=l.div`
  flex: 1;
`,s7=l.div`
  display: flex;
  align-items: flex-start;
...
`;up.defaultProps={$empty:"Drag and drop any field here",color:h.black};const i7=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.xs};
`,o7=l.div`
...
`;Eo.defaultProps={$empty:"Drag and drop any field here"};const r7=l.div`
  display: grid;
  grid-template-columns: 1fr 1fr;
  gap: ${m.xl};
...
`,d7=l.div`
  color: ${h.warning};
`,$l=(t,n)=>n.options.handle!==".handle",u7=t=>{const n=(i,o)=>{const r=t.current[i];r&&Ne.create(r,o)};Object.entries({unassigned:{group:{name:"shared",put:$l},animation:150,sort:!1},hidden:{group:{name:"shared",put:$l},animation:150,sort:!0,filter:".field-item-remove",onFilter:o=>t.current.unassigned.appendChild(o.item)},groupWrapper:{handle:".handle",filter:".group-remove",sort:!0,animation:150,onFilter:o=>{const r=Array.from(t.current[o.item.dataset.id].children);t.current.unassigned.append(...r),o.item.remove()}}}).forEach(([o,r])=>{n(o,r)})},p7=(t,n,s)=>{t&&(Ne.create(t,{animation:150,group:{name:`group-${n}`,put:(i,o)=>o.options.handle!==".handle"},sort:!0,filter:".field-item-remove",onFilter:i=>s.current.unassigned.appendChild(i.item)}),s.current[n]=t)},h7=({color:t,onChange:n})=>{const[s,i]=g.useState(!1),o=$t({callback:()=>i(!1),isEnabled:s});return e.jsxs(l7,{ref:o,children:[e.jsx(a7,{type:"button",color:t,"aria-expanded":s,"aria-label":d("Select Color"),onClick:()=>i(r=>!r)}),s&&e.jsx(c7,{children:e.jsx(cu,{value:t,onChange:n})})]})},x7=({closeModal:t})=>{const[n,s]=g.useState({}),[i,o]=g.useState(),[r,a]=g.useState(!1),c=g.useRef({}),{addGroup:u,updateGroupInfo:p,syncFromRefs:x}=Xy(n,s,c),{data:f}=ap();g.useEffect(()=>{f&&!r&&(s(f),a(!0))},[f,r]),g.useEffect(()=>{u7(c)},[]);const b=Ky({onSuccess:()=>{t()},onError:y=>{o(y.errors)}}),j=b.isPending;return e.jsxs(ve,{style:{maxWidth:"70%"},children:[e.jsx(we,{children:e.jsx("h1",{children:d("Field Type Manager")})}),e.jsxs(e7,{children:[e.jsxs(dp,{ref:y=>{c.current.groupWrapper=y},$empty:d("Click the 'Add Group' button on the right to begin."),children:[i?.length&&e.jsx(d7,{children:d("Something went wrong!")}),n.groups?.grouped?.map(y=>e.jsxs(t7,{"data-id":y.uid,children:[e.jsxs(n7,{children:[e.jsxs(s7,{children:[e.jsx(h7,{color:y.color,onChange:w=>p("color",w,y.uid)}),e.jsx(je,{value:y.label,property:{type:K.Label,handle:y.uid},updateValue:w=>p("label",w,y.uid)})]}),e.jsx(up,{$empty:d("Drag and drop any field here"),ref:w=>{p7(w,y.uid,c)},color:y.color,children:y.types?.map(w=>e.jsx(Wi,{typeClass:w},w))})]}),e.jsxs(i7,{children:[e.jsx("button",{type:"button",className:"group-remove",children:e.jsx(dt,{})}),e.jsx("button",{type:"button",className:"handle",children:e.jsx(Ir,{})})]})]},y.uid))]}),e.jsxs(o7,{children:[e.jsx("button",{onClick:u,type:"button",className:"btn add icon dashed",children:d("Add Group")}),e.jsxs(r7,{children:[e.jsxs(wl,{className:"unassigned",children:[e.jsx("h3",{children:d("Unassigned")}),e.jsx(Eo,{$empty:d("Drag and drop any fields here. Unassigned fields will display at the bottom of the list of field types."),ref:y=>{c.current.unassigned=y},children:n.types?.map(y=>e.jsx(Wi,{typeClass:y},y))})]}),e.jsxs(wl,{children:[e.jsx("h3",{children:d("Hidden")}),e.jsx(Eo,{$empty:d("Drag and drop any fields here to hide them."),ref:y=>{c.current.hidden=y},children:n.groups?.hidden?.map(y=>e.jsx(Wi,{typeClass:y},y))})]})]})]})]}),e.jsxs($e,{children:[e.jsx("button",{type:"button",className:"btn",onClick:t,disabled:j,children:d("Cancel")}),e.jsx("button",{type:"button",className:"btn submit",children:e.jsx(Z,{loadingText:d("Saving"),loading:j,onClick:()=>b.mutate(x()),spinner:!0,children:d("Save")})})]})]})},m7=()=>{const{openModal:t}=Ke();return()=>{t(x7)}},g7=d("Field Types"),Cl=({group:t})=>{const n=Yt(),s=t.types.map(i=>{const o=n(i);return o?.visible?o&&e.jsx(Qy,{fieldType:o},i):null}).filter(Boolean);return s.length?e.jsxs(Hy,{color:t.color,children:[t.label&&e.jsx(qy,{children:d(t.label)}),e.jsx(ci,{children:s})]},t.uid):null},f7=()=>{const t=_y(),{data:n,isFetching:s,isError:i,error:o}=ap({select:t}),r=m7();return!n&&s?e.jsx(Nr,{words:[50,70],items:16}):i?e.jsx(li,{children:o.message}):e.jsxs(cp,{button:I.limitations.can("layout.fieldManager")&&{icon:e.jsx(Er,{}),title:d("Edit Manager"),onClick:r},minEdition:re.Lite,title:d(g7),children:[n.groups.grouped?.map(a=>e.jsx(Cl,{group:a},a.uid)),n?.types&&e.jsx(Cl,{group:{uid:"external",types:n.types}})]})},ui={all:["field-favorites"]},pp=({select:t}={})=>B({queryKey:ui.all,queryFn:()=>T.get("/api/fields/favorites").then(n=>n.data),staleTime:1/0,select:t}),b7=(t,n)=>{const s=Mt(n);return Object.entries(t.properties).forEach(([i,o])=>{const r=s?.properties?.find(a=>a.handle===i);r&&(r.value=o)}),s},j7=({favorite:t})=>{const{typeClass:n,label:s}=t,i=Me(n),o=b7(t,i),r=H(),{ref:a}=Mr(o);if(!i||!o)return null;const{icon:c}=i,u=()=>{r(Oe.move.newField.newRow({fieldType:o}))};return e.jsx(zr,{icon:c,label:s,onClick:u,dragRef:a})},y7=({label:t,field:n,type:s})=>{const i={label:t,properties:n.properties,typeClass:s.typeClass};return T.post("/api/fields/favorites",i)},v7=()=>{const t=ee();return ce({mutationFn:y7,onSuccess:()=>{t.invalidateQueries({queryKey:ui.all})}})},w7=(t={})=>{const n=ee(),s=t?.onSuccess;return t.onSuccess=(i,o,r,a)=>{s?.(i,o,r,a),n.invalidateQueries({queryKey:ui.all})},ce({...t,mutationFn:i=>T.post("/api/fields/favorites/update",i)})},$7=(t={})=>{const n=ee(),s=t?.onSuccess;return t.onSuccess=(i,o,r,a)=>{s?.(i,o,r,a);const c=o;n.setQueryData(ui.all,u=>u.filter(p=>p.id!==c))},ce({...t,mutationFn:i=>T.post("/api/fields/favorites/delete",{id:i})})},C7=t=>t?typeof t=="string"?e.jsx(Us,{dangerouslySetInnerHTML:{__html:O.sanitize(t)}}):e.jsx(Us,{children:t}):null,Ar=({label:t,icon:n,children:s})=>e.jsxs(zx,{children:[e.jsx(Xo,{"data-label":t,children:s}),C7(n)]}),k7=({property:t,siblingProperties:n,state:s,errors:i,updateValueCallback:o})=>{const r=vs(n,s,o);return e.jsx(je,{value:s?.[t.handle]||"",property:t,updateValue:r(t),errors:i,context:{properties:s}})},S7=t=>n=>n.section===t,L7=({field:t,errors:n,values:s,updateValueCallback:i})=>{const{data:o}=nr(),r=Me(t?.typeClass);if(!t||!r||!o)return null;const a=[],c=s?.label||d(r.name);return o.sort((u,p)=>u.order-p.order).forEach(({handle:u,label:p,icon:x})=>{const f=r.properties.filter(S7(u));f.length&&a.push(e.jsx(Ar,{label:d(p),icon:x,children:f.map(b=>e.jsx(k7,{errors:n?.[b.handle],state:s,siblingProperties:r.properties,property:b,updateValueCallback:i},b.handle))},u))}),e.jsxs(e.Fragment,{children:[e.jsxs(gn,{children:[e.jsx(Jn,{dangerouslySetInnerHTML:{__html:O.sanitize(r.icon)}}),e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(c)}})]}),e.jsx($d,{size:"small",children:e.jsx(lr,{children:a})})]})},F7=l.div`
  display: flex;
  justify-content: space-between;
...
`;l.button`
  ...
  top: 0;
  right: 0;
`;const M7=({favorite:t,label:n,errors:s,isActive:i,onClick:o,onDelete:r})=>{const a=g.useRef(null),c=Ct(a),u=Me(t.typeClass);if(!u)return null;const p=s?.length;return e.jsxs(N7,{ref:a,onClick:o,className:E(i&&"active",p&&"errors"),children:[e.jsx(z7,{dangerouslySetInnerHTML:{__html:O.sanitize(u.icon)}}),e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(n)}}),e.jsx(Nn,{active:c,onClick:r})]},t.id)},I7=({closeModal:t})=>{const{data:n}=pp(),[s,i]=g.useState(),[o,r]=g.useState({}),[a,c]=g.useState(),[u,p]=g.useState(!1),x=w7({onSuccess:()=>{t()},onError:j=>{c(j.errors)}}),f=$7({onSuccess:(j,y)=>{const w=n.filter(v=>v.id!==y)?.at(0);w?i(w):t()}});g.useEffect(()=>{if(!n||u)return;p(!0),i(n?.[0]);const j={};n.forEach(y=>{j[y.id]=y.properties}),r(j)},[n,u]);const b=x.isPending||f.isPending;return e.jsxs(ve,{style:{maxWidth:"70%"},children:[e.jsx(we,{children:e.jsx("h1",{children:d("Favorite Fields")})}),e.jsxs(F7,{children:[e.jsx(T7,{children:n.map(j=>e.jsx(M7,{favorite:j,label:o?.[j.id]?.label||j.label,errors:a?.[j.id],isActive:s?.id===j.id,onClick:()=>i(j),onDelete:()=>{confirm(`Are you sure you wish to delete the "${j.label}" field?`)&&f.mutate(j.id)}},j.id))}),e.jsx(E7,{children:s&&e.jsx(L7,{field:s,values:o?.[s.id],errors:a?.[s.id],updateValueCallback:(j,y)=>{r(w=>({...w,[s.id]:{...w[s.id],[j]:y}}))}})})]}),e.jsxs($e,{children:[e.jsx("button",{type:"button",className:"btn",onClick:t,disabled:b,children:d("Cancel")}),e.jsx("button",{type:"button",className:"btn submit",disabled:b,onClick:()=>x.mutate(o),children:e.jsx(Z,{loadingText:d("Saving"),loading:b,spinner:!0,children:d("Save")})})]})]})},A7=()=>{const{openModal:t}=Ke();return()=>{t(I7)}},R7=d("Favorites"),P7=()=>{const t=Wy(),{data:n,isFetching:s,isError:i,error:o}=pp({select:t}),r=A7(),a=Yt();return!n&&s?e.jsx(Nr,{words:[60],items:2}):i?e.jsx(li,{children:o.message}):n.length?e.jsx(cp,{title:d(R7),button:I.limitations.can("layout.favoritesManager")&&{icon:e.jsx(Er,{}),title:d("Edit Favorites"),onClick:r},children:e.jsx(ci,{children:n.map(c=>{const u=a(c.typeClass);return!u||!u?.visible?null:e.jsx(j7,{favorite:c},c.id)})})}):null},D7={all:["field-forms"]},B7=({select:t})=>B({queryKey:D7.all,queryFn:()=>T.get("/api/fields/forms").then(n=>n.data),staleTime:1/0,select:t}),O7=t=>e.jsx(R,{height:"1em",viewBox:"0 0 320 512",...t,children:e.jsx("path",{d:"M305 239c9.4 9.4 9.4 24.6 0 33.9L113 465c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l175-175L79 81c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0L305 239z"})}),_7=(t,n)=>{const s=Mt(n);return Object.entries(t.properties).forEach(([i,o])=>{const r=s?.properties?.find(a=>a.handle===i);r&&(r.value=o)}),s},W7=({field:t})=>{const{typeClass:n,label:s}=t,i=Me(n),o=_7(t,i),r=H(),{ref:a}=Mr(o);if(!i)return null;const{icon:c}=i,u=()=>{r(Oe.move.newField.newRow({fieldType:o}))};return e.jsx(zr,{icon:c,label:s,onClick:u,dragRef:a})},U7=t=>Y({maxHeight:t?200:0,paddingTop:t?8:0,paddingBottom:t?8:0,config:{tension:500,friction:t?26:40}}),H7=l.div`
  cursor: pointer;
  position: relative;
...
`,K7=({form:t})=>{const[n,s]=g.useState(!1),i=P(di.query(Sn.Fields)),o=Yt(),r=n||i.length>0,a=U7(r);return t.fields.length?e.jsxs(Q7,{className:E(r&&"open"),children:[e.jsxs(H7,{onClick:()=>s(!n),children:[t.name,e.jsx(hp,{children:e.jsx(O7,{})})]}),e.jsx(q7,{style:a,children:e.jsx(ci,{children:t.fields.map(c=>{const u=o(c.typeClass);return!u||!u?.visible?null:e.jsx(W7,{field:c},c.id)})})})]}):null},V7=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.sm};
`,G7=()=>{const{uid:t}=P(Pe.current),n=Uy(),{data:s,isFetching:i,isError:o,error:r}=B7({select:n});if(!s&&i)return null;if(o)return e.jsx(li,{children:r.message});if(!s||!s.length)return null;const a=s.filter(u=>u.uid!==t).sort((u,p)=>u.name.localeCompare(p.name)),c=a.some(u=>u.fields.length>0);return!a.length||!c?null:e.jsxs(V7,{children:[e.jsx(Tr,{children:d("Fields from other Forms")}),a.map(u=>e.jsx(K7,{form:u},u.uid))]})},Y7=()=>{const t=qt(),[n,s]=g.useState(""),i=xs(n,1e3);return g.useEffect(()=>{t(Eh.update({type:Sn.Fields,query:i}))},[i,t]),[n,s]},xp=t=>e.jsx(R,{viewBox:"0 0 512 512",...t,children:e.jsx("path",{fill:"currentColor",d:"M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352c79.5 0 144-64.5 144-144s-64.5-144-144-144S64 128.5 64 208s64.5 144 144 144z"})}),mp=l.div`
  position: relative;
  z-index: 1;
...
`,bp=l.div`
  ...
  color: ${h.gray400};
`,Z7=()=>{const[t,n]=Y7();return e.jsx(mp,{children:e.jsxs(gp,{children:[e.jsx(bp,{children:e.jsx(xp,{})}),e.jsx(fp,{type:"text",placeholder:d("Search"),className:"fullwidth text",value:t,onChange:s=>{n(s.target.value)}})]})})},X7=()=>{nr();const t=P(Ae.count),n=I.editions.is(re.Express)&&t>=I.limits.fields;return e.jsxs(Dy,{className:E(n&&"fields-disabled"),children:[e.jsx(Z7,{}),e.jsx(P7,{}),e.jsx(f7,{}),I.limitations.can("layout.formsFields")&&e.jsx(G7,{})]})},jp=l.div`
  position: relative;
  display: flex;
  gap: 0;
  ...
  background: #fff;
`,To=t=>e.jsx(R,{viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zM175 175c9.4-9.4 24.6-9.4 33.9 0l47 47 47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47 47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47-47-47c-9.4-9.4-9.4-24.6 0-33.9z"})}),ev=t=>e.jsx(R,{viewBox:"0 0 576 512",...t,children:e.jsx("path",{d:"M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9l2.6-2.4C267.2 438.6 256 404.6 256 368c0-97.2 78.8-176 176-176c28.3 0 55 6.7 78.7 18.5c.9-6.5 1.3-13 1.3-19.6v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5zM576 368c0-79.5-64.5-144-144-144s-144 64.5-144 144s64.5 144 144 144s144-64.5 144-144zm-76.7-43.3c6.2 6.2 6.2 16.4 0 22.6l-72 72c-6.2 6.2-16.4 6.2-22.6 0l-40-40c-6.2-6.2-6.2-16.4 0-22.6s16.4-6.2 22.6 0L416 385.4l60.7-60.7c6.2-6.2 16.4-6.2 22.6 0z"})}),tv=t=>e.jsx(R,{viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M244 84L255.1 96L267.1 84.02C300.6 51.37 347 36.51 392.6 44.1C461.5 55.58 512 115.2 512 185.1V190.9C512 232.4 494.8 272.1 464.4 300.4L283.7 469.1C276.2 476.1 266.3 480 256 480C245.7 480 235.8 476.1 228.3 469.1L47.59 300.4C17.23 272.1 0 232.4 0 190.9V185.1C0 115.2 50.52 55.58 119.4 44.1C164.1 36.51 211.4 51.37 244 84C243.1 84 244 84.01 244 84L244 84zM255.1 163.9L210.1 117.1C188.4 96.28 157.6 86.4 127.3 91.44C81.55 99.07 48 138.7 48 185.1V190.9C48 219.1 59.71 246.1 80.34 265.3L256 429.3L431.7 265.3C452.3 246.1 464 219.1 464 190.9V185.1C464 138.7 430.4 99.07 384.7 91.44C354.4 86.4 323.6 96.28 301.9 117.1L255.1 163.9z"})}),nv=({category:t,handle:n,error:s})=>{const i=s.errors?.[t]?.[n];return i?e.jsx("ul",{className:"errors",children:i.map((o,r)=>e.jsxs("li",{children:[e.jsx("span",{className:"visually-hidden",children:"Error:"}),o]},r))}):null},sv=l.div`
  display: flex;
  justify-content: space-between;
  flex-direction: column;
  gap: ${m.lg};
`,iv=l.div`
  display: flex;
  justify-content: center;
`,ov=({field:t,type:n,mutation:s})=>{const[i,o]=g.useState("");return g.useEffect(()=>{o(t.properties.label||n?.name),s.reset()},[t.uid,n?.name]),e.jsxs(sv,{children:[e.jsx(ls,{children:e.jsx(Dt,{property:{label:d("Create a favorite"),handle:t.properties?.handle,flags:[],placeholder:t.properties?.label,type:K.String},value:i,updateValue:r=>o(r)})}),e.jsx(iv,{children:e.jsx("button",{type:"button",disabled:s.isPending,className:E("btn fullwidth",!s.isSuccess&&"submit",s.isPending&&"disabled"),onClick:()=>{s.mutate({label:i,field:t,type:n})},children:e.jsx(Z,{spinner:!0,loading:s.isPending,loadingText:"Saving",children:d(s.isSuccess?"Saved!":"Favorite")})})}),s.isError&&e.jsx(nv,{category:"favorites",handle:"name",error:s.error})]})},yp=l(_.div)`
  position: absolute;
  top: 24px;
  right: -16px;
...
`,dv=({field:t})=>{const n=Me(t?.typeClass),s=v7(),[i,o]=g.useState(!1),[r,a]=g.useState(!1);g.useEffect(()=>{o(!1),a(!1),s.reset()},[t?.uid,s.reset]);const c=Y({to:{opacity:i?1:0,scale:i?1:1.1,rotate:i?0:-10},config:{tension:700}}),u=Y({to:{scale:r?1.2:1},config:{tension:600,mass:3}}),p=$t({callback:()=>{o(!1),a(!1)},isEnabled:i});return os(()=>{o(!1),a(!1)},i),!t?.uid||n.type==="group"?null:e.jsxs(cv,{className:E(i&&"active"),ref:p,children:[e.jsxs(lv,{style:u,onClick:()=>o(!i),onMouseOver:()=>a(!0),onMouseOut:()=>a(!1),children:[s.isSuccess&&e.jsx(ev,{}),!s.isSuccess&&e.jsx(tv,{})]}),e.jsxs(yp,{style:c,children:[e.jsx(rv,{}),e.jsx(av,{children:e.jsx(ov,{field:t,type:n,mutation:s})})]})]})},uv=({property:t,field:n,autoFocus:s})=>{const i=H(),o=Me(n.typeClass),{getTranslation:r,updateTranslation:a,canUseTranslationValue:c}=Ce(n),u=P(Ae.one(n.uid)),p={id:u.id,...u?.properties||{}},x=vs(o.properties,p,(j,y)=>{a(j,y)||i(be.edit({uid:n.uid,handle:j,value:y}))}),f=n.properties?.[t.handle],b=r(t.handle,f);return e.jsx(je,{autoFocus:s,value:c(t)?b:f,property:t,updateValue:x(t),errors:n.errors?.[t.handle],context:n})},Ui=l.div`
  display: flex;
  flex-direction: column;

  height: 100%;
  background: ${h.gray050};
`,pv=t=>n=>n.section===t,hv=({uid:t})=>{const n=H(),{data:s,isFetching:i}=nr(),o=P(Ae.one(t)),r=Me(o?.typeClass),a=g.useMemo(()=>{const c=[];return s?.sort((u,p)=>u.order-p.order)?.forEach(({handle:u,label:p,icon:x},f)=>{const b=r?.properties.filter(pv(u)).filter(j=>j.visible);b?.length&&c.push(e.jsx(Ar,{label:d(p),icon:x,children:b.map((j,y)=>e.jsx(uv,{autoFocus:f===0&&y===0,field:o,property:j},j.handle))},u))}),c},[s,r,o]);return!o||!r?e.jsx(Ui,{}):!s&&i?e.jsxs(Ui,{children:[e.jsxs(gn,{children:[e.jsx(Jn,{dangerouslySetInnerHTML:{__html:O.sanitize(r.icon)}}),e.jsx("span",{children:d(r.name)})]}),e.jsx(Zn,{children:e.jsx(k,{})})]}):e.jsxs(Ui,{children:[e.jsx(no,{onClick:()=>n(ye.unfocus()),children:e.jsx(To,{})}),I.limitations.can("layout.favorite")&&e.jsx(dv,{field:o}),e.jsxs(gn,{children:[e.jsx(Jn,{dangerouslySetInnerHTML:{__html:O.sanitize(r.icon)}}),e.jsx("span",{children:d(r.name)})]}),e.jsx(Zn,{children:a})]})},xv=({property:t,page:n})=>{const s=H(),{getTranslation:i,updateTranslation:o}=Ce(n),r=t.handle,a=p=>{o(r,p)||s(kn.editButtons({uid:n.uid,key:r,value:p}))},c=n.buttons?.[r],u=typeof c=="string"?i(r,c):c;return e.jsx(je,{value:u,property:t,updateValue:a,context:n})},Sl=l.div`
  display: flex;
  flex-direction: column;

  height: 100%;
  background: ${h.gray050};
`,mv=t=>n=>n.section===t,gv=({uid:t})=>{const n=H(),s=P(et.one(t)),{data:i,isFetching:o}=gd();if(!i&&o)return e.jsxs(Sl,{children:[e.jsx(no,{onClick:()=>n(ye.unfocus()),children:e.jsx(To,{})}),e.jsx(gn,{children:e.jsx("span",{children:s.label})}),e.jsxs(Zn,{style:{paddingTop:20},children:[e.jsx(k,{height:30}),e.jsx(k,{height:30}),e.jsx(k,{height:30})]})]});if(!s)return null;const r=[];return i.sections.forEach(({handle:a,label:c,icon:u})=>{const p=i.properties.filter(mv(a)).filter(x=>x.visible);p.length&&r.push(e.jsx(Ar,{label:c,icon:u,children:p.map(x=>e.jsx(xv,{page:s,property:x},x.handle))},a))}),e.jsxs(Sl,{children:[e.jsx(no,{onClick:()=>n(ye.unfocus()),children:e.jsx(To,{})}),e.jsx(gn,{children:e.jsx("span",{children:s.label})}),e.jsx(Zn,{children:r})]})},fv=()=>{const t=H(),n=P(Ot.focus),{active:s,type:i}=n;os(()=>t(ye.unfocus()),s);const o=$t({callback:()=>{t(ye.unfocus())},isEnabled:s,excludeClassNames:["field-layout","page-buttons","page-tab","save-button","main-tabs","editable-content","dropdown-rollout","breadcrumbs","tagify__dropdown","tox","elementselectormodal"]}),r=oc(s?[n]:null,{from:{transform:"translate3d(100%, 0, 0)",opacity:1},enter:{transform:"translate3d(0%, 0, 0)",opacity:1,zIndex:2},leave:{transform:"translate3d(-100%, 0, 0)"},config:{tension:500,friction:50}});return e.jsx($d,{size:"small",children:e.jsx(Tx,{$active:s,ref:o,children:e.jsx($r,{message:`Could not load property editor for "${i}" type`,children:r((a,c)=>e.jsxs(Nx,{style:a,children:[!!c&&c.type==="field"&&e.jsx(hv,{uid:c.uid}),!!c&&c.type==="page"&&e.jsx(gv,{uid:c.uid})]}))})})})},bv=()=>{const t=st("");return e.jsxs(Ej,{children:[e.jsx(q,{id:"layout",label:d("Layout"),url:t.pathname}),e.jsxs(jp,{children:[e.jsxs(De,{$noPadding:!0,children:[e.jsx(fv,{}),e.jsx(X7,{})]}),e.jsx(Ay,{})]})]})},pi=l.div`
  position: relative;
  flex: 1;
...
`,vp=l.div`
  ...
  flex-direction: column;
  gap: ${m.md};
`,jv=()=>{const t=st(""),n=yr(),{templates:s}=vr(""),{templates:{canCreate:i,method:o}}=I,r=()=>{n({type:"form"})};return e.jsxs(pi,{children:[e.jsx(q,{id:"notification-manager",label:d("Manager"),url:t.pathname}),e.jsxs(vp,{children:[e.jsx("h1",{children:d("Notification Manager")}),e.jsx(Eu,{children:e.jsx(Co,{value:"",title:d("Form Templates"),templates:s.form,openEditOnClick:!0,onClick:()=>{},canCreate:i&&o!==is.Global,onCreate:r})})]})]})},yv=l.div`
  display: flex;
  height: 100%;
`,vv=(t,n)=>(s,i)=>{const{className:o,properties:r,newInstanceName:a}=t,c={};r.forEach(x=>{c[x.handle]=x.value});const u=In.count.ofType(o)(i()),p=`${a} notification ${u+1}`;s(Rt.add({uid:n,className:o,enabled:!0,...c,name:p}))},wv=t=>n=>{n(Rt.remove(t.uid))},Hi=20,hi=l.div`
  display: block;
  width: ${Hi}px;
  height: ${Hi}px;
  font-size: ${Hi}px;
...
`,kv=l.div`
  ...
  color: ${h.gray300};
`,Sv=({type:t,children:n})=>{const s=ne(),i=H(),{setLastTab:o}=We("notifications"),{name:r,edition:a}=t,{isAtLeast:c}=I.editions;return c(t.edition)?e.jsxs(No,{children:[e.jsxs(zo,{children:[e.jsx(Ll,{children:d(r)}),e.jsx(Cv,{type:"button",className:E("btn","add","icon","small","dashed"),onClick:()=>{const u=G();i(vv(t,u)),o(u),s(u)},children:d("New")})]}),e.jsx(Mo,{children:n})]}):e.jsxs(No,{children:[e.jsx(zo,{children:e.jsx(Ll,{children:d(r)})}),e.jsx(Mo,{style:{opacity:.7},children:e.jsxs(Rr,{className:"flex",to:Craft.getCpUrl("plugin-store/freeform"),target:"_blank",children:[e.jsx(hi,{className:E("disabled-icon"),children:e.jsx("i",{className:"fa-thin fa-star-exclamation"})}),e.jsx("span",{className:E("edition-label"),children:d("Upgrade to {edition} to enable.",{edition:dc(a)})})]})})]})},Lv=()=>e.jsx(Mn,{children:e.jsxs(No,{children:[e.jsx(zo,{children:e.jsx(k,{width:50})}),e.jsx(Mo,{style:{padding:14},children:[0,1,2].map(t=>e.jsxs("div",{style:{display:"flex",gap:10,alignItems:"center"},children:[e.jsx(k,{width:20,height:20,circle:!0}),e.jsx("div",{style:{flexGrow:2},children:e.jsx(k,{width:100,style:{top:2}})}),e.jsx(k,{width:10,height:10,circle:!0,style:{top:6}})]},t))})]})}),Fv=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M535.6 85.7C513.7 63.8 478.3 63.8 456.4 85.7L432 110.1L529.9 208L554.3 183.6C576.2 161.7 576.2 126.3 554.3 104.4L535.6 85.7zM236.4 305.7C230.3 311.8 225.6 319.3 222.9 327.6L193.3 416.4C190.4 425 192.7 434.5 199.1 441C205.5 447.5 215 449.7 223.7 446.8L312.5 417.2C320.7 414.5 328.2 409.8 334.4 403.7L496 241.9L398.1 144L236.4 305.7zM160 128C107 128 64 171 64 224L64 480C64 533 107 576 160 576L416 576C469 576 512 533 512 480L512 384C512 366.3 497.7 352 480 352C462.3 352 448 366.3 448 384L448 480C448 497.7 433.7 512 416 512L160 512C142.3 512 128 497.7 128 480L128 224C128 206.3 142.3 192 160 192L256 192C273.7 192 288 177.7 288 160C288 142.3 273.7 128 256 128L160 128z"})}),Ev=({icon:t,notification:{uid:n}})=>{const{setLastTab:s}=We("notifications"),{name:i,enabled:o,errors:r}=P(In.one(n));return e.jsxs(Rr,{onClick:()=>s(n),to:`${n}`,className:E(bn(r)&&"errors",!o&&"inactive"),children:[t&&e.jsx(hi,{dangerouslySetInnerHTML:{__html:O.sanitize(t)}}),e.jsx(wp,{children:i}),e.jsx($v,{$enabled:o,className:E("status-dot")})]})},Tv=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.sm};
  height: 100%;
  ...
  overflow-y: auto;
  ${Q};
`,Nv=I.templates.method,zv=()=>{const t=I.limitations,{formId:n,uid:s}=V(),{pathname:i}=Ht(),o=ne(),{lastTab:r,setLastTab:a}=We("notifications"),{data:c,isFetching:u}=Kc();Yo(n?Number(n):void 0);const p=P(In.all);return g.useEffect(()=>{!s&&!i.endsWith("/manager")&&r&&o(r)},[s,r,o,i]),g.useEffect(()=>{if(!i.endsWith("/manager")&&!s&&!r&&c&&p){const x=p.find(Boolean);x&&(a(x.uid),o(x.uid))}},[s,c,p,r,o,i,a]),!c&&u?e.jsx(De,{children:e.jsx(Lv,{})}):!c&&!u?e.jsx(e.Fragment,{children:"Empty"}):e.jsx(De,{$lean:!0,children:e.jsxs(Tv,{children:[c.filter(x=>t.can(`notifications.tab.${x.className}`)).map(x=>e.jsxs(Sv,{type:x,children:[p?.filter(f=>f.className===x.className).map(f=>e.jsx(Ev,{icon:x.icon,notification:f},f.uid)),!p?.filter(f=>f.className===x.className)?.length&&e.jsx(kv,{children:d("None configured")})]},x.className)),Nv!==is.Global&&e.jsxs(Rr,{onClick:()=>a(s),to:"manager",children:[e.jsx(hi,{children:e.jsx(Fv,{})}),e.jsx(wp,{children:d("Template Manager")})]})]})})},Mv=()=>{const t=st("");return e.jsxs(yv,{children:[e.jsx(q,{id:"notifications",label:d("Notifications"),url:t.pathname}),e.jsx(zv,{}),e.jsx(jt,{})]})},Iv=({notification:t,property:n})=>{const s=H(),{uid:i}=t,{handle:o}=n,r=c=>{s(Rt.modify({uid:i,key:o,value:c}))},a=t?.[n.handle];return e.jsx(je,{value:a,property:n,updateValue:r,errors:t.errors?.[n.handle],context:t})},Av=t=>e.jsxs(R,{height:"1em",viewBox:"0 0 512 512",...t,children:[e.jsx("defs",{children:e.jsx("style",{children:".fa-secondary{opacity:0.2;fill:#a1a5aa;}.fa-primary{fill:#a6a8ab;}"})}),e.jsx("path",{className:"fa-primary",d:"M380.7 185.8c5.1-6.7 4.2-16.2-2.1-21.8s-15.9-5.3-21.9 .7l-179 179-13 13c-3 3-4.7 7.1-4.7 11.3v8 56 48c0 13.2 8.1 25 20.3 29.8s26.2 1.6 35.2-8.1L284 427.7l-60-25V389.4L380.7 185.8z"}),e.jsx("path",{className:"fa-secondary",d:"M498.1 5.6c10.1 7 15.4 19.1 13.5 31.2l-64 416c-1.5 9.7-7.4 18.2-16 23s-18.9 5.4-28 1.6L224 402.7V389.4L380.7 185.8c5.2-6.7 4.2-16.4-2.3-21.9s-16.1-5.1-22 1.1L178.8 350.6l-14.1 14.1c-3 3-4.7 7.1-4.7 11.3l-28.3-11.8-112-46.7C8.4 312.8 .8 302.2 .1 290s5.5-23.7 16.1-29.8l448-256c10.7-6.1 23.9-5.5 34 1.4z"})]}),Rv=()=>e.jsx(pi,{children:e.jsx(at,{title:d("No notifications found"),subtitle:d("To add a notification, use the sidebar on the left"),icon:e.jsx(Av,{})})});l.div`
  display: flex;
  gap: ${m.md};
`;const Pv=()=>e.jsx(pi,{children:e.jsxs(Mn,{children:[e.jsx(k,{width:120,height:20}),e.jsx("br",{}),e.jsx(k,{width:100,height:10}),e.jsx(k,{width:50,height:20}),e.jsx("br",{}),e.jsx(k,{width:200,height:10}),e.jsx(k,{width:500,height:10}),e.jsx(k,{height:30}),e.jsx("br",{}),e.jsx(k,{width:150,height:10}),e.jsx(k,{width:300,height:10}),e.jsx(k,{height:30})]})}),Dv=t=>e.jsx(R,{fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor",className:"w-6 h-6",...t,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"})}),Bv=({hovering:t})=>Y({opacity:1,background:t?h.error:"transparent",color:t?"#fff":h.gray300,scale:t?1.2:1,config:n=>{switch(n){case"background":case"color":return{tension:330,friction:20};default:return{tension:330,friction:15}}}}),Ov=l(_.button)`
  position: absolute;
  top: 15px;
  right: 20px;
  z-index: 2;
...
`,_v=({notification:t})=>{const n=ne(),s=H(),[i,o]=g.useState(!1),r=Bv({hovering:i});return e.jsx(Ov,{type:"button",style:r,onMouseEnter:()=>o(!0),onMouseLeave:()=>o(!1),onClick:()=>{s(wv(t)),n("..")},children:e.jsx(Dv,{})})},Wv=()=>{const{formId:t,uid:n}=V(),s=st(""),{data:i}=Kc(),{data:o,isFetching:r}=Yo(t?Number(t):void 0),a=P(In.one(n));if(!o&&r)return e.jsx(Pv,{});if(!a)return e.jsx(Rv,{});const c=i?.find(u=>u.className===a.className)?.properties||[];return e.jsxs(pi,{children:[e.jsx(q,{id:"notification",label:a.name,url:s.pathname}),e.jsx(_v,{notification:a}),e.jsx(vp,{children:c.map(u=>e.jsx(Iv,{notification:a,property:u},u.handle))})]})},Pr={one:(t,n)=>s=>s.rules.buttons?.items?.find(i=>i.page===t&&i.button===n),hasRule:(t,n)=>X(s=>s.rules.buttons.items,s=>!!s.find(i=>i.page===t&&i.button===n)),hasFieldInRule:t=>X(n=>n.rules.buttons.items,n=>!!n.find(s=>s.conditions.some(i=>i.field===t)))},Dr=({value:t,onChange:n})=>e.jsx("div",{className:"select",children:e.jsxs("select",{value:t,onChange:s=>n?.(s.target.value),children:[e.jsx("option",{value:mn.Show,children:d("show")}),e.jsx("option",{value:mn.Hide,children:d("hide")})]})}),tt=l.div`
  position: relative;
  ...
  overflow-y: auto;
  ${Q};
`,Uv=t=>e.jsx(R,{fill:"none",viewBox:"0 0 24 24",strokeWidth:"1.5",stroke:"currentColor",className:"w-6 h-6",...t,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0"})}),Hv=({hovering:t})=>Y({opacity:1,background:t?h.error:"transparent",color:t?"#fff":h.gray300,scale:t?1.2:1,config:n=>{switch(n){case"background":case"color":return{tension:330,friction:20};default:return{tension:330,friction:15}}}}),qv=l(_.button)`
  position: absolute;
  top: 15px;
  right: 20px;
  z-index: 2;
...
`,xi=({onClick:t})=>{const[n,s]=g.useState(!1),i=Hv({hovering:n});return e.jsx(qv,{type:"button",style:i,onMouseEnter:()=>s(!0),onMouseLeave:()=>s(!1),onClick:t,children:e.jsx(Uv,{})})},mi=({label:t})=>{const n=P(Ae.all),s=n.length>0?n[0].uid:"",i=n.length>1?n[1].uid:"",o={combinator:Be.Or,conditions:[{field:s,operator:ie.Contains,value:"John Doe",uid:"test-1"},{field:i,operator:ie.EndsWith,value:"@gmail.com",uid:"test-2"}],display:mn.Show};return e.jsxs(tt,{children:[e.jsx(lt,{children:e.jsx(Z,{children:e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(t)}})})}),e.jsxs(Qv,{children:[e.jsx(Vv,{dangerouslySetInnerHTML:{__html:O.sanitize(d('<a href="{link}" target="_blank">Upgrade to Freeform Pro</a> to create conditional rules.',{link:Craft.getCpUrl("plugin-store/freeform")}))}}),e.jsxs(Kv,{children:[e.jsxs(sn,{children:[e.jsx(Dr,{value:o.display}),d("this field when"),e.jsx(tn,{value:o.combinator}),d("of the following rules match:")]}),e.jsx(nn,{conditions:o.conditions,buttonLabel:"Upgrade to Freeform Pro to create conditional rules."})]})]})]})},Qv=l.div`
  position: relative;
`,Kv=l.div`
  user-select: none;
  pointer-events: none;
...
`,s9=()=>{const t=P(bt.cartographed.fullLayoutList);return e.jsx(Mn,{children:t.map((n,s)=>e.jsxs("div",{children:[e.jsx("div",{style:{marginBottom:14},children:e.jsx(k,{width:"100%",height:30})}),n.map((i,o)=>e.jsx(n9,{style:{display:"flex"},children:i.map((r,a)=>e.jsx(k,{width:"100%",height:28},a))},o))]},s))})},Cp=l.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  flex-wrap: nowrap;
...
`,r9=({field:t})=>{const n=I.limitations.can("rules.tab.fields"),{uid:s,button:i}=V(),o=ne(),r=Ht(),{setLastTab:a}=We("rules"),c=Me(t?.typeClass),u=s===t.uid,p=P(pn.one(s)),x=P(Br.one(s)),f=P(Or.one),b=P(Pr.one(s,i)),j=P(pn.hasRule(t.uid)),y=r.pathname.endsWith("/rules/submit"),w=P(pn.isInCondition(t.uid)),v=p?.conditions.find($=>$.field===t.uid)||x?.conditions.find($=>$.field===t.uid)||y&&f?.conditions.find($=>$.field===t.uid)||i&&b?.conditions.find($=>$.field===t.uid);return t?.properties===void 0?null:e.jsxs(o9,{onClick:$=>{if($.stopPropagation(),n){const C=s===t.uid?"":`field/${t.uid}`;a(C),o(C)}},className:E(c?.type==="group"&&"group",u&&"active",j&&"has-rule",w&&"is-in-condition",v&&"is-in-condition-active",!n&&"read-only",Dn.negative.includes(v?.operator)&&"not-equals"),children:[e.jsxs(Cp,{children:[e.jsx(kp,{dangerouslySetInnerHTML:{__html:O.sanitize(c?.icon)}}),e.jsx(i9,{dangerouslySetInnerHTML:{__html:O.sanitize(t.properties.label||c?.name)}})]}),c?.type==="group"&&e.jsx(Sp,{children:e.jsx(Lp,{layoutUid:t.properties.layout})})]})},a9=({row:t})=>{const n=P(Ae.inRow(t));return e.jsx($p,{children:n.map(s=>e.jsx(r9,{field:s},s.uid))})},l9=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.xs};
`,Lp=({layoutUid:t})=>{const n=Pt(i=>bt.one(i,t)),s=Pt(i=>ns.inLayout(i,n?.uid));return!n||!s.length?null:e.jsx(l9,{children:s.map(i=>e.jsx(a9,{row:i},i.uid))})},c9=l.div`
  display: flex;
  justify-content: space-between;
...
`,u9=({page:t,button:{handle:n,label:s}})=>{const i=I.limitations.can("rules.tab.buttons"),{uid:o,button:r}=V(),a=ne(),{setLastTab:c}=We("rules"),u=o===t.uid&&n===r,p=P(Pr.hasRule(t.uid,n));return i?e.jsx(Fp,{type:"button",className:E(n,u&&"active",p&&"has-rule"),onClick:()=>{const x=u?"":`page/${t.uid}/buttons/${n}`;c(x),a(x)},children:d(s)}):null},p9=({page:t})=>{const n=Xu(t);return e.jsx(c9,{children:n.map((s,i)=>e.jsx(d9,{className:"page-buttons",children:s.map((o,r)=>e.jsx(u9,{button:o,page:t},r))},i))})},h9=t=>e.jsx(R,{height:"1em",viewBox:"0 0 384 512",...t,children:e.jsx("path",{d:"M64 496c-26.5 0-48-21.5-48-48V64c0-26.5 21.5-48 48-48H204.1c1.3 0 2.6 .1 3.9 .2V136c0 22.1 17.9 40 40 40H367.8c.2 1.3 .2 2.6 .2 3.9V448c0 26.5-21.5 48-48 48H64zM358.6 157.3c.9 .9 1.7 1.8 2.4 2.7H248c-13.3 0-24-10.7-24-24V22.9c1 .8 1.9 1.6 2.7 2.4L358.6 157.3zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V179.9c0-12.7-5.1-24.9-14.1-33.9L238.1 14.1c-9-9-21.2-14.1-33.9-14.1H64zm40 256c-4.4 0-8 3.6-8 8s3.6 8 8 8H280c4.4 0 8-3.6 8-8s-3.6-8-8-8H104zm0 64c-4.4 0-8 3.6-8 8s3.6 8 8 8H280c4.4 0 8-3.6 8-8s-3.6-8-8-8H104zm0 64c-4.4 0-8 3.6-8 8s3.6 8 8 8H280c4.4 0 8-3.6 8-8s-3.6-8-8-8H104z"})}),x9=l.div`
  display: flex;
  flex: 1;
  flex-direction: column;
`,m9=l.button`
...
`,f9=l.div``,b9=l.label`
  ...
  text-overflow: ellipsis;
  white-space: nowrap;
`,j9=({page:t})=>{const n=I.limitations.can("rules.tab.pages"),{uid:s,button:i}=V(),o=ne(),{setLastTab:r}=We("rules"),a=P(Br.hasRule(t.uid)),{label:c,uid:u}=t,p=s===u&&!i;return e.jsxs(x9,{children:[e.jsxs(m9,{onClick:()=>{if(n){const x=p?"":`page/${u}`;r(x),o(x)}},className:E(p&&"active",a&&"has-rule",!n&&"read-only"),children:[e.jsx(f9,{children:e.jsx(h9,{})}),e.jsx(b9,{children:c})]}),e.jsxs(g9,{className:E(p&&"active",a&&"has-rule"),children:[e.jsx(Lp,{layoutUid:t.layoutUid}),e.jsx(p9,{page:t})]})]})},y9=t=>e.jsx(R,{viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z"})}),v9=l.div`
  cursor: pointer;
...
`,w9=l.label`
  ...
  text-overflow: ellipsis;
  white-space: nowrap;
`,$9=()=>{const t=I.limitations.can("rules.tab.submit"),n=ne(),s=Ht(),{setLastTab:i}=We("rules"),o=P(Or.hasRule),r=s.pathname.endsWith("/rules/submit");return t?e.jsxs(v9,{onClick:()=>{i("submit"),n("submit")},className:E(r&&"active",o&&"has-rule"),children:[e.jsx("div",{children:e.jsx(y9,{})}),e.jsx(w9,{children:d("Submit Form Early")})]}):null},C9=()=>{const{formId:t}=V(),{isFetching:n}=Tn(Number(t||0)),s=P(et.all),{lastTab:i}=We("rules"),o=ne();return g.useEffect(()=>{i&&o(i)},[i,o]),e.jsx(De,{children:e.jsxs(t9,{children:[n&&e.jsx(s9,{}),!n&&s.map(r=>e.jsx(j9,{page:r},r.uid)),s.length>1&&e.jsx($9,{})]})})},k9=()=>{const t=st("");return e.jsxs(e9,{children:[e.jsx(q,{id:"rules",label:d("Rules"),url:t.pathname}),e.jsx(C9,{}),e.jsx(jt,{})]})},_r=t=>{const n=g.useCallback(s=>{if(s.key==="s"){const i=window.navigator.platform.match(/Mac/);return i&&!s.metaKey||!i&&!s.ctrlKey?void 0:(s.preventDefault(),t(),!1)}},[t]);ft({callback:n,type:"keydown"},[t])},S9=({closeModal:t,data:n})=>{const s=()=>{t(),window.location.href=n?.url};return e.jsx(wt,{closeModal:t,children:e.jsxs(ve,{children:[e.jsx(we,{children:e.jsx("h1",{children:d("Leave the form builder?")})}),e.jsx("div",{style:{padding:20},children:d("You are about to leave the form builder. Any unsaved changes may be lost if you continue.")}),e.jsxs($e,{children:[e.jsx("button",{type:"button",className:"btn cancel",onClick:t,children:d("Cancel")}),e.jsx("button",{type:"button",className:"btn submit",onClick:s,children:d("Continue")})]})]})})},L9=()=>{const t=I.limitations,n=H(),s=P(Pe.current),i=P(Ot.state),{openModal:o}=Ke(),r=P(Pe.errors),a=P(Ae.hasErrors),c=P(In.errors.any),u=P(as.errors.any),{getTranslation:p}=Ce({...s.settings.general,namespaceType:"settings",namespace:"general"}),x=p("name",s.settings.general?.name),{data:f}=Gt(),b=()=>{n(Ec())};_r(b);const j=s.settings?.general?.storeData!==!1,y=!!s.canManageSubmissions,w=!!s.id&&j&&y,v=s.submissionCount??0,C=new URLSearchParams(window.location.search).get("site"),F=`submissions?${C?`site=${C}&`:""}source=form:${s.id}`,N=M=>{M.preventDefault(),s?.id&&o(S9,{url:me(F)})};return e.jsxs(Kd,{children:[e.jsx(q,{id:"form-name",label:s.name||"Create a new Form",url:`/forms/${s.id}`}),e.jsx(Vd,{children:e.jsx(Gd,{children:x||d("Create a new Form")})}),e.jsxs(fs,{className:"main-tabs",children:[e.jsx(he,{to:`/forms/${s.id}`,end:!0,className:E(a&&"errors"),children:e.jsx("span",{children:d("Layout")})}),t.can("notifications.tab")&&e.jsx(he,{to:`/forms/${s.id}/notifications`,className:E(c&&"errors"),children:e.jsx("span",{children:d("Notifications")})}),t.can("rules.tab")&&e.jsx(he,{to:`/forms/${s.id}/rules`,children:e.jsx("span",{children:d("Rules")})}),I.limitations.can("integrations.tab")&&e.jsx(he,{to:`/forms/${s.id}/integrations`,className:E(u&&"errors"),children:e.jsx("span",{children:d("Integrations")})}),I.editions.is(re.Pro)&&s.formMonitor.enabled&&e.jsx(he,{to:`/forms/${s.id}/form-monitor`,children:e.jsxs("span",{children:[d("Monitoring"),e.jsx(Kf,{children:d("BETA")})]})}),f&&I.limitations.can("settings.tab")&&e.jsx(he,{to:`/forms/${s.id}/settings`,className:E((bn(r?.general)||bn(r?.behavior))&&"errors"),children:e.jsx("span",{children:d("Settings")})})]}),w&&e.jsxs(Qf,{href:me(F),onClick:N,title:d("View submissions"),className:"go",children:[v," ",d("submissions")]}),e.jsx(Yd,{children:e.jsx(qf,{type:"button",onClick:b,disabled:i===It.Processing,className:E("btn","submit","save-button"),children:e.jsx(Z,{loadingText:d("Saving"),loading:i===It.Processing,spinner:!0,children:d("Save")})})})]})},F9=()=>e.jsxs(Id,{children:[e.jsx(L9,{}),e.jsx(Ad,{children:e.jsxs(mc,{children:[e.jsx(U,{index:!0,element:e.jsx(bv,{})}),e.jsxs(U,{path:"notifications",element:e.jsx(Mv,{}),children:[e.jsx(U,{path:"manager",element:e.jsx(jv,{})}),e.jsx(U,{path:":uid?",element:e.jsx(Wv,{})})]}),e.jsx(U,{path:"integrations",element:e.jsx($j,{}),children:e.jsx(U,{path:":id?/:handle?",element:e.jsx(Fj,{})})}),e.jsxs(U,{path:"rules",element:e.jsx(k9,{}),children:[e.jsx(U,{index:!0,element:e.jsx(Yv,{})}),e.jsx(U,{path:"field/:uid",element:e.jsx(Jv,{})}),e.jsx(U,{path:"page/:uid",element:e.jsx(Zv,{})}),e.jsx(U,{path:"page/:uid/buttons/:button",element:e.jsx(Gv,{})}),e.jsx(U,{path:"submit",element:e.jsx(Xv,{})})]}),e.jsxs(U,{path:"settings",element:e.jsx(Sf,{}),children:[e.jsx(U,{index:!0,element:e.jsx(bl,{})}),e.jsx(U,{path:":sectionHandle",element:e.jsx(bl,{})})]}),e.jsx(U,{path:"form-monitor",element:e.jsx(gg,{}),children:e.jsx(U,{index:!0,element:e.jsx(xf,{})})})]})})]}),E9=()=>e.jsx(Gu,{style:{flex:1},children:e.jsxs(Vu,{children:[e.jsx(Qu,{children:e.jsx(k,{height:10,width:60,baseColor:h.gray300,highlightColor:h.gray200})}),e.jsx(Ku,{children:e.jsx(k,{height:8,width:300})}),e.jsx(k,{height:30,width:"100%"})]})}),Ns=()=>e.jsx(Ju,{children:e.jsx(Zu,{children:e.jsx(E9,{})})}),T9=()=>e.jsxs(Lr,{children:[e.jsx(Ns,{}),e.jsx(Ns,{}),e.jsx(Ns,{}),e.jsx(Ns,{})]}),N9=()=>e.jsxs(ep,{children:[e.jsx(So,{}),e.jsx(So,{children:e.jsx(tp,{className:"btn btn-submit",children:e.jsx(k,{width:50,baseColor:h.gray400})})})]}),z9=()=>e.jsxs(np,{children:[e.jsx(T9,{}),e.jsx(N9,{})]}),M9=()=>e.jsx(Qt,{children:e.jsx(sp,{children:e.jsxs(ip,{children:[e.jsx(Lo,{children:e.jsx(Fo,{className:"active",children:e.jsx("span",{children:e.jsx(k,{width:42})})})}),e.jsx(Lo,{children:e.jsx(Fo,{children:e.jsx("span",{children:e.jsx(k,{width:42})})})})]})})}),I9=()=>e.jsxs(Uu,{children:[e.jsx(M9,{}),e.jsx(z9,{})]}),A9=()=>e.jsx(mp,{children:e.jsxs(gp,{children:[e.jsx(bp,{children:e.jsx(xp,{})}),e.jsx(fp,{disabled:!0,className:"fullwidth text",placeholder:d("Search")})]})}),R9=()=>e.jsxs(De,{children:[e.jsx(A9,{}),e.jsx(Nr,{words:[50,70],items:16})]}),P9=()=>e.jsxs(e.Fragment,{children:[e.jsx(R9,{}),e.jsx(I9,{})]}),D9=()=>e.jsx(Qt,{baseColor:h.gray300,highlightColor:h.gray200,height:10,children:e.jsxs(Kd,{children:[e.jsx(Vd,{children:e.jsx(Gd,{children:e.jsx(k,{width:"50%",height:20})})}),e.jsxs(fs,{children:[e.jsx("a",{className:"active",children:e.jsx("span",{children:e.jsx(k,{width:43})})}),e.jsx("a",{children:e.jsx("span",{children:e.jsx(k,{width:82})})}),I.editions.is(re.Pro)&&e.jsx("a",{children:e.jsx("span",{children:e.jsx(k,{width:36})})}),e.jsx("a",{children:e.jsx("span",{children:e.jsx(k,{width:77})})}),e.jsx("a",{children:e.jsx("span",{children:e.jsx(k,{width:54})})})]}),e.jsx(Yd,{children:e.jsx(k,{})})]})}),B9=()=>e.jsxs(Id,{children:[e.jsx(D9,{}),e.jsx(Ad,{children:e.jsx(jp,{children:e.jsx(P9,{})})})]}),O9=()=>{const{formId:t}=V(),n=t?Number(t):void 0,s=H(),i=Hh(n),o=Uh(n),r=km(n);Gt(),Tn(n),Md(n),Yo(n),Go(n);const{data:a,isFetching:c,isError:u,error:p}=Oh(n);return g.useEffect(()=>{if(t===void 0||!a)return;const{translations:x,layout:{fields:f,pages:b,layouts:j,rows:y}}=a;s(gt.update(a)),s(be.set(f)),s(kn.set(b)),s(Cn.set(j)),s(Ze.set(y)),s(to.init(x)),document.title=a.name,i(),o(),r(),b.length===0?s(op()):s(ye.setPage(b.find(Boolean)?.uid))},[a,t,s,o,i,r]),c?e.jsx(B9,{}):u?e.jsxs("div",{children:["ERROR: ",p.message]}):e.jsx(F9,{})},_9=Qo`
  #freeform-client-app {
    height: calc(100vh - 100px);
  }
`,W9=()=>e.jsxs(e.Fragment,{children:[e.jsx(q,{id:"form-editor",label:"Forms",url:"/forms"}),e.jsx(_9,{}),e.jsx(Sc,{children:e.jsx(O9,{})})]});function Fl(t,n,s,i){const o=g.useRef(n);$c(()=>{o.current=n},[n]),g.useEffect(()=>{const r=window;if(!r?.addEventListener)return;const a=c=>{o.current(c)};return r.addEventListener(t,a,i),()=>{r.removeEventListener(t,a,i)}},[t,s,i])}const qi=typeof window>"u";function Ep(t,n,s={}){const{deserializer:i,initializeWithValue:o=!0,serializer:r}=s,a=g.useRef(n),c=g.useCallback(()=>{const v=a.current;return v instanceof Function?v():v},[]),u=g.useCallback(v=>r?r(v):JSON.stringify(v),[r]),p=g.useCallback(v=>{if(i)return i(v);if(v==="undefined")return;const $=c();let C;try{C=JSON.parse(v)}catch(F){return console.error("Error parsing JSON:",F),$}return C},[i,c]),x=g.useCallback(()=>{const v=c();if(qi)return v;try{const $=window.localStorage.getItem(t);return $?p($):v}catch($){return console.warn(`Error reading localStorage key “${t}”:`,$),v}},[p,c,t]),[f,b]=g.useState(()=>o?x():c()),j=eo(v=>{qi&&console.warn(`Tried setting localStorage key “${t}” even though environment is not a client`);try{const $=v instanceof Function?v(x()):v;window.localStorage.setItem(t,u($)),b($),window.dispatchEvent(new StorageEvent("local-storage",{key:t}))}catch($){console.warn(`Error setting localStorage key “${t}”:`,$)}}),y=eo(()=>{qi&&console.warn(`Tried removing localStorage key “${t}” even though environment is not a client`);const v=c();window.localStorage.removeItem(t),b(v),window.dispatchEvent(new StorageEvent("local-storage",{key:t}))});g.useEffect(()=>{b(v=>{const $=x();return Object.is(v,$)?v:$})},[x]);const w=g.useCallback(v=>{v.key&&v.key!==t||b(x())},[t,x]);return Fl("storage",w),Fl("local-storage",w),[f,j,y]}const U9=l.header`
  display: grid;
...
`;zp.defaultProps={$empty:"Click the 'Add Group' button on the right to begin."};const ew=l.div`
  display: flex;
  padding-bottom: ${m.lg};
  gap: ${m.lg};
`,Mp=l.div`
...
`;Mp.defaultProps={$empty:"Drag and drop any field here",color:h.black};const tw=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.xs};
  position: absolute;
...
`;Ip.defaultProps={$empty:"Drag and drop any field here"};const sw=l.div`
  padding-top: ${m.lg};
...
`,dw=l.div`
  ...
  line-height: 1px;
  overflow: hidden;
`,El=({form:t})=>{const n=g.useRef(null),s=Ct(n),{id:i,name:o,settings:r}=t,{color:a}=r.general;return e.jsxs(rw,{"data-id":i,ref:n,children:[e.jsx(aw,{children:e.jsx(lw,{children:o})}),s&&e.jsx(cw,{className:"remove form-item-remove",children:e.jsx(dt,{})}),e.jsx(dw,{$color:a})]})},uw=(t,n,s)=>{const{getCurrentHandleWithFallback:i,current:o}=Fe(),r=g.useCallback(()=>{n(u=>({...u,formGroups:{...u.formGroups,site:u.formGroups?.site?u.formGroups.site:i(),groups:[...u.formGroups?.groups||[],{uid:G(),label:"",formIds:[]}]}}))},[n,i]),a=g.useCallback((u,p,x)=>{n(f=>({...f,formGroups:{...f.formGroups,groups:f.formGroups.groups.map(b=>b.uid===x?{...b,[u]:p}:b)}}))},[n]),c=g.useCallback(()=>{const p=Ne.get(s.current.groupWrapper).toArray().map(y=>{const w=t.formGroups?.groups.find(v=>v.uid===y);if(w){const v={...w};return delete v.forms,{...v,formIds:Ne.get(s.current[y]).toArray().map(Number)}}return null}).filter(Boolean),x=s.current?.unassigned,f=x?Ne.get(x):null,b=f?f.toArray().map(Number):[],j=[...p.flatMap(y=>y.formIds),...b];return{siteId:t.formGroups?.siteId||o?.id,site:t.formGroups?.site||i(),groups:p,orderedFormIds:j}},[s,t,i,o?.id]);return{addGroup:r,updateGroupInfo:a,syncFormGroupsRefs:c}},pw=(t={})=>{const n=ee(),{getCurrentHandleWithFallback:s}=Fe(),i=t?.onSuccess;return t.onSuccess=(o,r,a,c)=>{i?.(o,r,a,c),n.invalidateQueries({queryKey:ut.all(s())})},ce({...t,mutationFn:async o=>{const{orderedFormIds:r,...a}=o;await T.post("/api/forms/groups",a),r&&r.length>0&&await T.post("/api/forms/sort",{orderedFormIds:r})}})},hw=(t,n)=>n.options.handle!==".handle",xw=t=>{const n=(i,o)=>{const r=t.current[i];r&&Ne.create(r,o)};Object.entries({unassigned:{group:{name:"shared",put:hw},animation:150,sort:!0},groupWrapper:{handle:".handle",filter:".group-remove",sort:!0,animation:150,onFilter:o=>{const r=Array.from(t.current[o.item.dataset.id].children);t.current.unassigned.append(...r),o.item.remove()}}}).forEach(([o,r])=>{n(o,r)})},mw=(t,n,s)=>{t&&(Ne.create(t,{animation:150,group:{name:`group-${n}`,put:(i,o)=>o.options.handle!==".handle"},sort:!0,filter:".form-item-remove",onFilter:i=>s.current.unassigned.appendChild(i.item)}),s.current[n]=t)},gw=({closeModal:t})=>{const[n,s]=g.useState({}),[i,o]=g.useState(!1),[r,a]=g.useState(),{data:c}=Np(),u=g.useRef({}),{addGroup:p,updateGroupInfo:x,syncFormGroupsRefs:f}=uw(n,s,u);g.useEffect(()=>{c&&!i&&(s(c),o(!0))},[c,i]),g.useEffect(()=>{xw(u)},[]);const b=pw({onSuccess:()=>{t()},onError:y=>{a(y.errors)}}),j=b.isPending;return e.jsxs(ve,{style:{maxWidth:"60%"},children:[e.jsx(we,{children:e.jsx("h1",{children:d("Form Group Manager")})}),e.jsxs(Z9,{children:[e.jsxs(zp,{ref:y=>{u.current.groupWrapper=y},$empty:d("Click the 'Add Group' button on the right to begin."),children:[r?.length&&e.jsx(ow,{children:d("Something went wrong!")}),n.formGroups?.groups?.map(y=>e.jsxs(X9,{"data-id":y.uid,children:[e.jsx(ew,{children:e.jsx(je,{value:y.label,property:{type:K.Label,handle:y.uid},updateValue:w=>x("label",w,y.uid)})}),e.jsx(Mp,{$empty:d("Drag and drop any field here"),ref:w=>{mw(w,y.uid,u)},children:y.forms?.map(w=>e.jsx(El,{form:w},w.id))}),e.jsxs(tw,{children:[e.jsx("button",{type:"button",className:"group-remove",children:e.jsx(dt,{})}),e.jsx("button",{type:"button",className:"handle",children:e.jsx(Ir,{})})]})]},y.uid))]}),e.jsxs(nw,{children:[e.jsx("button",{onClick:p,type:"button",className:"btn add icon dashed",children:d("Add Group")}),e.jsx(sw,{children:e.jsxs(iw,{className:"unassigned",children:[e.jsx("h3",{children:d("Unassigned")}),e.jsx(Ip,{$empty:d("Drag and drop any form here. Unassigned form will display at the bottom of the list of Groups."),ref:y=>{u.current.unassigned=y},children:n?.forms?.filter(y=>y.dateArchived===null).map(y=>e.jsx(El,{form:y},y.id))})]})})]})]}),e.jsxs($e,{children:[e.jsx("button",{type:"button",className:"btn cancel",onClick:t,children:d("Close")}),e.jsx("button",{type:"button",className:"btn submit",children:e.jsx(Z,{loadingText:d("Saving"),loading:j,onClick:()=>b.mutate(f()),spinner:!0,children:d("Save")})})]})]})},fw=()=>{const{openModal:t}=Ke();return()=>{t(gw)}},Ap=t=>e.jsx(R,{height:"1em",viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-384c-13.3 0-24 10.7-24 24V264c0 13.3 10.7 24 24 24s24-10.7 24-24V152c0-13.3-10.7-24-24-24zm32 224a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z"})}),bw=t=>e.jsx(R,{height:"1em",viewBox:"0 0 384 512",...t,children:e.jsx("path",{d:"M345 137l17-17L328 86.1l-17 17-119 119L73 103l-17-17L22.1 120l17 17 119 119L39 375l-17 17L56 425.9l17-17 119-119L311 409l17 17L361.9 392l-17-17-119-119L345 137z"})}),jw=t=>e.jsx(R,{height:"1em",viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336c-13.3 0-24 10.7-24 24s10.7 24 24 24h80c13.3 0 24-10.7 24-24s-10.7-24-24-24h-8V248c0-13.3-10.7-24-24-24H216c-13.3 0-24 10.7-24 24s10.7 24 24 24h24v64H216zm40-144a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"})}),yw=t=>e.jsx(R,{height:"1em",viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M231.9 44.4C215.7 16.9 186.1 0 154.2 0H152C103.4 0 64 39.4 64 88c0 14.4 3.5 28 9.6 40H48c-26.5 0-48 21.5-48 48v64c0 20.9 13.4 38.7 32 45.3V288 448c0 35.3 28.7 64 64 64H416c35.3 0 64-28.7 64-64V288v-2.7c18.6-6.6 32-24.4 32-45.3V176c0-26.5-21.5-48-48-48H438.4c6.1-12 9.6-25.6 9.6-40c0-48.6-39.4-88-88-88h-2.2c-31.9 0-61.5 16.9-77.7 44.4L256 85.5l-24.1-41zM464 176v64H432 288V176h72H464zm-240 0v64H80 48V176H152h72zm0 112V464H96c-8.8 0-16-7.2-16-16V288H224zm64 176V288H432V448c0 8.8-7.2 16-16 16H288zm72-336H288h-1.3l34.8-59.2C329.1 55.9 342.9 48 357.8 48H360c22.1 0 40 17.9 40 40s-17.9 40-40 40zm-136 0H152c-22.1 0-40-17.9-40-40s17.9-40 40-40h2.2c14.9 0 28.8 7.9 36.3 20.8L225.3 128H224z"})}),Tl=t=>e.jsx(R,{height:"1em",viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M248.4 84.3c1.6-2.7 4.5-4.3 7.6-4.3s6 1.6 7.6 4.3L461.9 410c1.4 2.3 2.1 4.9 2.1 7.5c0 8-6.5 14.5-14.5 14.5H62.5c-8 0-14.5-6.5-14.5-14.5c0-2.7 .7-5.3 2.1-7.5L248.4 84.3zm-41-25L9.1 385c-6 9.8-9.1 21-9.1 32.5C0 452 28 480 62.5 480h387c34.5 0 62.5-28 62.5-62.5c0-11.5-3.2-22.7-9.1-32.5L304.6 59.3C294.3 42.4 275.9 32 256 32s-38.3 10.4-48.6 27.3zM288 368a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm-8-184c0-13.3-10.7-24-24-24s-24 10.7-24 24v96c0 13.3 10.7 24 24 24s24-10.7 24-24V184z"})}),Rp={all:["notices"]},vw=()=>B({queryKey:Rp.all,queryFn:()=>T.get("/api/notices").then(t=>t.data),enabled:I.feed}),ww=()=>{const t=ee();return ce({mutationFn:n=>T.delete(`/api/notices/${n}`),onMutate:n=>{t.setQueryData(Rp.all,s=>({...s,notices:s.notices.filter(i=>i.id!==n)}))}})},$w=l.ul`
  display: flex;
  flex-direction: column;
  gap: 10px;
...
`,Cw=l.button`
  align-self: center;
`,kw=[{type:"new",accent:"#038052",bg:"transparent"},{type:"info",accent:"#007bff",bg:"transparent"},{type:"warning",accent:"#e87b00",bg:"transparent"},{type:"critical",accent:"#cf1324",bg:"#fbe4e4"},{type:"error",accent:"#cf1324",bg:"transparent"},{type:"log-list",accent:"#cf1324",bg:"transparent"}];let Pp="";kw.forEach(({type:t,accent:n,bg:s})=>{Pp+=`
    &[data-type='${t}'] {
      fill: ${n};
      color: ${n};
      border-color: ${n};
...
`,Lw={info:e.jsx(jw,{}),warning:e.jsx(Tl,{}),critical:e.jsx(Tl,{}),error:e.jsx(Ap,{}),new:e.jsx(yw,{})},Dp=()=>{const{data:t,isFetching:n}=vw(),s=ww();return!I.feed||!t&&n||!t.notices.length&&!t.errors?null:e.jsxs($w,{children:[t.notices.map(i=>e.jsxs(Ml,{"data-type":i.type,children:[e.jsx(Nl,{children:Lw[i.type]}),e.jsx(zl,{children:i.message}),e.jsx(Cw,{onClick:()=>s.mutate(i.id),children:e.jsx(bw,{})})]},i.id)),!!t.errors&&e.jsxs(Ml,{"data-type":"log-list",children:[e.jsx(Nl,{children:e.jsx(Ap,{})}),e.jsx(zl,{dangerouslySetInnerHTML:{__html:O.sanitize(d('There are currently <a href="{link}">{errors} logged errors</a> in the Freeform error log files.',{link:me("settings/error-log"),errors:t.errors}))}})]})]})},Fw=({data:t,closeModal:n})=>{const[s,i]=g.useState(!1),[o,r]=g.useState(""),[a,c]=g.useState(!1),u=ee(),{getCurrentHandleWithFallback:p}=Fe();ft({callback:b=>{if(b.key==="Enter"){f();return}}},[s]);const x=b=>{r(b.target.value)},f=async()=>{if(s){c(!0);try{await T.post("/api/forms/delete",{id:t?.form.id}),await u.invalidateQueries({queryKey:ut.all(p())}),await u.invalidateQueries({queryKey:fe.all(p())}),r(""),i(!1),n()}finally{c(!1)}}};return g.useEffect(()=>{i(o.toUpperCase()==="DELETE")},[o]),e.jsxs(ve,{children:[e.jsx(we,{children:e.jsx("h1",{children:t?.form.name})}),e.jsxs(Hr,{children:[e.jsx("div",{children:d("Are you sure you want to permanently delete this form? This action cannot be undone.")}),e.jsx("div",{dangerouslySetInnerHTML:{__html:O.sanitize(d("To delete this form, please type <strong>DELETE</strong> in the box below:"))}}),e.jsx("input",{type:"text",autoFocus:!0,value:o,autoComplete:"off",onChange:x,className:"text fullwidth"})]}),e.jsxs($e,{children:[e.jsx("button",{type:"button",className:"btn cancel",onClick:n,children:d("Cancel")}),e.jsx("button",{type:"button",className:E("btn submit",!s&&"disabled"),onClick:f,children:e.jsx(Z,{loadingText:d("Deleting"),loading:a,spinner:!0,children:d("Delete")})})]})]})},Kr=t=>{const{openModal:n}=Ke();return()=>{n(Fw,t)}},Vr=()=>{const t=ee(),{getCurrentHandleWithFallback:n}=Fe();return ce({mutationFn:s=>T.post(`/api/forms/${s}/archive`,{site:n()}),onMutate:s=>s,onSuccess:()=>{t.invalidateQueries({queryKey:ut.all(n())}),t.invalidateQueries({queryKey:fe.all(n())})}})},Bp=()=>{const t=ee(),{getCurrentHandleWithFallback:n}=Fe();return ce({mutationFn:s=>T.post(`/api/forms/${s}/clone`),onMutate:s=>s,onSuccess:()=>{t.invalidateQueries({queryKey:ut.all(n())}),t.invalidateQueries({queryKey:fe.all(n())})}})},Ew=l.li`
  line-height: 1.4;
  list-style-type: disc;
...
`,zw=({form:t})=>{const n=ne(),{getCurrentHandleWithFallback:s}=Fe(),i=ee(),{id:o,name:r,links:a,dateArchived:c}=t,u=Vr(),p=u.isPending&&u.context===o,x=u.isSuccess&&u.context===o,{canDelete:f}=I.metadata.freeform,b=Kr({form:t}),j=()=>{i.invalidateQueries({queryKey:fe.single(Number(o))}),n(`${o}`)},y=a.filter(({type:$})=>$==="title").length,w=t.links.filter(({type:$})=>$==="linkList"),v=$=>r0(dn($),"yyyy-MM-dd");return e.jsxs(Ew,{className:E(p&&"disabled",x&&"restored"),children:[y?e.jsx(Tw,{onClick:j,children:r}):e.jsx(Op,{children:r}),c&&e.jsxs(Nw,{children:["(",d("archived")," ",v(c),")"]}),w.length>0&&w.filter(({count:$})=>$).map(($,C)=>$.internal?e.jsx(zs,{children:e.jsx(he,{to:$.url,children:$.label})},C):e.jsx(zs,{children:e.jsx("a",{href:$.url,children:$.label})},C)),e.jsx(zs,{children:e.jsx("button",{type:"button",onClick:()=>{u.mutate(o)},children:d("Restore this Form")})}),f&&e.jsx(zs,{children:e.jsx("button",{type:"button",onClick:async $=>{$.metaKey&&$.shiftKey?(await T.post("/api/forms/delete",{id:o}),i.invalidateQueries({queryKey:ut.all(s())}),i.invalidateQueries({queryKey:fe.all(s())})):b()},children:d("Delete this Form and its Submissions")})})]})},Mw=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.md};
`,Iw=l.button`
...
`,qp=l.div``,Xr=l.div`
  ...
  overflow: hidden;
`,Rw=(t,n)=>Math.floor(Math.random()*(n-t+1))+t,Pw=()=>e.jsxs(Zr,{children:[e.jsx(k,{height:8,width:60}),e.jsx(k,{height:8,width:40})]}),Qi=()=>{const t="#dfdfdf",n=Array.from({length:10},()=>({value:Rw(0,Math.random()>.9?8:4)}));return e.jsxs(bi,{children:[e.jsxs(Gr,{children:[e.jsx(Yr,{children:e.jsxs(Jr,{children:[e.jsx(k,{height:15,width:"90%"}),e.jsx(k,{height:8,width:"60%"}),e.jsx(k,{height:8,width:"30%"})]})}),e.jsxs(fi,{children:[e.jsx("li",{children:e.jsx(k,{height:8,width:90})}),e.jsx("li",{children:e.jsx(k,{height:8,width:50})})]})]}),e.jsx(nt,{width:"100%",height:40,children:e.jsxs(yt,{data:n,margin:{top:10,bottom:3,left:0,right:0},children:[e.jsx("defs",{children:e.jsxs("linearGradient",{id:"colorGradient",x1:0,y1:0,x2:0,y2:1,children:[e.jsx("stop",{offset:"5%",stopColor:t,stopOpacity:.4}),e.jsx("stop",{offset:"95%",stopColor:t,stopOpacity:.3})]})}),e.jsx(vt,{type:"monotone",dataKey:"value",stroke:t,strokeWidth:1,strokeOpacity:1,fillOpacity:1,fill:"url(#colorGradient)",isAnimationActive:!1})]})}),e.jsx(Xr,{$color:t})]})},Dw=t=>e.jsx(R,{viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z"})}),Bw=t=>e.jsx(R,{viewBox:"0 0 512 512",...t,children:e.jsx("path",{d:"M248.4 84.3c1.6-2.7 4.5-4.3 7.6-4.3s6 1.6 7.6 4.3L461.9 410c1.4 2.3 2.1 4.9 2.1 7.5c0 8-6.5 14.5-14.5 14.5l-387 0c-8 0-14.5-6.5-14.5-14.5c0-2.7 .7-5.3 2.1-7.5L248.4 84.3zm-41-25L9.1 385c-6 9.8-9.1 21-9.1 32.5C0 452 28 480 62.5 480l387 0c34.5 0 62.5-28 62.5-62.5c0-11.5-3.2-22.7-9.1-32.5L304.6 59.3C294.3 42.4 275.9 32 256 32s-38.3 10.4-48.6 27.3zM288 368a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm-8-184c0-13.3-10.7-24-24-24s-24 10.7-24 24l0 96c0 13.3 10.7 24 24 24s24-10.7 24-24l0-96z"})}),Ow=l.span`
  display: inline-block;
  white-space: nowrap;
  align-items: center;
  border-radius: 3px;
...
`,sa=()=>e.jsx(Le,{className:"fa-solid fa-folder"}),b$=()=>e.jsx(Le,{className:"fa-duotone fa-clipboard-list"}),j$=()=>e.jsx(Le,{className:"fa-light fa-folder-bookmark"}),y$=()=>e.jsx(Le,{className:"fa-light fa-file-heart"}),v$=()=>e.jsx(Le,{className:"fa-duotone fa-inbox-in"}),w$=()=>e.jsx(Le,{className:"fa-light fa-envelope"}),$$=()=>e.jsx(Le,{className:"fa-light fa-file-pdf"}),C$=()=>e.jsx(Le,{className:"fa-light fa-file-half-dashed"}),k$=()=>e.jsx(Le,{className:"fa-light fa-file-code"}),S$=()=>e.jsx(Le,{className:"fa-light fa-file-check"}),L$=()=>e.jsx(Le,{className:"fa-duotone fa-gear"}),Ut=l.li`
...
`,Je=t=>{const{label:n,icon:s,itemIcon:i,labelExtras:o}=t,{items:r,selection:a,onUpdate:c}=t,{labelKey:u,selectionKey:p,nested:x}=t,f=t.id||K1(n);return!Array.isArray(r)||!r.length?null:e.jsxs(Ut,{children:[e.jsxs(vn,{children:[e.jsx(wn,{children:e.jsx(ct,{id:`${f}-all`,checked:a.length===r.length,onChange:()=>a.length===r.length?c([]):c(r.map(b=>b[p]))})}),x&&e.jsx(Zs,{$dash:!0}),e.jsx(sa,{}),e.jsx(Wt,{htmlFor:`${f}-all`,children:n})]}),e.jsx("ul",{children:r.map(b=>e.jsx(Ut,{className:E("selectable",a.includes(b[p])&&"selected"),children:e.jsxs(vn,{children:[e.jsx(wn,{children:e.jsx(ct,{id:`${f}-${b[p]}`,checked:a.includes(b[p]),onChange:()=>c(a.includes(b[p])?a.filter(j=>j!==b[p]):[...a,b[p]])})}),e.jsx(Zs,{$dash:!0,$width:x?2:void 0}),s,i?.(b),e.jsxs(Wt,{htmlFor:`${f}-${b[p]}`,children:[x$(b[u]),o?.(b)]})]})},b[p]))})]})},F$=({value:t,onUpdate:n})=>e.jsx(Ut,{children:e.jsx("ul",{children:e.jsx(Ut,{className:E("selectable",t&&"selected"),children:e.jsxs(vn,{children:[e.jsx(wn,{children:e.jsx(ct,{id:"export-settings",checked:t,onChange:()=>n(!t)})}),e.jsx(L$,{}),e.jsx(Wt,{htmlFor:"export-settings",children:d("Settings")})]})})})}),E$=({submissions:t,options:n,onUpdate:s})=>!Array.isArray(t)||!t.length?null:e.jsxs(Ut,{children:[e.jsxs(vn,{children:[e.jsx(wn,{children:e.jsx(ct,{id:"submissions-all",checked:n.length===t.length,onChange:()=>n.length===t.length?s([]):s(t.map(i=>i.form.uid))})}),e.jsx(sa,{}),e.jsx(Wt,{htmlFor:"submissions-all",children:d("Submissions")})]}),e.jsx("ul",{children:t.map(i=>e.jsx(Ut,{className:E("selectable",n.includes(i.form.uid)&&"selected"),children:e.jsxs(vn,{children:[e.jsx(wn,{children:e.jsx(ct,{id:`submissions-${i.form.uid}`,checked:n.includes(i.form.uid),onChange:()=>s(n.includes(i.form.uid)?n.filter(o=>o!==i.form.uid):[...n,i.form.uid])})}),e.jsx(Zs,{$dash:!0}),e.jsx(v$,{}),e.jsxs(Wt,{$light:!0,htmlFor:`submissions-${i.form.uid}`,children:[i.form.name," (",i.count,")"]})]})},i.form.uid))})]}),Ol=(t,n)=>n.pdf.length===t.pdf.length&&n.wrapper.length===t.wrapper.length&&n.notification.length===t.notification.length&&n.formatting.length===t.formatting.length&&n.success.length===t.success.length,T$=({templates:t,options:n,onUpdate:s})=>!t.pdf.length&&!t.wrapper.length&&!t.notification.length&&!t.formatting.length&&!t.success.length?null:e.jsxs(Ut,{children:[e.jsxs(vn,{children:[e.jsx(wn,{children:e.jsx(ct,{id:"templates-all",checked:Ol(t,n),onChange:()=>Ol(t,n)?s({pdf:[],wrapper:[],notification:[],formatting:[],success:[]}):s({pdf:t.pdf.map(i=>i.uid),wrapper:t.wrapper.map(i=>i.uid),notification:t.notification.map(i=>i.uid),formatting:t.formatting.map(i=>i.fileName),success:t.success.map(i=>i.fileName)})})}),e.jsx(sa,{}),e.jsx(Wt,{htmlFor:"templates-all",children:d("Templates")})]}),e.jsxs("ul",{children:[e.jsx(Je,{nested:!0,label:d("PDF"),labelKey:"name",icon:e.jsx($$,{}),items:t.pdf,selection:n.pdf,selectionKey:"uid",onUpdate:i=>s({...n,pdf:i})}),e.jsx(Je,{nested:!0,label:d("Wrapper"),labelKey:"name",icon:e.jsx(C$,{}),items:t.wrapper,selection:n.wrapper,selectionKey:"uid",onUpdate:i=>s({...n,wrapper:i})}),e.jsx(Je,{nested:!0,label:d("Notification"),labelKey:"name",icon:e.jsx(w$,{}),items:t.notification,selection:n.notification,selectionKey:"uid",onUpdate:i=>s({...n,notification:i})}),e.jsx(Je,{nested:!0,label:d("Formatting"),labelKey:"name",icon:e.jsx(k$,{}),items:t.formatting,selection:n.formatting,selectionKey:"fileName",onUpdate:i=>s({...n,formatting:i})}),e.jsx(Je,{nested:!0,label:d("Success"),labelKey:"name",icon:e.jsx(S$,{}),items:t.success,selection:n.success,selectionKey:"fileName",onUpdate:i=>s({...n,success:i})})]})]}),ji=({data:t,options:n,disabled:s,onUpdate:i})=>{const o=p$(n,t),r=Gp(),a=h$(t);return e.jsx(m$,{className:E(s&&"disabled"),children:e.jsxs(f$,{children:[e.jsx(g$,{onClick:()=>{i(o?r:a)},children:d(o?"Deselect All":"Select All")}),e.jsxs("ul",{children:[e.jsx(Je,{label:d("Forms"),icon:e.jsx(b$,{}),labelKey:"name",selectionKey:"uid",items:t.forms,selection:n.forms,onUpdate:c=>i({...n,forms:c}),labelExtras:c=>c.pages.length>1&&e.jsxs("small",{children:["(",d("{count} pages",{count:c.pages.length}),")"]})}),e.jsx(Je,{label:d("Form Groups"),icon:e.jsx(j$,{}),labelKey:"label",selectionKey:"uid",items:t.formGroups,selection:n.formGroups,onUpdate:c=>i({...n,formGroups:c})}),e.jsx(Je,{label:d("Favorite Fields"),icon:e.jsx(y$,{}),labelKey:"label",selectionKey:"uid",items:t.favorites,selection:n.favorites,onUpdate:c=>i({...n,favorites:c})}),e.jsx(T$,{templates:t.templates,options:n.templates,onUpdate:c=>i({...n,templates:c}),formNames:jf(t.forms,"uid","name")}),e.jsx(Je,{label:d("Integrations"),labelKey:"name",selectionKey:"uid",items:t.integrations,selection:n.integrations,onUpdate:c=>i({...n,integrations:c}),itemIcon:c=>c.icon?e.jsx(Le,{dangerouslySetInnerHTML:{__html:O.sanitize(c.icon)}}):e.jsx(Le,{className:"fa-duotone fa-gear"})}),e.jsx(E$,{submissions:t.formSubmissions,options:n.formSubmissions,onUpdate:c=>i({...n,formSubmissions:c})}),e.jsx(Je,{label:d("Limited Users"),icon:e.jsx(Le,{className:"fa-regular fa-user-shield"}),labelKey:"name",selectionKey:"uid",items:t.limitedUsers,selection:n.limitedUsers,onUpdate:c=>i({...n,limitedUsers:c})}),t.settings&&e.jsx(F$,{value:n.settings,onUpdate:c=>i({...n,settings:c})})]})]})})},N$=t=>Y({opacity:t?1:0,scaleY:t?1:0,height:t?100:0,config:{tension:400}}),z$=t=>Y({opacity:t?1:0,scaleY:t?1:0,height:t?40:0,config:{tension:400}}),M$=l(_.div)`
...
`,B$={primary:"#e12d39",secondary:"#B0BEC5"},_l=({show:t,active:n,variant:s="primary",value:i,max:o,width:r,children:a})=>t?e.jsxs(R$,{className:E(s),children:[a&&e.jsx("label",{children:a}),e.jsx(D$,{style:{width:r},$color:B$[s],$value:i,$max:o,className:E(n&&"active")})]}):null,yi=({label:t,finishLabel:n,event:s})=>{const{progress:{displayProgress:i,showDone:o,progress:r,total:a,info:c,errors:u}}=s,p=N$(i),x=z$(o);return e.jsxs("div",{children:[e.jsxs(M$,{style:p,children:[e.jsx(_l,{width:"60%",show:!0,value:r[0],max:a[0],active:!0,children:t}),e.jsx(_l,{width:"60%",show:!0,variant:"secondary",value:r[1],max:a[1],active:!0,children:c})]}),u?.length>0&&e.jsx("ul",{className:"errors",children:u.map((f,b)=>e.jsx("li",{children:f},b))}),!u?.length&&e.jsx(I$,{style:x,children:e.jsxs(A$,{children:[e.jsx("i",{className:"fa-sharp fa-solid fa-check"}),e.jsx("span",{children:n})]})})]})},vi=()=>{const t=g.useRef(null),n=g.useRef([]),[s,i]=g.useState(),[o,r]=g.useState(!1),[a,c]=g.useState(!1),[u,p]=g.useState(!1),[x,f]=g.useState([0,0]),[b,j]=g.useState([0,0]),[y,w]=g.useState(),[v,$]=g.useState(),C=g.useCallback(z=>{i(z)},[]),F=g.useCallback(()=>{i(void 0),$(void 0),f([0,0]),j([0,0]),r(!0),w(void 0)},[]),N=g.useCallback((z,L)=>{n.current=[...n.current.filter(([A])=>A!==z),[z,L]]},[]),M=g.useCallback(z=>{z.onopen=()=>{c(!0)},z.onerror=()=>{console.error("An error occurred during import"),z.close(),r(!1),c(!1)},z.addEventListener("progress",L=>{const A=parseInt(L.data,10);f(D=>[D[0]+A,D[1]+A])}),z.addEventListener("total",L=>{j([parseInt(L.data,10),0]),$([])}),z.addEventListener("info",L=>{w(L.data)}),z.addEventListener("err",L=>{const A=L.data;$(D=>D===void 0?[A]:[...D,A])}),z.addEventListener("reset",L=>{j(A=>[A[0],parseInt(L.data,10)]),f(A=>[A[0],0])}),z.addEventListener("exit",()=>{z.close(),c(!1),r(!1),p(!0),setTimeout(()=>{p(!1)},5e3)}),n.current.forEach(([L,A])=>{z.addEventListener(L,A)})},[]);return g.useEffect(()=>{t.current&&t.current.close(),s&&(t.current=new EventSource(s),M(t.current))},[s,M]),{progress:{active:o,displayProgress:a,showDone:u,progress:x,total:b,info:y,errors:v},triggerProgress:C,clearProgress:F,attachListener:N}},O$=(t,n)=>{const s=window.URL.createObjectURL(new Blob([t])),i=document.createElement("a");i.href=s,i.setAttribute("download",n),document.body.appendChild(i),i.click(),i.parentNode.removeChild(i)},_$={data:["export","freeform","data"]},W$=()=>T.get("/export/forms/data").then(t=>t.data),U$=()=>B({queryKey:_$.data,queryFn:W$}),H$=t=>ce({mutationFn:n=>T.post("/export/forms/init",n),...t}),q$=()=>{const t=vi(),{attachListener:n,triggerProgress:s,clearProgress:i,progress:{active:o}}=t,{data:r,isFetching:a}=U$(),{mutate:c,isPending:u}=H$({onSuccess:y=>{const w=y.data.token;s(me(`/api/export?server-token=${w}`))}}),[p]=g.useState(!1),[x,f]=g.useState(Gp());g.useEffect(()=>{n("file-token",async y=>{const w=y.data,v=me(`/api/export/download?server-token=${w}`),$=await T.get(v,{responseType:"blob"}),F=`freeform-export-${new Date().toISOString().replace(/[-:]/g,"").replace("T","-").slice(0,-5)}.zip`;O$($.data,F)})},[n]);const b=()=>{i(),c(x)},j=a||p||o||u;return a?e.jsx(Qe,{children:d("Loading...")}):e.jsxs(Qe,{children:[e.jsx(q,{id:"export",label:"Export",url:"export/forms"}),e.jsx(q,{id:"export-forms",label:"Freeform Data",url:"export/forms"}),r&&e.jsx(_t,{label:d("Select Data to Export"),instructions:d("Choose which Freeform data to include in the export. If you export submissions without the corresponding form, the submissions will not be included."),children:e.jsx(ji,{disabled:!1,data:r,options:x,onUpdate:y=>f(y)})}),e.jsx(Dt,{value:x.password||"",updateValue:y=>f({...x,password:y}),property:{handle:"password",label:"Password-protect the Export File (optional)",instructions:"Enter a password if you want to protect your zip file with a password.",type:K.String,placeholder:"Enter a password"}}),e.jsx("div",{className:"field",children:e.jsx("button",{type:"button",disabled:j,onClick:b,className:E("btn","submit",j&&"disabled",ta(x)&&"disabled"),children:e.jsx(Z,{loadingText:d("Exporting..."),loading:j,spinner:!0,children:d("Begin Export")})})}),e.jsx(yi,{label:d("Export Progress"),finishLabel:d("Export completed successfully!"),event:t})]})},ia=({data:t,strategy:n,disabled:s,onUpdate:i})=>e.jsxs("div",{children:[e.jsx(_t,{label:d("Existing Form Behavior"),instructions:d("Choose the behavior Freeform should use if this site contains any forms that match the data in this import."),className:E(s&&"disabled",!t.forms.length&&"hidden"),children:e.jsx("div",{className:"select",children:e.jsxs("select",{value:n.forms,onChange:o=>i({...n,forms:o.target.value}),children:[e.jsx("option",{value:"skip",children:d("Skip")}),e.jsx("option",{value:"replace",children:d("Replace")})]})})}),e.jsx(_t,{label:d("Existing Template Behavior"),instructions:d("Choose the behavior Freeform should use if this site contains any email notification, formatting or success templates that match the data in this import."),className:E(s&&"disabled",!t.templates.notification.length&&"hidden"),children:e.jsx("div",{className:"select",children:e.jsxs("select",{value:n.templates,onChange:o=>i({...n,templates:o.target.value}),children:[e.jsx("option",{value:"skip",children:d("Skip")}),e.jsx("option",{value:"replace",children:d("Replace")})]})})})]}),oa=()=>({forms:[],favorites:[],formGroups:[],limitedUsers:[],formSubmissions:[],templates:{pdf:[],wrapper:[],notification:[],formatting:[],success:[]},integrations:[],strategy:{forms:"skip",templates:"skip"},settings:!1}),Q$={data:["expressForms","data"]},K$=()=>T.get("/import/express-forms/data").then(t=>t.data),V$=()=>B({queryKey:Q$.data,queryFn:K$}),G$=()=>{const[t,n]=g.useState(oa()),s=vi(),i=s.progress.active,{data:o,isFetching:r}=V$(),a=async()=>{s.clearProgress();const{data:c}=await T.post("/api/import/prepare",{exporter:"\\Solspace\\Freeform\\Bundles\\Backup\\Export\\ExpressFormsExporter",options:t}),u=me(`/api/import?server-token=${c.token}`);s.triggerProgress(u)};return r?e.jsx(Qe,{children:d("Loading...")}):!o.forms.length&&!o.templates.pdf.length&&!o.templates.notification.length&&!o.templates.formatting.length&&!o.templates.success.length&&!o.formSubmissions.length?e.jsx(Qe,{children:d("No data found")}):e.jsxs(Qe,{children:[e.jsx(q,{id:"import",label:"Import",url:"import/express-forms"}),e.jsx(q,{id:"import-express",label:"Express Forms",url:"import/express-forms"}),o&&e.jsx(_t,{label:d("Select Data"),children:e.jsx(ji,{disabled:i,data:o,options:t,onUpdate:c=>n({...t,...c})})}),e.jsx(ia,{data:o,strategy:t.strategy,disabled:i,onUpdate:c=>n(u=>({...u,strategy:c}))}),e.jsx("button",{type:"button",disabled:i,onClick:a,className:E("field btn","submit",i&&"disabled",ta(t)&&"disabled"),children:e.jsx(Z,{loadingText:d("Processing"),loading:i,spinner:!0,children:d("Begin Import")})}),e.jsx(yi,{label:d("Import"),finishLabel:d("Import completed successfully!"),event:s})]})},Y$=()=>B({queryKey:["formie","import-data"],queryFn:async()=>{const{data:t}=await T.get("/import/formie/v3/data");return t}}),J$=()=>{const[t,n]=g.useState(oa()),s=vi(),i=s.progress.active,{data:o,isFetching:r}=Y$(),a=async()=>{s.clearProgress();const{data:c}=await T.post("/api/import/prepare",{exporter:"\\Solspace\\Freeform\\Bundles\\Backup\\Export\\FormieV3Exporter",options:t}),u=me(`/api/import?server-token=${c.token}`);s.triggerProgress(u)};return r?e.jsx(Qe,{children:d("Loading...")}):o?!o.forms.length&&!o.templates.pdf.length&&!o.templates.notification.length&&!o.templates.formatting.length&&!o.templates.success.length&&!o.formSubmissions.length?e.jsx(Qe,{children:d("No data found")}):e.jsxs(Qe,{children:[e.jsx(q,{id:"import",label:"Import",url:"import/formie3"}),e.jsx(q,{id:"import-formie3",label:"Formie (v3)",url:"import/formie3"}),o&&e.jsx(_t,{label:d("Select Data"),children:e.jsx(ji,{disabled:i,data:o,options:t,onUpdate:c=>n({...t,...c})})}),e.jsx(ia,{data:o,strategy:t.strategy,disabled:i,onUpdate:c=>n(u=>({...u,strategy:c}))}),e.jsx("button",{type:"button",disabled:i,onClick:a,className:E("field btn","submit",i&&"disabled",ta(t)&&"disabled"),children:e.jsx(Z,{loadingText:d("Processing"),loading:i,spinner:!0,children:d("Begin Import")})}),e.jsx(yi,{label:d("Import"),finishLabel:d("Import completed successfully!"),event:s})]}):e.jsx(Qe,{children:d("No data found")})},Z$=l.div`
  //
`,X$=l.input`
  cursor: pointer;
...
`,nC=()=>{const t=g.useRef(null);return g.useEffect(()=>{const n=s=>{if(s.isComposing||s.altKey||s.ctrlKey||s.metaKey)return;const i=s.target;if(!(i&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.isContentEditable))&&s.key==="/"){s.preventDefault();const o=t.current;o?.focus(),o?.select?.()}};return window.addEventListener("keydown",n),()=>{window.removeEventListener("keydown",n)}},[]),t},sC=t=>e.jsx(R,{viewBox:"0 0 512 512",...t,children:e.jsx("path",{fill:"currentColor",d:"M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352c79.5 0 144-64.5 144-144s-64.5-144-144-144S64 128.5 64 208s64.5 144 144 144z"})}),iC=l.div`
  position: relative;
  z-index: 1;
`,oC=l.div`
  position: relative;
...
`,cC=l.div`
  ...
  color: ${h.gray400};
`,dC=({placeholder:t,query:n,setQuery:s})=>{const i=nC();return e.jsx(iC,{children:e.jsxs(oC,{children:[e.jsx(cC,{children:e.jsx(sC,{})}),e.jsx(aC,{children:"/"}),e.jsx(rC,{ref:i,type:"text",placeholder:d(t||"Search"),className:"fullwidth text",value:n,onChange:o=>{s?.(o.target.value)}})]})})},uC="integrations-favorites",Yp=()=>{const[t,n]=Ep(uC,[]),s=g.useCallback(o=>{const r=Hl(o);n(a=>{const c=Ul(a);return c.has(r)?c.delete(r):c.add(r),Array.from(c)})},[n]),i=g.useCallback(o=>{const r=Hl(o);return Ul(t).has(r)},[t]);return{toggleFavorite:s,hasFavorite:i}},Ul=t=>new Set(t.map(n=>n.trim()).filter(Boolean)),Hl=({type:t,shortName:n})=>`${t}:${n}`,ql=l.nav`
  display: flex;
  flex-direction: column;
  gap: 0;
...
`,gC=l.span`
  ...
  color: ${h.gray300};
  margin-left: auto;
`,Yl=({entry:t})=>{const n=I.editions.edition,{pathname:s}=Ht(),i=t.type,o=t.type.name,r=t.instances.length>0,a=t.type.editions.length>0&&!t.type.editions.includes(n),c=t.instances.length,u=c>1?c:"";let p=`${i.type}/${i.shortName}`;const x=s.includes(p);return c>0&&(p+=`/${t.instances[0].id}`),e.jsx(xC,{children:e.jsxs(he,{to:p,className:E(x&&"active",a&&"unsupported"),children:[e.jsx(Ws,{className:E(r&&!a&&"active",a&&"unsupported"),children:u}),t.type.iconSvg&&e.jsx(Gl,{dangerouslySetInnerHTML:{__html:O.sanitize(t.type.iconSvg)}}),!t.type.iconSvg&&e.jsx(Gl,{children:e.jsx("i",{className:"fa-solid fa-cog"})}),e.jsx(mC,{children:o}),i.version&&e.jsx(gC,{children:i.version})]})})},Jp=()=>B({queryKey:ze.navigation,queryFn:()=>T.get("/api/integrations/navigation").then(t=>t.data),gcTime:1/0,staleTime:1/0}),fC=()=>{const{data:t,isFetching:n}=Jp(),{hasFavorite:s}=Yp(),[i,o]=g.useState("");if(n&&!t)return e.jsx(ql,{});const r=t.map(u=>({...u,entries:u.entries.filter(p=>p.type.name.toLowerCase().includes(i.toLowerCase())||p.instances.some(x=>x.name.toLowerCase().includes(i.toLowerCase())))})).filter(u=>u.entries.length>0),a=r.flatMap(u=>u.entries.filter(p=>s(p.type))),c=r.map(u=>({...u,entries:u.entries.filter(p=>!s(p.type))})).filter(u=>u.entries.length>0);return e.jsxs(ql,{children:[e.jsx(pC,{children:e.jsx(dC,{query:i,setQuery:o})}),e.jsxs(hC,{children:[a.length>0&&e.jsxs(Ql,{children:[e.jsx(Kl,{children:d("Favorites")}),e.jsx(Vl,{children:a.map(u=>e.jsx(Yl,{entry:u},u.type.shortName))})]},"favorites"),c.map(u=>e.jsxs(Ql,{children:[e.jsx(Kl,{children:u.title}),e.jsx(Vl,{children:u.entries.map(p=>e.jsx(Yl,{entry:p},p.type.shortName))})]},u.handle))]})]})},bC=()=>(Fn("integrations"),e.jsxs("div",{children:[e.jsx(q,{id:"integrations",label:"Integrations",url:"integrations"}),e.jsx(Ln,{children:d("Integrations")}),e.jsxs(Du,{children:[e.jsx(fC,{}),e.jsx(tC,{children:e.jsx(jt,{})})]})]})),jC=({property:t,integration:n,autoFocus:s,values:i,errors:o,onUpdate:r})=>{const a=vs(n.properties,{},(f,b)=>{r?.(f,b)}),c=t.handle,u=i.metadata[c]??t.value,p={...t,flags:(t.flags||[])?.filter(f=>f!=="as-readonly-in-instance")},x={...n,values:{name:i.name,handle:i.handle,enabled:i.enabled,...i.metadata}};return e.jsx(je,{autoFocus:s,value:u,property:p,updateValue:a(p),errors:o?.metadata?.[c],context:x})},Po=l.div`
  position: relative;
  height: 100%;
`,ra=l.div`
  position: relative;
...
`,LC=()=>e.jsxs(ra,{children:[e.jsxs(Zp,{children:[e.jsx(Xp,{className:"spinning",children:e.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 640 640",children:[e.jsx("title",{children:"Loading"}),e.jsx("path",{d:"M320 180C291.3 180 268 156.7 268 128C268 99.3 291.3 76 320 76C348.7 76 372 99.3 372 128C372 156.7 348.7 180 320 180zM320 480C337.7 480 352 494.3 352 512C352 529.7 337.7 544 320 544C302.3 544 288 529.7 288 512C288 494.3 302.3 480 320 480zM512 352C494.3 352 480 337.7 480 320C480 302.3 494.3 288 512 288C529.7 288 544 302.3 544 320C544 337.7 529.7 352 512 352zM96 320C96 302.3 110.3 288 128 288C145.7 288 160 302.3 160 320C160 337.7 145.7 352 128 352C110.3 352 96 337.7 96 320zM495.4 223.8C473.5 245.7 438.1 245.7 416.2 223.8C394.3 201.9 394.3 166.5 416.2 144.6C438.1 122.7 473.5 122.7 495.4 144.6C517.3 166.5 517.3 201.9 495.4 223.8zM161.6 478.4C149.1 465.9 149.1 445.6 161.6 433.1C174.1 420.6 194.4 420.6 206.9 433.1C219.4 445.6 219.4 465.9 206.9 478.4C194.4 490.9 174.1 490.9 161.6 478.4zM433.1 478.4C420.6 465.9 420.6 445.6 433.1 433.1C445.6 420.6 465.9 420.6 478.4 433.1C490.9 445.6 490.9 465.9 478.4 478.4C465.9 490.9 445.6 490.9 433.1 478.4zM150.3 150.3C169.1 131.5 199.4 131.5 218.2 150.3C237 169.1 237 199.4 218.2 218.2C199.4 237 169.1 237 150.3 218.2C131.5 199.4 131.5 169.1 150.3 150.3z"})]})}),e.jsx(k,{width:200})]}),e.jsx("hr",{}),e.jsxs("div",{children:[e.jsx(k,{width:80}),e.jsx(k,{width:270,height:10}),e.jsx(k,{width:"100%",height:30})]}),e.jsx("hr",{}),e.jsxs("div",{children:[e.jsx(k,{width:180}),e.jsx(k,{width:200,height:10}),e.jsx(k,{width:"100%",height:30})]}),e.jsxs("div",{children:[e.jsx(k,{width:70}),e.jsx(k,{width:340,height:10}),e.jsx(k,{width:"100%",height:30})]})]}),FC=({integration:t})=>{if(t.supported)return null;let n=I.editions.edition;return n=n.charAt(0).toUpperCase()+n.slice(1).toLowerCase(),e.jsx(EC,{children:e.jsx(at,{title:d("Not available for {edition} edition",{edition:n}),subtitle:d("Upgrade to Pro to get access to this integration."),icon:e.jsx(ps,{}),children:e.jsx("a",{href:Craft.getCpUrl("plugin-store/freeform"),target:"_blank",rel:"noreferrer",children:d("Plugin Store")})})})},EC=l.div`
  position: absolute;
  left: 0;
  top: 0;
  right: 0;
...
`,IC=({active:t,content:n})=>{const s=V1.parse(n,{gfm:!0,async:!1});return n?e.jsx(Xl,{children:e.jsx(zC,{className:E("markdown-body",t&&"active"),children:e.jsx(MC,{dangerouslySetInnerHTML:{__html:O.sanitize(s)}})})}):e.jsx(Xl,{})},e1=t=>{const n=window.Craft;return n?.sendActionRequest?n.sendActionRequest("POST",t):fetch(`/actions/${t}`,{method:"POST",credentials:"same-origin"})},AC=()=>e1("freeform/form-monitor/disable-me").then(()=>{}),RC=()=>e1("freeform/form-monitor/delete-me").then(()=>{}),PC=({onClose:t,onConfirm:n})=>{const[s,i]=g.useState(!1),[o,r]=g.useState(!1),[a,c]=g.useState(""),u=async()=>{if(o)try{i(!0),await n(),t()}finally{i(!1)}};return g.useEffect(()=>{r(a.toUpperCase()==="CONFIRM")},[a]),e.jsx(wt,{closeModal:t,children:e.jsxs(ve,{children:[e.jsx(we,{children:e.jsx("h1",{children:d("Disable Monitoring")})}),e.jsxs(hs,{children:[e.jsx("div",{children:d("Are you sure you want to disable monitoring for this site?")}),e.jsx("div",{dangerouslySetInnerHTML:{__html:O.sanitize(d("To disable monitoring, please type <strong>CONFIRM</strong> in the box below:"))}}),e.jsx("input",{type:"text",autoFocus:!0,value:a,autoComplete:"off",onChange:p=>c(p.target.value),className:"text fullwidth"})]}),e.jsxs($e,{children:[e.jsx("button",{type:"button",disabled:s,className:"btn cancel",onClick:t,children:d("Cancel")}),e.jsx("button",{type:"button",disabled:!o||s,className:E("btn submit",!o&&"disabled"),onClick:u,children:d("Disable")})]})]})})},DC=({onClose:t,onConfirm:n})=>{const[s,i]=g.useState(!1),[o,r]=g.useState(""),[a,c]=g.useState(!1),u=async()=>{if(s)try{c(!0),await n(),t()}finally{c(!1)}};return g.useEffect(()=>{i(o.toUpperCase()==="CONFIRM")},[o]),e.jsx(wt,{closeModal:t,children:e.jsxs(ve,{children:[e.jsx(we,{children:e.jsx("h1",{children:d("Disable & Delete Monitoring Data")})}),e.jsxs(hs,{children:[e.jsx("div",{children:d("Are you sure you want to disable monitoring and delete all monitoring data for this site?")}),e.jsx("div",{dangerouslySetInnerHTML:{__html:O.sanitize(d("To disable monitoring and delete all data, please type <strong>CONFIRM</strong> in the box below:"))}}),e.jsx("input",{type:"text",autoFocus:!0,value:o,autoComplete:"off",onChange:p=>r(p.target.value),className:"text fullwidth"})]}),e.jsxs($e,{children:[e.jsx("button",{type:"button",disabled:a,className:"btn cancel",onClick:t,children:d("Cancel")}),e.jsx("button",{type:"button",disabled:!s||a,className:E("btn submit",!s&&"disabled"),onClick:u,children:d("Disable & Delete")})]})]})})},BC=()=>{const t=ee(),n=ne(),[s,i]=g.useState(!1),[o,r]=g.useState(!1),a=()=>i(!0),c=()=>r(!0);return e.jsxs(e.Fragment,{children:[e.jsx("button",{type:"button",className:"btn small",onClick:a,children:e.jsx("span",{children:d("Disable Monitoring")})}),e.jsx("button",{type:"button",className:"btn small",onClick:c,children:e.jsx("span",{children:d("Disable & Delete Monitoring Data")})}),s&&e.jsx(PC,{onClose:()=>i(!1),onConfirm:async()=>{await AC(),t.invalidateQueries({queryKey:ze.all}),Xe.success(d("Monitoring disabled."))}}),o&&e.jsx(DC,{onClose:()=>r(!1),onConfirm:async()=>{await RC(),t.invalidateQueries({queryKey:ze.all}),Xe.success(d("Monitoring disabled and data deleted.")),n("/integrations",{replace:!0})}})]})},OC=t=>t.type.class==="Solspace\\Freeform\\Integrations\\Single\\FormMonitor\\FormMonitor",_C=t=>e.jsxs(R,{viewBox:"0 0 640 640",...t,children:[e.jsx("path",{className:"star-filler",d:"M119.2 254.7L209 344.6C214.4 350 216.9 357.7 215.7 365.3L195.9 490.8L309.2 433.2C316 429.7 324.1 429.7 331 433.2L444.3 490.8L424.5 365.3C423.3 357.7 425.8 350 431.2 344.6L521 254.7L395.5 234.7C387.9 233.5 381.4 228.7 377.9 221.9L320.1 108.8L262.3 222C258.8 228.8 252.3 233.6 244.7 234.8L119.2 254.8z"}),e.jsx("path",{d:"M320.1 32C329.1 32 337.4 37.1 341.5 45.1L415 189.3L574.9 214.7C583.8 216.1 591.2 222.4 594 231C596.8 239.6 594.5 249 588.2 255.4L473.7 369.9L499 529.8C500.4 538.7 496.7 547.7 489.4 553C482.1 558.3 472.4 559.1 464.4 555L320.1 481.6L175.8 555C167.8 559.1 158.1 558.3 150.8 553C143.5 547.7 139.8 538.8 141.2 529.8L166.4 369.9L52 255.4C45.6 249 43.4 239.6 46.2 231C49 222.4 56.3 216.1 65.3 214.7L225.2 189.3L298.8 45.1C302.9 37.1 311.2 32 320.2 32zM320.1 108.8L262.3 222C258.8 228.8 252.3 233.6 244.7 234.8L119.2 254.8L209 344.7C214.4 350.1 216.9 357.8 215.7 365.4L195.9 490.9L309.2 433.3C316 429.8 324.1 429.8 331 433.3L444.3 490.9L424.5 365.4C423.3 357.8 425.8 350.1 431.2 344.7L521 254.8L395.5 234.8C387.9 233.6 381.4 228.8 377.9 222L320.1 108.8z"})]}),WC=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M320 576C461.4 576 576 461.4 576 320C576 178.6 461.4 64 320 64C178.6 64 64 178.6 64 320C64 461.4 178.6 576 320 576zM288 224C288 206.3 302.3 192 320 192C337.7 192 352 206.3 352 224C352 241.7 337.7 256 320 256C302.3 256 288 241.7 288 224zM280 288L328 288C341.3 288 352 298.7 352 312L352 400L360 400C373.3 400 384 410.7 384 424C384 437.3 373.3 448 360 448L280 448C266.7 448 256 437.3 256 424C256 410.7 266.7 400 280 400L304 400L304 336L280 336C266.7 336 256 325.3 256 312C256 298.7 266.7 288 280 288z"})}),UC=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M552 256L408 256C398.3 256 389.5 250.2 385.8 241.2C382.1 232.2 384.1 221.9 391 215L437.7 168.3C362.4 109.7 253.4 115 184.2 184.2C109.2 259.2 109.2 380.7 184.2 455.7C259.2 530.7 380.7 530.7 455.7 455.7C463.9 447.5 471.2 438.8 477.6 429.6C487.7 415.1 507.7 411.6 522.2 421.7C536.7 431.8 540.2 451.8 530.1 466.3C521.6 478.5 511.9 490.1 501 501C401 601 238.9 601 139 501C39.1 401 39 239 139 139C233.3 44.7 382.7 39.4 483.3 122.8L535 71C541.9 64.1 552.2 62.1 561.2 65.8C570.2 69.5 576 78.3 576 88L576 232C576 245.3 565.3 256 552 256z"})}),HC=t=>e.jsx(R,{viewBox:"0 0 640 640",...t,children:e.jsx("path",{d:"M320 64C324.6 64 329.2 65 333.4 66.9L521.8 146.8C543.8 156.1 560.2 177.8 560.1 204C559.6 303.2 518.8 484.7 346.5 567.2C329.8 575.2 310.4 575.2 293.7 567.2C121.3 484.7 80.6 303.2 80.1 204C80 177.8 96.4 156.1 118.4 146.8L306.7 66.9C310.9 65 315.4 64 320 64zM320 130.8L320 508.9C458 442.1 495.1 294.1 496 205.5L320 130.9L320 130.9z"})}),qC=(t,n)=>{const s=Craft.getCpUrl(`freeform/integrations/${t}/authorize`),i=600,o=700,r=window.screenX+(window.outerWidth-i)/2,a=window.screenY+(window.outerHeight-o)/2,u=Object.entries({width:i,height:o,top:a,left:r,toolbar:0,menubar:0}).map(([f,b])=>`${f}=${b}`).join(","),p=window.open(s,"OAuthFlow",u),x=f=>{f.origin===window.location.origin&&f.data.type==="oauth2"&&(p?.close(),n(),window.removeEventListener("message",x))};window.addEventListener("message",x)},QC=t=>{const{id:n}=t;return B({queryKey:ze.authCheck(n),enabled:!!n&&t.implements.includes("apiIntegration"),queryFn:async()=>T.get(`/api/integrations/${n}/status`).then(s=>s.data)})},KC=["authorized","unauthorized","error"],VC=["authorized","error"],GC=({integration:t})=>{const n=ee(),s=ne(),[i,o]=g.useState("pending"),[r,a]=g.useState([]),[c,u]=g.useState(!1),{toggleFavorite:p,hasFavorite:x}=Yp(),{data:f,isFetching:b,refetch:j}=QC(t);g.useEffect(()=>{b?(o("pending"),a([])):f&&(o(f.status),a(f.errors||[]))},[f,b]);const y=()=>{confirm(d("Are you sure you want to remove this integration?"))&&T.post(`/api/integrations/${t.id}/delete`).then(()=>{n.invalidateQueries({queryKey:ze.all}),s("/integrations"),Xe.success(d("Integration deleted successfully."))})},w=OC({...t,id:String(t.id)}),v=I.permissions.integrations==="manage",$=v&&t.id&&t.supported,C=x(t.type),F=!!t.type.readmeContent,N=v&&t.id&&t.supported&&t.implements.includes("apiIntegration");return e.jsxs(e.Fragment,{children:[e.jsxs(Zp,{children:[e.jsx(Xp,{dangerouslySetInnerHTML:{__html:O.sanitize(t.type.iconSvg)}}),e.jsx("span",{children:t.name||t.type.name}),t.type.version&&e.jsx(yC,{children:t.type.version}),e.jsx(vC,{type:"button",className:E(C&&"active"),onClick:()=>p(t.type),title:d("Favorite"),children:e.jsx(_C,{})}),N&&e.jsxs(wC,{children:[e.jsxs(CC,{className:i,children:[e.jsx(Qn,{}),e.jsx($C,{children:YC[i]})]}),e.jsxs(Ji,{children:[VC.includes(i)&&e.jsx(Zi,{className:"btn small",onClick:()=>j(),children:e.jsx(UC,{})}),KC.includes(i)&&e.jsxs(Zi,{className:"btn small",onClick:()=>qC(t.id,j),children:[e.jsx(HC,{}),e.jsx("span",{children:d("Authorize")})]})]})]}),F&&e.jsx(Ji,{children:e.jsxs(Zi,{className:"btn small info-button",onClick:()=>u(!c),children:[e.jsx(WC,{}),e.jsx("span",{children:d("Show Instructions")})]})}),v&&t.enabled&&w&&i==="authorized"&&e.jsx(Ji,{children:e.jsx(BC,{})}),$&&e.jsx(kC,{children:e.jsx(Nn,{active:!0,onClick:y})})]}),r.length>0&&e.jsx(SC,{children:r.map((M,z)=>{try{const L=JSON.parse(M);if(L)return e.jsx("li",{children:e.jsx("pre",{children:JSON.stringify(L,null,2)})},z)}catch{}return e.jsx("li",{children:M},z)})}),e.jsx(IC,{active:c,content:t.type.readmeContent})]})},YC={authorized:d("Authorized"),unauthorized:d("Unauthorized"),pending:d("Checking..."),error:d("Error")},JC=()=>{const t=ne(),{type:n,integration:s,id:i}=V(),{data:o,isFetching:r}=TC(n,s,i),{data:a}=Jp();g.useEffect(()=>{if(a&&s&&!i){const z=a.find(A=>A.handle===n);if(!z)return;const L=z.entries.find(A=>A.type.shortName===s);if(L){const A=L.instances?.[0];if(A){t(`/integrations/${n}/${s}/${A.id}`);return}}}},[a,s,i,t,n]);const[c,u]=g.useState({name:"",handle:"",enabled:!0,metadata:{}}),[p,x]=g.useState({}),{mutate:f,isPending:b}=NC(o?.type.class,i,z=>{if(!z.errors){x({});return}const L={metadata:{}};Object.entries(z.errors).forEach(([A,D])=>{/^metadata\./.test(A)?L.metadata[A.replace(/^metadata\./,"")]=D:L[A]=D}),x(L)});g.useEffect(()=>{b&&x({})},[b]),g.useEffect(()=>{if(o){const z=o.properties.reduce((L,A)=>(L[A.handle]=A.value,L),{});u({name:o.name,handle:o.handle,enabled:o.enabled,metadata:z})}},[o]);const j=I.permissions.integrations==="manage",y=i==="new",w=r||!o,v=()=>{o?.supported&&f(c)};_r(v);const $=a?.find(z=>z.handle===n)?.entries?.find(z=>z.type.shortName===s)?.instances,C=$?.length||0,F=C>1||y,N=!!o?.type?.singleton,M=C>0&&n!==fu.Singles&&!N;return!n||!s?null:w?e.jsxs(Po,{children:[F&&e.jsx(Zl,{children:$?.map(z=>e.jsx(he,{to:`../${n}/${s}/${z.id}`,children:e.jsx("span",{children:z.name})},z.id))}),j&&e.jsx(Jl,{children:e.jsxs("div",{className:"btngroup",children:[M&&e.jsx("button",{type:"button",title:d("Add new integration of the same type"),className:E("btn","add","icon","disabled")}),e.jsx("button",{type:"button",className:E("btn",o?.supported&&"submit","disabled"),children:d("Save")})]})}),e.jsx(LC,{})]}):e.jsxs(Po,{children:[e.jsx(q,{id:"integration-edit",label:o.name,url:`integrations/${n}/${s}${i?`/${i}`:""}`}),e.jsx(FC,{integration:o}),F&&e.jsxs(Zl,{children:[$.map(z=>e.jsx(he,{to:`../${n}/${s}/${z.id}`,children:e.jsx("span",{children:z.name})},z.id)),y&&e.jsx("a",{className:"active",children:e.jsx("span",{children:d("Create a new instance")})})]}),j&&e.jsx(Jl,{children:e.jsxs("div",{className:"btngroup",children:[M&&e.jsx("button",{type:"button",title:d("Add new integration of the same type"),className:E("btn","add","icon",!o.supported&&"disabled"),onClick:()=>t(`/integrations/${n}/${s}/new`)}),e.jsx("button",{type:"button",className:E("btn",o.supported?"submit":"disabled"),onClick:v,children:e.jsx(Z,{loading:b,loadingText:d("Saving"),spinner:!0,children:d("Save")})})]})}),e.jsxs(ra,{children:[e.jsx(GC,{integration:o}),e.jsx(Dt,{property:{handle:"name",label:"Name",required:!0,instructions:d("What this integration will be called in the CP."),type:K.String},updateValue:z=>{u(L=>({...L,name:z,handle:Jo(z,{transliterate:!0,camelize:!0})}))},value:c.name,errors:p?.handle,autoFocus:o.supported}),e.jsx("hr",{}),o.properties.map(z=>e.jsx(jC,{integration:o,property:z,values:c,errors:p,onUpdate:(L,A)=>{u(D=>({...D,metadata:{...D.metadata,[L]:A}}))}},z.handle))]})]})},ZC=()=>e.jsx(Po,{children:e.jsx(ra,{children:e.jsx(at,{title:d("Please select an integration"),subtitle:d("To add a new integration, select its type in the sidebar."),icon:e.jsx(ps,{})})})}),ws={all:["limited-users"],one:t=>[...ws.all,t]},XC=()=>B({queryKey:ws.all,queryFn:()=>T.get("/api/limited-users").then(t=>t.data),staleTime:1/0}),ek=t=>B({queryKey:ws.one(t),queryFn:()=>T.get(`/api/limited-users/${t}`).then(n=>n.data),staleTime:1/0}),tk=t=>{const n=ee();return ce({mutationFn:s=>T.post(`/api/limited-users/${t}`,{name:s.name,description:s.description,items:s.items}),onSuccess:()=>{n.invalidateQueries({queryKey:ws.all})}})},nk=()=>{const t=ee();return ce({mutationFn:n=>T.delete(`/api/limited-users/${n}/delete`),onSuccess:()=>{t.invalidateQueries({queryKey:ws.all})}})},t1=l.div`
  &.craft-4 {
...
`,$k=Object.keys(ht),ec=({fieldId:t,selectedChartType:n,isShown:s,toggle:i,changeType:o})=>{const{mutate:r,isPending:a}=jk();return e.jsxs(d1,{className:E(a&&"loading",s&&"open"),onClick:i,children:[e.jsx(fk,{}),s&&e.jsx(vk,{children:$k.map(c=>e.jsx(wk,{className:n===c&&"selected",onClick:()=>{o(c),r({fieldId:t,chartType:c})},children:c},c))})]})},Ck=l.li`
  display: grid;
...
`,zk=(t,n,s=1)=>n(t).replace(/rgb\((\d+, \d+, \d+)\)/i,`rgba($1, ${s})`),Mk=t=>{const n=Math.max(0,Math.min(1,t)),s=Math.max(0,Math.min(255,Math.round(34.61+n*(1172.33-n*(10793.56-n*(33300.12-n*(38394.49-n*14825.05))))))),i=Math.max(0,Math.min(255,Math.round(23.31+n*(557.33+n*(1225.33-n*(3574.96-n*(1073.77+n*707.56))))))),o=Math.max(0,Math.min(255,Math.round(27.2+n*(3211.1-n*(15327.97-n*(27814-n*(22569.18-n*6838.66)))))));return`rgb(${s}, ${i}, ${o})`},tc=Math.PI/180,u1=({breakdown:t,pie:n})=>{const s=t.filter(({votes:r})=>r>0),i=t.map(({ranking:r})=>zk(r/t.length,Mk)),o=({cx:r,cy:a,midAngle:c,outerRadius:u,percent:p,index:x})=>{const f=u+30,b=r+f*Math.cos(-c*tc),j=a+f*Math.sin(-c*tc);return e.jsxs("text",{x:b,y:j,fill:"black",textAnchor:b>r?"start":"end",dominantBaseline:"central",children:[e.jsx("tspan",{style:{fontWeight:"bold"},children:s[x].label}),e.jsxs("tspan",{style:{fontSize:"12px",fill:"#999"},children:[" ","(",`${(p*100).toFixed(0)}%`,")"]})]},x)};return e.jsx("div",{style:{width:800},children:e.jsx(nt,{width:"100%",height:400,children:e.jsx(G1,{children:e.jsx(Y1,{data:s,dataKey:"votes",nameKey:"label",cx:"50%",cy:"50%",outerRadius:180,innerRadius:n?0:100,fill:"#82ca9d",labelLine:!0,label:o,children:s.map((r,a)=>e.jsx(J1,{fill:i[a]},`cell-${a}`))})})})})},Ik=()=>e.jsx("div",{children:"hidden"}),Ak=l.div`
  display: grid;
  gap: 2px;
...
`,Ok=({breakdown:t})=>e.jsx(e.Fragment,{children:t.map(({label:n,value:s,votes:i,percentage:o,ranking:r})=>e.jsxs(Ak,{children:[e.jsx(Rk,{children:n}),e.jsxs(Dk,{children:[i," ",d("resp.")]}),e.jsxs(Pk,{children:[Math.round(o),"%"]}),e.jsx(Bk,{percentage:o,ranking:r})]},s.toString()))}),_k=({breakdown:t})=>e.jsx(u1,{breakdown:t,pie:!0}),Wk=l.div``,Uk=l.div`
  padding: 10px 15px;

  &:not(:last-child) {
    border-bottom: 1px solid #eff3f6;
  }
`,Hk=({breakdown:t})=>e.jsx(Wk,{children:t.map(n=>e.jsxs(Uk,{children:[n.label,n.votes>1&&` (${n.votes})`]},n.value.toString()))}),qk=l.div`
  width: 900px;
  overflow-x: auto;
...
`,Zk=({breakdown:t})=>e.jsx(qk,{children:e.jsx(Qk,{count:t.length,children:t.map(({label:n,value:s,votes:i,percentage:o,ranking:r})=>e.jsxs(Kk,{children:[e.jsxs(Gk,{children:[Math.round(o),"%"]}),e.jsxs(Yk,{children:[i," ",d("resp.")]}),e.jsx(Jk,{percentage:o,ranking:r}),e.jsx(Vk,{children:n})]},s.toString()))})}),Xk=Object.freeze(Object.defineProperty({__proto__:null,Donut:u1,Hidden:Ik,Horizontal:Ok,Pie:_k,Text:Hk,Vertical:Zk},Symbol.toStringTag,{value:"Module"})),eS=l.div`
  margin-top: 10px;
...
`,nS=l.span`
  color: #a4a6aa;
`,sS=({average:t,max:n})=>t===null||n===null?null:e.jsxs(eS,{children:[d("Average"),": ",e.jsx(tS,{children:t})," ",e.jsxs(nS,{children:["/ ",n]})]}),iS=[ht.Hidden,ht.Text],oS=({field:t,responses:n,breakdown:s,skipped:i,bulletin:o,average:r,max:a})=>{const c=Me(t.class),[u,p]=g.useState(ht.Horizontal),[x,f]=g.useState(!1),{data:b}=o1(),j=g.useRef(null);if(g.useEffect(()=>{if(b){let v=b.fieldSettings.find($=>$.id===t.id)?.chartType;v===void 0&&(v=b.chartDefaults?.[t.class]||ht.Horizontal),p(v)}else p(ht.Horizontal)},[b,t]),g.useEffect(()=>{iS.includes(u)},[u]),!b)return null;const{permissions:y}=b,w=Xk[u];return u===ht.Hidden?e.jsxs(Nk,{children:[y.reports&&e.jsx(ec,{fieldId:t.id,selectedChartType:u,isShown:x,toggle:()=>f(!x),changeType:v=>p(v)}),"--"," ",e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(d("Question <b>{index}</b> Hidden",{index:o}))}})," ","--"]}):e.jsxs(Ck,{ref:j,"data-chart-id":t.id,children:[e.jsx(kk,{children:e.jsx("span",{children:o})}),e.jsxs(Sk,{children:[e.jsxs(Lk,{children:[c&&e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(c.icon)}}),t.label]}),e.jsxs(Fk,{children:[d("{answered} answered, {skipped} skipped",{answered:n-i,skipped:i}),t.multiChoice&&e.jsx(Ek,{children:d("multiple choice")})]}),e.jsx(sS,{average:r,max:a})]}),e.jsx(yk,{children:y.reports&&e.jsx(ec,{fieldId:t.id,selectedChartType:u,isShown:x,toggle:()=>f(!x),changeType:v=>p(v)})}),e.jsx(Tk,{children:e.jsx(w,{breakdown:s})})]})},p1=l.ul`
  display: block;
...
`,CS=()=>{const{installed:t,extra:n,buttons:s}=gS();return e.jsxs(fS,{children:[e.jsx(q,{id:"welcome",label:"Welcome",url:"/forms"}),e.jsx(bS,{children:e.jsx(mS,{})}),e.jsxs(jS,{children:[e.jsx(yS,{style:t.icon,children:e.jsx(hS,{})}),e.jsx(vS,{style:t.text,children:e.jsx("span",{children:d("Awesome! Freeform is successfully installed!")})})]}),e.jsx(wS,{style:n,children:d("Thanks for choosing Freeform! Craft will automatically set you up with the free Express edition. If you're excited to explore even more features, consider switching to the Lite or Pro edition! We've included some helpful links below to get you started. Enjoy!")}),e.jsxs($S,{children:[e.jsx(Rs,{style:s[0],className:"btn",children:e.jsx(he,{to:"/forms",children:d("Create Forms")})}),e.jsx(Rs,{style:s[2],className:"btn",children:e.jsx("a",{href:me("/settings/demo-templates"),children:d("Install Demo")})}),e.jsx(Rs,{style:s[1],className:"btn",children:e.jsx("a",{href:"https://docs.solspace.com/craft/freeform/v5/guides/getting-started/",children:d("Getting Started")})}),e.jsx(Rs,{style:s[1],className:"btn submit",children:e.jsx("a",{href:me("/settings"),children:d("Configure Freeform")})})]})]})},kS=Qo`
  #main-content {
    padding: 0;
  }
...
`,LS=()=>e.jsxs(e.Fragment,{children:[e.jsx(kS,{}),e.jsx(SS,{})]}),FS=new URLSearchParams(window.location.search),sc=FS.get("mode")==="debug",ES={blue:"color: #068FFE",reset:""},ic=new Proxy(console,{get:(t,n)=>n==="colors"?ES:n==="dbg"?sc?(...s)=>{t.log("🀄️🔆🔆🔆🀄️",...s)}:()=>{}:typeof t[n]=="function"&&!sc?()=>{}:t[n]}),TS=document.getElementById("freeform-client"),NS=hc.createRoot(TS);ic.log(`%c
  ███████╗██████╗ ███████╗███████╗███████╗ ██████╗ ██████╗ ███╗   ███╗
  ██╔════╝██╔══██╗██╔════╝██╔════╝██╔════╝██╔═══██╗██╔══██╗████╗ ████║
  █████╗  ██████╔╝█████╗  █████╗  █████╗  ██║   ██║██████╔╝██╔████╔██║
  ██╔══╝  ██╔══██╗██╔══╝  ██╔══╝  ██╔══╝  ██║   ██║██╔══██╗██║╚██╔╝██║
  ██║     ██║  ██║███████╗███████╗██║     ╚██████╔╝██║  ██║██║ ╚═╝ ██║
  ╚═╝     ╚═╝  ╚═╝╚══════╝╚══════╝╚═╝      ╚═════╝ ╚═╝  ╚═╝╚═╝     ╚═╝
`,ic.colors.blue);NS.render(e.jsx(X1,{backend:e0,children:e.jsx(t0,{basename:me("/",!1),children:e.jsx(n0,{client:S0,children:e.jsx(u0,{children:e.jsx(b0,{children:e.jsx(y0,{children:e.jsx(g0,{children:e.jsx(s0,{store:Ih,children:e.jsx(F0,{children:e.jsxs(Sc,{children:[e.jsx(q,{id:"root",label:"Freeform",url:"/forms"}),e.jsx(LS,{}),null,e.jsx(f0,{}),e.jsx(mc,{children:e.jsxs(U,{path:"/",element:e.jsx(Vh,{}),children:[e.jsxs(U,{path:"forms",children:[e.jsx(U,{path:":formId/*",element:e.jsx(W9,{})}),e.jsx(U,{index:!0,element:e.jsx(l$,{})})]}),e.jsx(U,{path:"/surveys/:handle",element:e.jsx(pS,{})}),e.jsx(U,{path:"welcome",element:e.jsx(CS,{})}),e.jsxs(U,{path:"integrations",element:e.jsx(bC,{}),children:[e.jsx(U,{index:!0,element:e.jsx(ZC,{})}),e.jsx(U,{path:":type/:integration/:id?",element:e.jsx(JC,{})})]}),e.jsx(U,{path:"settings/ai",element:e.jsx(Cm,{})}),e.jsxs(U,{path:"import",element:e.jsx(Bl,{}),children:[e.jsx(U,{path:"forms",element:e.jsx(eC,{})}),e.jsx(U,{path:"express-forms",element:e.jsx(G$,{})}),e.jsx(U,{path:"formie/v3",element:e.jsx(J$,{})})]}),e.jsx(U,{path:"export",element:e.jsx(Bl,{}),children:e.jsx(U,{path:"forms",element:e.jsx(q$,{})})}),e.jsxs(U,{path:"settings/limited-users",children:[e.jsx(U,{path:":id",element:e.jsx(xk,{})}),e.jsx(U,{index:!0,element:e.jsx(ck,{})})]}),e.jsx(U,{path:"ab-tests",element:e.jsx(P2,{})})]})})]})})})})})})})})})}));export{Sa as S,X2 as U,io as a,Ed as b,h as c,d as t};

...
/**
 * m260107_132757_AddDigestDateToNotificationLogTable migration.
 */
class m260107_132757_AddDigestDateToNotificationLogTable extends Migration
{
    public function safeUp(): bool
    {
        ...
        // Already handled in m250724_111642_AddDigestDateToNotificationLogTable
        if ($this->db->columnExists($table, 'digestDate')) {
            return true;
        }
    ...
    {
        echo "m260107_132757_AddDigestDateToNotificationLogTable cannot be reverted.\n";

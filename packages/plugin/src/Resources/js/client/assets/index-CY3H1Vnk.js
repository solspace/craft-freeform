...
`,Ad=l.div`
  ...
  box-shadow:
    ...
    0 2px 12px rgb(205 216 228 / 50%);
  border-radius: ${S.lg};
`,Ue={base:["form-monitor"],tests:(t,n)=>[...Ue.base,"tests",t,n],stats:t=>[...Ue.base,"stats",t],testEmailHistory:t=>[...Ue.base,"test-email-history",t],testEmailStatus:t=>[...Ue.base,"test-email-status",t],mailerInfo:()=>[...Ue.base,"mailer-info"]},Sm=(t,n={})=>{const{limit:s=100,offset:i=0}=n;return B({queryKey:Ue.tests(t,{limit:s,offset:i}),queryFn:()=>T.get(`/api/form-monitor/forms/${t}/tests`,{params:{limit:s,offset:i}}).then(o=>o.data),staleTime:0,refetchOnWindowFocus:!1,enabled:!!t})},Rd=(t,n)=>B({queryKey:Ue.stats(t),queryFn:()=>T.get(`/api/form-monitor/forms/${t}/stats`).then(s=>s.data),enabled:n?.enabled??!!t}),Lm=(t,n={})=>{const{limit:s=50,offset:i=0}=n;return B({queryKey:Ue.testEmailHistory({limit:s,offset:i}),queryFn:()=>T.get("/api/form-monitor/test-email/history",{params:{limit:s,offset:i}}).then(o=>o.data),staleTime:0,refetchOnWindowFocus:!1,enabled:!!t})},Fm=(t,n)=>B({queryKey:Ue.testEmailStatus(t||""),queryFn:()=>T.get("/api/form-monitor/test-email/status",{params:{token:t}}).then(s=>s.data),enabled:(n?.enabled??!0)&&!!t,refetchInterval:n?.refetchInterval??!1}),Em=(t,n)=>ce({mutationFn:()=>T.post("/api/form-monitor/test-email",{formId:t}).then(s=>s.data),onSuccess:s=>{n?.onSuccess?.(s)},onError:n?.onError}),Pd=()=>B({queryKey:Ue.mailerInfo(),queryFn:()=>T.get("/api/form-monitor/mailer-info").then(t=>t.data),staleTime:300*1e3});l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.lg};
  padding: ${m.xl};
...
`,J8=({value:t})=>e.jsx(Jt,{"data-edit":d("Click to edit data"),children:e.jsxs(Y8,{children:[!t&&e.jsx(kt,{children:d("Not configured yet")}),e.jsx("div",{dangerouslySetInnerHTML:{__html:O.sanitize(t)}})]})}),Z8=({value:t,property:n,updateValue:s})=>e.jsx(Qe,{preview:e.jsx(J8,{value:t}),excludeClassNames:["tox"],children:e.jsx(V8,{menu:n.menu,statusbar:n.statusbar,toolbar:n.toolbar,value:t,updateValue:s})}),X8=l.div`
  margin-bottom: ${m.sm};

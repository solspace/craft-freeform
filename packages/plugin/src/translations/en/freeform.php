...
return [
    ...
    'Comma-separated Stripe payment method types allowed on subscriptions (e.g. "bacs_debit, card, us_bank_account"). Leave blank to use your Stripe account default.' => 'Comma-separated Stripe payment method types allowed on subscriptions (e.g. "bacs_debit, card, us_bank_account"). Leave blank to use your Stripe account default.',
    'e.g. "bacs_debit"' => 'e.g. "bacs_debit"',

...
return [
    ...
    'Enter allowed terms you would like to be ignored as gibberish, and separate multiples on new lines. Example: RFP, ABB, KUKA or other technical phrases.' => 'Enter allowed terms you would like to be ignored as gibberish, and separate multiples on new lines. Example: RFP, ABB, KUKA or other technical phrases.',
    'Enter any field handles you would like checked for gibberish, and separate multiples on new lines. By default textarea type fields are automatically checked.' => 'Enter any field handles you would like checked for gibberish, and separate multiples on new lines. By default textarea type fields are automatically checked.',
    ...
    'If enabled, email field(s) will be checked for valid MX record.' => 'If enabled, email field(s) will be checked for valid MX record.',
    'Check DNS Block Lists' => 'Check DNS Block Lists',
    'If enabled, IP addresses will be checked against DNS block lists.' => 'If enabled, IP addresses will be checked against DNS block lists.',
    'DNS Block Lists' => 'DNS Block Lists',
    'Enter DNS block lists you would like to be used, and separate multiples on new lines.' => 'Enter DNS block lists you would like to be used, and separate multiples on new lines.',

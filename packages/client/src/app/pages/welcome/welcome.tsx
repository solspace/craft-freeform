  ...
  return (
    <WelcomeWrapper>
      ...
      <ExtraContentWrapper style={extra}>
        {translate('Thank you for choosing Freeform! Craft will install the free Express edition by default. If you wish to maximize your experience, be sure to manually switch the edition to Lite or Pro. Below are a few helpful links to get you started.')}
      </ExtraContentWrapper>

...
return [
    ...
    'Gibberish check failed' => 'Onzincontrole mislukt',
    'Gibberish Word Length' => 'Onzinwoordlengte',
    'Enter any field handles you would like checked for gibberish, and separate multiples on new lines. By default textarea type fields are automatically checked.' => 'Voer de veldhandvatten in die u wilt controleren op onzin en scheid ze op nieuwe regels. Standaard worden velden van het type tekstvak automatisch gecontroleerd.',
    'Check MX Record' => 'MX-record controleren',
    'If enabled, email field values will be checked for valid MX record.' => 'Indien ingeschakeld, worden e-mailveldwaarden gecontroleerd op geldige MX-records.',
    'Check DNS Block Lists' => 'DNS-blokkeerlijsten controleren',
    'If enabled, users IP address will be checked against DNS block lists.' => 'Indien ingeschakeld, worden de IP-adressen van gebruikers gecontroleerd aan de hand van DNS-blokkeerlijsten.',
    'DNS Block Lists' => 'DNS-blokkeerlijsten',
    'Enter DNS block lists you would like to be used, and separate multiples on new lines.' => 'Voer de DNS-blokkeerlijsten in die u wilt gebruiken en scheid ze op nieuwe regels.',

...
`,Vi=c.div`
  ...
  ${q};
`,qe=({preview:t,onEdit:n,onAfterEdit:s,excludeClassNames:o=[],children:i})=>{const[r,a]=m.useState(void 0),l=m.useRef(null),d=m.useRef(null),h=m.useRef(r),{editorAnimation:x}=Tc({wrapper:l.current,editor:d.current,isEditing:r});yt({callback:()=>{a(!1)},isEnabled:r,refObject:d,excludeClassNames:["tagify__dropdown","dropdown-rollout","elementselectormodal",...o]});const g=()=>{a(!1)},b=_1();return Jn(()=>a(!1),!!r),m.useEffect(()=>{h.current&&r===!1&&s?.(),h.current=r},[r,s]),e.jsxs(hd,{ref:l,children:[e.jsx(Ec,{children:e.jsx(ag,{style:{zIndex:b,pointerEvents:r?"initial":"none",...x},className:F(r&&"active","editable-content"),ref:d,children:typeof i=="function"?i(r,g):i})}),e.jsx(Ki,{onClick:()=>{a(!0),n?.()},children:t})]})},Re={all:J(t=>t.layout.fields,t=>t),count:J(t=>t.layout.fields,t=>t.length),one:t=>J(n=>n.layout.fields,n=>n.find(s=>s.uid===t)),hasErrors:J(t=>t.layout.fields,t=>t.some(n=>n.errors!==void 0)),inRow:t=>J(n=>n.layout.fields,n=>n.filter(s=>s.rowUid===t.uid).sort((s,o)=>(s.order??0)-(o.order??0)))},lg=t=>A(Re.all).filter(o=>t.availableFieldTypes.includes("*")?!0:t.availableFieldTypes.includes(o.typeClass)).map(o=>o.properties.handle),cg=c.div`
  display: flex;
  align-items: center;
  gap: ${f.md};
...
`,Jt=({enabled:t,readOnly:n,errors:s,onClick:o})=>{const{is:i}=I.metadata.craft;return e.jsx(ef,{className:F(t&&"on",s&&"error",n&&"readonly",i.atLeast("5.8.0")&&"craft-5_8"),onClick:()=>{n||o?.(!t)},children:e.jsx(ei,{})})},Gs=c.div`
  display: flex;
  justify-content: start;
  align-items: center;
  gap: ${f.sm};
...
`,Fd=c.div`
  padding: 0 !important;
`,tf=c.div``,fn=({value:t,property:n,errors:s,context:o,updateValue:i})=>{const r=n.flags?.includes("readonly")||n.flags?.includes("as-readonly-in-instance");return e.jsx(_,{property:n,errors:s,context:o,preContent:e.jsx(Gs,{children:e.jsx(Fd,{children:e.jsx(Jt,{enabled:t,readOnly:r,onClick:a=>i(a),errors:s})})})})},Td=(t=!0)=>B({queryKey:["autosuggest","env"],queryFn:()=>N.get("/api/autosuggest/env").then(n=>n.data),enabled:t,staleTime:1/0,gcTime:1/0}),nf=t=>!!t,sf=()=>{const{data:t}=Td();return m.useMemo(()=>{const n=[{label:u("Yes"),value:"true",icon:e.jsx("span",{className:"status enabled","aria-hidden":"true"})},{label:u("No"),value:"false",icon:e.jsx("span",{className:"status white","aria-hidden":"true"})}],s=t?.map(i=>({label:i.label,children:i.data.map(r=>({label:r.name,value:r.name,hint:r.hint,icon:e.jsx("span",{className:F("status",nf(r.hint)?"enabled":"white"),"aria-hidden":"true"})}))}))??[];return[...n,...s]},[t])},of=({children:t})=>e.jsxs(rf,{className:"notice has-icon",children:[e.jsx("span",{className:"icon","aria-hidden":"true"}),e.jsx("span",{className:"visually-hidden",children:"Tip: "}),e.jsx("span",{children:t})]}),rf=c.p`
  margin-top: 5px;
...
`,Ji=({value:t,options:n,onClick:s})=>{const o=[];return n.forEach((i,r)=>{"value"in i&&o.push(e.jsx(df,{className:F(i.value===t&&"active"),onClick:()=>s(i.value),children:i.label},r))}),e.jsx(cf,{children:o})},uf=({value:t,property:n,errors:s,updateValue:o})=>{const{options:i}=n;return e.jsx(_,{property:n,errors:s,children:e.jsx(Ji,{value:t,options:i,onClick:r=>o(r)})})},pf=c.div`
  display: flex;
  align-items: center;
  gap: ${f.md};
...
`,Q3=({recipients:t,spanMultiple:n,onChange:s})=>e.jsx(q3,{className:F(n&&"multiple"),children:e.jsx(rr,{value:t,onChange:s})}),Ba=c.div`
  flex: 1 1 0;
...
`,c6={save:e.jsx(o6,{}),back:e.jsx(s6,{}),submit:e.jsx(i6,{})},d6=({value:t,property:n,errors:s,updateValue:o,context:i})=>{const{layouts:r}=n,a=i.order,l={save:i?.buttons?.save,back:i?.buttons?.back,submit:!0},d=[],h=r.map(x=>{const g=x.split(" ").map(b=>b.split("|").filter(y=>l.back||y!=="back").filter(y=>l.save||y!=="save").filter(y=>a!==0||y!=="back").filter(Boolean));return d.some(b=>Es(b,g))?null:(d.push(g),{layout:x,groups:g})}).filter(Boolean);return e.jsx(_,{property:n,errors:s,children:e.jsx(r6,{children:h.map((x,g)=>e.jsx(l6,{onClick:()=>o(x.layout),className:F(t===x.layout&&"active"),children:x.groups.map((b,y)=>e.jsx(a6,{children:b.map((j,w)=>e.jsx(di,{className:F(j,l?.[j]&&"enabled"),children:c6[j]},w))},y))},g))})})},u6=t=>{switch(t){case Ae.Elements:return{source:Ae.Elements,typeClass:"",properties:{}};case Ae.Predefined:return{source:Ae.Predefined,typeClass:"",properties:{}};default:return{source:Ae.Custom,useCustomValues:!1,options:[]}}};class ar extends me.Component{constructor(n){super(n),this.state={hasError:!1}}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(n,s){console.error(n,s)}render(){return this.state.hasError?e.jsx("div",{children:this.props.message}):this.props.children}}c.div`
  display: flex;
  flex-direction: row;
  justify-content: start;
  align-items: center;
...
`),[t,n]);return e.jsxs(su,{onClick:()=>{navigator.clipboard.writeText(i()),o(1),setTimeout(()=>o(0),2e3)},children:[e.jsx("i",{className:F(s===0&&"fa-classic fa-copy",s===1&&"fa-classic fa-check")}),e.jsx("span",{children:u(s===0?"Copy to clipboard":"Copied")})]})},Oa=(t,n)=>({...t,options:[...t.options.slice(0,n),{label:"",value:""},...t.options.slice(n)]}),$6=(t,n)=>({...t,options:n}),To=(t,n,s)=>{const o=[...s.options];return o[t]=n,{...s,options:o}},C6=(t,n)=>{const s=n.options.filter((o,i)=>i!==t);return{...n,options:s}},k6=t=>({...t,options:t.options.filter(n=>!!n.label||!!n.value)}),S6=(t,n)=>n?{...t,useCustomValues:n}:{...t,useCustomValues:n,options:t.options.map(s=>({...s,value:s.label}))},L6=(t,n,s)=>{const o=[...t.options];return{...t,options:qs(o,{$splice:[[n,1],[s,0,o[n]]]})}},F6=({value:t,updateValue:n,defaultValue:s,updateDefaultValue:o,isMultiple:i,allowOptgroup:r,autoUpdateHandle:a})=>{const[l,d]=m.useState(t),h=as(l,500);m.useEffect(()=>{n(h)},[h,n]),m.useEffect(()=>{l.options.length||d(Oa(l,0))},[l]);const{options:x=[],useCustomValues:g=!1}=l,b=m.useRef([]);b.current=x.map((E,T)=>b.current[T]||me.createRef());const{activeCell:y,setActiveCell:j,setCellRef:w,keyPressHandler:v}=Ln(x.length,g?2:1),$=(E,T)=>{j(T!==void 0?T+1:x.length,E),d(Oa(l,T===void 0?x.length:T+1))},C=(E,T,z)=>{let M=[];z&&(x[0]&&x[0].label===""&&x[0].value===""?M=[]:M=[...x]),E.split(`
`).forEach(S=>{let[D,P]=S.split(T);D=D.trim(),P=P?.trim();let ae=!1;D.startsWith("@@")&&(ae=!0,D=D.replace(/^@@/,"").trim()),!(!D&&!P)&&M.push({label:D,value:g&&P?P:D,optgroup:ae})}),d($6(l,M))};return e.jsxs(tt,{children:[e.jsxs(j6,{children:[e.jsx(fn,{property:{label:u("Use custom values"),handle:"useCustomValues",type:Y.Boolean},value:g,updateValue:()=>d(S6(l,!g))}),e.jsxs(v6,{children:[e.jsx(qe,{preview:e.jsxs(su,{children:[e.jsx("i",{className:"fa-duotone fa-list"}),e.jsx("span",{children:u("Add options in bulk")})]}),children:(E,T)=>e.jsx(y6,{open:E,close:T,bulkImport:C})}),e.jsx(w6,{options:l.options,copyValues:g})]})]}),!!x.length&&e.jsxs(ou,{children:[e.jsx(us,{children:e.jsxs(ps,{children:[e.jsx("thead",{children:e.jsxs("tr",{children:[r&&e.jsx("th",{children:u("Optgroup")}),e.jsx("th",{children:u("Label")}),g&&e.jsx("th",{children:u("Value")}),x.length>1&&e.jsxs(e.Fragment,{children:[e.jsx("th",{children:u("Selected")}),e.jsx("th",{colSpan:2,children:u("Actions")})]})]})}),e.jsx("tbody",{children:x.map((E,T)=>e.jsxs(lr,{index:T,dragRef:b.current[T],onDrop:(z,M)=>d(L6(l,z,M)),children:[r&&e.jsx(de,{$tiny:!0,children:e.jsx(kt,{children:e.jsx(Jt,{enabled:E.optgroup,onClick:z=>d(To(T,{...E,optgroup:z},l))})})}),e.jsx(de,{children:e.jsx(nt,{type:"text",value:E.label,placeholder:u("Label"),autoFocus:y===`${T}:0`,ref:z=>w(z,T,0),onFocus:()=>j(T,0),onKeyDown:v({onEnter:({shiftKey:z})=>{$(0,z?T:void 0)}}),onChange:z=>d(To(T,{...E,label:z.target.value,value:a||!g?z.target.value:E.value},l))})}),g&&e.jsx(de,{children:e.jsx(nt,{type:"text",className:"code",value:E.value,placeholder:u("Value"),autoFocus:y===`${T}:1`,ref:z=>w(z,T,1),onFocus:()=>j(T,1),onKeyDown:v({onEnter:({shiftKey:z})=>{$(1,z?T:void 0)}}),onChange:z=>d(To(T,{...E,value:z.target.value},l))})}),x.length>1&&e.jsxs(e.Fragment,{children:[e.jsx(de,{$tiny:!0,children:e.jsx(kt,{children:e.jsx(fn,{property:{label:"",handle:`${T}-check`,type:Y.Boolean,width:50},value:i?s.includes(E.value):E.value===s,updateValue:()=>{if(i){const z=s;o(z.includes(E.value)?z.filter(M=>M!==E.value):[...z,E.value])}else o(E.value===s?"":E.value)}})})}),e.jsx(de,{$tiny:!0,children:e.jsx(kt,{children:e.jsx(Rt,{ref:b.current[T],className:"handle",children:e.jsx(Zs,{})})})}),e.jsx(de,{$tiny:!0,children:e.jsx(kt,{children:e.jsx(Rt,{onClick:()=>{d(C6(T,l)),j(Math.max(T-1,0),0)},children:e.jsx(cs,{})})})})]})]},T))})]})}),e.jsx(ls,{label:"Add an option",onClick:()=>$(0)})]}),e.jsx(Yt,{children:e.jsx("span",{dangerouslySetInnerHTML:{__html:O.sanitize(u("Press <b>enter</b> while editing a cell to add a new row."))}})})]})},T6=c(Gi)`
  display: flex;
...
`,B7=({field:t})=>{const n=I.limitations.can("rules.tab.fields"),{uid:s,button:o}=K(),i=te(),r=Wt(),{setLastTab:a}=_e("rules"),l=Ne(t?.typeClass),d=s===t.uid,h=A(ln.one(s)),x=A(kr.one(s)),g=A(Sr.one),b=A($r.one(s,o)),y=A(ln.hasRule(t.uid)),j=r.pathname.endsWith("/rules/submit"),w=A(ln.isInCondition(t.uid)),v=h?.conditions.find($=>$.field===t.uid)||x?.conditions.find($=>$.field===t.uid)||j&&g?.conditions.find($=>$.field===t.uid)||o&&b?.conditions.find($=>$.field===t.uid);return t?.properties===void 0?null:e.jsxs(P7,{onClick:$=>{if($.stopPropagation(),n){const C=s===t.uid?"":`field/${t.uid}`;a(C),i(C)}},className:F(l?.type==="group"&&"group",d&&"active",y&&"has-rule",w&&"is-in-condition",v&&"is-in-condition-active",!n&&"read-only",Nn.negative.includes(v?.operator)&&"not-equals"),children:[e.jsxs(Qu,{children:[e.jsx(Ku,{dangerouslySetInnerHTML:{__html:O.sanitize(l?.icon)}}),e.jsx(D7,{dangerouslySetInnerHTML:{__html:O.sanitize(t.properties.label||l?.name)}})]}),l?.type==="group"&&e.jsx(Vu,{children:e.jsx(Gu,{layoutUid:t.properties.layout})})]})},O7=({row:t})=>{const n=A(Re.inRow(t));return e.jsx(qu,{children:n.map(s=>e.jsx(B7,{field:s},s.uid))})},W7=c.div`
  display: flex;
  flex-direction: column;
  gap: ${f.xs};
...
`,U7=({page:t,button:{handle:n,label:s}})=>{const o=I.limitations.can("rules.tab.buttons"),{uid:i,button:r}=K(),a=te(),{setLastTab:l}=_e("rules"),d=i===t.uid&&n===r,h=A($r.hasRule(t.uid,n));return o?e.jsx(Yu,{type:"button",className:F(n,d&&"active",h&&"has-rule"),onClick:()=>{const x=d?"":`page/${t.uid}/buttons/${n}`;l(x),a(x)},children:u(s)}):null},q7=({page:t})=>{const n=vu(t);return e.jsx(_7,{children:n.map((s,o)=>e.jsx(H7,{className:"page-buttons",children:s.map((i,r)=>e.jsx(U7,{button:i,page:t},r))},o))})},Q7=t=>e.jsx(R,{height:"1em",viewBox:"0 0 384 512",...t,children:e.jsx("path",{d:"M64 496c-26.5 0-48-21.5-48-48V64c0-26.5 21.5-48 48-48H204.1c1.3 0 2.6 .1 3.9 .2V136c0 22.1 17.9 40 40 40H367.8c.2 1.3 .2 2.6 .2 3.9V448c0 26.5-21.5 48-48 48H64zM358.6 157.3c.9 .9 1.7 1.8 2.4 2.7H248c-13.3 0-24-10.7-24-24V22.9c1 .8 1.9 1.6 2.7 2.4L358.6 157.3zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V179.9c0-12.7-5.1-24.9-14.1-33.9L238.1 14.1c-9-9-21.2-14.1-33.9-14.1H64zm40 256c-4.4 0-8 3.6-8 8s3.6 8 8 8H280c4.4 0 8-3.6 8-8s-3.6-8-8-8H104zm0 64c-4.4 0-8 3.6-8 8s3.6 8 8 8H280c4.4 0 8-3.6 8-8s-3.6-8-8-8H104zm0 64c-4.4 0-8 3.6-8 8s3.6 8 8 8H280c4.4 0 8-3.6 8-8s-3.6-8-8-8H104z"})}),K7=c.div`
  display: flex;
  flex: 1;
  flex-direction: column;
`,V7=c.button`
...
`,eC=Object.keys(ct),Tl=({fieldId:t,selectedChartType:n,isShown:s,toggle:o,changeType:i})=>{const{mutate:r,isPending:a}=Y$();return e.jsxs(Mp,{className:F(a&&"loading",s&&"open"),onClick:o,children:[e.jsx(V$,{}),s&&e.jsx(Z$,{children:eC.map(l=>e.jsx(X$,{className:n===l&&"selected",onClick:()=>{i(l),r({fieldId:t,chartType:l})},children:l},l))})]})},tC=c.li`
  display: grid;

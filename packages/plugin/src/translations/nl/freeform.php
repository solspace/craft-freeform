...
return [
    ...
    'Auto Grow' => 'Automatisch meegroeien',
    'Automatically adjust the height of this field to fit its contents.' => 'Past de hoogte van dit veld automatisch aan de inhoud aan.',
    'Maximum Height' => 'Maximale hoogte',
    'The maximum height in pixels before scrolling. Leave blank for no limit.' => 'De maximale hoogte in pixels voordat scrollen nodig is. Laat leeg voor geen limiet.',
    ...
    'Sends notifications to fixed recipients, such as admins or internal team members.' => 'Verstuurt meldingen naar vaste ontvangers, zoals beheerders of interne teamleden.',
    'Sends notifications only when configured rules or field values match.' => 'Verstuurt alleen meldingen wanneer geconfigureerde regels of veldwaarden overeenkomen.',
    'Routes notifications based on the user’s selected option. To email the submitter, use Email Field instead.' => 'Routeert meldingen op basis van de door de gebruiker geselecteerde optie. Gebruik in plaats daarvan E-mailveld om de inzender een e-mail te sturen.',
    'Sends a notification to an address entered in an Email field, such as a submitter confirmation email.' => 'Verstuurt een melding naar een adres dat is ingevoerd in een e-mailveld, bijvoorbeeld een bevestigingsmail voor de inzender.',
    'Admin' => 'Beheerder',
    ...
    'Show Processing Overlay on Submit' => 'Toon verwerkingsoverlay bij verzenden',
    'Dim the form and show a centered spinner and processing message while a submission is being processed.' => 'Dim het formulier en toon tijdens de verwerking een laadindicator en bericht in het midden.',
    'Text shown on the submit button or processing overlay when the form is processing.' => 'Tekst die tijdens de verwerking op de verzendknop of in de verwerkingsoverlay wordt getoond.',
    ...
    'Block' => 'Blokkeren',
    'Blocked' => 'Geblokkeerd',
    'Block IP Address' => 'IP-adres blokkeren',
    'Could not block IP Address.' => 'Kon IP-adres niet blokkeren.',
    'Block IP Address %s?' => 'IP-adres %s blokkeren?',
    'IP Address is not valid.' => 'IP-adres is ongeldig.',
    'IP Address blocked successfully.' => 'IP-adres succesvol geblokkeerd.',
    'IP Address was missing.' => 'IP-adres ontbrak.',
    'Could not create Blocked IP Addresses integration.' => 'Kon integratie voor geblokkeerde IP-adressen niet aanmaken.',
    'Delete' => 'Verwijder',
    'Delete...' => 'Verwijder...',
    ...
    'Custom Cron Schedule' => 'Aangepast Cron-schema',
    ...
    "Specify how often and which days (if applicable) you'd like to receive the email notifications. Custom schedules are evaluated in the site timezone." => 'Geef aan hoe vaak en op welke dagen (indien van toepassing) u de e-mailmeldingen wilt ontvangen. Aangepaste schema’s worden geëvalueerd in de tijdzone van de site.',
    'Enter a standard five-part cron expression (minute, hour, day of month, month, day of week). For example, `0 0 1 * *` runs monthly on the 1st, `0 0 15 * *` runs monthly on the 15th, and `0 0 1,15 * *` runs on both.' => 'Voer een standaard Cron-expressie met vijf delen in (minuut, uur, dag van de maand, maand, dag van de week). Voorbeelden: `0 0 1 * *` wordt maandelijks op de 1e uitgevoerd, `0 0 15 * *` op de 15e en `0 0 1,15 * *` op beide dagen.',
    "For reliable delivery, configure your server to run `php craft freeform/export-notifications/run` every minute. Use <a href='https://crontab.guru/' target='_blank' rel='noopener'>Crontab.guru</a> to build and check an expression." => "Configureer voor betrouwbare bezorging uw server om `php craft freeform/export-notifications/run` elke minuut uit te voeren. Gebruik <a href='https://crontab.guru/' target='_blank' rel='noopener'>Crontab.guru</a> om een expressie te maken en te controleren.",
    'A cron expression is required for a custom schedule.' => 'Een Cron-expressie is vereist voor een aangepast schema.',
    'Enter a valid five-part cron expression.' => 'Voer een geldige Cron-expressie met vijf delen in.',
    ...
    'Payment configurations apply to one-time payments only. To limit methods on subscriptions, use the Subscription Payment Methods setting below.' => 'Betaalconfiguraties gelden alleen voor eenmalige betalingen. Gebruik de instelling Betaalmethoden voor abonnementen hieronder om methoden voor abonnementen te beperken.',
    'e.g. "pmc_1PxtjcD6lnhW9qH54DHV8LbZ"' => 'bijv. "pmc_1PxtjcD6lnhW9qH54DHV8LbZ"',
    'Subscription Payment Methods' => 'Betaalmethoden voor abonnementen',
    'Comma-separated Stripe payment method types allowed on subscriptions (e.g. `card, paypal, bacs_debit, us_bank_account`). Leave blank to use your Stripe account default.' => 'Door komma’s gescheiden Stripe-betaalmethodetypes die zijn toegestaan bij abonnementen (bijv. `card, paypal, bacs_debit, us_bank_account`). Laat leeg om de standaardinstelling van je Stripe-account te gebruiken.',
    'e.g. "card, paypal, bacs_debit, us_bank_account"' => 'bijv. "card, paypal, bacs_debit, us_bank_account"',
    ...
    'Allow Assigning Permissions to Other Users' => 'Toewijzen van rechten aan andere gebruikers toestaan',
    'Lets a non-admin user hand out form and submission permissions to other users (the \'by Form\' checkboxes on another user\'s Permissions screen). Craft only lets someone assign a permission they hold themselves, so enabling this automatically grants this user access to every form and its submissions, both existing forms and any added later. Because of that, a user with this enabled effectively has access to all forms and cannot be limited to a subset.' => 'Hiermee kan een niet-beheerder formulier- en inzendingsrechten aan andere gebruikers toewijzen (de selectievakjes \'per formulier\' op het rechtenscherm van een andere gebruiker). Craft staat alleen toe dat iemand een recht toewijst dat hij zelf heeft. Door dit in te schakelen krijgt deze gebruiker daarom automatisch toegang tot elk formulier en de bijbehorende inzendingen, zowel bestaande als later toegevoegde formulieren. Daardoor heeft een gebruiker met deze optie ingeschakeld feitelijk toegang tot alle formulieren en kan hij niet tot een subset worden beperkt.',
    'This capability only takes effect on individual users. Assigning it to a user group has no effect - enable it on each user who should be able to hand out form access.' => 'Deze mogelijkheid heeft alleen effect op individuele gebruikers. Toewijzen aan een gebruikersgroep heeft geen effect - schakel het in voor elke gebruiker die formuliertoegang moet kunnen verlenen.',
    ...
    'Nationality: Afghan' => 'Afghaans',
    'Nationality: Albanian' => 'Albanees',
    'Nationality: Algerian' => 'Algerijns',
    'Nationality: American' => 'Amerikaans',
    'Nationality: Andorran' => 'Andorrees',
    'Nationality: Angolan' => 'Angolees',
    'Nationality: Antiguan and Barbudan' => 'Antiguaans en Barbudiaans',
    'Nationality: Argentine' => 'Argentijns',
    'Nationality: Armenian' => 'Armeens',
    'Nationality: Australian' => 'Australisch',
    'Nationality: Austrian' => 'Oostenrijks',
    'Nationality: Azerbaijani' => 'Azerbeidzjaans',
    'Nationality: Bahamian' => 'Bahamaans',
    'Nationality: Bahraini' => 'Bahreins',
    'Nationality: Bangladeshi' => 'Bengaals',
    'Nationality: Barbadian' => 'Barbadiaans',
    'Nationality: Basotho' => 'Basotho',
    'Nationality: Belarusian' => 'Wit-Russisch',
    'Nationality: Belgian' => 'Belgisch',
    'Nationality: Belizean' => 'Belizaans',
    'Nationality: Beninese' => 'Benins',
    'Nationality: Bhutanese' => 'Bhutaans',
    'Nationality: Bissau-Guinean' => 'Bissau-Guinees',
    'Nationality: Bolivian' => 'Boliviaans',
    'Nationality: Bosnian and Herzegovinian' => 'Bosnisch en Herzegovijns',
    'Nationality: Botswanan' => 'Botswaans',
    'Nationality: Brazilian' => 'Braziliaans',
    'Nationality: British' => 'Brits',
    'Nationality: Bruneian' => 'Bruneis',
    'Nationality: Bulgarian' => 'Bulgaars',
    'Nationality: Burkinabé' => 'Burkinees',
    'Nationality: Burmese' => 'Birmees',
    'Nationality: Burundian' => 'Burundees',
    'Nationality: Cabo Verdean' => 'Kaapverdisch',
    'Nationality: Cambodian' => 'Cambodjaans',
    'Nationality: Cameroonian' => 'Kameroens',
    'Nationality: Canadian' => 'Canadees',
    'Nationality: Central African' => 'Centraal-Afrikaans',
    'Nationality: Chadian' => 'Tsjadisch',
    'Nationality: Chilean' => 'Chileens',
    'Nationality: Chinese' => 'Chinees',
    'Nationality: Colombian' => 'Colombiaans',
    'Nationality: Comorian' => 'Comorees',
    'Nationality: Congolese (DR Congo)' => 'Congolees (DR Congo)',
    'Nationality: Congolese (Republic of the Congo)' => 'Congolees (Republiek Congo)',
    'Nationality: Costa Rican' => 'Costa Ricaans',
    'Nationality: Croatian' => 'Kroatisch',
    'Nationality: Cuban' => 'Cubaans',
    'Nationality: Cypriot' => 'Cypriotisch',
    'Nationality: Czech' => 'Tsjechisch',
    'Nationality: Danish' => 'Deens',
    'Nationality: Djiboutian' => 'Djiboutiaans',
    'Nationality: Dominican (Dominica)' => 'Dominicaans (Dominica)',
    'Nationality: Dominican (Dominican Republic)' => 'Dominicaans (Dominicaanse Republiek)',
    'Nationality: Dutch' => 'Nederlands',
    'Nationality: Ecuadorian' => 'Ecuadoraans',
    'Nationality: Egyptian' => 'Egyptisch',
    'Nationality: Emirati' => 'Emiratisch',
    'Nationality: Equatorial Guinean' => 'Equatoriaal-Guinees',
    'Nationality: Eritrean' => 'Eritrees',
    'Nationality: Estonian' => 'Ests',
    'Nationality: Eswatini' => 'Eswatinisch',
    'Nationality: Ethiopian' => 'Ethiopisch',
    'Nationality: Fijian' => 'Fijisch',
    'Nationality: Filipino' => 'Filipijns',
    'Nationality: Finnish' => 'Fins',
    'Nationality: French' => 'Frans',
    'Nationality: Gabonese' => 'Gabonees',
    'Nationality: Gambian' => 'Gambiaans',
    'Nationality: Georgian' => 'Georgisch',
    'Nationality: German' => 'Duits',
    'Nationality: Ghanaian' => 'Ghanees',
    'Nationality: Greek' => 'Grieks',
    'Nationality: Grenadian' => 'Grenadiaans',
    'Nationality: Guatemalan' => 'Guatemalteeks',
    'Nationality: Guinean' => 'Guinees',
    'Nationality: Guyanese' => 'Guyaans',
    'Nationality: Haitian' => 'Haïtiaans',
    'Nationality: Honduran' => 'Hondurees',
    'Nationality: Hungarian' => 'Hongaars',
    'Nationality: Icelandic' => 'IJslands',
    'Nationality: Indian' => 'Indiaas',
    'Nationality: Indonesian' => 'Indonesisch',
    'Nationality: Iranian' => 'Iraans',
    'Nationality: Iraqi' => 'Iraaks',
    'Nationality: Irish' => 'Iers',
    'Nationality: Israeli' => 'Israëlisch',
    'Nationality: Italian' => 'Italiaans',
    'Nationality: Ivorian' => 'Ivoriaans',
    'Nationality: Jamaican' => 'Jamaicaans',
    'Nationality: Japanese' => 'Japans',
    'Nationality: Jordanian' => 'Jordaans',
    'Nationality: Kazakhstani' => 'Kazachs',
    'Nationality: Kenyan' => 'Keniaans',
    'Nationality: Kiribati' => 'Kiribatisch',
    'Nationality: Kittitian and Nevisian' => 'Kittitiaans en Nevisiaans',
    'Nationality: Kuwaiti' => 'Koeweits',
    'Nationality: Kyrgyzstani' => 'Kirgizisch',
    'Nationality: Lao' => 'Laotiaans',
    'Nationality: Latvian' => 'Lets',
    'Nationality: Lebanese' => 'Libanees',
    'Nationality: Liberian' => 'Liberiaans',
    'Nationality: Libyan' => 'Libisch',
    'Nationality: Liechtensteiner' => 'Liechtensteins',
    'Nationality: Lithuanian' => 'Litouws',
    'Nationality: Luxembourgish' => 'Luxemburgs',
    'Nationality: Malagasy' => 'Malagassisch',
    'Nationality: Malawian' => 'Malawisch',
    'Nationality: Malaysian' => 'Maleisisch',
    'Nationality: Maldivian' => 'Maldivisch',
    'Nationality: Malian' => 'Malinees',
    'Nationality: Maltese' => 'Maltees',
    'Nationality: Marshallese' => 'Marshallees',
    'Nationality: Mauritanian' => 'Mauritaans',
    'Nationality: Mauritian' => 'Mauritiaans',
    'Nationality: Mexican' => 'Mexicaans',
    'Nationality: Micronesian' => 'Micronesisch',
    'Nationality: Moldovan' => 'Moldavisch',
    'Nationality: Monégasque' => 'Monegaskisch',
    'Nationality: Mongolian' => 'Mongools',
    'Nationality: Montenegrin' => 'Montenegrijns',
    'Nationality: Moroccan' => 'Marokkaans',
    'Nationality: Mozambican' => 'Mozambikaans',
    'Nationality: Namibian' => 'Namibisch',
    'Nationality: Nauruan' => 'Nauruaans',
    'Nationality: Nepalese' => 'Nepalees',
    'Nationality: New Zealander' => 'Nieuw-Zeelands',
    'Nationality: Nicaraguan' => 'Nicaraguaans',
    'Nationality: Nigerian' => 'Nigeriaans',
    'Nationality: Nigerien' => 'Nigerees',
    'Nationality: North Korean' => 'Noord-Koreaans',
    'Nationality: North Macedonian' => 'Noord-Macedonisch',
    'Nationality: Norwegian' => 'Noors',
    'Nationality: Omani' => 'Omaans',
    'Nationality: Pakistani' => 'Pakistaans',
    'Nationality: Palauan' => 'Palaus',
    'Nationality: Palestinian' => 'Palestijns',
    'Nationality: Panamanian' => 'Panamees',
    'Nationality: Papua New Guinean' => 'Papoea-Nieuw-Guinees',
    'Nationality: Paraguayan' => 'Paraguayaans',
    'Nationality: Peruvian' => 'Peruaans',
    'Nationality: Polish' => 'Pools',
    'Nationality: Portuguese' => 'Portugees',
    'Nationality: Qatari' => 'Qatarees',
    'Nationality: Romanian' => 'Roemeens',
    'Nationality: Russian' => 'Russisch',
    'Nationality: Rwandan' => 'Rwandees',
    'Nationality: Saint Lucian' => 'Saint Luciaans',
    'Nationality: Salvadoran' => 'Salvadoraans',
    'Nationality: Sammarinese' => 'San Marinees',
    'Nationality: Samoan' => 'Samoaans',
    'Nationality: São Toméan' => 'Santomees',
    'Nationality: Saudi Arabian' => 'Saoedi-Arabisch',
    'Nationality: Senegalese' => 'Senegalees',
    'Nationality: Serbian' => 'Servisch',
    'Nationality: Seychellois' => 'Seychels',
    'Nationality: Sierra Leonean' => 'Sierra Leoons',
    'Nationality: Singaporean' => 'Singaporees',
    'Nationality: Slovak' => 'Slowaaks',
    'Nationality: Slovenian' => 'Sloveens',
    'Nationality: Solomon Islander' => 'Salomoneilands',
    'Nationality: Somali' => 'Somalisch',
    'Nationality: South African' => 'Zuid-Afrikaans',
    'Nationality: South Korean' => 'Zuid-Koreaans',
    'Nationality: South Sudanese' => 'Zuid-Soedanees',
    'Nationality: Spanish' => 'Spaans',
    'Nationality: Sri Lankan' => 'Sri Lankaans',
    'Nationality: Sudanese' => 'Soedanees',
    'Nationality: Surinamese' => 'Surinaams',
    'Nationality: Swedish' => 'Zweeds',
    'Nationality: Swiss' => 'Zwitsers',
    'Nationality: Syrian' => 'Syrisch',
    'Nationality: Taiwanese' => 'Taiwanees',
    'Nationality: Tajikistani' => 'Tadzjieks',
    'Nationality: Tanzanian' => 'Tanzaniaans',
    'Nationality: Thai' => 'Thais',
    'Nationality: Timorese' => 'Timorees',
    'Nationality: Togolese' => 'Togolees',
    'Nationality: Tongan' => 'Tongaans',
    'Nationality: Trinidadian and Tobagonian' => 'Trinidadiaans en Tobagoniaans',
    'Nationality: Tunisian' => 'Tunesisch',
    'Nationality: Turkish' => 'Turks',
    'Nationality: Turkmen' => 'Turkmeens',
    'Nationality: Tuvaluan' => 'Tuvaluaans',
    'Nationality: Ugandan' => 'Oegandees',
    'Nationality: Ukrainian' => 'Oekraïens',
    'Nationality: Uruguayan' => 'Uruguayaans',
    'Nationality: Uzbekistani' => 'Oezbeeks',
    'Nationality: Vanuatuan' => 'Vanuatuaans',
    'Nationality: Vatican' => 'Vaticaans',
    'Nationality: Venezuelan' => 'Venezolaans',
    'Nationality: Vietnamese' => 'Vietnamees',
    'Nationality: Vincentian' => 'Vincentiaans',
    ...
    'Time Intervals' => 'Tijdsintervallen',
    'Age Ranges' => 'Leeftijdsgroepen',
    'Company Sizes' => 'Bedrijfsgroottes',
    'Industries' => 'Sectoren',
    'Employment Statuses' => 'Arbeidsstatussen',
    'Continents' => 'Continenten',
    'Choose a country to list its states, regions, provinces, or constituent countries.' => 'Kies een land om de staten, regio’s, provincies of landsdelen weer te geven.',
    'Survey Scale' => 'Enquêteschaal',
    'Identifiers are scores from 1 (lowest) to 5 (highest).' => 'De identificatoren zijn scores van 1 (laagste) tot 5 (hoogste).',
    ...
    'End Time' => 'Eindtijd',
    'Enter a time in 24-hour HH:MM format, e.g. 09:00.' => 'Voer een tijd in de 24-uursnotatie HH:MM in, bijvoorbeeld 09:00.',
    'Enter a time in 24-hour HH:MM format, e.g. 17:00. Must be on the same day and at or after the start time.' => 'Voer een tijd in de 24-uursnotatie HH:MM in, bijvoorbeeld 17:00. Deze moet op dezelfde dag vallen en gelijk zijn aan of later zijn dan de begintijd.',
    'Interval' => 'Interval',
    '15 minutes' => '15 minuten',
    '30 minutes' => '30 minuten',
    '60 minutes' => '60 minuten',
    'Time Label Format' => 'Tijdnotatie van het label',
    'Stored values always use 24-hour HH:MM format. These options do not check appointment availability.' => 'Opgeslagen waarden gebruiken altijd de 24-uursnotatie HH:MM. Deze opties controleren niet of afspraken beschikbaar zijn.',
    '24-hour' => '24-uursnotatie',
    '12-hour' => '12-uursnotatie',
    'AM' => 'AM',
    'PM' => 'PM',
    'Under 18' => 'Jonger dan 18',
    '65 or older' => '65 jaar of ouder',
    'Prefer not to say' => 'Zeg ik liever niet',
    '1 employee' => '1 medewerker',
    '2–10 employees' => '2–10 medewerkers',
    '11–50 employees' => '11–50 medewerkers',
    '51–200 employees' => '51–200 medewerkers',
    '201–500 employees' => '201–500 medewerkers',
    '501–1,000 employees' => '501–1.000 medewerkers',
    '1,001–5,000 employees' => '1.001–5.000 medewerkers',
    '5,001 or more employees' => '5.001 of meer medewerkers',
    'Agriculture, Forestry and Fishing' => 'Landbouw, bosbouw en visserij',
    'Arts and Entertainment' => 'Kunst en entertainment',
    'Construction' => 'Bouw',
    'Education' => 'Onderwijs',
    'Energy and Utilities' => 'Energie en nutsvoorzieningen',
    'Finance and Insurance' => 'Financiën en verzekeringen',
    'Government and Public Administration' => 'Overheid en openbaar bestuur',
    'Healthcare and Social Assistance' => 'Gezondheidszorg en maatschappelijke dienstverlening',
    'Hospitality and Food Services' => 'Horeca',
    'Information Technology' => 'Informatietechnologie',
    'Manufacturing' => 'Maakindustrie',
    'Media and Communications' => 'Media en communicatie',
    'Mining and Extraction' => 'Mijnbouw en winning',
    'Nonprofit and Charitable Organizations' => 'Non-profitorganisaties en goede doelen',
    'Professional and Business Services' => 'Professionele en zakelijke dienstverlening',
    'Real Estate' => 'Vastgoed',
    'Retail' => 'Detailhandel',
    'Transportation and Logistics' => 'Transport en logistiek',
    'Wholesale' => 'Groothandel',
    'Employed full-time' => 'In loondienst, voltijds',
    'Employed part-time' => 'In loondienst, deeltijds',
    'Self-employed' => 'Zelfstandig ondernemer',
    'Unemployed' => 'Werkloos',
    'Student' => 'Student',
    'Retired' => 'Gepensioneerd',
    'Homemaker' => 'Huisvrouw/huisman',
    'Unable to work' => 'Niet in staat om te werken',
    'Africa' => 'Afrika',
    'Asia' => 'Azië',
    'Europe' => 'Europa',
    ...
    'Strongly disagree' => 'Helemaal mee oneens',
    'Disagree' => 'Mee oneens',
    'Neither agree nor disagree' => 'Niet mee eens, niet mee oneens',
    'Agree' => 'Mee eens',
    'Strongly agree' => 'Helemaal mee eens',
    'Very dissatisfied' => 'Zeer ontevreden',
    'Dissatisfied' => 'Ontevreden',
    'Neither satisfied nor dissatisfied' => 'Niet tevreden, niet ontevreden',
    'Satisfied' => 'Tevreden',
    ...
    'Slightly important' => 'Enigszins belangrijk',
    'Moderately important' => 'Redelijk belangrijk',
    'Very important' => 'Zeer belangrijk',
    'Extremely important' => 'Uiterst belangrijk',
    'Very unlikely' => 'Zeer onwaarschijnlijk',
    'Unlikely' => 'Onwaarschijnlijk',
    'Neither likely nor unlikely' => 'Niet waarschijnlijk, niet onwaarschijnlijk',
    ...
    'Lombardy' => 'Lombardije',
    'Trentino-South Tyrol' => 'Trentino-Zuid-Tirol',
    'Veneto' => 'Veneto',
    ...
    'Scotland' => 'Schotland',
    'Wales' => 'Wales',
    'Browser Autofill' => 'Automatisch invullen door browser',
    'Use browser default' => 'Standaardinstelling van browser gebruiken',
    'Tell browsers what information this field collects so they can offer saved details.' => 'Geef aan welke gegevens dit veld verzamelt, zodat browsers opgeslagen gegevens kunnen voorstellen.',
    'On' => 'Aan',
    'Off' => 'Uit',
    'Full name' => 'Volledige naam',
    'Given name' => 'Voornaam',

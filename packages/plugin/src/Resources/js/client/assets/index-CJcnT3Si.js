const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ai.usage-chart-D23ZZjg8.js","./vendor-BX5MopCP.js","./date-fns-BTAAV4UA.js","./vendor-BOeeMEG-.css"])))=>i.map(i=>d[i]);
...
`,Tn=({active:t,onClick:n,...s})=>{const i=g.useRef(null),o=kt(i),a={...hg({active:t,hovering:o}),...s?.style};return delete s.style,e.jsx(Od,{type:"button",ref:i,style:a,onClick:n,...s,children:e.jsx(Yc,{})})},xg={dark:ne`
...
`,dr=l.div`
  ...
  ${Q};
`,Qe=({preview:t,onEdit:n,onAfterEdit:s,excludeClassNames:i=[],children:o})=>{const[r,a]=g.useState(void 0),c=g.useRef(null),u=g.useRef(null),h=g.useRef(r),{editorAnimation:x}=td({wrapper:c.current,editor:u.current,isEditing:r});Ct({callback:()=>{a(!1)},isEnabled:r,refObject:u,excludeClassNames:["tagify__dropdown","dropdown-rollout","elementselectormodal",...i]});const f=()=>{a(!1)},b=f0();return os(()=>a(!1),!!r),g.useEffect(()=>{h.current&&r===!1&&s?.(),h.current=r},[r,s]),e.jsxs(Ud,{ref:c,children:[e.jsx(nd,{children:e.jsx($f,{style:{zIndex:b,pointerEvents:r?"initial":"none",...x},className:E(r&&"active","editable-content"),ref:u,children:typeof o=="function"?o(r,f):o})}),e.jsx(cr,{onClick:()=>{a(!0),n?.()},children:t})]})},Ae={all:Z(t=>t.layout.fields,t=>t),count:Z(t=>t.layout.fields,t=>t.length),one:t=>Z(n=>n.layout.fields,n=>n.find(s=>s.uid===t)),hasErrors:Z(t=>t.layout.fields,t=>t.some(n=>n.errors!==void 0)),inRow:t=>Z(n=>n.layout.fields,n=>n.filter(s=>s.rowUid===t.uid).sort((s,i)=>(s.order??0)-(i.order??0)))},Cf=t=>P(Ae.all).filter(i=>t.availableFieldTypes.includes("*")?!0:t.availableFieldTypes.includes(i.typeClass)).map(i=>i.properties.handle),kf=l.div`
  display: flex;
  align-items: center;
  gap: ${m.md};
...
`,sb=({onCreate:t})=>e.jsx(Cu,{className:"dashed",onClick:t,children:e.jsx(wu,{children:e.jsxs(ib,{children:[e.jsx("i",{className:"fa-solid fa-plus"}),d("Create New Template")]})})}),ib=l.div`
  display: flex;
  align-items: center;
  gap: 8px;
...
`,cj=({id:t,name:n,handle:s,icon:i})=>{const{setLastTab:o}=We("integrations"),r=P(as.one(t));if(!r)return null;const a=r.errors&&Object.values(r.errors).some(c=>c.length>0);return e.jsx(rj,{children:e.jsxs(he,{onClick:()=>o(`${t}/${s}`),to:`${t}/${s}`,className:E(!r.enabled&&"inactive",a&&"errors"),children:[!i&&e.jsx(jl,{children:e.jsx(oj,{})}),!!i&&e.jsx(jl,{dangerouslySetInnerHTML:{__html:O.sanitize(i)}}),e.jsx(aj,{children:n}),e.jsx(lj,{$enabled:r.enabled,className:E("status-dot")})]})})},dj=({label:t,children:n})=>e.jsxs(Du,{children:[e.jsx(sj,{children:e.jsx(Bu,{children:t})}),e.jsx(ij,{children:n.map(s=>e.jsx(cj,{...s},s.id))})]}),uj=()=>e.jsx(zn,{children:e.jsxs(Du,{children:[e.jsx(Bu,{children:e.jsx(k,{width:50})}),e.jsx(Ou,{style:{padding:14},children:[0,1,2].map(t=>e.jsxs("div",{style:{display:"flex",gap:10,alignItems:"center"},children:[e.jsx(k,{width:20,height:20,circle:!0}),e.jsx("div",{style:{flexGrow:2},children:e.jsx(k,{width:100,style:{top:2}})}),e.jsx(k,{width:10,height:10,circle:!0,style:{top:6}})]},t))})]})}),_i=l.ul`
  ...
  list-style: none;
`,pj=()=>{const{formId:t,id:n}=V(),s=te(),{data:i,isFetching:o}=Go(t&&Number(t));nj();const{lastTab:r,setLastTab:a}=We("integrations");if(g.useEffect(()=>{r&&s(r)},[s,r]),g.useEffect(()=>{if(!n&&!r&&i){const u=i.find(Boolean);u&&(a(`${u.id}/${u.handle}`),s(`${u.id}/${u.handle}`))}},[n,i,r,s,a]),!i&&o)return e.jsx(De,{children:e.jsx(_i,{children:e.jsx(uj,{})})});if(!i&&!o)return e.jsx(De,{children:e.jsx(_i,{})});const c={};return i.forEach(u=>{const{type:h}=u;c[h]||(c[h]={type:h,label:d(h.replace("-"," ")),children:[]}),c[h].children.push(u)}),e.jsx(De,{$lean:!0,children:e.jsx(_i,{children:Object.values(c).map(u=>e.jsx(dj,{...u},u.type))})})},hj=()=>{const t=st("");return e.jsxs(Pu,{children:[e.jsx(q,{id:"integrations",label:d("Integrations"),url:t.pathname}),e.jsx(pj,{}),e.jsx(yt,{})]})},xj=({integration:t,property:n})=>{const s=H(),i=vs(t.properties,t.values,(r,a)=>{s(At.modify({id:t.id,key:r,value:a}))}),o=t.values[n.handle];return n.type===K.Hidden?null:e.jsx(je,{value:o,property:n,updateValue:i(n),errors:t?.errors?.[n.handle],context:t})},kr=l.div`
  flex: 1;
...
`,$j=({active:t,onClick:n,...s})=>{const i=g.useRef(null),o=kt(i),a={...vj({active:t,hovering:o}),...s?.style};return delete s.style,e.jsx(Uu,{type:"button",ref:i,style:a,onClick:n,...s,children:e.jsx(wj,{})})},Hu=t=>{const n=H(),[{isOver:s},i]=ss(()=>({accept:[ee.FieldType,ee.Field],collect:r=>({isOver:r.isOver({shallow:!0})}),canDrop:(r,a)=>a.isOver({shallow:!0}),drop:r=>{r.type===ee.FieldType&&n(Oe.move.newField.newRow({fieldType:r.data,layoutUid:t.uid})),r.type===ee.Field&&n(Oe.move.existingField.newRow({field:r.data,layoutUid:t.uid}))}}),[t]),o=Y({to:{opacity:s?1:0,transform:s?"scaleY(1)":"scaleY(0)"},config:{tension:300}});return{dropRef:i,placeholderAnimation:o}},Cj=l.div`
  position: relative;
  flex-grow: 1;
...
`,Gu=g.memo(({field:t,row:n,index:s,width:i,isOver:o,isCurrentRow:r,isDraggingField:a,dragFieldIndex:c,hoverPosition:u})=>{const h=H(),[x,f]=g.useState(!1),{isDragging:b,drag:j,preview:y}=Gj(t,s),w=Vj({width:i,isDragging:b,isOver:o,isCurrentRow:r,isDraggingField:a,dragFieldIndex:c,index:s,hoverPosition:u}),v=I.limitations.can("layout.fields.clone");return e.jsxs(e.Fragment,{children:[e.jsx(q1,{connect:y,src:Yj(t.properties?.label)}),e.jsxs(Vu,{onMouseEnter:()=>f(!0),onMouseLeave:()=>f(!1),ref:$=>{j($)},style:w,children:[v&&e.jsx($j,{active:x,onClick:()=>{h(ye.unfocus()),h(Oe.duplicate(t,n))}}),e.jsx(Tn,{active:x,onClick:()=>{h(ye.unfocus()),h(Oe.remove(t))}}),e.jsx(Qj,{field:t})]})]})});Gu.displayName="Field";const Jj=l(_.div)`
  position: absolute;
  top: 0;
  bottom: 0;
...
`;l(_.div)`
  ...
  flex-grow: 1;
  flex-shrink: 0;
`;const Sr=g.memo(({row:t})=>{const n=P(Ae.inRow(t)),{ref:s,dimensions:i}=yj(),o=i.width,r=i.x,{ref:a,isOver:c}=ty(t),u=Xj(c),h=ey(c),{ref:x,isOver:f,isCurrentRow:b,isDraggingField:j,dragFieldIndex:y,hoverPosition:w,fieldWidth:v}=ny(s,t,n.length,o,r),$=x(s);return e.jsxs(Yu,{ref:$,children:[e.jsx(iy,{ref:C=>{a(C)},children:e.jsx(oy,{style:u})}),e.jsxs(Ju,{style:h,children:[e.jsx(Zj,{isActive:f,hoverPosition:w,fieldWidth:v}),n.map((C,F)=>e.jsx(Gu,{field:C,row:t,isOver:f,hoverPosition:w,isCurrentRow:b,isDraggingField:j,dragFieldIndex:y,index:F,width:v||o},C.uid))]})]})});Sr.displayName="Row";const Lr=l.div`
  position: relative;
...
`,dy={back:"btn",save:"btn",submit:"btn btn-submit"},uy=({page:t})=>{const n=H(),{getTranslation:s}=Ce(t),{active:i,type:o,uid:r}=P(Ot.focus),a=g.useMemo(()=>i&&o===Yn.Page&&r===t.uid,[i,o,r,t.uid]),c=Zu(t),u=c.flat().map(b=>b.assetId).filter(Boolean),{data:h,isFetching:x}=fr(u,""),f=g.useCallback(b=>{const j=h?.[b]?.src;return x?e.jsx(cy,{}):e.jsx("img",{src:j,alt:`${b}Alt`})},[h,x]);return e.jsx(Lr,{children:e.jsx(Xu,{className:E(a&&"active"),onClick:()=>{n(ye.setFocusedItem({type:Yn.Page,uid:t.uid}))},children:c.map((b,j)=>e.jsx(So,{className:"page-buttons",children:b.map(({handle:y,label:w,iconPosition:v,assetId:$},C)=>e.jsxs(ep,{className:dy[y],type:"button",children:[$&&v==="left"&&f($),s(`${y}Label`,w),$&&v==="right"&&f($)]},C))},j))})})},tp=l.div`
  ...
  overflow-x: hidden;
  ${Q};
`,py=({page:t})=>{const n=Pt(s=>jt.pageLayout(s,t?.layoutUid));return e.jsxs(tp,{children:[n&&e.jsx(ly,{layout:n}),e.jsx(uy,{page:t})]})},np=l.div`
  margin: 10px 15px;
`,sp=l.div`
  display: flex;
  justify-content: flex-start;
...
`,Ay=l.div`
  text-transform: uppercase;
  font-size: 10px;
`,zr=({icon:t,label:n,dragRef:s,onClick:i})=>e.jsxs(Fr,{ref:o=>{s&&s(o)},onClick:i,title:n,children:[e.jsx(Ly,{dangerouslySetInnerHTML:{__html:t}}),e.jsx(Sy,{dangerouslySetInnerHTML:{__html:n}})]}),Mr=t=>{const{dragOn:n,dragOff:s}=ai(),[{isDragging:i},o]=qo(()=>({type:ee.FieldType,collect:r=>({isDragging:r.isDragging()}),item:{type:ee.FieldType,data:t}}));return g.useEffect(()=>{i?n(ee.FieldType):s()},[i,n,s]),{ref:o}},Ry=({fieldType:t})=>{const{icon:n,name:s}=t,i=H(),{ref:o}=Mr(t),r=()=>{i(Oe.move.newField.newRow({fieldType:t}))};return e.jsx(zr,{icon:n,label:d(s),onClick:r,dragRef:o})},Py=(t={})=>{const n=X(),s=t?.onSuccess;return t.onSuccess=(i,o,r,a)=>{s?.(i,o,r,a),n.invalidateQueries({queryKey:op.all})},le({...t,mutationFn:i=>T.post("/api/fields/types/groups",i)})},Ir=t=>e.jsxs(R,{height:"15",viewBox:"0 0 15 15",width:"15",...t,children:[e.jsx("path",{d:"m0 0h15v15h-15z",fill:"none"}),e.jsx("path",{d:"m7.5 9.61c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"}),e.jsx("path",{d:"m3.57 5.68c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"}),e.jsx("path",{d:"m11.43 5.68c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"}),e.jsx("path",{d:"m7.5 1.75c1.005 0 1.82.815 1.82 1.82s-.815 1.82-1.82 1.82-1.82-.815-1.82-1.82.815-1.82 1.82-1.82z"})]}),Dy=l.div`
  cursor: pointer;
...
`;dp.defaultProps={$empty:"Drag and drop any field here",color:p.black};const Vy=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.xs};
`,Gy=l.div`
...
`,V7=l.div`
  display: flex;
  justify-content: center;
`,G7=({field:t,type:n,mutation:s})=>{const[i,o]=g.useState("");return g.useEffect(()=>{o(t.properties.label||n?.name),s.reset()},[t.uid,n?.name]),e.jsxs(K7,{children:[e.jsx(ls,{children:e.jsx(Dt,{property:{label:d("Create a favorite"),handle:t.properties?.handle,flags:[],placeholder:t.properties?.label,type:K.String},value:i,updateValue:r=>o(r)})}),e.jsx(V7,{children:e.jsx("button",{type:"button",disabled:s.isPending,className:E("btn fullwidth",!s.isSuccess&&"submit",s.isPending&&"disabled"),onClick:()=>{s.mutate({label:i,field:t,type:n})},children:e.jsx(J,{spinner:!0,loading:s.isPending,loadingText:"Saving...",children:d(s.isSuccess?"Saved!":"Favorite")})})}),s.isError&&e.jsx(Q7,{category:"favorites",handle:"name",error:s.error})]})},jp=l(_.div)`
  position: absolute;
  top: 24px;
  right: -16px;
...
`,yp=l.div`
  ...
  flex-direction: column;
  gap: ${m.md};
`,cv=()=>{const t=st(""),n=yr(),{templates:s}=vr(""),{templates:{canCreate:i,method:o}}=I,r=()=>{n({type:"form"})};return e.jsxs(pi,{children:[e.jsx(q,{id:"notification-manager",label:d("Manager"),url:t.pathname}),e.jsxs(yp,{children:[e.jsx("h1",{children:d("Notification Manager")}),e.jsx(Fu,{children:e.jsx(Co,{value:"",title:d("Form Templates"),templates:s.form,openEditOnClick:!0,onClick:()=>{},canCreate:i&&o!==is.Global,onCreate:r})})]})]})},dv=l.div`
  display: flex;
  height: 100%;
...
`,Kv=()=>{const t=P(jt.cartographed.fullLayoutList);return e.jsx(zn,{children:t.map((n,s)=>e.jsxs("div",{children:[e.jsx("div",{style:{marginBottom:14},children:e.jsx(k,{width:"100%",height:30})}),n.map((i,o)=>e.jsx(Qv,{style:{display:"flex"},children:i.map((r,a)=>e.jsx(k,{width:"100%",height:28},a))},o))]},s))})},$p=l.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  flex-wrap: nowrap;
...
`,Yv=({field:t})=>{const n=I.limitations.can("rules.tab.fields"),{uid:s,button:i}=V(),o=te(),r=Ht(),{setLastTab:a}=We("rules"),c=Me(t?.typeClass),u=s===t.uid,h=P(un.one(s)),x=P(Br.one(s)),f=P(Or.one),b=P(Pr.one(s,i)),j=P(un.hasRule(t.uid)),y=r.pathname.endsWith("/rules/submit"),w=P(un.isInCondition(t.uid)),v=h?.conditions.find($=>$.field===t.uid)||x?.conditions.find($=>$.field===t.uid)||y&&f?.conditions.find($=>$.field===t.uid)||i&&b?.conditions.find($=>$.field===t.uid);return t?.properties===void 0?null:e.jsxs(Gv,{onClick:$=>{if($.stopPropagation(),n){const C=s===t.uid?"":`field/${t.uid}`;a(C),o(C)}},className:E(c?.type==="group"&&"group",u&&"active",j&&"has-rule",w&&"is-in-condition",v&&"is-in-condition-active",!n&&"read-only",Pn.negative.includes(v?.operator)&&"not-equals"),children:[e.jsxs($p,{children:[e.jsx(Cp,{dangerouslySetInnerHTML:{__html:O.sanitize(c?.icon)}}),e.jsx(Vv,{dangerouslySetInnerHTML:{__html:O.sanitize(t.properties.label||c?.name)}})]}),c?.type==="group"&&e.jsx(kp,{children:e.jsx(Sp,{layoutUid:t.properties.layout})})]})},Jv=({row:t})=>{const n=P(Ae.inRow(t));return e.jsx(wp,{children:n.map(s=>e.jsx(Yv,{field:s},s.uid))})},Zv=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.xs};
`,Sp=({layoutUid:t})=>{const n=Pt(i=>jt.one(i,t)),s=Pt(i=>ns.inLayout(i,n?.uid));return!n||!s.length?null:e.jsx(Zv,{children:s.map(i=>e.jsx(Jv,{row:i},i.uid))})},Xv=l.div`
  display: flex;
  justify-content: space-between;
...
`,ww=({form:t})=>{const n=te(),{getCurrentHandleWithFallback:s}=Fe(),i=X(),{id:o,name:r,links:a,dateArchived:c}=t,u=Vr(),h=u.isPending&&u.context===o,x=u.isSuccess&&u.context===o,{canDelete:f}=I.metadata.freeform,b=Kr({form:t}),j=()=>{i.invalidateQueries({queryKey:fe.single(Number(o))}),n(`${o}`)},y=a.filter(({type:$})=>$==="title").length,w=t.links.filter(({type:$})=>$==="linkList"),v=$=>bc(Qn($),"yyyy-MM-dd");return e.jsxs(jw,{className:E(h&&"disabled",x&&"restored"),children:[y?e.jsx(yw,{onClick:j,children:r}):e.jsx(Bp,{children:r}),c&&e.jsxs(vw,{children:["(",d("archived")," ",v(c),")"]}),w.length>0&&w.filter(({count:$})=>$).map(($,C)=>$.internal?e.jsx(zs,{children:e.jsx(he,{to:$.url,children:$.label})},C):e.jsx(zs,{children:e.jsx("a",{href:$.url,children:$.label})},C)),e.jsx(zs,{children:e.jsx("button",{type:"button",onClick:()=>{u.mutate(o)},children:d("Restore this Form")})}),f&&e.jsx(zs,{children:e.jsx("button",{type:"button",onClick:async $=>{$.metaKey&&$.shiftKey?(await T.post("/api/forms/delete",{id:o}),i.invalidateQueries({queryKey:ut.all(s())}),i.invalidateQueries({queryKey:fe.all(s())})):b()},children:d("Delete this Form and its Submissions")})})]})},$w=l.div`
  display: flex;
  flex-direction: column;
  gap: ${m.md};
`,Cw=l.button`
...
`,wk=(t,n,s=1)=>n(t).replace(/rgb\((\d+, \d+, \d+)\)/i,`rgba($1, ${s})`),$k=t=>{const n=Math.max(0,Math.min(1,t)),s=Math.max(0,Math.min(255,Math.round(34.61+n*(1172.33-n*(10793.56-n*(33300.12-n*(38394.49-n*14825.05))))))),i=Math.max(0,Math.min(255,Math.round(23.31+n*(557.33+n*(1225.33-n*(3574.96-n*(1073.77+n*707.56))))))),o=Math.max(0,Math.min(255,Math.round(27.2+n*(3211.1-n*(15327.97-n*(27814-n*(22569.18-n*6838.66)))))));return`rgb(${s}, ${i}, ${o})`},tc=Math.PI/180,d1=({breakdown:t,pie:n})=>{const s=t.filter(({votes:r})=>r>0),i=t.map(({ranking:r})=>wk(r/t.length,$k)),o=({cx:r,cy:a,midAngle:c,outerRadius:u,percent:h,index:x})=>{const f=u+30,b=r+f*Math.cos(-c*tc),j=a+f*Math.sin(-c*tc);return e.jsxs("text",{x:b,y:j,fill:"black",textAnchor:b>r?"start":"end",dominantBaseline:"central",children:[e.jsx("tspan",{style:{fontWeight:"bold"},children:s[x].label}),e.jsxs("tspan",{style:{fontSize:"12px",fill:"#999"},children:[" ","(",`${(h*100).toFixed(0)}%`,")"]})]},x)};return e.jsx("div",{style:{width:800},children:e.jsx(nt,{width:"100%",height:400,children:e.jsx(V1,{children:e.jsx(G1,{data:s,dataKey:"votes",nameKey:"label",cx:"50%",cy:"50%",outerRadius:180,innerRadius:n?0:100,fill:"#82ca9d",labelLine:!0,label:o,children:s.map((r,a)=>e.jsx(Y1,{fill:i[a]},`cell-${a}`))})})})})},Ck=()=>e.jsx("div",{children:"hidden"}),kk=l.div`
  display: grid;
  gap: 2px;
...
`,Tk=({breakdown:t})=>e.jsx(e.Fragment,{children:t.map(({label:n,value:s,votes:i,percentage:o,ranking:r})=>e.jsxs(kk,{children:[e.jsx(Sk,{children:n}),e.jsxs(Fk,{children:[i," ",d("resp.")]}),e.jsxs(Lk,{children:[Math.round(o),"%"]}),e.jsx(Ek,{percentage:o,ranking:r})]},s.toString()))}),Nk=({breakdown:t})=>e.jsx(d1,{breakdown:t,pie:!0}),zk=l.div``,Mk=l.div`
  padding: 10px 15px;

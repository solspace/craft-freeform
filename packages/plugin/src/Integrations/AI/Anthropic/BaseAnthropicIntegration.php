...
namespace Solspace\Freeform\Integrations\AI\Anthropic;
...
abstract class BaseAnthropicIntegration extends APIIntegration implements AiIntegrationInterface
{
    use DefaultTemperatureTrait;

    public const LOG_CATEGORY = 'Anthropic';

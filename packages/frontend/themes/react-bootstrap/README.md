...
Official Bootstrap 5 starter theme for Freeform React. It does **not** ship CSS or a copy of Bootstrap.
...
```bash
npm install @solspace/freeform-react-theme-bootstrap @solspace/freeform-react bootstrap
```

Do **not** import `@solspace/freeform-react-theme-default/styles.css` on the same form, or BEM styles will fight Bootstrap.
...
import { bootstrapTheme } from "@solspace/freeform-react-theme-bootstrap";
...
```tsx
import { createTheme } from "@solspace/freeform-react-theme-bootstrap";

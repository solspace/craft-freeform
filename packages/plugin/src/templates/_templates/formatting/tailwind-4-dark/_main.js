...
forms.forEach((function(e) {
  e.addEventListener("freeform-ready", (function(e) {
    var r = e.freeform;
    r.setOption("errorClassList", ["mt-1", "text-sm", "text-red-700"]),
    r.setOption("errorClassField", ["outline-1", "-outline-offset-1", "outline-red-700", "border-1", "border-red-700"])
  }));
  ...
  e.addEventListener('freeform-render-success', function (event) {
    ...
    successBlock.classList.add('freeform-success-banner', 'rounded-md', 'bg-green-900/20', 'p-4', 'mb-10');
    ...
    title.classList.add('text-md', 'font-medium', 'text-green-100');
  ...
  e.addEventListener('freeform-render-form-errors', function (event) {
    ...
    errorBlock.classList.add('freeform-error-banner', 'rounded-md', 'bg-red-900/20', 'p-4', 'mb-10');
    ...
    const title = document.createElement('h3');
    title.classList.add('text-md', 'font-medium', 'text-red-100');
    ...
    errorsListContainer.classList.add('mt-2', 'text-sm', 'text-red-200');
  ...
  e.addEventListener("freeform-on-submit", (function(e) {
    ...
    forms.forEach((function(e) {
      ...
      e.querySelectorAll(".freeform-input").forEach((e => e.classList.remove("border-red-700"))))
    }))
  }))
}));

...
Official Tailwind starter theme for Freeform React. It does **not** ship CSS or a copy of Tailwind.
...
```bash
npm install @solspace/freeform-react-theme-tailwind @solspace/freeform-react
```

Do **not** import `@solspace/freeform-react-theme-default/styles.css` on the same form, or BEM styles will fight the utilities.
...
content: [
  "./src/**/*.{js,ts,jsx,tsx}",
  "./node_modules/@solspace/freeform-react-theme-tailwind/dist/**/*.js",
],
```
...
```tsx
import { createTheme } from "@solspace/freeform-react-theme-tailwind";

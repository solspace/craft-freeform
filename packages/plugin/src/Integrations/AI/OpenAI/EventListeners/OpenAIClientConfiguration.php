...
namespace Solspace\Freeform\Integrations\AI\OpenAI\EventListeners;
...
class OpenAIClientConfiguration extends FeatureBundle
{
    ...
    public function configureClient(GetAuthorizedClientEvent $event): void
    {
        ...
        if (!$integration instanceof BaseOpenAIIntegration) {
            return;
        }

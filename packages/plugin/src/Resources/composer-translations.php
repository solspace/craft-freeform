...
return [
    ...
    'Date Time Type',
    'Use date, time or both.',
    'Both',
    'Time',
    "You can use 'now', 'today', '5 days ago', '2024-01-01 20:00:00', etc.",
    'Use built-in datepicker',
    'Use date format as placeholder',
    'Date order',
    ...
    'Four digit year',
    'Date leading zero',
    'Include a leading zero for day and month numbers.',
    'Date separator',
    ...
    'Validation',
    'Use built-in javascript validation on pattern',
    ...
    'Use built-in javascript for adding and removing rows',

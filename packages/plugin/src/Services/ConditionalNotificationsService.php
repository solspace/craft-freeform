...
class ConditionalNotificationsService extends AbstractNotificationService implements NotificationHandlerInterface
{
    ...
    {
        return NotificationRecord::TYPE_CONDITIONAL;
    }

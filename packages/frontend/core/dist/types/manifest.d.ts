...
export type SubmitIntent = "submit" | "next" | "back" | "validate" | "saveDraft";
export type ManifestSecurityIntegration = {
    name: string;
    errorMessage?: string;
    value?: string;
};
export type ManifestCaptchaProvider = "turnstile" | "recaptcha" | "hcaptcha" | "friendly-captcha" | string;
...
export type ConditionalOperator = "equals" | "notEquals" | "greaterThan" | "greaterThanOrEquals" | "lessThan" | "lessThanOrEquals" | "contains" | "notContains" | "startsWith" | "endsWith" | "isEmpty" | "isNotEmpty" | "isOneOf" | "isNotOneOf";

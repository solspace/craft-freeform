...
return [
    ...
    'Gibberish check failed' => 'Controle op onzin mislukt',
    'Gibberish Word Minimum Length' => 'Minimale lengte van onzinwoorden',
    'Allowed Terms' => 'Toegestane termen',
    'Default Allowed Terms' => 'Standaard toegestane termen',
    'Enter allowed terms you would like to be ignored as gibberish, and separate multiples on new lines. Example: RFP, ABB, KUKA or other technical phrases.' => 'Voer toegestane termen in die u als onzin wilt negeren en scheid meervouden op nieuwe regels. Bijvoorbeeld: RFP, ABB, KUKA of andere technische termen.',
    'Enter any field handles you would like checked for gibberish, and separate multiples on new lines. By default textarea type fields are automatically checked.' => 'Voer alle veldhandles in die u wilt controleren op onzin en scheid meervouden op nieuwe regels. Standaard worden velden van het type tekstvak automatisch gecontroleerd.',
    ...
    'If enabled, email field(s) will be checked for valid MX record.' => 'Indien ingeschakeld, worden e-mailvelden gecontroleerd op geldige MX-records.',
    'Check DNS Block Lists' => 'Controleer DNS-blokkeerlijsten',
    'If enabled, IP addresses will be checked against DNS block lists.' => 'Indien ingeschakeld, worden IP-adressen gecontroleerd aan de hand van DNS-blokkeerlijsten.',
    'DNS Block Lists' => 'DNS-blokkeerlijsten',
    'Enter DNS block lists you would like to be used, and separate multiples on new lines.' => 'Voer de DNS-blokkeerlijsten in die u wilt gebruiken en scheid meervouden op nieuwe regels.',

...
return [
    ...
    'Please check the <a href="{{ extra.url }}">{{ extra.type }}</a> to see if there are any potential issues.' => 'Please check the <a href="{{ extra.url }}">{{ extra.type }}</a> to see if there are any potential issues.',
    'error log' => 'error log',
    'integrations log' => 'integrations log',
    'email log' => 'email log',
    'forms' => 'forms',

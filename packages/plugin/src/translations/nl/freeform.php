...
return [
    ...
    'Allow File-based Email Templates to be managed inside the Notifications area' => 'Sta toe dat e-mailsjablonen op basis van bestanden worden beheerd in het gedeelte Meldingen',
    'Allowing users to modify or generate template files from inside the CP can potentially cause issues with certain workflows.' => 'Het toestaan van het aanpassen of genereren van sjabloonbestanden in het controlepaneel kan tot problemen leiden in bepaalde workflows.',
    ...
    'Recent Credit Usage' => 'Recent creditgebruik',
    'The number of requests (credit usage) per day for the last 30 days.' => 'Het aantal aanvragen (creditgebruik) per dag over de afgelopen 30 dagen.',
    'Requests' => 'Aanvragen',
    'SolspaceAI <span class="badge">Pro</span>' => 'SolspaceAI <span class="badge">Pro</span>',
    'SolspaceAI <span class="light">(enable)</span>' => 'SolspaceAI <span class="light">(inschakelen)</span>',
